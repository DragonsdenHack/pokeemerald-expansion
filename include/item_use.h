...
void ItemUseOutOfBattle_CandyXS(u8);
void ItemUseOutOfBattle_CandyS(u8);
void ItemUseOutOfBattle_CandyXM(u8);
void ItemUseOutOfBattle_CandyM(u8);
void ItemUseOutOfBattle_CandyL(u8);
void ItemUseOutOfBattle_CandyXL(u8);
