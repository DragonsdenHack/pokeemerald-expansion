...
#define MULTI_SILPH_ASCENSOR		       134
#define MULTI_CELADON_ASCENSOR		       135
#define MULTI_SILPH_ASCENSOR2			   136
...
#define MULTI_POKEMON_ASCENSOS             141
#define MULTI_POKEMON_ASCENSOS_DESPUES     142
