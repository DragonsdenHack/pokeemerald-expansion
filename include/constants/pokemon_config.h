...
#define ITEM_BUTTERFRITA         ITEM_NONE
...
#define ITEM_STARMIETITE         ITEM_NONE
...
#define ITEM_MILOTICITE          ITEM_NONE
#define ITEM_BANETTITE           ITEM_NONE
#define ITEM_AGGRONITE           ITEM_NONE
#define ITEM_FLYGONITE           ITEM_NONE
#define ITEM_GARDEVOIRITE        ITEM_NONE
#define ITEM_DUSKNOIRITA         ITEM_NONE
