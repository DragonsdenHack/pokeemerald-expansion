...
#define FLAG_HOENN_152 (TRAINER_FLAGS_END + 152) // CUEVA RUTA 120 || ITEM_TM123_SOLAR_BLADE ITEM_TM123 
#define FLAG_HOENN_153 (TRAINER_FLAGS_END + 153) // CUEVA GROUDON HOENN || ITEM_TM128_FISSURE ITEM_TM128
#define FLAG_HOENN_154 (TRAINER_FLAGS_END + 154) // CASINO MALVALONA S2 || ITEM_TM129_POISON_TAIL ITEM_TM129
#define FLAG_HOENN_155 (TRAINER_FLAGS_END + 155) // CUEVA REGIGIGAS || ITEM_TM131_EARTH_POWER ITEM_TM131
#define FLAG_HOENN_156 (TRAINER_FLAGS_END + 156) // S3 TORRE POKEMON || ITEM_TM134_CURSE ITEM_TM134
#define FLAG_HOENN_157 (TRAINER_FLAGS_END + 157) // DESIERTO HOENN || ITEM_TM139_SCORCHING_SANDS ITEM_TM139
#define FLAG_HOENN_158 (TRAINER_FLAGS_END + 158) // MONTE PÍRICO CIMA INTERIOR || ITEM_TM140_POLTERGEIST ITEM_TM140
#define FLAG_HOENN_159 (TRAINER_FLAGS_END + 159) // LABORATORIO OAK S2 || ITEM_TM141_STEEL_BEAM ITEM_TM141
#define FLAG_HOENN_160 (TRAINER_FLAGS_END + 160) // SECUNDARIA KANTO BAYAS || ITEM_TM143_LEECH_LIFE ITEM_TM143
#define FLAG_HOENN_161 (TRAINER_FLAGS_END + 161) // CUEVA GRANITO || ITEM_TM144_ROCK_BLAST ITEM_TM144
#define FLAG_HOENN_162 (TRAINER_FLAGS_END + 162) // ZONA CAMINO CULTO LAVANDA || ITEM_TM145_STORED_POWER ITEM_TM145
#define FLAG_HOENN_163 (TRAINER_FLAGS_END + 163) // CEMENTERIO GIMNASIO || ITEM_TM148_DREAM_EATER ITEM_TM148
#define FLAG_HOENN_164 (TRAINER_FLAGS_END + 164) // MALVALANOVA || ITEM_TM149_ZAP_CANNON ITEM_TM149
#define FLAG_HOENN_165 (TRAINER_FLAGS_END + 165) // TEMPLO PUNTANEVA || ITEM_TM151_ICICLE_SPEAR ITEM_TM151
#define FLAG_HOENN_166 (TRAINER_FLAGS_END + 166) // MONTE PÍRICO CIMA EXTERIOR || ITEM_TM152_MYSTICAL_FIRE ITEM_TM152
#define FLAG_HOENN_167 (TRAINER_FLAGS_END + 167) // CUEVA DE KYOGRE || ITEM_TM154_SHEER_COLD ITEM_TM154
#define FLAG_HOENN_168 (TRAINER_FLAGS_END + 168) // NEO FUCSIA ZONA NORTE ABANDONADA || ITEM_TM155_VENOSHOCK ITEM_TM155
#define FLAG_HOENN_169 (TRAINER_FLAGS_END + 169) // ZONA SAFARI HOENN || ITEM_TM157_PIN_MISSILE ITEM_TM157
#define FLAG_HOENN_170 (TRAINER_FLAGS_END + 170) // ZONA SAFARI HOENN || ITEM_TM160_HORN_DRILL ITEM_TM160
