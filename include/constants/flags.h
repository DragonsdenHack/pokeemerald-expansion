...
#define FLAG_HIDE_LILYCOVE_CONTEST_HALL_BLEND_MASTER                0x340 // PEGASO PADRE ESCUELA
#define FLAG_HIDE_GRANITE_CAVE_STEVEN                               0x341 // ZEUS TORRE BELLSPROUT
...
#define FLAG_HIDE_SLATEPORT_CITY_CAPTAIN_STERN                      0x348 // BLOQUEO ENCINAR
