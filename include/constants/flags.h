...
#define FLAG_HOENN_74 (TRAINER_FLAGS_END + 74) // BAYA 1, SECUNDARIA KANTO
#define FLAG_HOENN_75 (TRAINER_FLAGS_END + 75) // BAYA 2, SECUNDARIA KANTO
#define FLAG_HOENN_76 (TRAINER_FLAGS_END + 76) // BAYA 3, SECUNDARIA KANTO
#define FLAG_HOENN_77 (TRAINER_FLAGS_END + 77) // BAYA 4, SECUNDARIA KANTO
#define FLAG_HOENN_78 (TRAINER_FLAGS_END + 78) // BAYA 5, SECUNDARIA KANTO
#define FLAG_HOENN_79 (TRAINER_FLAGS_END + 79) // BAYA 6, SECUNDARIA KANTO
#define FLAG_HOENN_80 (TRAINER_FLAGS_END + 80) // BAYA 7, SECUNDARIA KANTO
#define FLAG_HOENN_81 (TRAINER_FLAGS_END + 81) // BAYA 8, SECUNDARIA KANTO
#define FLAG_HOENN_82 (TRAINER_FLAGS_END + 82) // BAYA 9, SECUNDARIA KANTO
#define FLAG_HOENN_83 (TRAINER_FLAGS_END + 83) // BAYA 10, SECUNDARIA KANTO
#define FLAG_HOENN_84 (TRAINER_FLAGS_END + 84) // Mercenarios secundaria Kanto Bayas
