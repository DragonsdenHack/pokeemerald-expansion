...
static const u8 sText_ABoosted[] = _("");
...
static const u8 sText_PkmnCoveredByVeil[] = _("¡El {B_ATK_PREFIX2} se\nprotegió con un Velo!");
...
static const u8 sText_ZPowerUnleashed[] = _("¡{B_ATK_NAME_WITH_PREFIX} despliega toda su\nfuerza para ejecutar un movimiento Z!");
...
static const u8 sText_TrainerBlockedBall[] = _("¡La BALL fue rechazada!");
static const u8 sText_DontBeAThief[] = _("¡No se puede capturar!");
...
static const u8 sText_AarghAlmostHadIt[] = _("¡Uy!\n¡Casi lo consigues!");
static const u8 sText_ShootSoClose[] = _("¡Qué pena!\n¡Te faltó poco!");
...
static const u8 sText_Someones[] = _("Bill");
...
static const u8 sText_SandstormIsRaging[] = _("La tormenta arrecia…");
...
// #if GAME_LANGUAGE == LANGUAGE_ENGLISH
 static const s8 sText_EnduredViaSturdy[] = _("¡{B_DEF_NAME_WITH_PREFIX} aguantó\nel golpe con {B_DEF_ABILITY}!");
    ...
    static const u8 sText_PkmnSurroundedWithVeilOfWater[] = _("¡El {B_ATK_NAME_WITH_PREFIX} se ha rodeado\ncon un velo de agua!");
    ...
    static const u8 sText_MoldBreakerEnters[] = _("¡{B_SCR_ACTIVE_NAME_WITH_PREFIX} tiene Rompemoldes!");
    ...
    static const u8 sText_TerrainBecomesPsychic[] = _("¡El terreno de combate se ha vuelto\nmuy extraño!");
	...
	static const u8 sText_CanActFaster[] = _("{B_ATK_NAME_WITH_PREFIX} actúa antes,\ngracias a {B_BUFF1}!");
	...
	static const u8 sText_PkmnAboutToBeAttackedByItsItem[] = _("¡{B_DEF_NAME_WITH_PREFIX} es\natacado por su {B_BUFF1}!");
