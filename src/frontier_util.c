...
{
    [FRONTIER_FACILITY_TOWER]   = TRAINER_TRAINER_164,
    [FRONTIER_FACILITY_DOME]    = TRAINER_PEGASO_DISCIPULO,
    [FRONTIER_FACILITY_PALACE]  = TRAINER_ELM_2,
    [FRONTIER_FACILITY_ARENA]   = TRAINER_AQUILES_2,
    [FRONTIER_FACILITY_FACTORY] = TRAINER_PRESIDENTE_SILPH,
    [FRONTIER_FACILITY_PIKE]    = TRAINER_MAGNO_2,
    [FRONTIER_FACILITY_PYRAMID] = TRAINER_HELIO,
};
