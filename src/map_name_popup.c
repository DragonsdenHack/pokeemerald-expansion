...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
	...
	[MAPSEC_ROUTE_28 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_31 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_VIOLET_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_ROUTE_36 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_32 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_33 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_34 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_GOLDENROD_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_ROUTE_37 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_38 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_39 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_OLIVINE_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_ROUTE_40 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_27 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_MT_SILVER - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROCKET_HIDEOUT_JOHTO - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
