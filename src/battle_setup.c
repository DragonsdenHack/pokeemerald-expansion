...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ANDRES] = REMATCH(TRAINER_LADRON_3, TRAINER_LYSSON, TRAINER_LUSAMINE, TRAINER_CHAIRMAN_ROSE, TRAINER_GIOVANNI_2, ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_BRUNO_1, TRAINER_ANDRA_5, TRAINER_BILL_2, TRAINER_SILPH, TRAINER_OAK_1, ROUTE111),
    [REMATCH_LOLA] = REMATCH(TRAINER_PANUELO, TRAINER_LOLA_2, TRAINER_LOLA_3, TRAINER_LOLA_4, TRAINER_LOLA_5, ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_RICKY_1, TRAINER_CMIGUEL_3, TRAINER_RICKY_3, TRAINER_RICKY_4, TRAINER_RICKY_5, ROUTE109),
    [REMATCH_LILA_AND_ROY] = REMATCH(TRAINER_LILA_AND_ROY_1, TRAINER_LILA_AND_ROY_2, TRAINER_LILA_AND_ROY_3, TRAINER_SLOWBRO, TRAINER_LILA_AND_ROY_5, ROUTE124),
    ...
    [REMATCH_WILTON] = REMATCH(TRAINER_JADEN, TRAINER_ZEUS_3, TRAINER_MAGMAADMIN, TRAINER_AQUAADMIN, TRAINER_GIOVANNI_1, ROUTE111),
    ...
    [REMATCH_FERNANDO] = REMATCH(TRAINER_FERNANDO_1, TRAINER_CAMPEON_FANTASMA, TRAINER_CAMPEON_VENENO, TRAINER_FERNANDO_4, TRAINER_FERNANDO_5, ROUTE123),
    ...
    [REMATCH_CALVIN] = REMATCH(TRAINER_CALVIN_1, TRAINER_CALVIN_2, TRAINER_PETREL, TRAINER_ANDRA_6, TRAINER_AZUL_3, ROUTE102),
    ...
    [REMATCH_DYLAN] = REMATCH(TRAINER_PROTON, TRAINER_ANDRA_9, TRAINER_DIANTA, TRAINER_CINTIA, TRAINER_DYLAN_5, ROUTE117),
    ...
    [REMATCH_PABLO] = REMATCH(TRAINER_PABLO_1, TRAINER_ANDRA_9 , TRAINER_DIANTA, TRAINER_CINTIA, TRAINER_PABLO_5, ROUTE126),
    ...
    [REMATCH_ROBERT] = REMATCH(TRAINER_ROBERT_1, TRAINER_ROBERT_2, TRAINER_ROBERT_3, TRAINER_LORELEI, TRAINER_BRUNO_2, ROUTE120),
    [REMATCH_LAO] = REMATCH(TRAINER_KOGA, TRAINER_SABRINA, TRAINER_LAO_3, TRAINER_LAO_4, TRAINER_LAO_5, ROUTE113),
    [REMATCH_CYNDY] = REMATCH(TRAINER_AZUL_1, TRAINER_AYUDANTE_1, TRAINER_AYUDANTE_2, TRAINER_AYUDANTE_3, TRAINER_AYUDANTE_4, ROUTE115),
    [REMATCH_MADELINE] = REMATCH(TRAINER_AYUDANTE_5, TRAINER_GUARDA, TRAINER_ATLAS_1, TRAINER_ANDRA_8, TRAINER_BILL_3, ROUTE113),
    ...
    [REMATCH_ERNEST] = REMATCH(TRAINER_ERNEST_1, TRAINER_ENTRENAMIENTO_5, TRAINER_ENTRENAMIENTO_6, TRAINER_ENTRENAMIENTO_7, TRAINER_ERNEST_5, ROUTE125),
    [REMATCH_CORY] = REMATCH(TRAINER_ATLAS_3, TRAINER_PRESIDENTE_DEVON_2, TRAINER_CMIGUEL_4, TRAINER_BILL_4, TRAINER_EUSINE, ROUTE108),
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_ALTORANGO, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MT_PYRE_3F),
    ...
    [REMATCH_BRAWLY] = REMATCH(TRAINER_BRAWLY_1, TRAINER_BRAWLY_2, TRAINER_BRAWLY_3, TRAINER_AGATHA_2, TRAINER_CULTO_3, DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_WATTSON_1, TRAINER_ZEUS_4, TRAINER_WATTSON_3, TRAINER_WATTSON_4, TRAINER_WATTSON_5, MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_FLANNERY_1, TRAINER_CULTO_2, TRAINER_ESENCIA_HOOH, TRAINER_ESENCIA_LUGIA, TRAINER_ESENCIA_ZIGARDE, LAVARIDGE_TOWN),
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN_1, TRAINER_NORMAN_2, TRAINER_ESENCIA_1, TRAINER_ESENCIA_2, TRAINER_ESENCIA_3, PETALBURG_CITY),
    [REMATCH_WINONA] = REMATCH(TRAINER_WINONA_1, TRAINER_ESENCIA_4, TRAINER_ESENCIA_5, TRAINER_ESENCIA_6, TRAINER_RECLUTA_BALL_1, FORTREE_CITY),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_TATE_AND_LIZA_1, TRAINER_RECLUTA_BALL_2, TRAINER_TATE_AND_LIZA_3, TRAINER_GRANJERO_1, TRAINER_GRANJERO_2, MOSSDEEP_CITY),
    [REMATCH_JUAN] = REMATCH(TRAINER_JUAN_1, TRAINER_LADRON_4, TRAINER_LADRON_4, TRAINER_LADRON_4, TRAINER_SHAKURA, SOOTOPOLIS_CITY),
