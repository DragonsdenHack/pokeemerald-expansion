...
#define SOUND_LIST_BGM \
    ...
    X(MUS_ENCOUNTER_ANDRA, "MUS-ENCOUNTER-ANDRA") \
    X(MUS_BASEPROFUNDA, "MUS-BASEPROFUNDA") \
    X(MUS_UNKNOWN_CHAMBER, "MUS-UNKNOWN-CHAMBER") \
	X(MUS_UNKNOWN_CHAMBER2, "MUS-UNKNOWN-CHAMBER2") \
    X(MUS_BW_CASTILLO, "MUS-BW-CASTILLO") \
	X(MUS_BW_CASTILLO2, "MUS-BW-CASTILLO2") \
    X(MUS_BW_ROUTE10, "MUS-BW-ROUTE10") \
    X(MUS_ENCOUNTER_MIRTO, "MUS-ENCOUNTER-MIRTO") \
    X(MUS_PORTADA, "MUS-PORTADA") \
    X(MUS_ROCAOMBLIGO, "MUS-ROCAOMBLIGO") \
    X(MUS_VS_ANDRA, "MUS-VS-ANDRA") \
    X(MUS_VS_ATLAS, "MUS-VS-ATLAS") \
	X(MUS_VS_RED, "MUS-VS-RED") \
    X(MUS_VS_LANCE, "MUS-VS-LANCE") \
    X(MUS_VS_LUGIA, "MUS-VS-LUGIA") \
    X(MUS_VS_BILL, "MUS-VS-BILL") \
    X(MUS_VS_OAK, "MUS-VS-OAK") \
    X(MUS_VS_SECTA, "MUS-VS-SECTA") \
    X(MUS_VS_JONES, "MUS-VS-JONES") \
	X(MUS_VS_ELM, "MUS-VS-ELM") \
	X(MUS_VS_TRAINER2, "MUS-VS-TRAINER2") \
	X(MUSSAQUA, "MUS-SAQUA") \
    X(MUS_GSC_VS_WILD, "MUS-GSC-VS-WILD") \
	X(MUS_GIOVANNI_ENCOUNTER, "MUS-GIOVANNI-ENCOUNTER") \
    X(MUS_VS_GIOVANNI, "MUS-VS-GIOVANNI") \
	X(MUS_GSC_VS_LEADER, "MUS-GSC-VS-LEADER") \
	X(MUS_GSC_ROCKET_HIDEOUT, "MUS-GSC-ROCKET-HIDEOUT") \
	X(MUS_ZEUS_ENCOUNTER, "MUS-ZEUS-ENCOUNTER") \
	X(MUS_VS_ZEUS, "MUS-VS-ZEUS") \
	X(MUS_GSC_NEW_BARK, "MUS-GSC-NEW-BARK") \
	X(MUS_GSC_CHERRYGROVE_CITY, "MUS-GSC-CHERRYGROVE-CITY") \
	X(MUS_GSC_ECRUTEAK_CITY, "MUS-GSC-ECRUTEAK-CITY") \
	X(MUS_GSC_GOLDENROD_CITY, "MUS-GSC-GOLDENROD-CITY") \
	X(MUS_GSC_BELLSPROUT_TOWER, "MUS-GSC-BELLSPROUT-TOWER") \
	X(MUS_GSC_BELLSPROUT_TOWER2, "MUS-GSC-BELLSPROUT-TOWER2") \
	X(MUS_GSC_TIN_TOWER, "MUS-GSC-TIN-TOWER") \
	X(MUS_GSC_DARK_CAVE, "MUS-GSC-DARK-CAVE") \
	X(MUS_GSC_DRAGON_HIDEOUT, "MUS-GSC-DRAGON-HIDEOUT") \
	X(MUS_GSC_ENCOUNTER_1, "MUS-GSC-ENCOUNTER-1") \
	X(MUS_GSC_ENCOUNTER_2, "MUS-GSC-ENCOUNTER-2") \
	X(MUS_GSC_ENCOUNTER_3, "MUS-GSC-ENCOUNTER-3") \
	X(MUS_GSC_ENCOUNTER_4, "MUS-GSC-ENCOUNTER-4") \
	X(MUS_GSC_ENCOUNTER_KIMONO, "MUS-GSC-ENCOUNTER-KIMONO") \
	X(MUS_GSC_ENCOUNTER_PENSADOR, "MUS-GSC-ENCOUNTER-PENSANDOR") \
	X(MUS_GSC_ENCOUNTER_ROCKET, "MUS-GSC-ENCOUNTER-ROCKET") \
	X(MUS_GSC_GAME_CORNER, "MUS-GSC-GAME-CORNER") \
	X(MUS_GSC_GYM, "MUS-GSC-GYM") \
	X(MUS_GSC_INDIGO_PLATEAU, "MUS-GSC-INDIGO-PLATEAU") \
	X(MUS_GSC_LAVENDER_TOWN, "MUS-GSC-LAVENDER-TOWN") \
	X(MUS_GSC_VS_LEADER_KANTO, "MUS-GSC-VS-LEADER-KANTO") \
	X(MUS_GSC_MT_SILVER, "MUS-GSC-MT-SILVER") \
	X(MUS_GSC_NATIONAL_PARK, "MUS-GSC-NATIONAL-PARK") \
	X(MUS_GSC_ROUTE26, "MUS-GSC-ROUTE26") \
	X(MUS_GSC_ROUTE29, "MUS-GSC-ROUTE29") \
	X(MUS_GSC_ROUTE30, "MUS-GSC-ROUTE30") \
	X(MUS_GSC_ROUTE32, "MUS-GSC-ROUTE32") \
	X(MUS_GSC_ROUTE34, "MUS-GSC-ROUTE34") \
	X(MUS_GSC_RUINS_OF_ALPH, "MUS-RUINS-OF-ALPH") \
	X(MUS_GSC_RUINS_OF_ALPH2, "MUS-RUINS-OF-ALPH2") \
	X(MUS_GSC_SURF, "MUS-GSC-SURF") \
	X(MUS_GSC_BURN_TOWER, "MUS-GSC-BURN-TOWER") \
	X(MUS_GSC_VICTORY_ROAD, "MUS-GSC-VICTORY-ROAD") \
	X(MUS_GSC_VS_ROCKET, "MUS-GSC-VS-ROCKET") \
	X(MUS_GSC_VS_TRAINER, "MUS-GSC-VS-TRAINER") \
	X(MUS_END_OF_TIME, "MUS-END-OF-TIME") \
	X(MUS_RG_VS_LEGEND2, "MUS-RG-VS-LEGEND2") \
	X(MUS_DRAGONSPIRAL_TOWER, "MUS-DRAGONSPIRAL") \
	X(MUS_SINJOH_RUINS, "MUS-SINJOH-RUINS") \
	X(MUS_VS_DEVON_BOSS, "MUS-VS-DEVON-BOSS") \
	X(MUS_GALACTIC_VICTORY, "MUS-GALACTIC-VICTORY") \
	X(MUS_HGSS_ROUTE47, "MUS-HGSS-ROUTE47") \
	X(MUS_VS_HOOH, "MUS-VS-HOOH") \
	X(MUS_HOOH_ENCOUNTER, "MUS-HOOH-ENCOUNTER") \
	X(MUS_HOOH_SUMMONING, "MUS-HOOH-SUMMONING") \
	X(MUS_VS_EUSINE, "MUS-VS-EUSINE") \
	X(MUS_VS_COLRESS, "MUS-VS-COLRESS") \
	X(MUS_NS_CASTLE, "MUS-NS-CASTLE") \
	X(MUS_VS_KYUREM_FUSION, "MUS-VS-KYUREM-FUSION") \
	X(MUS_VICTORY_PLASMA, "MUS-VICTORY-PLASMA") \
	X(MUS_NS_CASTLE_BRIDGE, "MUS-NS-CASTLE-BRIDGE") \
	X(MUS_VS_MIRTO, "MUS-VS-MIRTO") \
