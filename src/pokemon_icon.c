...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_EONEON] = gMonIcon_Eoneon,
    [SPECIES_TRXATU] = gMonIcon_Trxatu,
    [SPECIES_ELECTRODE_Y] = gMonIcon_ElectrodeY,
    [SPECIES_TAUROS_X] = gMonIcon_TaurosX,
    [SPECIES_PORYGON3] = gMonIcon_Porygon3,
    [SPECIES_ELECTIVIRE_X] = gMonIcon_ElectivireX,
    [SPECIES_MAGMORTAR_Y] = gMonIcon_MagmortarY,
    [SPECIES_NIDOQUEEN_Y] = gMonIcon_NidoqueenY,
    [SPECIES_NIDOKING_X] = gMonIcon_NidokingX,
    [SPECIES_PORYGONZ_X] = gMonIcon_PorygonZX,
    [SPECIES_PORYGONZ_Y] = gMonIcon_PorygonZY,
    [SPECIES_NIDOGOD] = gMonIcon_Nidogod,
    [SPECIES_AERODACTYL_SKEL] = gMonIcon_AerodactylSkel,
    [SPECIES_CRADILY_Y] = gMonIcon_CradilyY,
    [SPECIES_RAMPARDOS_X] = gMonIcon_RampardosX,
    [SPECIES_BASTIODON_X] = gMonIcon_BastiodonX,
    [SPECIES_TYRANTRUM_X] = gMonIcon_TyrantrumX,
    [SPECIES_ARCHEOPS_X] = gMonIcon_ArcheopsX,
    [SPECIES_REGIROCK_X] = gMonIcon_RegirockX,
    [SPECIES_REGICE_Y] = gMonIcon_RegiceY,
    [SPECIES_REGISTEEL_Z] = gMonIcon_RegisteelZ,
    [SPECIES_DEOXYS_ATTACK_Y] = gMonIcon_DeoxysAttackY,
    [SPECIES_DEOXYS_SPEED_Y] = gMonIcon_DeoxysSpeedY,
    [SPECIES_MEWTWO_ARM] = gMonIcon_MewtwoArm,
    [SPECIES_GENESECT_X] = gMonIcon_GenesectX,
    [SPECIES_GENESECT_Y] = gMonIcon_GenesectY,
    [SPECIES_ULTIMATE_PROYECT] = gMonIcon_UltimateProyect,
    [SPECIES_POLIWRATH_BOND] = gMonIcon_PoliwrathBond,
    [SPECIES_BUTTERFREE_BOND] = gMonIcon_ButterfreeBond,
    [SPECIES_FERALIGATR_BOND] = gMonIcon_FeraligatrBond,
    [SPECIES_RAPIDASH_BOND] = gMonIcon_RapidashBond,
    [SPECIES_KINGDRA_BOND] = gMonIcon_KingdraBond,
    [SPECIES_SKARMORY_BOND] = gMonIcon_SkarmoryBond,
    [SPECIES_EEVEE_BOND] = gMonIcon_EeveeBond,
    [SPECIES_HYPNO_BOND] = gMonIcon_HypnoBond,
    [SPECIES_DUNSPARCE_OLD] = gMonIcon_DunsparceOld,
    [SPECIES_DELPHOX_BOND] = gMonIcon_DelphoxBond,
    [SPECIES_RHYPERIOR_BOND] = gMonIcon_RhyperiorBond,
    [SPECIES_LAPRAS_BOND] = gMonIcon_LaprasBond,
    [SPECIES_EMPOLEON_BOND] = gMonIcon_EmpoleonBond,
    [SPECIES_INFERNAPE_BOND] = gMonIcon_InfernapeBond,
    [SPECIES_MESPRIT_BOND] = gMonIcon_MespritBond,
    [SPECIES_SERPERIOR_BOND] = gMonIcon_SerperiorBond,
    [SPECIES_HAXORUS_BOND] = gMonIcon_HaxorusBond,
    [SPECIES_WEAVILE_BOND] = gMonIcon_WeavileBond,
    [SPECIES_AEGISLASH_BOND] = gMonIcon_AegislashBond,
    [SPECIES_VOLCARONA_BOND] = gMonIcon_VolcaronaBond,
    [SPECIES_GOODRA_BOND] = gMonIcon_GoodraBond,
    [SPECIES_HYDREIGON_BOND] = gMonIcon_HydreigonBond,
    [SPECIES_DRAGONITE_BOND] = gMonIcon_DragoniteBond,
    [SPECIES_MAROGHOST] = gMonIcon_Maroghost,
    [SPECIES_KABUTOPS_SKEL] = gMonIcon_KabutopsSkel,
    [SPECIES_DUDUNSPARCE] = gMonIcon_Dudunsparce,
    [SPECIES_GHOST] = gMonIcon_Ghost,
    [SPECIES_UNOWN_GOLD] = gMonIcon_UnownGold,
    [SPECIES_UNOWN_KING] = gMonIcon_UnownKing,
    [SPECIES_ARTICUNO_PRIMAL] = gMonIcon_ArticunoPrimal,
    [SPECIES_ZAPDOS_PRIMAL] = gMonIcon_ZapdosPrimal,
    [SPECIES_MOLTRES_PRIMAL] = gMonIcon_MoltresPrimal,
    [SPECIES_RAIKOU_BOND] = gMonIcon_RaikouBond,
    [SPECIES_ENTEI_BOND] = gMonIcon_EnteiBond,
    [SPECIES_SUICUNE_BOND] = gMonIcon_SuicuneBond,
    [SPECIES_KURUSU] = gMonIcon_Kurusu,
    [SPECIES_AKUA] = gMonIcon_Akua,
    [SPECIES_AKUERIA] = gMonIcon_Akueria,
    [SPECIES_BOOHOO] = gMonIcon_Boohoo,
    [SPECIES_IKARY] = gMonIcon_Ikary,
    [SPECIES_PURAKKUSU] = gMonIcon_Purakkusu,
    [SPECIES_RAICHU_EVO] = gMonIcon_Raichu,
    [SPECIES_OCTILLERY_EVO] = gMonIcon_Octillery,
    [SPECIES_QWILFISH_EVO] = gMonIcon_Qwilfish,
    [SPECIES_TAABAN] = gMonIcon_Taaban,
    [SPECIES_BOMUSHIKAA] = gMonIcon_Bomushikaa,
    [SPECIES_MADAAMU] = gMonIcon_Madaamu,
    [SPECIES_SUI] = gMonIcon_Sui,
    [SPECIES_RAI] = gMonIcon_Rai,
    [SPECIES_EN] = gMonIcon_En,
    [SPECIES_SACRED_DRAGON] = gMonIcon_SacredDragon,
    [SPECIES_ORIGINAL_DRAGON] = gMonIcon_OriginalDragon,
    [SPECIES_ARCEUS_PRIMAL] = gMonIcon_ArceusPrimal,
    ...
    [SPECIES_DUSKNOIR_MEGA] = gMonIcon_DusknoirMega,
    [SPECIES_FLYGON_MEGA] = gMonIcon_FlygonMega,
    [SPECIES_STARMIE_MEGA] = gMonIcon_StarmieMega,
    [SPECIES_BUTTERFREE_MEGA] = gMonIcon_ButterfreeMega,
    [SPECIES_NOIVERN_MEGA] = gMonIcon_NoivernMega,
    [SPECIES_MILOTIC_MEGA] = gMonIcon_MiloticMega,
    [SPECIES_PORYGON_Z_MEGA] = gMonIcon_PorygonZMega,
    [SPECIES_COFAGRIGUS_MEGA] = gMonIcon_CofagrigusMega,
    [SPECIES_DURALUDON_MEGA] = gMonIcon_DuraludonMega,
    ...
    [SPECIES_DARKRAI_PRIMAL] = gMonIcon_DarkraiPrimal,
    [SPECIES_HO_OH_PRIMAL] = gMonIcon_HoOhPrimal,
    [SPECIES_LUGIA_PRIMAL] = gMonIcon_LugiaPrimal,
    [SPECIES_CELEBI_PRIMAL] = gMonIcon_CelebiPrimal,
    [SPECIES_JIRACHI_PRIMAL] = gMonIcon_JirachiPrimal,
    [SPECIES_VICTINI_PRIMAL] = gMonIcon_VictiniPrimal,
    [SPECIES_REGIGIGAS_PRIMAL] = gMonIcon_RegigigasPrimal,
    [SPECIES_DIALGA_PRIMAL] = gMonIcon_DialgaPrimal,
    [SPECIES_PALKIA_PRIMAL] = gMonIcon_PalkiaPrimal,
    [SPECIES_KYUREM_PRIMAL] = gMonIcon_KyuremPrimal,
    ...
    [SPECIES_AERODACTYL_PRIMAL] = gMonIcon_AerodactylPrimal,
    [SPECIES_CROBAT_BOND] = gMonIcon_CrobatBond,
    [SPECIES_CROBAT2_BOND] = gMonIcon_Crobat2Bond,
    [SPECIES_KABUTOPS_PRIMAL] = gMonIcon_KabutopsPrimal,
    [SPECIES_GHOST_PRIMAL] = gMonIcon_GhostPrimal,
    [SPECIES_MAMOSWINE_BOND] = gMonIcon_MamoswineBond,
    [SPECIES_DECIDUEYE_HISUI] = gMonIcon_DecidueyeHisui,
    [SPECIES_TYPHLOSION_HISUI] = gMonIcon_TyphlosionHisui,
    [SPECIES_SAMUROTT_HISUI] = gMonIcon_SamurottHisui,
    [SPECIES_WYRDEER] = gMonIcon_Wyrdeer,
    [SPECIES_KLEAVOR] = gMonIcon_Kleavor,
    [SPECIES_QWILFISH_HISUI] = gMonIcon_QwilfishHisui,
    [SPECIES_OVERQWIL] = gMonIcon_Overqwil,
    [SPECIES_LILLIGANT_HISUI] = gMonIcon_LilligantHisui,
    [SPECIES_URSALUNA] = gMonIcon_Ursaluna,
    [SPECIES_SLIGGOO_HISUI] = gMonIcon_SliggooHisui,
    [SPECIES_GOODRA_HISUI] = gMonIcon_GoodraHisui,
    [SPECIES_GROWLITHE_HISUI] = gMonIcon_GrowlitheHisui,
    [SPECIES_ARCANINE_HISUI] = gMonIcon_ArcanineHisui,
    ...
    [SPECIES_VOLTORB_HISUI] = gMonIcon_VoltorbHisui,
    [SPECIES_ELECTRODE_HISUI] = gMonIcon_ElectrodeHisui,
    [SPECIES_SNEASEL_HISUI] = gMonIcon_SneaselHisui,
    [SPECIES_SNEASLER] = gMonIcon_Sneasler,
    [SPECIES_AVALUGG_HISUI] = gMonIcon_AvaluggHisui,
    [SPECIES_ZORUA_HISUI] = gMonIcon_ZoruaHisui,
    [SPECIES_ZOROARK_HISUI] = gMonIcon_ZoroarkHisui,
    [SPECIES_BRAVIARY_HISUI] = gMonIcon_BraviaryHisui,
    ...
    [SPECIES_WOOPER_PALDEA] = gMonIcon_WooperPaldea,
    [SPECIES_CLODSIRE] = gMonIcon_Clodsire,
    [SPECIES_ANNIHILAPE] = gMonIcon_Annihilape,
    [SPECIES_FARIGIRAF] = gMonIcon_Farigiraf,
    [SPECIES_TAUROS_PALDEA_COMBAT] = gMonIcon_TaurosPaldeaCombat,
    [SPECIES_TAUROS_PALDEA_BLAZE] = gMonIcon_TaurosPaldeaBlaze,
    [SPECIES_TAUROS_PALDEA_AQUA] = gMonIcon_TaurosPaldeaAqua,
...
const u8 *const gMonIconTableFemale[] =
{
    ...
    [SPECIES_DUNSPARCE_OLD] = gMonIcon_DunsparceOldF,
};
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_NIDOGOD] = 2,
    [SPECIES_AERODACTYL_SKEL] = 1,
    [SPECIES_CRADILY_Y] = 1,
    [SPECIES_RAMPARDOS_X] = 1,
    [SPECIES_BASTIODON_X] = 1,
    [SPECIES_TYRANTRUM_X] = 1,
    [SPECIES_ARCHEOPS_X] = 1,
    [SPECIES_REGIROCK_X] = 1,
    [SPECIES_REGICE_Y] = 1,
    [SPECIES_REGISTEEL_Z] = 1,
    [SPECIES_DEOXYS_ATTACK_Y] = 1,
    [SPECIES_DEOXYS_SPEED_Y] = 1,
    [SPECIES_MEWTWO_ARM] = 1,
    [SPECIES_GENESECT_X] = 1,
    [SPECIES_GENESECT_Y] = 1,
    [SPECIES_ULTIMATE_PROYECT] = 1,
    [SPECIES_POLIWRATH_BOND] = 1,
    [SPECIES_BUTTERFREE_BOND] = 0,
    [SPECIES_FERALIGATR_BOND] = 1,
    [SPECIES_RAPIDASH_BOND] = 1,
    [SPECIES_KINGDRA_BOND] = 1,
    [SPECIES_SKARMORY_BOND] = 1,
    [SPECIES_EEVEE_BOND] = 1,
    [SPECIES_HYPNO_BOND] = 1,
    [SPECIES_DUNSPARCE_OLD] = 0,
    [SPECIES_DELPHOX_BOND] = 1,
    [SPECIES_RHYPERIOR_BOND] = 1,
    [SPECIES_LAPRAS_BOND] = 1,
    [SPECIES_EMPOLEON_BOND] = 1,
    [SPECIES_INFERNAPE_BOND] = 1,
    [SPECIES_MESPRIT_BOND] = 1,
    [SPECIES_SERPERIOR_BOND] = 1,
    [SPECIES_HAXORUS_BOND] = 1,
    [SPECIES_WEAVILE_BOND] = 1,
    [SPECIES_AEGISLASH_BOND] = 1,
    [SPECIES_VOLCARONA_BOND] = 1,
    [SPECIES_GOODRA_BOND] = 1,
    [SPECIES_HYDREIGON_BOND] = 1,
    [SPECIES_DRAGONITE_BOND] = 1,
    [SPECIES_MAROGHOST] = 1,
    [SPECIES_KABUTOPS_SKEL] = 1,
    [SPECIES_DUDUNSPARCE] = 0,
    [SPECIES_GHOST] = 1,
    [SPECIES_UNOWN_GOLD] = 1,
    [SPECIES_UNOWN_KING] = 1,
    [SPECIES_ARTICUNO_PRIMAL] = 1,
    [SPECIES_ZAPDOS_PRIMAL] = 0,
    [SPECIES_MOLTRES_PRIMAL] = 1,
    ...
    [SPECIES_IKARY] = 0,
    [SPECIES_PURAKKUSU] = 2,
    [SPECIES_RAICHU_EVO] = 0,
    [SPECIES_OCTILLERY_EVO] = 0,
    [SPECIES_QWILFISH_EVO] = 0,
    [SPECIES_TAABAN] = 0,
    [SPECIES_BOMUSHIKAA] = 0,
    [SPECIES_MADAAMU] = 1,
    [SPECIES_SUI] = 1,
    [SPECIES_RAI] = 1,
    [SPECIES_EN] = 1,
    [SPECIES_SACRED_DRAGON] = 0,
    [SPECIES_ORIGINAL_DRAGON] = 1,
    [SPECIES_ARCEUS_PRIMAL] = 1,
    [SPECIES_MISSINGNO] = 1,
    ...
    [SPECIES_DARKRAI_PRIMAL] = 1,
    [SPECIES_HO_OH_PRIMAL] = 1,
    [SPECIES_LUGIA_PRIMAL] = 1,
    [SPECIES_CELEBI_PRIMAL] = 1,
    [SPECIES_JIRACHI_PRIMAL] = 1,
    [SPECIES_VICTINI_PRIMAL] = 1,
    [SPECIES_REGIGIGAS_PRIMAL] = 1,
    [SPECIES_DIALGA_PRIMAL] = 2,
    [SPECIES_PALKIA_PRIMAL] = 2,
    [SPECIES_KYUREM_PRIMAL] = 1,
    ...
    [SPECIES_AERODACTYL_PRIMAL] = 1,
    [SPECIES_CROBAT_BOND] = 2,
    [SPECIES_CROBAT2_BOND] = 2,
    [SPECIES_KABUTOPS_PRIMAL] = 1,
    [SPECIES_GHOST_PRIMAL] = 1,
    [SPECIES_MAMOSWINE_BOND] = 2,
    [SPECIES_DECIDUEYE_HISUI] = 0,
    [SPECIES_TYPHLOSION_HISUI] = 1,
    [SPECIES_SAMUROTT_HISUI] = 0,
    [SPECIES_WYRDEER] = 2,
    [SPECIES_KLEAVOR] = 2,
    [SPECIES_QWILFISH_HISUI] = 0,
    [SPECIES_OVERQWIL] = 2,
    [SPECIES_LILLIGANT_HISUI] = 1,
    [SPECIES_URSALUNA] = 2,
    [SPECIES_SLIGGOO_HISUI] = 2,
    [SPECIES_GOODRA_HISUI] = 2,
    [SPECIES_GROWLITHE_HISUI] = 0,
    [SPECIES_ARCANINE_HISUI] = 0,
    [SPECIES_BASCULIN_WHITE_STRIPED] = 0,
    [SPECIES_BASCULEGION] = 1,
    [SPECIES_BASCULEGION_FEMALE] = 0,
    [SPECIES_VOLTORB_HISUI] = 0,
    [SPECIES_ELECTRODE_HISUI] = 1,
    [SPECIES_SNEASEL_HISUI] = 2,
    [SPECIES_SNEASLER] = 2,
    [SPECIES_AVALUGG_HISUI] = 5,
    [SPECIES_ZORUA_HISUI] = 0,
    [SPECIES_ZOROARK_HISUI] = 0,
    [SPECIES_BRAVIARY_HISUI] = 2,
    [SPECIES_ENAMORUS] = 1,
    [SPECIES_ENAMORUS_THERIAN] = 1,
    [SPECIES_DIALGA_ORIGIN] = 0,
    [SPECIES_PALKIA_ORIGIN] = 2,
    [SPECIES_WOOPER_PALDEA] = 1,
    [SPECIES_CLODSIRE] = 1,
    ...
    [SPECIES_GREAT_TUSK] = 1,
    [SPECIES_SCREAM_TAIL] = 1,
    [SPECIES_BRUTE_BONNET] = 1,
    [SPECIES_FLUTTER_MANE] = 1,
    [SPECIES_SLITHER_WING] = 1,
    [SPECIES_SANDY_SHOCKS] = 1,
    [SPECIES_IRON_TREADS] = 1,
    [SPECIES_IRON_BUNDLE] = 1,
    [SPECIES_IRON_HANDS] = 1,
    [SPECIES_IRON_JUGULIS] = 1,
    [SPECIES_IRON_MOTH] = 1,
    ...
    [SPECIES_TING_LU] = 1,
    [SPECIES_CHI_YU] = 1,
    [SPECIES_ROARING_MOON] = 1,
    [SPECIES_IRON_VALIANT] = 1,
    [SPECIES_KORAIDON] = 1,
    [SPECIES_MIRAIDON] = 1,
    [SPECIES_WALKING_WAKE] = 1,
