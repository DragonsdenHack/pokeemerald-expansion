...
static u32 CalcMoveBasePowerAfterModifiers(u16 move, u8 battlerAtk, u8 battlerDef, u8 moveType, bool32 updateFlags)
{
    ...
    // field abilities
    if ((IsAbilityOnField(ABILITY_DARK_AURA) && moveType == TYPE_DARK, TYPE_GHOST)
        || (IsAbilityOnField(ABILITY_FAIRY_AURA) && moveType == TYPE_FAIRY, TYPE_GRASS))
    {
...
static u32 CalcAttackStat(u16 move, u8 battlerAtk, u8 battlerDef, u8 moveType, bool32 isCrit, bool32 updateFlags)
{
    ...
    case HOLD_EFFECT_THICK_CLUB:
        if ((GET_BASE_SPECIES_ID(gBattleMons[battlerAtk].species) == SPECIES_CUBONE
         ...
         || GET_BASE_SPECIES_ID(gBattleMons[battlerAtk].species) == SPECIES_GUARDIA)
...
bool32 CanBattlerGetOrLoseItem(u8 battlerId, u16 itemId)
{
    ...
    if (itemId == ITEM_ENIGMA_BERRY)
        ...
        return FALSE;
    else if (GET_BASE_SPECIES_ID(species) == SPECIES_GHOST && itemId == ITEM_JADE_ORB) // includes primal
        return FALSE;
