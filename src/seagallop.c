...
static void Task_Seagallop_3b(void);
...
static const s8 sSeag[][4] = {
    ...
    [SEAGALLOP_ONE_ISLAND]      = {MAP(ONE_ISLAND),   0x08, 0x05},
    [SEAGALLOP_TWO_ISLAND]      = {MAP(TWO_ISLAND),   0x08, 0x05},
    [SEAGALLOP_THREE_ISLAND]    = {MAP(THREE_ISLAND), 0x08, 0x05},
    [SEAGALLOP_FOUR_ISLAND]     = {MAP(FOUR_ISLAND),  0x08, 0x05},
    [SEAGALLOP_FIVE_ISLAND]     = {MAP(FIVE_ISLAND),  0x08, 0x05},
    [SEAGALLOP_SIX_ISLAND]      = {MAP(SIX_ISLAND),   0x08, 0x05},
    [SEAGALLOP_SEVEN_ISLAND]    = {MAP(SEVEN_ISLAND), 0x08, 0x05},
