...
} static const sTrainerClassesAndMusic[] =
{
	...
	// {TRAINER_CLASS_EMPERADOR, 
    // {TRAINER_CLASS_ALTOMANDO,
    // {TRAINER_CLASS_CULTISTA,
    // {TRAINER_CLASS_PRESIDENTE,
    // {TRAINER_CLASS_GIOVANNI,
    // {TRAINER_CLASS_ANDRA,
    // {TRAINER_CLASS_MIGUEL,
    // {TRAINER_CLASS_ATLAS,
    // {TRAINER_CLASS_OAK,
    // {TRAINER_CLASS_KANTO,
    // {TRAINER_CLASS_JOHTO,
    // {TRAINER_CLASS_SEVII,
    // {TRAINER_CLASS_PROTON,
    // {TRAINER_CLASS_RECLUTA, TRAINER_ENCOUNTER_MUSIC_ROCKET},
    // {TRAINER_CLASS_ADMINISTRADOR,
    // {TRAINER_CLASS_ZEUS,
    // {TRAINER_CLASS_JONES,
    // {TRAINER_CLASS_DIOS,
    // {TRAINER_CLASS_RIVALES,
    // {TRAINER_CLASS_ESENCIA,
    // {TRAINER_CLASS_AVES,
    // {TRAINER_CLASS_CAPITAN,
    // {TRAINER_CLASS_EXCAMPEON,
    // {TRAINER_CLASS_CAMPEON,
    // {TRAINER_CLASS_LIDER,
    // {TRAINER_CLASS_SINGULAR,
    // {TRAINER_CLASS_BILL,
    // {TRAINER_CLASS_ANCIENT,
    // {TRAINER_CLASS_POLICIA,
    // {TRAINER_CLASS_DOMADOR,
    // {TRAINER_CLASS_PESCADOR,
    // {TRAINER_CLASS_GUAY,
    // {TRAINER_CLASS_FUJI,
    // {TRAINER_CLASS_PAREJAGUAY,
    // {TRAINER_CLASS_CIENTIFICO,
    // {TRAINER_CLASS_TRABAJADOR,
    // {TRAINER_CLASS_ORNITOLOGA,
    // {TRAINER_CLASS_EXORCISTA,
    // {TRAINER_CLASS_POKECOLECTOR,
    // {TRAINER_CLASS_EXCULTISTA,
    // {TRAINER_CLASS_JOVEN,
    // {TRAINER_CLASS_CAZABICHOS,
    // {TRAINER_CLASS_CHICA,
    // {TRAINER_CLASS_NINJA,
    // {TRAINER_CLASS_MARINERO,
    // {TRAINER_CLASS_CAMPISTA,
    // {TRAINER_CLASS_DOMINGUERA,
    // {TRAINER_CLASS_SUPERNECIO, TRAINER_ENCOUNTER_MUSIC_ROCKETKANTO},
    // {TRAINER_CLASS_MOTORISTA, TRAINER_ENCOUNTER_MUSIC_CHICOKANTO},
    // {TRAINER_CLASS_LADRONJOHTO,
    // {TRAINER_CLASS_LADRON,
    // {TRAINER_CLASS_SABIO,
    // {TRAINER_CLASS_INGENIERO,
    // {TRAINER_CLASS_NADADOR,
    // {TRAINER_CLASS_CALVO,
    // {TRAINER_CLASS_GUAYJOHTO,
    // {TRAINER_CLASS_JUGADOR,
    // {TRAINER_CLASS_BELLA,
    // {TRAINER_CLASS_NADADORA,
    // {TRAINER_CLASS_MEDIUM,
    // {TRAINER_CLASS_ROCKERO,
    // {TRAINER_CLASS_JUGLAR,
    // {TRAINER_CLASS_ORNITOLOGO,
    // {TRAINER_CLASS_KARATEKAJOHTO,
    // {TRAINER_CLASS_MONTANEROJOHTO,
    // {TRAINER_CLASS_POKEABU,
    // {TRAINER_CLASS_JOVENJOHTO,
    // {TRAINER_CLASS_DOMADORJOHTO,
    // {TRAINER_CLASS_POKEMANIACOJOHTO,
    // {TRAINER_CLASS_PESCADORJOHTO,
    // {TRAINER_CLASS_ORNITOLOGOJOHTO,
    // {TRAINER_CLASS_DOMINGUERAJOHTO,
    // {TRAINER_CLASS_GEMELAS,
    // {TRAINER_CLASS_PAREJAJOVEN,
    // {TRAINER_CLASS_DUOFUERTE,
    // {TRAINER_CLASS_HERMANOS,
    // {TRAINER_CLASS_RUINAMANIACO,
    // {TRAINER_CLASS_CHICAFUERTE,
    // {TRAINER_CLASS_PLAYERA,
    // {TRAINER_CLASS_CRIAPOKEMON,
    // {TRAINER_CLASS_POKEGUARDA,
    // {TRAINER_CLASS_SRAAROMA,
    // {TRAINER_CLASS_DAMISELA,
    // {TRAINER_CLASS_PINTORA,
    // {TRAINER_CLASS_POKEGUARDAJOHTO,
    // {TRAINER_CLASS_MALABARISTA,
    // {TRAINER_CLASS_JUGONJOHTO,
    // {TRAINER_CLASS_CAZABICHOSJOHTO,
    // {TRAINER_CLASS_PENSADOR,
    // {TRAINER_CLASS_MECANICOJOHTO,
    // {TRAINER_CLASS_RUINAMANIACOJOHTO,
    // {TRAINER_CLASS_NADADORJOHTO,
    // {TRAINER_CLASS_RICO,
    // {TRAINER_CLASS_CALVOJOHTO,
    // {TRAINER_CLASS_SUPERNECIOJOHTO,
    // {TRAINER_CLASS_CABALLEROJOHTO,
    // {TRAINER_CLASS_BELLAJOHTO,
    // {TRAINER_CLASS_CHICAJOHTO,
    // {TRAINER_CLASS_MALABARISTAJOHTO,
    // {TRAINER_CLASS_PAREJAJOHTO,
    // {TRAINER_CLASS_CRIAPOKEMONJOHTO,
    // {TRAINER_CLASS_MENTALISTAJOHTO,
    // {TRAINER_CLASS_PINTORAJOHTO,
    // {TRAINER_CLASS_MARINEROJOHTO,
    // {TRAINER_CLASS_NADADORAJOHTO,
    // {TRAINER_CLASS_CHICAFUERTEJOHTO,
    // {TRAINER_CLASS_ELM,
    // {TRAINER_CLASS_KIMONO,
    // {TRAINER_CLASS_COMEFUEGO,
    // {TRAINER_CLASS_FARERO,
    // {TRAINER_CLASS_MONTANEROHOENN,
    // {TRAINER_CLASS_CIENTIFICOHOENN,
    // {TRAINER_CLASS_MAESTRO,
    // {TRAINER_CLASS_MOTORISTAJOHTO,
    // {TRAINER_CLASS_CIENTIFICOJOHTO,
    // {TRAINER_CLASS_POLICIAHOENN,
    // {TRAINER_CLASS_SALVAJE,
    // {TRAINER_CLASS_EXPERIMENTO,
};
