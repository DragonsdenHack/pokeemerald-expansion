...
static const struct Fusion sCalyrexFusionTable[] = {
    {FORM_ITEM_USE, ITEM_REINS_OF_UNITY, SPECIES_CALYREX,  SPECIES_SPECTRIER, SPECIES_CALYREX_SHADOW_RIDER, MOVE_ASTRAL_BARRAGE,  MOVE_CONFUSION},
	{FORM_ITEM_USE, ITEM_REINS_OF_UNITY, SPECIES_CALYREX,  SPECIES_GLASTRIER, SPECIES_CALYREX_ICE_RIDER,    MOVE_GLACIAL_LANCE,   MOVE_CONFUSION},
    {FUSION_TERMINATOR},
};
