...
const u8 *const gItemEffectTable[] =
{
	...
	[ITEM_EXP_CANDY_XM - ITEM_POTION]    = gItemEffect_RareCandy,
	...
	[ITEM_DYNAMAX_CANDY - ITEM_POTION]  = gItemEffect_RareCandy,
	[ITEM_DYNAMAX_CANDY2 - ITEM_POTION]  = gItemEffect_RareCandy,
};
