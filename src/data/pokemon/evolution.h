const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_BUTTERFREE]            = {{EVO_MEGA_EVOLUTION, ITEM_BUTTERFRITA, SPECIES_BUTTERFREE_MEGA}},
    ...
    [SPECIES_RATTATA]               = {{EVO_LEVEL, 20, SPECIES_RATICATE},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_RATTATA_ALOLAN}},
    [SPECIES_RATICATE]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_RATICATE_ALOLAN}},
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_RAICHU_ALOLAN}},
    [SPECIES_RAICHU]                = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_GOROCHU}},
    [SPECIES_SANDSHREW]             = {{EVO_LEVEL, 22, SPECIES_SANDSLASH},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_SANDSHREW_ALOLAN}},
    [SPECIES_SANDSLASH]             = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_SANDSLASH_ALOLAN}},
    [SPECIES_NIDORAN_F]             = {{EVO_LEVEL, 16, SPECIES_NIDORINA}},
    [SPECIES_NIDORINA]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NIDOQUEEN}},
    [SPECIES_NIDOQUEEN]             = {{EVO_ITEM, ITEM_CHIPPED_POT, SPECIES_NIDOQUEEN_Y}},
    [SPECIES_NIDORAN_M]             = {{EVO_LEVEL, 16, SPECIES_NIDORINO}},
    [SPECIES_NIDORINO]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NIDOKING}},
    [SPECIES_NIDOKING]                = {{EVO_ITEM, ITEM_CHIPPED_POT, SPECIES_NIDOKING_X}},
    [SPECIES_CLEFAIRY]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_CLEFABLE}},
    [SPECIES_VULPIX]                = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_NINETALES},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_VULPIX_ALOLAN}},
    [SPECIES_NINETALES]             = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_NINETALES_ALOLAN}},
    [SPECIES_JIGGLYPUFF]            = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_WIGGLYTUFF}},
    [SPECIES_ZUBAT]                 = {{EVO_LEVEL, 22, SPECIES_GOLBAT}},
    [SPECIES_GOLBAT]                = {{EVO_LEVEL, 47, SPECIES_CROBAT}},
    ...
    [SPECIES_DIGLETT]               = {{EVO_LEVEL, 26, SPECIES_DUGTRIO},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_DIGLETT_ALOLAN}},
    [SPECIES_DUGTRIO]               = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_DUGTRIO_ALOLAN}},
    [SPECIES_MEOWTH]                = {{EVO_LEVEL, 28, SPECIES_PERSIAN},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_MEOWTH_ALOLAN}},
    [SPECIES_PERSIAN]               = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_PERSIAN_ALOLAN}},
    [SPECIES_PSYDUCK]               = {{EVO_LEVEL, 33, SPECIES_GOLDUCK}},
    [SPECIES_MANKEY]                = {{EVO_LEVEL, 28, SPECIES_PRIMEAPE}},
    [SPECIES_PRIMEAPE]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_ANNIHILAPE}},
    [SPECIES_GROWLITHE]             = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ARCANINE},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_GROWLITHE_HISUI}},
    [SPECIES_ARCANINE]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_ARCANINE_HISUI}},
    [SPECIES_GROWLITHE_HISUI]       = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ARCANINE_HISUI},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_GROWLITHE}},
    [SPECIES_ARCANINE_HISUI]        = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_ARCANINE}},
    [SPECIES_POLIWAG]               = {{EVO_LEVEL, 25, SPECIES_POLIWHIRL}},
    [SPECIES_POLIWHIRL]             = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                                       {EVO_LEVEL, 50, SPECIES_POLITOED}},
    [SPECIES_ABRA]                  = {{EVO_LEVEL, 16, SPECIES_KADABRA}},
    [SPECIES_KADABRA]               = {{EVO_LEVEL, 45, SPECIES_ALAKAZAM}},
    [SPECIES_ALAKAZAM]              = {{EVO_MEGA_EVOLUTION, ITEM_ALAKAZITE, SPECIES_ALAKAZAM_MEGA}},
    [SPECIES_MACHOP]                = {{EVO_LEVEL, 28, SPECIES_MACHOKE}},
    [SPECIES_MACHOKE]               = {{EVO_LEVEL, 51, SPECIES_MACHAMP}},
    ...
    [SPECIES_GEODUDE]               = {{EVO_LEVEL, 25, SPECIES_GRAVELER},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_GEODUDE_ALOLAN}},
    [SPECIES_GRAVELER]              = {{EVO_LEVEL, 45, SPECIES_GOLEM},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_GRAVELER_ALOLAN}},
    [SPECIES_GOLEM]                 = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_GOLEM_ALOLAN}},
    [SPECIES_PONYTA]                = {{EVO_LEVEL, 40, SPECIES_RAPIDASH},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_PONYTA_GALARIAN}},
    [SPECIES_RAPIDASH]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_RAPIDASH_GALARIAN}},
    [SPECIES_SLOWPOKE]              = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                                       {EVO_ITEM, ITEM_CRACKED_POT, SPECIES_SLOWKING},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_SLOWPOKE_GALARIAN}},
    [SPECIES_SLOWBRO]               = {{EVO_MEGA_EVOLUTION, ITEM_SLOWBRONITE, SPECIES_SLOWBRO_MEGA},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_SLOWBRO_GALARIAN}},
    [SPECIES_MAGNEMITE]             = {{EVO_LEVEL, 30, SPECIES_MAGNETON}},
    [SPECIES_MAGNETON]              = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_MAGNEZONE}},
    [SPECIES_FARFETCHD]             = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_FARFETCHD_GALARIAN}},
    ...
    [SPECIES_GRIMER]                = {{EVO_LEVEL, 38, SPECIES_MUK},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_GRIMER_ALOLAN}},
    [SPECIES_MUK]                   = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_MUK_ALOLAN}},
    [SPECIES_SHELLDER]              = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_CLOYSTER}},
    [SPECIES_GASTLY]                = {{EVO_LEVEL, 25, SPECIES_HAUNTER}},
    [SPECIES_HAUNTER]               = {{EVO_LEVEL, 52, SPECIES_GENGAR}},
    [SPECIES_GENGAR]                = {{EVO_MEGA_EVOLUTION, ITEM_GENGARITE, SPECIES_GENGAR_MEGA}},
    [SPECIES_ONIX]                  = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_STEELIX}},
    [SPECIES_DROWZEE]               = {{EVO_LEVEL, 26, SPECIES_HYPNO}},
    [SPECIES_KRABBY]                = {{EVO_LEVEL, 28, SPECIES_KINGLER}},
    [SPECIES_VOLTORB]               = {{EVO_LEVEL, 30, SPECIES_ELECTRODE},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_VOLTORB_HISUI}},
    [SPECIES_ELECTRODE]             = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_ELECTRODE_HISUI},
                                       {EVO_ITEM, ITEM_CHIPPED_POT, SPECIES_ELECTRODE_Y}},
    [SPECIES_VOLTORB_HISUI]         = {{EVO_LEVEL, 30, SPECIES_ELECTRODE_HISUI},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_VOLTORB}},
    [SPECIES_ELECTRODE_HISUI]       = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_ELECTRODE}},
    [SPECIES_EXEGGCUTE]             = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR}},
    [SPECIES_EXEGGUTOR]             = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_EXEGGUTOR_ALOLAN}},
    [SPECIES_CUBONE]                = {{EVO_LEVEL, 28, SPECIES_MAROWAK}},
    [SPECIES_MAROWAK]               = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_MAROWAK_ALOLAN},
									   {EVO_LEVEL, 108, SPECIES_GUARDIA}},
    [SPECIES_MAROWAK_ALOLAN]        = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_MAROWAK}},                            
    [SPECIES_LICKITUNG]             = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_LICKILICKY}},
    [SPECIES_KOFFING]               = {{EVO_LEVEL, 35, SPECIES_WEEZING}},
    [SPECIES_WEEZING]               = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_WEEZING_GALARIAN}},
    [SPECIES_WEEZING_GALARIAN]      = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_WEEZING}},
    [SPECIES_RHYHORN]               = {{EVO_LEVEL, 42, SPECIES_RHYDON}},
    [SPECIES_RHYDON]                = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_RHYPERIOR}},
    [SPECIES_CHANSEY]               = {{EVO_FRIENDSHIP, 0, SPECIES_BLISSEY}},
    [SPECIES_TANGELA]               = {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_TANGROWTH},
                                      {EVO_ITEM, ITEM_CRACKED_POT, SPECIES_TANGROWTH}},
    ...
    [SPECIES_SEADRA]                = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_KINGDRA}},
    [SPECIES_GOLDEEN]               = {{EVO_LEVEL, 33, SPECIES_SEAKING}},
    [SPECIES_STARYU]                = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    [SPECIES_STARMIE]               = {{EVO_MEGA_EVOLUTION, ITEM_STARMIETITE, SPECIES_STARMIE_MEGA}},
    [SPECIES_MR_MIME]               = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_MR_MIME_GALARIAN}},
    [SPECIES_SCYTHER]               = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_SCIZOR},
                                      {EVO_ITEM, ITEM_TART_APPLE, SPECIES_KLEAVOR}},
    [SPECIES_ELECTABUZZ]            = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_ELECTIVIRE}},
    [SPECIES_ELECTIVIRE]            = {{EVO_ITEM, ITEM_CHIPPED_POT, SPECIES_ELECTIVIRE_X}},
    [SPECIES_MAGMAR]                = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_MAGMORTAR}},
    [SPECIES_MAGMORTAR]             = {{EVO_ITEM, ITEM_CHIPPED_POT, SPECIES_MAGMORTAR_Y}},
    [SPECIES_PINSIR]                = {{EVO_MEGA_EVOLUTION, ITEM_PINSIRITE, SPECIES_PINSIR_MEGA},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_PURAKKUSU}},
    [SPECIES_TAUROS]                = {{EVO_ITEM, ITEM_CHIPPED_POT, SPECIES_TAUROS_X}},
    ...
    [SPECIES_PORYGON_Z]             = {{EVO_MEGA_EVOLUTION, ITEM_PORYGONITA, SPECIES_PORYGON_Z_MEGA}},
    ...
    [SPECIES_AERODACTYL]            = {{EVO_MEGA_EVOLUTION, ITEM_AERODACTYLITE, SPECIES_AERODACTYL_MEGA},
                                       {EVO_ITEM, ITEM_CHIPPED_POT, SPECIES_AERODACTYL_PRIMAL}},
    [SPECIES_ARTICUNO]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_ARTICUNO_GALARIAN}},
    [SPECIES_ZAPDOS]                = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_ZAPDOS_GALARIAN}},
    [SPECIES_MOLTRES]               = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_MOLTRES_GALARIAN}},
    [SPECIES_ARTICUNO_GALARIAN]     = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_ARTICUNO}},
    [SPECIES_ZAPDOS_GALARIAN]       = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_ZAPDOS}},
    [SPECIES_MOLTRES_GALARIAN]      = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_MOLTRES}},
    ...
    [SPECIES_TYPHLOSION]            = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_TYPHLOSION_HISUI}},
    [SPECIES_TYPHLOSION_HISUI]      = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_TYPHLOSION}},
    ...
    [SPECIES_NOCTOWL]               = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_BOOHOO}},
    ...
    [SPECIES_XATU]                  = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_TRXATU}},
    ...
    [SPECIES_SLOWKING]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_SLOWKING_GALARIAN}},
    [SPECIES_MISDREAVUS]            = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_MISMAGIUS}},
    [SPECIES_GIRAFARIG]             = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_FARIGIRAF}},
    [SPECIES_PINECO]                = {{EVO_LEVEL, 31, SPECIES_FORRETRESS}},
    [SPECIES_CROBAT]                = {{EVO_LEVEL, 90, SPECIES_CROBAT_BOND}},
    [SPECIES_GLIGAR]                = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_GLISCOR}},
    [SPECIES_DUNSPARCE]             = {{EVO_LEVEL, 75, SPECIES_DUDUNSPARCE},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_DUNSPARCE_OLD_PREEVO}},
    [SPECIES_DUNSPARCE_OLD_PREEVO]  = {{EVO_MAPSEC, MAPSEC_SPECIAL_AREA, SPECIES_DUNSPARCE_OLD}},
    [SPECIES_STEELIX]               = {{EVO_MEGA_EVOLUTION, ITEM_STEELIXITE, SPECIES_STEELIX_MEGA}},
    [SPECIES_SNUBBULL]              = {{EVO_LEVEL, 23, SPECIES_GRANBULL}},
    [SPECIES_QWILFISH]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_QWILFISH_HISUI}},
    [SPECIES_QWILFISH_HISUI]        = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_QWILFISH},
                                       {EVO_LEVEL, 50, SPECIES_OVERQWIL}},
    [SPECIES_OVERQWIL]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_QWOLTFISH}},
    [SPECIES_QWOLTFISH]             = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_OVERQWIL}},
    ...
    [SPECIES_SNEASEL]               = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_WEAVILE},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_SNEASEL_HISUI}},
    [SPECIES_SNEASEL_HISUI]         = {{EVO_LEVEL, 50, SPECIES_SNEASLER},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_SNEASEL}},
    [SPECIES_WEAVILE]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_SNEASLER}},
    [SPECIES_SNEASLER]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_WEAVILE}},
    [SPECIES_TEDDIURSA]             = {{EVO_LEVEL, 30, SPECIES_URSARING}},
    [SPECIES_URSARING]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_URSALUNA}},
    ...
    [SPECIES_PILOSWINE]             = {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_MAMOSWINE},
                                      {EVO_ITEM, ITEM_CRACKED_POT, SPECIES_MAMOSWINE}},
    [SPECIES_CORSOLA]               = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_CORSOLA_GALARIAN}},
    [SPECIES_REMORAID]              = {{EVO_LEVEL, 25, SPECIES_OCTILLERY}},
    [SPECIES_OCTILLERY]             = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_WARTILLERY}},
    ...
    [SPECIES_PORYGON2]              = {{EVO_ITEM, ITEM_DUBIOUS_DISC, SPECIES_PORYGON_Z},
                                       {EVO_ITEM, ITEM_CHIPPED_POT, SPECIES_PORYGON3}},
    [SPECIES_STANTLER]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_WYRDEER}},
    ...
    [SPECIES_ZIGZAGOON]             = {{EVO_LEVEL, 20, SPECIES_LINOONE},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_ZIGZAGOON_GALARIAN}},
    [SPECIES_LINOONE]               = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_LINOONE_GALARIAN}},
    ...
    [SPECIES_NOSEPASS]              = {{EVO_LEVEL, 49, SPECIES_PROBOPASS}},
    ...
    [SPECIES_FEEBAS]                = {{EVO_LEVEL, 54, SPECIES_MILOTIC},
    ...
    [SPECIES_DUSCLOPS]              = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_DUSKNOIR}},
    [SPECIES_DUSKNOIR]              = {{EVO_MEGA_EVOLUTION, ITEM_DUSKNOIRITA, SPECIES_DUSKNOIR_MEGA}},
    ...
    [SPECIES_CLAMPERL]              = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_HUNTAIL},
                                       {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_GOREBYSS}},
    ...
    [SPECIES_CRADILY]              =  {{EVO_ITEM, ITEM_GALARICA_CUFF, SPECIES_CRADILY_Y}},
    [SPECIES_ANORITH]               = {{EVO_LEVEL, 40, SPECIES_ARMALDO}},
    [SPECIES_ARMALDO]              =  {{EVO_ITEM, ITEM_GALARICA_CUFF, SPECIES_ARMALDO_PRIMAL}},
    [SPECIES_RELICANTH]            =  {{EVO_ITEM, ITEM_GALARICA_CUFF, SPECIES_RELICANTH_PRIMAL}},
    ...
    [SPECIES_STARLY]                = {{EVO_LEVEL, 14, SPECIES_STARAVIA},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_STARAPTOR}},
    ...
    [SPECIES_SAMUROTT]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_SAMUROTT_HISUI}},
    [SPECIES_SAMUROTT_HISUI]        = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_SAMUROTT}},
    ...
    [SPECIES_BOLDORE]               = {{EVO_LEVEL, 49, SPECIES_GIGALITH}},
    ...
    [SPECIES_GURDURR]               = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_CONKELDURR}},
    ...
    [SPECIES_LILLIGANT]             = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_LILLIGANT_HISUI}},
    [SPECIES_LILLIGANT_HISUI]       = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_LILLIGANT}},
    [SPECIES_BASCULIN]              = {{EVO_ITEM_FEMALE, ITEM_TART_APPLE, SPECIES_BASCULEGION_FEMALE},
                                       {EVO_ITEM_MALE, ITEM_TART_APPLE, SPECIES_BASCULEGION}},
    ...
    [SPECIES_DARUMAKA]              = {{EVO_LEVEL, 35, SPECIES_DARMANITAN},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_DARUMAKA_GALARIAN}},
    [SPECIES_DARMANITAN]            = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_DARMANITAN_GALARIAN},
                                      {EVO_LEVEL, 105, SPECIES_DARMANITAN_ZEN_MODE}},
    [SPECIES_DARMANITAN_ZEN_MODE]   = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_DARMANITAN_ZEN_MODE_GALARIAN}},
    [SPECIES_DARMANITAN_ZEN_MODE_GALARIAN]   = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_DARMANITAN_ZEN_MODE}},
    ...
    [SPECIES_YAMASK]                = {{EVO_LEVEL, 34, SPECIES_COFAGRIGUS},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_YAMASK_GALARIAN}},
    ...
    [SPECIES_ZORUA]                 = {{EVO_LEVEL, 30, SPECIES_ZOROARK},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_ZORUA_HISUI}},
    [SPECIES_ZOROARK]               = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_ZOROARK_HISUI}},
    [SPECIES_ZORUA_HISUI]           = {{EVO_LEVEL, 30, SPECIES_ZOROARK_HISUI},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_ZORUA}},
    [SPECIES_ZOROARK_HISUI]         = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_ZOROARK}},
    ...
    [SPECIES_KARRABLAST]            = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_ESCAVALIER}},
    ...
    [SPECIES_SHELMET]               = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_ACCELGOR}},
    [SPECIES_MIENFOO]               = {{EVO_LEVEL, 50, SPECIES_MIENSHAO}},
    [SPECIES_STUNFISK]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_STUNFISK_GALARIAN}},
    [SPECIES_STUNFISK_GALARIAN]     = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_STUNFISK}},
    [SPECIES_GOLETT]                = {{EVO_LEVEL, 43, SPECIES_GOLURK}},
    [SPECIES_PAWNIARD]              = {{EVO_LEVEL, 52, SPECIES_BISHARP}},
    [SPECIES_BISHARP]               = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_KINGAMBIT}},
    [SPECIES_RUFFLET]               = {{EVO_LEVEL, 54, SPECIES_BRAVIARY}},
    [SPECIES_BRAVIARY]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_BRAVIARY_HISUI}},
    [SPECIES_BRAVIARY_HISUI]        = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_BRAVIARY}},
    ...
    [SPECIES_FLABEBE]               = {{EVO_LEVEL, 19, SPECIES_FLOETTE},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_FLOETTE_ETERNAL_FLOWER}},
    ...
    [SPECIES_SPRITZEE]              = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_AROMATISSE}},
    [SPECIES_SWIRLIX]               = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_SLURPUFF}},
    ...
    [SPECIES_SLIGGOO]               = {{EVO_LEVEL, 50, SPECIES_GOODRA},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_SLIGGOO_HISUI}},
    [SPECIES_SLIGGOO_HISUI]         = {{EVO_LEVEL, 50, SPECIES_GOODRA_HISUI},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_SLIGGOO}},
    [SPECIES_GOODRA]                = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_GOODRA_HISUI}},
    [SPECIES_GOODRA_HISUI]          = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_GOODRA}},
    [SPECIES_PHANTUMP]              = {{EVO_LEVEL, 42, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_GOURGEIST}},
    [SPECIES_BERGMITE]              = {{EVO_LEVEL, 37, SPECIES_AVALUGG}},
    [SPECIES_AVALUGG]               = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_AVALUGG_HISUI}},
    [SPECIES_AVALUGG_HISUI]         = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_AVALUGG}},
    [SPECIES_NOIBAT]                = {{EVO_LEVEL, 48, SPECIES_NOIVERN}},
    [SPECIES_NOIVERN]               = {{EVO_MEGA_EVOLUTION, ITEM_NOIVERNITA, SPECIES_NOIVERN_MEGA}},
    ...
    [SPECIES_DECIDUEYE]             = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_DECIDUEYE_HISUI}},
    [SPECIES_DECIDUEYE_HISUI]       = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_DECIDUEYE}},
    ...
    [SPECIES_ROCKRUFF]              = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_LYCANROC},
    ...
    [SPECIES_TYPE_NULL]             = {{EVO_LEVEL, 59, SPECIES_SILVALLY}},
    ...
    [SPECIES_TOXTRICITY]            = {{EVO_MEGA_EVOLUTION, ITEM_TOXTRICITIT, SPECIES_TOXTRICITY_MEGA}},
    [SPECIES_SIZZLIPEDE]            = {{EVO_LEVEL, 28, SPECIES_CENTISKORCH}},
    [SPECIES_CLOBBOPUS]             = {{EVO_MOVE, MOVE_TAUNT, SPECIES_GRAPPLOCT}},
    [SPECIES_SINISTEA]              = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_POLTEAGEIST}},
    ...
    [SPECIES_MILCERY]               = {{EVO_LEVEL, 40, SPECIES_ALCREMIE},
    ...
    [SPECIES_DURALUDON]              = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_DURALUDON_MEGA}},
    ...
    [SPECIES_RATTATA_ALOLAN]        = {{EVO_LEVEL_NIGHT, 20, SPECIES_RATICATE_ALOLAN},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_RATTATA}},
    [SPECIES_RATICATE_ALOLAN]       = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_RATICATE}},
    [SPECIES_RAICHU_ALOLAN]         = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_RAICHU}},
    [SPECIES_SANDSHREW_ALOLAN]      = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_SANDSLASH_ALOLAN},
                                      {EVO_ITEM, ITEM_TART_APPLE, SPECIES_SANDSHREW}},
    [SPECIES_SANDSLASH_ALOLAN]      = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_SANDSLASH}},
    [SPECIES_VULPIX_ALOLAN]         = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_NINETALES_ALOLAN},
                                      {EVO_ITEM, ITEM_TART_APPLE, SPECIES_VULPIX}},
    [SPECIES_NINETALES_ALOLAN]      = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_NINETALES}},
    [SPECIES_DIGLETT_ALOLAN]        = {{EVO_LEVEL, 26, SPECIES_DUGTRIO_ALOLAN},
                                      {EVO_ITEM, ITEM_TART_APPLE, SPECIES_DIGLETT}},
    [SPECIES_DUGTRIO_ALOLAN]        = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_DUGTRIO}},
    [SPECIES_MEOWTH_ALOLAN]         = {{EVO_FRIENDSHIP, 28, SPECIES_PERSIAN_ALOLAN},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_MEOWTH}},
    [SPECIES_PERSIAN_ALOLAN]        = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_PERSIAN}},
    [SPECIES_GEODUDE_ALOLAN]        = {{EVO_LEVEL, 25, SPECIES_GRAVELER_ALOLAN},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_GEODUDE}},
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_LEVEL, 45, SPECIES_GOLEM_ALOLAN},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_GRAVELER}},
    [SPECIES_GOLEM_ALOLAN]          = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_GOLEM}},
    [SPECIES_GRIMER_ALOLAN]         = {{EVO_LEVEL, 38, SPECIES_MUK_ALOLAN},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_GRIMER}},
    [SPECIES_MUK_ALOLAN]            = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_MUK}},
    [SPECIES_MEOWTH_GALARIAN]       = {{EVO_LEVEL, 28, SPECIES_PERRSERKER}},
    [SPECIES_PONYTA_GALARIAN]       = {{EVO_LEVEL, 40, SPECIES_RAPIDASH_GALARIAN},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_PONYTA}},
    [SPECIES_RAPIDASH_GALARIAN]     = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_RAPIDASH}},
    [SPECIES_SLOWPOKE_GALARIAN]     = {{EVO_LEVEL, 37, SPECIES_SLOWBRO_GALARIAN},
                                       {EVO_ITEM, ITEM_WATER_STONE, SPECIES_SLOWKING_GALARIAN}},
    [SPECIES_SLOWBRO_GALARIAN]      = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_SLOWBRO}},
    [SPECIES_SLOWKING_GALARIAN]     = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_SLOWKING}},
    [SPECIES_FARFETCHD_GALARIAN]    = {{EVO_LEVEL, 50, SPECIES_SIRFETCHD},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_FARFETCHD}},
    [SPECIES_SIRFETCHD]             = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_MADAAMU}},
    [SPECIES_MADAAMU]               = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_SIRFETCHD}},
    [SPECIES_MR_MIME_GALARIAN]      = {{EVO_LEVEL, 42, SPECIES_MR_RIME},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_MR_MIME}},
    [SPECIES_CORSOLA_GALARIAN]      = {{EVO_LEVEL, 38, SPECIES_CURSOLA},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_CORSOLA}},
    [SPECIES_ZIGZAGOON_GALARIAN]    = {{EVO_LEVEL, 20, SPECIES_LINOONE_GALARIAN},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_ZIGZAGOON}},
    [SPECIES_LINOONE_GALARIAN]      = {{EVO_LEVEL, 35, SPECIES_OBSTAGOON},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_LINOONE}},
    [SPECIES_DARUMAKA_GALARIAN]     = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_DARMANITAN_GALARIAN},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_DARUMAKA}},
    [SPECIES_DARMANITAN_GALARIAN]   = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_DARMANITAN},
                                       {EVO_LEVEL, 105, SPECIES_DARMANITAN_ZEN_MODE_GALARIAN}},
    [SPECIES_YAMASK_GALARIAN]       = {{EVO_LEVEL, 42, SPECIES_RUNERIGUS},
                                       {EVO_ITEM, ITEM_TART_APPLE, SPECIES_YAMASK}},
    [SPECIES_RUNERIGUS]             = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_COFAGRIGUS}},
    [SPECIES_COFAGRIGUS]             = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_RUNERIGUS}},
    ...
    [SPECIES_SINISTEA_ANTIQUE]      = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_POLTEAGEIST_ANTIQUE}},
    [SPECIES_GHOST]                 = {{EVO_PRIMAL_REVERSION, ITEM_JADE_ORB, SPECIES_GHOST_PRIMAL}},
    [SPECIES_FRIGIBAX]              = {{EVO_LEVEL, 35, SPECIES_ARCTIBAX}},
    [SPECIES_ARCTIBAX]              = {{EVO_LEVEL, 54, SPECIES_BAXCALIBUR}},
    [SPECIES_KURUSU]                = {{EVO_LEVEL, 40, SPECIES_AKUA}},
    [SPECIES_AKUA]                  = {{EVO_LEVEL, 64, SPECIES_AKUERIA}},
};
