const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_RATTATA]               = {{EVO_LEVEL, 20, SPECIES_RATICATE},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_RATTATA_ALOLAN}},
    [SPECIES_RATICATE]             = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_RATICATE_ALOLAN}},
    ...
    [SPECIES_RAICHU]                = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_RAICHU_ALOLAN}},
    [SPECIES_SANDSHREW]             = {{EVO_LEVEL, 22, SPECIES_SANDSLASH},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SANDSHREW_ALOLAN}},
    [SPECIES_SANDSLASH]             = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SANDSLASH_ALOLAN}},
    [SPECIES_NIDORAN_F]             = {{EVO_LEVEL, 16, SPECIES_NIDORINA}},
    [SPECIES_NIDORINA]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NIDOQUEEN}},
    [SPECIES_NIDOQUEEN]             = {{EVO_ITEM, ITEM_PIEDRA_ROCKET, SPECIES_NIDOQUEEN_Y}},
    [SPECIES_NIDORAN_M]             = {{EVO_LEVEL, 16, SPECIES_NIDORINO}},
    [SPECIES_NIDORINO]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NIDOKING}},
    [SPECIES_NIDOKING]                = {{EVO_ITEM, ITEM_PIEDRA_ROCKET, SPECIES_NIDOKING_X}},
    [SPECIES_CLEFAIRY]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_CLEFABLE}},
    [SPECIES_VULPIX]                = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_NINETALES},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_VULPIX_ALOLAN}},
    [SPECIES_NINETALES]             = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_NINETALES_ALOLAN}},
    ...
    [SPECIES_DIGLETT]               = {{EVO_LEVEL, 26, SPECIES_DUGTRIO},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_DIGLETT_ALOLAN}},
    [SPECIES_DUGTRIO]               = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_DUGTRIO_ALOLAN}},
    [SPECIES_MEOWTH]                = {{EVO_LEVEL, 28, SPECIES_PERSIAN},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_MEOWTH_ALOLAN}},
    [SPECIES_PERSIAN]               = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_PERSIAN_ALOLAN}},
    [SPECIES_PSYDUCK]               = {{EVO_LEVEL, 33, SPECIES_GOLDUCK}},
    [SPECIES_MANKEY]                = {{EVO_LEVEL, 28, SPECIES_PRIMEAPE}},
    [SPECIES_PRIMEAPE]              = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_ANNIHILAPE}},
    [SPECIES_GROWLITHE]             = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ARCANINE},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_GROWLITHE_HISUI}},
    [SPECIES_ARCANINE]              = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_ARCANINE_HISUI}},
    [SPECIES_GROWLITHE_HISUI]       = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ARCANINE_HISUI},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_GROWLITHE}},
    [SPECIES_ARCANINE_HISUI]        = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_ARCANINE}},
    ...
    [SPECIES_GEODUDE]               = {{EVO_LEVEL, 25, SPECIES_GRAVELER},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_GEODUDE_ALOLAN}},
    [SPECIES_GRAVELER]              = {{EVO_LEVEL, 45, SPECIES_GOLEM},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_GRAVELER_ALOLAN}},
    [SPECIES_GOLEM]                 = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_GOLEM_ALOLAN}},
    [SPECIES_PONYTA]                = {{EVO_LEVEL, 40, SPECIES_RAPIDASH},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_PONYTA_GALARIAN}},
    [SPECIES_RAPIDASH]              = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_RAPIDASH_GALARIAN}},
    [SPECIES_SLOWPOKE]              = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                                       {EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_SLOWKING},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SLOWPOKE_GALARIAN}},
    [SPECIES_SLOWBRO]               = {{EVO_MEGA_EVOLUTION, ITEM_SLOWBRONITE, SPECIES_SLOWBRO_MEGA},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SLOWBRO_GALARIAN}},
    ...
    [SPECIES_FARFETCHD]             = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_FARFETCHD_GALARIAN},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_MADAAMU}},
    ...
    [SPECIES_GRIMER]                = {{EVO_LEVEL, 38, SPECIES_MUK},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_GRIMER_ALOLAN}},
    [SPECIES_MUK]                   = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_MUK_ALOLAN}},
    ...
    [SPECIES_ONIX]                  = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_STEELIX}},
    [SPECIES_DROWZEE]               = {{EVO_LEVEL, 26, SPECIES_HYPNO}},
    [SPECIES_KRABBY]                = {{EVO_LEVEL, 28, SPECIES_KINGLER}},
    [SPECIES_VOLTORB]               = {{EVO_LEVEL, 30, SPECIES_ELECTRODE},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_VOLTORB_HISUI}},
    [SPECIES_ELECTRODE]             = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_ELECTRODE_HISUI},
                                       {EVO_ITEM, ITEM_PIEDRA_ROCKET, SPECIES_ELECTRODE_Y}},
    [SPECIES_VOLTORB_HISUI]         = {{EVO_LEVEL, 30, SPECIES_ELECTRODE_HISUI},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_VOLTORB}},
    [SPECIES_ELECTRODE_HISUI]       = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_ELECTRODE}},
    [SPECIES_EXEGGCUTE]             = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                       {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR_ALOLAN}},
    [SPECIES_EXEGGUTOR]             = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_EXEGGUTOR_ALOLAN}},
    [SPECIES_CUBONE]                = {{EVO_LEVEL, 28, SPECIES_MAROWAK},
                                       {EVO_LEVEL_NIGHT, 28, SPECIES_MAROWAK_ALOLAN}},
    [SPECIES_MAROWAK]             = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_MAROWAK_ALOLAN}},
    [SPECIES_LICKITUNG]             = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_LICKILICKY}},
    [SPECIES_KOFFING]               = {{EVO_LEVEL, 35, SPECIES_WEEZING}},
    [SPECIES_WEEZING]               = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_WEEZING_GALARIAN}},
    [SPECIES_RHYHORN]               = {{EVO_LEVEL, 42, SPECIES_RHYDON}},
    [SPECIES_RHYDON]                = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_RHYPERIOR}},
    [SPECIES_CHANSEY]               = {{EVO_FRIENDSHIP, 0, SPECIES_BLISSEY}},
    [SPECIES_TANGELA]               = {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_TANGROWTH},
                                      {EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_TANGROWTH}},
    ...
    [SPECIES_SEADRA]                = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_KINGDRA}},
    ...
    [SPECIES_MR_MIME]               = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_MR_MIME_GALARIAN}},
    [SPECIES_SCYTHER]               = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_SCIZOR},
                                      {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_KLEAVOR}},
    [SPECIES_ELECTABUZZ]            = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_ELECTIVIRE}},
    [SPECIES_ELECTIVIRE]            = {{EVO_ITEM, ITEM_PIEDRA_ROCKET, SPECIES_ELECTIVIRE_X}},
    [SPECIES_MAGMAR]                = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_MAGMORTAR}},
    [SPECIES_MAGMORTAR]             = {{EVO_ITEM, ITEM_PIEDRA_ROCKET, SPECIES_MAGMORTAR_Y}},
    [SPECIES_PINSIR]                = {{EVO_MEGA_EVOLUTION, ITEM_PINSIRITE, SPECIES_PINSIR_MEGA},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_PURAKKUSU}},
    [SPECIES_TAUROS]                = {{EVO_ITEM, ITEM_PIEDRA_ROCKET, SPECIES_TAUROS_X}},
    ...
    [SPECIES_PORYGON_Z]             = {{EVO_ITEM, ITEM_PIEDRA_ROCKET, SPECIES_PORYGON3}},
    ...
    [SPECIES_AERODACTYL]            = {{EVO_MEGA_EVOLUTION, ITEM_AERODACTYLITE, SPECIES_AERODACTYL_MEGA},
                                       {EVO_ITEM, ITEM_PIEDRA_ROCKET, SPECIES_AERODACTYL_PRIMAL}},
    [SPECIES_ARTICUNO]              = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_ARTICUNO_GALARIAN}},
    [SPECIES_ZAPDOS]                = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_ZAPDOS_GALARIAN}},
    [SPECIES_MOLTRES]             = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_MOLTRES_GALARIAN}},
    ...
    [SPECIES_TYPHLOSION]            = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_TYPHLOSION_HISUI}},
    [SPECIES_TYPHLOSION_HISUI]      = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_TYPHLOSION}},
    ...
    [SPECIES_NOCTOWL]               = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_BOOHOO}},
    ...
    [SPECIES_SLOWKING]              = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SLOWKING_GALARIAN}},
    [SPECIES_MISDREAVUS]            = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_MISMAGIUS}},
    [SPECIES_GIRAFARIG]             = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_FARIGIRAF}},
    [SPECIES_PINECO]                = {{EVO_LEVEL, 31, SPECIES_FORRETRESS}},
    [SPECIES_CROBAT]                = {{EVO_LEVEL, 91, SPECIES_CROBAT_BOND}},
    [SPECIES_GLIGAR]                = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_GLISCOR}},
    [SPECIES_DUNSPARCE]             = {{EVO_LEVEL, 75, SPECIES_DUDUNSPARCE},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_DUNSPARCE_OLD_PREEVO}},
    ...
    [SPECIES_QWILFISH]              = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_QWILFISH_HISUI}},
    [SPECIES_QWILFISH_HISUI]        = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_QWILFISH}},
    ...
    [SPECIES_SNEASEL]               = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_WEAVILE},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SNEASEL_HISUI}},
    [SPECIES_SNEASEL_HISUI]         = {{EVO_ITEM_HOLD_NIGHT, ITEM_RAZOR_CLAW, SPECIES_SNEASLER},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SNEASEL}},
    [SPECIES_TEDDIURSA]             = {{EVO_LEVEL, 30, SPECIES_URSARING}},
    [SPECIES_URSARING]              = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_URSALUNA}},
    ...
    [SPECIES_PILOSWINE]             = {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_MAMOSWINE},
                                      {EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_MAMOSWINE}},
    [SPECIES_CORSOLA]               = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_CORSOLA_GALARIAN}},
    ...
    [SPECIES_STANTLER]              = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_WYRDEER}},
    ...
    [SPECIES_ZIGZAGOON]             = {{EVO_LEVEL, 20, SPECIES_LINOONE},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_ZIGZAGOON_GALARIAN}},
    [SPECIES_LINOONE]               = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_LINOONE_GALARIAN}},
    ...
    [SPECIES_DUSCLOPS]              = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_DUSKNOIR}},
    ...
    [SPECIES_SAMUROTT]              = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SAMUROTT_HISUI}},
    [SPECIES_SAMUROTT_HISUI]        = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SAMUROTT}},
    ...
    [SPECIES_GURDURR]               = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_CONKELDURR}},
    ...
    [SPECIES_BASCULIN]              = {{EVO_ITEM_FEMALE, ITEM_PIEDRA_SAGRADA, SPECIES_BASCULEGION_FEMALE},
                                       {EVO_ITEM_MALE, ITEM_PIEDRA_SAGRADA, SPECIES_BASCULEGION}},
    ...
    [SPECIES_DARUMAKA]              = {{EVO_LEVEL, 35, SPECIES_DARMANITAN},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_DARUMAKA_GALARIAN}},
    [SPECIES_DARMANITAN]            = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_DARMANITAN_GALARIAN}},
    ...
    [SPECIES_YAMASK]                = {{EVO_LEVEL, 34, SPECIES_COFAGRIGUS},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_YAMASK_GALARIAN}},
    ...
    [SPECIES_ZORUA]                 = {{EVO_LEVEL, 30, SPECIES_ZOROARK},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_ZORUA_HISUI}},
    [SPECIES_ZOROARK]               = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_ZOROARK_HISUI}},
    [SPECIES_ZORUA_HISUI]           = {{EVO_LEVEL, 30, SPECIES_ZOROARK_HISUI},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_ZORUA}},
    [SPECIES_ZOROARK_HISUI]         = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_ZOROARK}},
    ...
    [SPECIES_KARRABLAST]            = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_ESCAVALIER}},
    ...
    [SPECIES_SHELMET]               = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_ACCELGOR}},
    [SPECIES_MIENFOO]               = {{EVO_LEVEL, 50, SPECIES_MIENSHAO}},
    [SPECIES_STUNFISK]              = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_STUNFISK_GALARIAN}},
    [SPECIES_GOLETT]                = {{EVO_LEVEL, 43, SPECIES_GOLURK}},
    [SPECIES_PAWNIARD]              = {{EVO_LEVEL, 52, SPECIES_BISHARP}},
    [SPECIES_BISHARP]               = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_KINGAMBIT}},
    [SPECIES_RUFFLET]               = {{EVO_LEVEL, 54, SPECIES_BRAVIARY}},
    [SPECIES_BRAVIARY]              = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_BRAVIARY_HISUI}},
    [SPECIES_BRAVIARY_HISUI]        = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_BRAVIARY}},
    ...
    [SPECIES_SPRITZEE]              = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_AROMATISSE}},
    [SPECIES_SWIRLIX]               = {{EVO_ITEM, ITEM_PIEDRA_LINK, SPECIES_SLURPUFF}},
    ...
    [SPECIES_SLIGGOO]               = {{EVO_LEVEL_RAIN, 50, SPECIES_GOODRA},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SLIGGOO_HISUI}},
    [SPECIES_SLIGGOO_HISUI]         = {{EVO_LEVEL_RAIN, 50, SPECIES_GOODRA_HISUI},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SLIGGOO}},
    [SPECIES_GOODRA_HISUI]          = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_GOODRA}},
    ...
    [SPECIES_AVALUGG]               = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_AVALUGG_HISUI}},
    [SPECIES_AVALUGG_HISUI]         = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_AVALUGG}},
    ...
    [SPECIES_DECIDUEYE]             = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_DECIDUEYE_HISUI}},
    [SPECIES_DECIDUEYE_HISUI]       = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_DECIDUEYE}},
    ...
    [SPECIES_RATTATA_ALOLAN]        = {{EVO_LEVEL_NIGHT, 20, SPECIES_RATICATE_ALOLAN},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_RATTATA}},
    [SPECIES_RATICATE_ALOLAN]       = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_RATICATE}},
    [SPECIES_RAICHU_ALOLAN]         = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_RAICHU}},
    [SPECIES_SANDSHREW_ALOLAN]      = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_SANDSLASH_ALOLAN},
                                      {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SANDSHREW}},
    [SPECIES_SANDSLASH_ALOLAN]      = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SANDSLASH}},
    [SPECIES_VULPIX_ALOLAN]         = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_NINETALES_ALOLAN},
                                      {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_VULPIX}},
    [SPECIES_NINETALES_ALOLAN]      = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_NINETALES}},
    [SPECIES_DIGLETT_ALOLAN]        = {{EVO_LEVEL, 26, SPECIES_DUGTRIO_ALOLAN},
                                      {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_DIGLETT}},
    [SPECIES_DUGTRIO_ALOLAN]        = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_DUGTRIO}},
    [SPECIES_MEOWTH_ALOLAN]         = {{EVO_FRIENDSHIP, 28, SPECIES_PERSIAN_ALOLAN},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_MEOWTH}},
    [SPECIES_PERSIAN_ALOLAN]        = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_PERSIAN}},
    [SPECIES_GEODUDE_ALOLAN]        = {{EVO_LEVEL, 25, SPECIES_GRAVELER_ALOLAN},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_GEODUDE}},
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_LEVEL, 45, SPECIES_GOLEM_ALOLAN},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_GRAVELER}},
    [SPECIES_GOLEM_ALOLAN]          = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_GOLEM}},
    [SPECIES_GRIMER_ALOLAN]         = {{EVO_LEVEL, 38, SPECIES_MUK_ALOLAN},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_GRIMER}},
    [SPECIES_MUK_ALOLAN]            = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_MUK}},
    [SPECIES_MEOWTH_GALARIAN]       = {{EVO_LEVEL, 28, SPECIES_PERRSERKER}},
    [SPECIES_PONYTA_GALARIAN]       = {{EVO_LEVEL, 40, SPECIES_RAPIDASH_GALARIAN},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_PONYTA}},
    [SPECIES_RAPIDASH_GALARIAN]     = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_RAPIDASH}},
    [SPECIES_SLOWPOKE_GALARIAN]     = {{EVO_LEVEL, 37, SPECIES_SLOWBRO_GALARIAN},
                                       {EVO_ITEM, ITEM_WATER_STONE, SPECIES_SLOWKING_GALARIAN}},
    [SPECIES_SLOWBRO_GALARIAN]      = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SLOWBRO}},
    [SPECIES_SLOWKING_GALARIAN]     = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_SLOWKING}},
    [SPECIES_FARFETCHD_GALARIAN]    = {{EVO_LEVEL, 50, SPECIES_SIRFETCHD},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_FARFETCHD}},
    [SPECIES_SIRFETCHD]             = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_MADAAMU}},
    [SPECIES_MR_MIME_GALARIAN]      = {{EVO_LEVEL, 42, SPECIES_MR_RIME},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_MR_MIME}},
    [SPECIES_CORSOLA_GALARIAN]      = {{EVO_LEVEL, 38, SPECIES_CURSOLA},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_CORSOLA}},
    [SPECIES_ZIGZAGOON_GALARIAN]    = {{EVO_LEVEL, 20, SPECIES_LINOONE_GALARIAN},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_ZIGZAGOON}},
    [SPECIES_LINOONE_GALARIAN]      = {{EVO_LEVEL, 35, SPECIES_OBSTAGOON},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_LINOONE}},
    [SPECIES_DARUMAKA_GALARIAN]     = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_DARMANITAN_GALARIAN},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_DARUMAKA}},
    [SPECIES_DARMANITAN_GALARIAN]   = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_DARMANITAN}},
    [SPECIES_YAMASK_GALARIAN]       = {{EVO_LEVEL, 42, SPECIES_RUNERIGUS},
                                       {EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_YAMASK}},
    [SPECIES_RUNERIGUS]             = {{EVO_ITEM, ITEM_PIEDRA_SAGRADA, SPECIES_COFAGRIGUS}},
