const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_EONEON] = sEoneonLevelUpLearnset,
    [SPECIES_TRXATU] = sTrxatuLevelUpLearnset,
    [SPECIES_ELECTRODE_Y] = sElectrodeYLevelUpLearnset,
    [SPECIES_TAUROS_X] = sTaurosXLevelUpLearnset,
    [SPECIES_PORYGON3] = sPorygon3LevelUpLearnset,
    [SPECIES_ELECTIVIRE_X] = sElectivireXLevelUpLearnset,
    [SPECIES_MAGMORTAR_Y] = sMagmortarYLevelUpLearnset,
    [SPECIES_NIDOQUEEN_Y] = sNidoqueenYLevelUpLearnset,
    [SPECIES_NIDOKING_X] = sNidokingXLevelUpLearnset,
    [SPECIES_PORYGONZ_X] = sPorygonZXLevelUpLearnset,
    [SPECIES_PORYGONZ_Y] = sPorygonZYLevelUpLearnset,
    [SPECIES_NIDOGOD] = sNidogodLevelUpLearnset,
    [SPECIES_AERODACTYL_SKEL] = sAerodactylSkelLevelUpLearnset,
    [SPECIES_CRADILY_Y] = sCradilyYLevelUpLearnset,
    [SPECIES_RAMPARDOS_X] = sRampardosXLevelUpLearnset,
    [SPECIES_BASTIODON_X] = sBastiodonXLevelUpLearnset,
    [SPECIES_TYRANTRUM_X] = sTyrantrumXLevelUpLearnset,
    [SPECIES_ARCHEOPS_X] = sArcheopsXLevelUpLearnset,
    [SPECIES_REGIROCK_X] = sRegirockXLevelUpLearnset,
    [SPECIES_REGICE_Y] = sRegiceYLevelUpLearnset,
    [SPECIES_REGISTEEL_Z] = sRegisteelZLevelUpLearnset,
    [SPECIES_DEOXYS_ATTACK_Y] = sDeoxysAttackYLevelUpLearnset,
    [SPECIES_DEOXYS_SPEED_Y] = sDeoxysSpeedYLevelUpLearnset,
    [SPECIES_MEWTWO_ARM] = sMewtwoArmLevelUpLearnset,
    [SPECIES_GENESECT_X] = sGenesectXLevelUpLearnset,
    [SPECIES_GENESECT_Y] = sGenesectYLevelUpLearnset,
    [SPECIES_ULTIMATE_PROYECT] = sUltimateProyectLevelUpLearnset,
    [SPECIES_POLIWRATH_BOND] = sPoliwrathBondLevelUpLearnset,
    [SPECIES_BUTTERFREE_BOND] = sButterfreeBondLevelUpLearnset,
    [SPECIES_FERALIGATR_BOND] = sFeraligatrBondLevelUpLearnset,
    [SPECIES_RAPIDASH_BOND] = sRapidashBondLevelUpLearnset,
    [SPECIES_KINGDRA_BOND] = sKingdraBondLevelUpLearnset,
    [SPECIES_SKARMORY_BOND] = sSkarmoryBondLevelUpLearnset,
    [SPECIES_EEVEE_BOND] = sEeveeBondLevelUpLearnset,
    [SPECIES_HYPNO_BOND] = sHypnoBondLevelUpLearnset,
    [SPECIES_DUNSPARCE_OLD] = sDunsparceOldLevelUpLearnset,
    [SPECIES_DELPHOX_BOND] = sDelphoxBondLevelUpLearnset,
    [SPECIES_RHYPERIOR_BOND] = sRhyperiorBondLevelUpLearnset,
    [SPECIES_LAPRAS_BOND] = sLaprasBondLevelUpLearnset,
    [SPECIES_EMPOLEON_BOND] = sEmpoleonBondLevelUpLearnset,
    [SPECIES_INFERNAPE_BOND] = sInfernapeBondLevelUpLearnset,
    [SPECIES_MESPRIT_BOND] = sMespritBondLevelUpLearnset,
    [SPECIES_SERPERIOR_BOND] = sSerperiorBondLevelUpLearnset,
    [SPECIES_HAXORUS_BOND] = sHaxorusBondLevelUpLearnset,
    [SPECIES_WEAVILE_BOND] = sWeavileBondLevelUpLearnset,
    [SPECIES_AEGISLASH_BOND] = sAegislashBondLevelUpLearnset,
    [SPECIES_VOLCARONA_BOND] = sVolcaronaBondLevelUpLearnset,
    [SPECIES_GOODRA_BOND] = sGoodraBondLevelUpLearnset,
    [SPECIES_HYDREIGON_BOND] = sHydreigonBondLevelUpLearnset,
    [SPECIES_DRAGONITE_BOND] = sDragoniteBondLevelUpLearnset,
    [SPECIES_MAROGHOST] = sMaroghostLevelUpLearnset,
    [SPECIES_KABUTOPS_SKEL] = sKabutopsSkelLevelUpLearnset,
    [SPECIES_DUDUNSPARCE] = sDudunsparceLevelUpLearnset,
    [SPECIES_GHOST] = sGhostLevelUpLearnset,
    [SPECIES_UNOWN_GOLD] = sUnownGoldLevelUpLearnset,
    [SPECIES_UNOWN_KING] = sUnownKingLevelUpLearnset,
    [SPECIES_ARTICUNO_PRIMAL] = sArticunoPrimalLevelUpLearnset,
    [SPECIES_ZAPDOS_PRIMAL] = sZapdosPrimalLevelUpLearnset,
    [SPECIES_MOLTRES_PRIMAL] = sMoltresPrimalLevelUpLearnset,
    [SPECIES_RAIKOU_BOND] = sRaikouBondLevelUpLearnset,
    [SPECIES_ENTEI_BOND] = sEnteiBondLevelUpLearnset,
    [SPECIES_SUICUNE_BOND] = sSuicuneBondLevelUpLearnset,
    [SPECIES_KURUSU] = sKurusuLevelUpLearnset,
    [SPECIES_AKUA] = sAkuaLevelUpLearnset,
    [SPECIES_AKUERIA] = sAkueriaLevelUpLearnset,
    [SPECIES_BOOHOO] = sBoohooLevelUpLearnset,
    [SPECIES_IKARY] = sIkaryLevelUpLearnset,
    [SPECIES_PURAKKUSU] = sPurakkusuLevelUpLearnset,
    [SPECIES_RAICHU_EVO] = sRaichuLevelUpLearnset,
    [SPECIES_OCTILLERY_EVO] = sOctilleryLevelUpLearnset,
    [SPECIES_QWILFISH_EVO] = sQwilfishLevelUpLearnset,
    [SPECIES_TAABAN] = sTaabanLevelUpLearnset,
    [SPECIES_BOMUSHIKAA] = sBomushikaaLevelUpLearnset,
    [SPECIES_MADAAMU] = sMadaamuLevelUpLearnset,
    [SPECIES_SUI] = sSuiLevelUpLearnset,
    [SPECIES_RAI] = sRaiLevelUpLearnset,
    [SPECIES_EN] = sEnLevelUpLearnset,
    [SPECIES_SACRED_DRAGON] = sSacredDragonLevelUpLearnset,
    [SPECIES_ORIGINAL_DRAGON] = sOriginalDragonLevelUpLearnset,
    [SPECIES_ARCEUS_PRIMAL] = sArceusPrimalLevelUpLearnset,
    ...
    [SPECIES_DUSKNOIR_MEGA] = sDusknoirMegaLevelUpLearnset,
    [SPECIES_FLYGON_MEGA] = sFlygonMegaLevelUpLearnset,
    [SPECIES_STARMIE_MEGA] = sStarmieMegaLevelUpLearnset,
    [SPECIES_BUTTERFREE_MEGA] = sButterfreeMegaLevelUpLearnset,
    [SPECIES_NOIVERN_MEGA] = sNoivernMegaLevelUpLearnset,
    [SPECIES_MILOTIC_MEGA] = sMiloticMegaLevelUpLearnset,
    [SPECIES_PORYGON_Z_MEGA] = sPorygonZMegaLevelUpLearnset,
    [SPECIES_COFAGRIGUS_MEGA] = sCofagrigusMegaLevelUpLearnset,
    [SPECIES_DURALUDON_MEGA] = sDuraludonMegaLevelUpLearnset,
    ...
    [SPECIES_DARKRAI_PRIMAL] = sDarkraiPrimalLevelUpLearnset,
    [SPECIES_HO_OH_PRIMAL] = sHoOhPrimalLevelUpLearnset,
    [SPECIES_LUGIA_PRIMAL] = sLugiaPrimalLevelUpLearnset,
    [SPECIES_CELEBI_PRIMAL] = sCelebiPrimalLevelUpLearnset,
    [SPECIES_JIRACHI_PRIMAL] = sJirachiPrimalLevelUpLearnset,
    [SPECIES_VICTINI_PRIMAL] = sVictiniPrimalLevelUpLearnset,
    [SPECIES_REGIGIGAS_PRIMAL] = sRegigigasPrimalLevelUpLearnset,
    [SPECIES_DIALGA_PRIMAL] = sDialgaPrimalLevelUpLearnset,
    [SPECIES_PALKIA_PRIMAL] = sPalkiaPrimalLevelUpLearnset,
    [SPECIES_KYUREM_PRIMAL] = sKyuremPrimalLevelUpLearnset,
    // Alolan Forms
    ...
    [SPECIES_AERODACTYL_PRIMAL] = sAerodactylPrimalLevelUpLearnset,
    [SPECIES_CROBAT_BOND] = sCrobatBondLevelUpLearnset,
    [SPECIES_CROBAT2_BOND] = sCrobat2BondLevelUpLearnset,
    [SPECIES_KABUTOPS_PRIMAL] = sKabutopsPrimalLevelUpLearnset,
    [SPECIES_GHOST_PRIMAL] = sGhostPrimalLevelUpLearnset,
    [SPECIES_MAMOSWINE_BOND] = sMamoswineBondLevelUpLearnset,
    ...
    [SPECIES_BASCULEGION_FEMALE] = sBasculegionFemaleLevelUpLearnset,
    ...
    [SPECIES_ENAMORUS_THERIAN] = sEnamorusTherianLevelUpLearnset,
