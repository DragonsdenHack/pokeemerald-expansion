const u8 gDummyPokedexText[] = _(		
    ...
    "De momento no se dispone de datos\n"		
    "concretos.");
...
"Soporta el peso del bulbo gracias\n"
"a sus fuertes patas y a su tronco.\n"
"Si pasa mucho tiempo al sol, el bulbo\n"
"se convierte en una enorme flor.");
...
"se vuelve agresivo y la llama que tiene\n"
"en la cola arde con un tono azulado.");
...
"Tiene tanta puntería que no fallaría al\n"
"tirar contra una lata pequeña a 50 metros.");

const u8 gCaterpiePokedexText[] = _(
"Tiene un apetito voraz. Es capaz de\n"
"devorar hojas que superan su tamaño\n"
"en un abrir y cerrar de ojos. Libera\n"
"un hedor terrible por las antenas.");
...
"toda costa. No conviene acercarse a su\n"
"colmena, por seguridad. Si se les molesta,\n"
"todo un enjambre atacará ferozmente.");

const u8 gPidgeyPokedexText[] = _(
"PIDGEY tiene un sentido de la orientación\n"
"muy desarrollado. Aunque se encuentre\n"
"muy lejos de las zonas que le resultan\n"
"familiares, es capaz de regresar a su nido.");

const u8 gPidgeottoPokedexText[] = _(
"Se hace con un territorio muy vasto y lo\n"
"sobrevuela para controlarlo. Si invaden\n"
"su espacio vital, no tendrá ningún reparo\n"
"en atacar con sus afiladas garras.");

const u8 gPidgeotPokedexText[] = _(
"Tiene un plumaje bonito e hipnótico.\n"
"Muchos ENTRENADORES se quedan\n"
"embobados con las plumas que tiene en\n"
"la cabeza y lo eligen como su POKéMON.");

const u8 gRattataPokedexText[] = _(
"RATTATA es cauto como él solo. Hasta\n"
"cuando duerme mueve las orejas para oír\n"
"todo lo que pueda suponer un peligro.\n"
"Cava su madriguera en cualquier sitio.");

const u8 gRaticatePokedexText[] = _(
"A RATICATE le crecen unos colmillos\n"
"firmes y fuertes. Para mantenerlos\n"
"afilados, roe rocas, troncos e\n"
"incluso las paredes de las casas.");

const u8 gSpearowPokedexText[] = _(
"Cuando pía, se le puede oír a 1 km. Si\n"
"a su agudo chillido le sigue una especie\n"
"de eco, estaremos oyendo a otros\n"
"SPEAROW responder al aviso de peligro.");

const u8 gFearowPokedexText[] = _(
"Se le reconoce por tener un pescuezo\n"
"y un pico largos que le permiten cazar\n"
"en agua y en tierra firme. Mueve el pico\n"
"con habilidad para atrapar a sus presas.");
...
"Tiene unas bolsas en las mejillas en\n"
"las que almacena electricidad. Cuando\n"
"la libera de golpe, la potencia de la\n"
"descarga es igual a la de un rayo.");
...
"Al variar la esencia de éste, consigue\n"
...
"Sólo paran de díaよ entonces, dejan\n"
...
"bosques y se le temeよ nadie se atreve\n"
...
"Se le diferencia por los dibujos del pelajeよ\n"
...
"acecho en la oscuridadよ no es fácil verlo.");
...
"al día. Su práctica del yoga es rigurosaよ\n"
...
"más duro que hayよ una misteriosa\n"
...
const u8 gBurmyPokedexText[] = _(
    "Aunque nazca en un lugar en el que no\n"
    "haya muchos materiales, siempre consigue\n"
    "crearse un caparazón.");

const u8 gWormadamPokedexText[] = _(
    "Su apariencia varía según dónde\n"
    "evolucione. Los materiales que\n"
    "haya pasan a formar parte de su cuerpo.");

const u8 gMothimPokedexText[] = _(
    "No tiene nido. Vuela sobre los\n"
    "campos y las montañas en busca de\n"
    "miel floral.");
...
const u8 gCherrimPokedexText[] = _(
    "Cuando los rayos del sol inundan su\n"
    "capullo, abre de par en par sus pétalos\n"
    "y se vuelve muy dinámico.");

const u8 gShellosPokedexText[] = _(
    "No hay que apretarle muy fuerte, \n"
    "ya que si lo haces, segrega un misterioso\n"
    "fluido morado.");

const u8 gGastrodonPokedexText[] = _(
    "Hace mucho tiempo tenía todo el lomo\n"
    "cubierto con una concha. Aún hay\n"
    "trazas de ella en sus células.");
...
const u8 gMimeJrPokedexText[] = _(
    "Cuando tiene a alguien delante imita su\n"
    "expresión y movimientos para extender\n"
    "sus sentimientos.");
...
const u8 gPorygonZPokedexText[] = _(
    "Se le instaló un software para mejorarlo.\n"
    "Sin embargo, comenzó a comportarse de\n"
    "manera extraña.");
...
const u8 gGiratinaPokedexText[] = _(
    "Vive en el Mundo Distorsión, un mundo\n"
    "opuesto al nuestro y cuyas leyes\n"
...
const u8 gShayminPokedexText[] = _(
    "Se dice que, cuando florecen las\n"
    "Gracídeas, Shaymin alza su vuelo para\n"
    "mostrar su gratitud.");

const u8 gArceusPokedexText[] = _(
    "Se dice que surgió de un huevo en un\n"
    "lugar en el que no había nada.\n"
...
const u8 gWhirlipedePokedexText[] = _(
    "Normalmente no se mueve, pero se\n"
...
const u8 gBasculinPokedexText[] = _(
    "Los Basculin con la raya roja y\n"
    "aquellos con la raya azul no dejan de\n"
    "pelearse. Son unos Pokémon muy violentos.");
...
const u8 gDarmanitanPokedexText[] = _(
    "Se queda firme como una estatua\n"
    "cuando es debilitado en combate.\n"
    "Agudiza el ingenio para luchar.");
...
const u8 gDeerlingPokedexText[] = _(
    "Durante los cambios de estación su\n"
    "pelaje y olor cambian. Esto anuncia\n"
    "el comienzo de una estación.");

const u8 gSawsbuckPokedexText[] = _(
    "Migra con el cambio de estación, por lo\n"
    "que hay quien considera a Sawsbuck el\n"
...
const u8 gTornadusPokedexText[] = _(
    "La energía que desprende de su cola\n"
    "genera violentas tempestades capaces\n"
    "de echar abajo casas.");

const u8 gThundurusPokedexText[] = _(
    "Su gusto por surcar el cielo lanzando\n"
    "rayos y provocando incendios forestales\n"
    "le ha granjeado pocas simpatías.");
...
const u8 gLandorusPokedexText[] = _(
    "Lo consideran una deidad de las\n"
    "cosechas porque los cultivos crecen\n"
    "en abundancia en las tierras\n"
    "por las que pasa.");
...
const u8 gKeldeoPokedexText[] = _(
    "Desprende agua por sus pezuñas para\n"
    "poder deslizarse. Es especialista\n"
    "en atacar usando sus patas.");

const u8 gMeloettaPokedexText[] = _(
    "Se han creado innumerables canciones\n"
    "inspiradas en las melodías que emite\n"
    "Meloetta. Hay quien cree que este\n"
    "Pokémon es tipo planta.");

const u8 gGenesectPokedexText[] = _(
    "Era temido hace 300 millones\n"
    "de años por ser el cazador más fiero\n"
    "y eficaz. Ha sido modificado por el\n"
    "Equipo Plasma.");
...
const u8 gGreninjaPokedexText[] = _(
    "Comprime agua y crea estrellas ninja\n"
    "con las que ataca al enemigo.\n"
    "Cuando las hace girar a gran velocidad\n"
    "cortan en dos hasta el metal.");
...
const u8 gScatterbugPokedexText[] = _(
    "Cuando recibe el ataque de un Pokémon\n"
    "pájaro, expulsa unas escamas negras\n"
    "que provocan parálisis si se entra en\n"
    "contacto con ellas.");

const u8 gSpewpaPokedexText[] = _(
    "Habita en la sombra de la espesura.\n"
    "Si percibe alguna amenaza, su pelaje se\n"
    "eriza y se vuelve muy afilado para  así\n"
    "intimidar al enemigo.");

const u8 gVivillonPokedexText[] = _(
    "En el mundo existen Vivillon con\n"
    "diferentes motivos en sus alas.\n"
    "El clima de cada región influye en\n"
    "sus rasgos.");
...
const u8 gFlabebePokedexText[] = _(
    "Puede controlar el poder oculto de las\n"
    "flores. La flor que lleva consigo es\n"
    "como si formara parte de su cuerpo.");

const u8 gFloettePokedexText[] = _(
    "Revolotea alrededor de campos de flores\n"
    "y cuida de aquellas que empiezan a\n"
    "marchitarse. Usa en combate el poder\n"
    "oculto de las flores.");

const u8 gFlorgesPokedexText[] = _(
    "Habita en preciosos jardines floridos.\n"
    "Absorbe la energía que emiten las\n"
    "plantas y la convierte en su fuente\n"
    "de poder.");
...
const u8 gFurfrouPokedexText[] = _(
    "Cuando le esquilan su mullido pelaje,\n"
    "no solo mejora su apariencia, sino que\n"
    "aumenta su agilidad.");
...
const u8 gMeowsticPokedexText[] = _(
    "Cuando percibe peligro, yergue sus\n"
    "orejas y desata un poder psíquico capaz\n"
    "de levantar un camión de unas\n"
    "10 toneladas.");
...
const u8 gAegislashPokedexText[] = _(
    "Han permanecido junto a estirpes de\n"
    "reyes durante generaciones. Mediante su\n"
    "poder espectral pueden controlar a\n"
    "humanos y a Pokémon.");
...
const u8 gPumpkabooPokedexText[] = _(
    "En el interior de la calabaza reside\n"
    "un espíritu que ha permanecido atrapado\n"
    "en este mundo. Entra en acción al caer\n"
    "la noche.");

const u8 gGourgeistPokedexText[] = _(
    "En las noches de luna nueva deambula\n"
    "por las calles de las ciudades y emite\n"
    "espeluznantes alaridos que maldicen a\n"
    "quienes los oyen.");
...
const u8 gXerneasPokedexText[] = _(
    "Cuando los cuernos de su cabeza brillan\n"
    "en siete colores, se dice que comparte\n"
...
const u8 gZygardePokedexText[] = _(
    "Vive en las profundidades de las\n"
    "cavernas, desde donde vigila a todos\n"
    "aquellos que se dediquen a destruir\n"
    "el ecosistema.");
...
const u8 gHoopaPokedexText[] = _(
    "Este problemático Pokémon envía cualquier\n"
    "objeto a lugares remotos mediante unos\n"
    "anillos que deforman el espacio.");
...
const u8 gGumshoosPokedexText[] = _(
    "Al detectar el rastro de una presa, la\n"
    "acecha con tenacidad, pero al ponerse\n"
    "el sol le vence el sueño.");
...
const u8 gVikavoltPokedexText[] = _(
    "Aturde al enemigo con su vuelo\n"
    "acrobático y aprovecha el desconcierto\n"
    "para propinarle una descarga en forma\n"
    "de rayo.");
...
const u8 gOricorioPokedexText[] = _(
    "Oricorio puede cambiar su cuerpo sorbiendo\n"
    "néctar de diferentes colores. Sus enemigos\n"
    "quedan impresionados al ver sus variados\n"
    "y hermosos bailes.");
...
const u8 gRibombeePokedexText[] = _(
    "Fabrica varios tipos de bolas de polen.\n"
    "Algunas se usan como alimento y otras\n"
    "para el combate.");

const u8 gRockruffPokedexText[] = _(
    "Acostumbran a vivir con los humanos\n"
    "desde la antigüedad. Intuyen si su\n"
    "Entrenador está triste, en cuyo caso no\n"
    "se despegan de su lado.");

const u8 gLycanrocPokedexText[] = _(
    "Bien equipado con garras y colmillos,\n"
    "también utiliza las afiladas piedras de\n"
    "su melena como armas. Ataca sin\n"
    "preocuparse por su propia seguridad.");

const u8 gWishiwashiPokedexText[] = _(
    "Cuando tiene problemas, sus ojos se\n"
    "humedecen y empiezan a brillar.\n"
    "La luz brillante atrae a sus camaradas,\n"
    "y se enfrentan juntos a sus enemigos.");
...
const u8 gAraquanidPokedexText[] = _(
    "Propina cabezazos con su burbuja. Los\n"
...
const u8 gLurantisPokedexText[] = _(
    "Dedica mucho tiempo y esfuerzo a\n"
    "acicalarse y preservar sus vivos\n"
    "colores. A algunos ejemplares incluso\n"
    "les lleva todo el día.");
...
const u8 gSalazzlePokedexText[] = _(
    "Por algún motivo desconocido, solo\n"
    "hay hembras. Suele formarse su\n"
    "propio harén compuesto por\n"
    "Salandit machos.");
...
const u8 gTypeNullPokedexText[] = _(
    "La pesada máscara le impide liberar\n"
    "toda su fuerza, que se cree que\n"
    "es extraordinaria.");

const u8 gSilvallyPokedexText[] = _(
    "La confianza con su Entrenador ha\n"
    "despertado su potencial. Ahora es\n"
    "capaz de cambiar de tipo a voluntad\n"
    "durante el combate.");

const u8 gMiniorPokedexText[] = _(
    "Vive en la capa de ozono hasta que su\n"
...
const u8 gTogedemaruPokedexText[] = _(
    "Cuando se siente amenazado, eriza las\n"
    "púas de su lomo para pinchar a quien\n"
    "ose atacarlo.");

const u8 gMimikyuPokedexText[] = _(
    "Su verdadero aspecto es un misterio total.\n"
    "Un investigador que intentó mirar dentro\n"
    "del saco recibió, literalmente, un susto\n"
    "de muerte.");
...
const u8 gJangmooPokedexText[] = _(
    "Comunica sus sentimientos haciendo sonar\n"
    "sus escamas. El ruido metálico producido\n"
    "reverbera en las altas montañas\n"
    "donde habita.");

const u8 gHakamooPokedexText[] = _(
    "Se lanza sobre su presa entonando\n"
    "un grito de guerra. Golpea al enemigo\n"
    "y lo hace trizas con sus escamas.");

const u8 gKommooPokedexText[] = _(
    "Lucha valerosamente con sus puños\n"
    "recubiertos de escamas de acero.\n"
    "Tiene un gancho formidable.");

const u8 gTapuKokoPokedexText[] = _(
    "El espíritu guardián de Melemele,\n"
    "curioso e inquisitivo. Invoca nubes\n"
    "de tormenta y acumula el poder\n"
    "de los rayos en su cuerpo.");

const u8 gTapuLelePokedexText[] = _(
    "El espíritu guardián de Akala,\n"
    "tan inocente como cruel. La fragancia\n"
    "de las flores constituye su fuente de\n"
    "energía.");

const u8 gTapuBuluPokedexText[] = _(
    "El indolente espíritu guardián de Ula-Ula.\n"
    "Inmoviliza al enemigo con la vegetación\n"
    "y lo embiste con sus cuernos.");

const u8 gTapuFiniPokedexText[] = _(
    "Es el espíritu guardián de Poni y tiene\n"
    "control sobre el agua. Dicen que puede\n"
    "purificar cualquier impureza con su\n"
    "agua límpida.");
...
const u8 gToxtricityPokedexText[] = _(
    "Cuando este Pokémon suena como si\n"
    "estuviera rasgando una guitarra, en\n"
    "realidad está arañando las protuberancias\n"
    "de su pecho para generar electricidad.");
...
const u8 gSinisteaPokedexText[] = _(
    "La taza de té donde se hospeda forma\n"
    "parte de una antigua y valiosa vajilla,\n"
    "de la que circulan numerosas\n"
    "falsificaciones.");

const u8 gPolteageistPokedexText[] = _(
    "Si avista una taza de té abandonada a su\n"
    "suerte, la rellena vertiendo parte de su\n"
    "propio cuerpo para generar otro\n"
    "Polteageist.");
...
const u8 gMrRimePokedexText[] = _(
    "Es un bailarín consumado de claqué.\n"
    "Agita su bastón de hielo mientras exhibe\n"
    "su destreza con gráciles pasos.");
...
const u8 gAlcremiePokedexText[] = _(
    "Obsequia bayas decoradas con nata a\n"
...
const u8 gEiscuePokedexText[] = _(
    "Se enfría constantemente la cara con hielo\n"
    "por su escasa resistencia al calor. Utiliza\n"
    "el pelo de la cabeza para pescar en el mar.");

const u8 gIndeedeePokedexText[] = _(
    "Con sus cuernos percibe las emociones\n"
    "de los seres vivos que se hallen cerca.\n"
    "Los sentimientos positivos constituyen\n"
    "su fuente de energía.");

const u8 gMorpekoPokedexText[] = _(
    "Siempre tiene apetito, sin importar lo\n"
    "mucho que coma. Lleva con sumo cuidado\n"
    "las semillas que ha tostado con su propia\n"
    "electricidad.");
...
const u8 gZacianPokedexText[] = _(
    "Este Pokémon está considerado como un\n"
    "héroe de leyenda. Absorbe el metal\n"
    "para transformarlo y emplearlo\n"
    "como armamento.");

const u8 gZamazentaPokedexText[] = _(
    "Este Pokémon se erigió en salvador de\n"
    "Galar, tras unir fuerzas con un rey de\n"
    "los hombres. Absorbe el metal para\n"
...
const u8 gUrshifuPokedexText[] = _(
    "Se considera que su estilo de lucha,\n"
    "a veces intenso y a veces comedido, se\n"
    "inspira en el fluir de la corriente de\n"
    "los rios.");
...
const u8 gTrxatuPokedexText[] = _(
    "Se cree que era adorado por una antigua\n"
    "civilización. En tiempos pasados podía\n"
    "verse en el exterior de ciertas ruinas.\n"
    "Guarda relación con los PERROS LEGENDARIOS.");

const u8 gPorygon3PokedexText[] = _(
    "Fue concebido con la ambición de superar\n"
    "la ofensiva especial de MEWTWO. Explota\n"
    "aún más la línea evolutiva de PORYGON2,\n"
    "en lugar del corrupto PORYGON-Z.");

const u8 gNidogodPokedexText[] = _(
    "Primer prototipo exitoso empleando la\n"
    "tecnología de ondas de radio. Se anuló\n"
    "por completo su voluntad, solo está\n"
    "programado para acabar con su enemigo.");

const u8 gAerodactylSkelPokedexText[] = _(
    "Uno de los POKÉMON protectores de\n"
    "RUINAS ALFA. La magia del lugar\n"
    "convirtió restos antiguos en una\n"
    "criatura muy peligrosa.");

const u8 gMewtwoArmPokedexText[] = _(
    "Se le inhibió por completo la voluntad\n"
    "para evitar repetir la historia del\n"
    "MEWTWO original. Su poder destructor\n"
...
const u8 gDunsparceOldPokedexText[] = _(
    "Conocido como el antepasado de los\n"
    "POKÉMON PSEUDOLEGENDARIOS. POKÉMON\n"
    "sagrado y extremadamente raro,\n"
    "símbolo del techo de los mortales");

const u8 gMaroghostPokedexText[] = _(
    "Alma en pena, incapaz de abandonar\n"
    "por completo este mundo hasta asegurarse\n"
    "de que su descendiente está a salvo");
...
const u8 gDudunsparcePokedexText[] = _(
    "Usa su dura cola para horadar el lecho\n"
    "rocoso en las profundidades de la tierra\n"
    "y establecer su propia madriguera, cuyos\n"
    "túneles se extienden 10 km.");

const u8 gGhostPokedexText[] = _(
    "Alma de un POKÉMON en pena, se\n"
    "cree que fue  el sufrimiento lo que\n"
    "le mantuvo anclado a este mundo. Sus\n"
    "poderes mentales son terribles.");

const u8 gKurusuPokedexText[] = _(
    "Creído extinto, apenas salen del\n"
    "nido, aunque poco a poco se les va\n"
    "adiestrando en la caza. MAGIKARP es\n"
    "su presa favorita.");

const u8 gAkuaPokedexText[] = _(
    "La gran mayoría termina pereciendo,\n"
    "ya que se les expone desde etapas muy\n"
    "tempranas a la caza de GYARADOS.");

const u8 gAkueriaPokedexText[] = _(
    "Es tremendamente hostil y agresivo,\n"
    "los GYARADOS huyen despavoridos de él.\n"
    "Se esconde en estrechas cavernas y\n"
    "odia acercarse a la superficie marina.");

const u8 gBoohooPokedexText[] = _(
    "Tiene la capacidad de recordar con\n"
    "absoluto detalle todas sus vivencias.\n"
    "Gracias a sus poderes PSÍQUICOS puede\n"
    "incluso rememorarlos como espectador.");

const u8 gIkaryPokedexText[] = _(
    "Antiguo POKÉMON, atrapado en las\n"
    "grutas del LAGO FURIA por millones\n"
    "de años. Su diminuto cerebro le\n"
    "hace atacar por puro instinto.");

const u8 gPurakkusuPokedexText[] = _(
    "En la antigua JOHTO era el rey de\n"
    "los insectos, debido a su fuerza\n"
...
const u8 gBomushikaaPokedexText[] = _(
    "Un POKÉMON muy noble y leal, dará\n"
    "todo por su ENTRENADOR. En la antigua\n"
    "JOHTO y SEVII era común ver ejemplares\n"
    "en zonas cálidas.");

const u8 gMadaamuPokedexText[] = _(
    "Su técnica de corte es exquisita,\n"
    "suele mantenerse tranquilo, pero si\n"
    "siente que le han ofendido, atacará\n"
    "de forma violenta sin importar el rival.");

const u8 gSuiPokedexText[] = _(
    "POKÉMON milenario, legado de generación\n"
    "en generación al GRAN MAESTRO del tercer\n"
    "pagoda de JOHTO. Una vez fue un VAPOREON,\n"
    "cuyo vínculo alcanzó el equilibrio perfecto.");

const u8 gRaiPokedexText[] = _(
    "POKÉMON milenario, legado de generación\n"
    "en generación al GRAN MAESTRO del tercer\n"
    "pagoda de JOHTO. Una vez fue un JOLTEON,\n"
    "cuyo vínculo alcanzó el equilibrio perfecto.");

const u8 gEnPokedexText[] = _(
    "POKÉMON milenario, legado de generación\n"
    "en generación al GRAN MAESTRO del tercer\n"
    "pagoda de JOHTO. Una vez fue un FLAREON,\n"
    "cuyo vínculo alcanzó el equilibrio perfecto.");
...
const u8 gWyrdeerPokedexText[] = _(
    "Sus orbes negros brillan con un fulgor\n"
    "misterioso cuando erige muros invisibles.\n"
    "El pelaje que se desprende de sus barbas\n"
    "es codiciado para crear cálidos ropajes.");

const u8 gKleavorPokedexText[] = _(
    "Las dos toscas hachas le permiten talar\n"
    "árboles mientras su piel pétrea lo protege.\n"
    "Dada su naturaleza agresiva, es aconsejable\n"
    "escapar en caso de toparse con uno salvaje.");

const u8 gOverqwilPokedexText[] = _(
    "Sus púas, afiladas como lanzas, y su vio-\n"
    "lento carácter le han granjeado el mote de\n"
    "Demonio del Mar. Puede sorber veneno como\n"
    "sustento alimenticio.");

const u8 gUrsalunaPokedexText[] = _(
    "Hay la teoría de que el terreno de la\n"
    "antigua JOHTO favoreció el desarrollo\n"
    "de su constitución robusta, así como su\n"
    "capacidad de manipular la turba a voluntad.");

const u8 gBasculegionPokedexText[] = _(
    "Durante las remontadas de los ríos, se\n"
    "envuelve de las almas de sus congéneres\n"
    "caídos en la ardua travesía. No tiene rival\n"
    "en las corrientes que fluyen por Hisui.");

const u8 gSneaslerPokedexText[] = _(
    "Gracias a su fortaleza física y potente\n"
    "veneno, ninguna especie de las alturas\n"
    "heladas le planta cara. Es de personalidad\n"
    "solitaria y no forma manadas.");

const u8 gEnamorusPokedexText[] = _(
    "Tras perder su apariencia femenina, surge\n"
    "de entre las nubes y, sin piedad alguna,\n"
    "desata toda su furia para castigar a\n"
...
const u8 gAnnihilapePokedexText[] = _(
    ...
    "crítico, adquirió un poder que lo libró\n"
    "para siempre de las limitaciones de su\n"
    "cuerpo material.");

const u8 gFarigirafPokedexText[] = _(
    "Las ondas cerebrales de la cola y la\n"
    "cabeza van al compás, lo que le confiere\n"
    "poderes psíquicos diez veces más potentes\n"
...
const u8 gFrigibaxPokedexText[] = _(
    ...
    "dorsal y lo convierte en energía gélida.\n"
    "Cuanto más alta es la temperatura, más\n"
    "más energía acumula.");

const u8 gArctibaxPokedexText[] = _(
    "Gracias a su poderoso tren inferior, da\n"
    "saltos mortales hacia delante y ataca a\n"
    "sus enemigos con las cuchillas de su\n"
    "placa dorsal.");

const u8 gBaxcaliburPokedexText[] = _(
    "Exhala un aliento extremadamente frío por\n"
    "la boca que es capaz de congelar al\n"
    "instante incluso magma al rojo vivo.");
...
const u8 gDunsparceOldPreevoPokedexText[] = _(
    "Se desconoce cómo obtenerlo sin usar la\n"
    "PIEDRA SAGRADA. Odia el contacto con la\n"
    "tierra y por ello prefiere volar, aunque\n"
    "aún lo hace de forma tosca.");

const u8 gDudunsparceEvoPokedexText[] = _(
    "Calyrex is a merciful Pokémon, capable of\n"
    "providing healing and blessings. It\n"
    "reigned over the Galar region in times\n"
    "of yore.");
