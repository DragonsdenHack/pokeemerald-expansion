const u8 gFacilityClassToPicIndex[] =
{
	...
	[FACILITY_CLASS_PLAYER_RECLUTA] = TRAINER_PIC_ROCKET_GRUNT_PLAYER,
	[FACILITY_CLASS_PLAYER_ALTO_RANGO] = TRAINER_PIC_ALTO_RANGO,
	[FACILITY_CLASS_PLAYER_EJECUTIVO] = TRAINER_PIC_EJECUTIVO,
	[FACILITY_CLASS_PLAYER_ADMIN] = TRAINER_PIC_ADMIN,
	[FACILITY_CLASS_PLAYER_ADMIN_JEFE] = TRAINER_PIC_ROCKET_ADMIN_PLAYER,
	[FACILITY_CLASS_PLAYER_ADMIN_JEFE2] = TRAINER_PIC_ADMIN_JEFE,
};
