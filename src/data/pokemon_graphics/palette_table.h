const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(EONEON, gMonPalette_Eoneon),
    SPECIES_PAL(TRXATU, gMonPalette_Trxatu),
    SPECIES_PAL(ELECTRODE_Y, gMonPalette_ElectrodeY),
    SPECIES_PAL(TAUROS_X, gMonPalette_TaurosX),
    SPECIES_PAL(PORYGON3, gMonPalette_Porygon3),
    SPECIES_PAL(ELECTIVIRE_X, gMonPalette_ElectivireX),
    SPECIES_PAL(MAGMORTAR_Y, gMonPalette_MagmortarY),
    SPECIES_PAL(NIDOQUEEN_Y, gMonPalette_NidoqueenY),
    SPECIES_PAL(NIDOKING_X, gMonPalette_NidokingX),
    SPECIES_PAL(PORYGONZ_X, gMonPalette_PorygonZX),
    SPECIES_PAL(PORYGONZ_Y, gMonPalette_PorygonZY),
    SPECIES_PAL(NIDOGOD, gMonPalette_Nidogod),
    SPECIES_PAL(AERODACTYL_SKEL, gMonPalette_AerodactylSkel),
    SPECIES_PAL(CRADILY_Y, gMonPalette_CradilyY),
    SPECIES_PAL(RAMPARDOS_X, gMonPalette_RampardosX),
    SPECIES_PAL(BASTIODON_X, gMonPalette_BastiodonX),
    SPECIES_PAL(TYRANTRUM_X, gMonPalette_TyrantrumX),
    SPECIES_PAL(ARCHEOPS_X, gMonPalette_ArcheopsX),
    SPECIES_PAL(REGIROCK_X, gMonPalette_RegirockX),
    SPECIES_PAL(REGICE_Y, gMonPalette_RegiceY),
    SPECIES_PAL(REGISTEEL_Z, gMonPalette_RegisteelZ),
    SPECIES_PAL(DEOXYS_ATTACK_Y, gMonPalette_DeoxysAttackY),
    SPECIES_PAL(DEOXYS_SPEED_Y, gMonPalette_DeoxysSpeedY),
    SPECIES_PAL(MEWTWO_ARM, gMonPalette_MewtwoArm),
    SPECIES_PAL(GENESECT_X, gMonPalette_GenesectX),
    SPECIES_PAL(GENESECT_Y, gMonPalette_GenesectY),
    SPECIES_PAL(ULTIMATE_PROYECT, gMonPalette_UltimateProyect),
    SPECIES_PAL(POLIWRATH_BOND, gMonPalette_PoliwrathBond),
    SPECIES_PAL(BUTTERFREE_BOND, gMonPalette_ButterfreeBond),
    SPECIES_PAL(FERALIGATR_BOND, gMonPalette_FeraligatrBond),
    SPECIES_PAL(RAPIDASH_BOND, gMonPalette_RapidashBond),
    SPECIES_PAL(KINGDRA_BOND, gMonPalette_KingdraBond),
    SPECIES_PAL(SKARMORY_BOND, gMonPalette_SkarmoryBond),
    SPECIES_PAL(EEVEE_BOND, gMonPalette_EeveeBond),
    SPECIES_PAL(HYPNO_BOND, gMonPalette_HypnoBond),
    SPECIES_PAL(DUNSPARCE_OLD, gMonPalette_DunsparceOld),
    SPECIES_PAL(DELPHOX_BOND, gMonPalette_DelphoxBond),
    SPECIES_PAL(RHYPERIOR_BOND, gMonPalette_RhyperiorBond),
    SPECIES_PAL(LAPRAS_BOND, gMonPalette_LaprasBond),
    SPECIES_PAL(EMPOLEON_BOND, gMonPalette_EmpoleonBond),
    SPECIES_PAL(INFERNAPE_BOND, gMonPalette_InfernapeBond),
    SPECIES_PAL(MESPRIT_BOND, gMonPalette_MespritBond),
    SPECIES_PAL(SERPERIOR_BOND, gMonPalette_SerperiorBond),
    SPECIES_PAL(HAXORUS_BOND, gMonPalette_HaxorusBond),
    SPECIES_PAL(WEAVILE_BOND, gMonPalette_WeavileBond),
    SPECIES_PAL(AEGISLASH_BOND, gMonPalette_AegislashBond),
    SPECIES_PAL(VOLCARONA_BOND, gMonPalette_VolcaronaBond),
    SPECIES_PAL(GOODRA_BOND, gMonPalette_GoodraBond),
    SPECIES_PAL(HYDREIGON_BOND, gMonPalette_HydreigonBond),
    SPECIES_PAL(DRAGONITE_BOND, gMonPalette_DragoniteBond),
    SPECIES_PAL(MAROGHOST, gMonPalette_Maroghost),
    SPECIES_PAL(KABUTOPS_SKEL, gMonPalette_KabutopsSkel),
    SPECIES_PAL(DUDUNSPARCE, gMonPalette_Dudunsparce),
    SPECIES_PAL(GHOST, gMonPalette_Ghost),
    SPECIES_PAL(UNOWN_GOLD, gMonPalette_UnownGold),
    SPECIES_PAL(UNOWN_KING, gMonPalette_UnownKing),
    SPECIES_PAL(ARTICUNO_PRIMAL, gMonPalette_ArticunoPrimal),
    SPECIES_PAL(ZAPDOS_PRIMAL, gMonPalette_ZapdosPrimal),
    SPECIES_PAL(MOLTRES_PRIMAL, gMonPalette_MoltresPrimal),
    SPECIES_PAL(RAIKOU_BOND, gMonPalette_RaikouBond),
    SPECIES_PAL(ENTEI_BOND, gMonPalette_EnteiBond),
    SPECIES_PAL(SUICUNE_BOND, gMonPalette_SuicuneBond),
    SPECIES_PAL(KURUSU, gMonPalette_Kurusu),
    SPECIES_PAL(AKUA, gMonPalette_Akua),
    SPECIES_PAL(AKUERIA, gMonPalette_Akueria),
    SPECIES_PAL(BOOHOO, gMonPalette_Boohoo),
    SPECIES_PAL(IKARY, gMonPalette_Ikary),
    SPECIES_PAL(PURAKKUSU, gMonPalette_Purakkusu),
    SPECIES_PAL(TAABAN, gMonPalette_Taaban),
    SPECIES_PAL(BOMUSHIKAA, gMonPalette_Bomushikaa),
    SPECIES_PAL(MADAAMU, gMonPalette_Madaamu),
    SPECIES_PAL(SUI, gMonPalette_Sui),
    SPECIES_PAL(RAI, gMonPalette_Rai),
    SPECIES_PAL(EN, gMonPalette_En),
    SPECIES_PAL(SACRED_DRAGON, gMonPalette_SacredDragon),
    SPECIES_PAL(ORIGINAL_DRAGON, gMonPalette_OriginalDragon),
    SPECIES_PAL(ARCEUS_PRIMAL, gMonPalette_ArceusPrimal),
    ...
    SPECIES_PAL(DUSKNOIR_MEGA, gMonPalette_DusknoirMega),
    ...
    SPECIES_PAL(NOIVERN_MEGA, gMonPalette_NoivernMega),
    SPECIES_PAL(MILOTIC_MEGA, gMonPalette_MiloticMega),
    SPECIES_PAL(PORYGON_Z_MEGA, gMonPalette_PorygonZMega),
    SPECIES_PAL(COFAGRIGUS_MEGA, gMonPalette_CofagrigusMega),
    SPECIES_PAL(DURALUDON_MEGA, gMonPalette_DuraludonMega),
    ...
    SPECIES_PAL(DARKRAI_PRIMAL, gMonPalette_DarkraiPrimal),
    SPECIES_PAL(HO_OH_PRIMAL, gMonPalette_HoOhPrimal),
    SPECIES_PAL(LUGIA_PRIMAL, gMonPalette_LugiaPrimal),
    SPECIES_PAL(CELEBI_PRIMAL, gMonPalette_CelebiPrimal),
    SPECIES_PAL(JIRACHI_PRIMAL, gMonPalette_JirachiPrimal),
    SPECIES_PAL(VICTINI_PRIMAL, gMonPalette_VictiniPrimal),
    SPECIES_PAL(REGIGIGAS_PRIMAL, gMonPalette_RegigigasPrimal),
    SPECIES_PAL(DIALGA_PRIMAL, gMonPalette_DialgaPrimal),
    SPECIES_PAL(PALKIA_PRIMAL, gMonPalette_PalkiaPrimal),
    SPECIES_PAL(KYUREM_PRIMAL, gMonPalette_KyuremPrimal),
    ...
    SPECIES_PAL(AERODACTYL_PRIMAL, gMonPalette_AerodactylPrimal),
    SPECIES_PAL(CROBAT_BOND, gMonPalette_CrobatBond),
    SPECIES_PAL(CROBAT2_BOND, gMonPalette_Crobat2Bond),
    SPECIES_PAL(KABUTOPS_PRIMAL, gMonPalette_KabutopsPrimal),
    SPECIES_PAL(GHOST_PRIMAL, gMonPalette_GhostPrimal),
    SPECIES_PAL(MAMOSWINE_BOND, gMonPalette_MamoswineBond),
    SPECIES_PAL(DECIDUEYE_HISUI, gMonPalette_DecidueyeHisui),
    SPECIES_PAL(TYPHLOSION_HISUI, gMonPalette_TyphlosionHisui),
    SPECIES_PAL(SAMUROTT_HISUI, gMonPalette_SamurottHisui),
    SPECIES_PAL(WYRDEER, gMonPalette_Wyrdeer),
    SPECIES_PAL(KLEAVOR, gMonPalette_Kleavor),
    SPECIES_PAL(QWILFISH_HISUI, gMonPalette_QwilfishHisui),
    SPECIES_PAL(OVERQWIL, gMonPalette_Overqwil),
    SPECIES_PAL(LILLIGANT_HISUI, gMonPalette_LilligantHisui),
    SPECIES_PAL(URSALUNA, gMonPalette_Ursaluna),
    SPECIES_PAL(SLIGGOO_HISUI, gMonPalette_SliggooHisui),
    SPECIES_PAL(GOODRA_HISUI, gMonPalette_GoodraHisui),
    SPECIES_PAL(GROWLITHE_HISUI, gMonPalette_GrowlitheHisui),
    SPECIES_PAL(ARCANINE_HISUI, gMonPalette_ArcanineHisui),
    ...
    SPECIES_PAL(VOLTORB_HISUI, gMonPalette_VoltorbHisui),
    SPECIES_PAL(ELECTRODE_HISUI, gMonPalette_ElectrodeHisui),
    SPECIES_PAL(SNEASEL_HISUI, gMonPalette_SneaselHisui),
    SPECIES_PAL(SNEASLER, gMonPalette_Sneasler),
    SPECIES_PAL(AVALUGG_HISUI, gMonPalette_AvaluggHisui),
    SPECIES_PAL(ZORUA_HISUI, gMonPalette_ZoruaHisui),
    SPECIES_PAL(ZOROARK_HISUI, gMonPalette_ZoroarkHisui),
    SPECIES_PAL(BRAVIARY_HISUI, gMonPalette_BraviaryHisui),
    ...
    SPECIES_PAL(WOOPER_PALDEA, gMonPalette_WooperPaldea),
    ...
    SPECIES_PAL(TAUROS_PALDEA_COMBAT, gMonPalette_TaurosPaldeaCombat),
    SPECIES_PAL(TAUROS_PALDEA_BLAZE, gMonPalette_TaurosPaldeaBlaze),
    SPECIES_PAL(TAUROS_PALDEA_AQUA, gMonPalette_TaurosPaldeaAqua),
    ...
    SPECIES_PAL(NINETALES_BOND, gMonPalette_NinetalesBond),
    SPECIES_PAL(FINIZEN, gMonPalette_Finizen),
    SPECIES_PAL(PALAFIN, gMonPalette_Palafin),
    SPECIES_PAL(TOXTRICITY_MEGA, gMonPalette_ToxtricityMega),
    SPECIES_PAL(DUNSPARCE_OLD_PREEVO, gMonPalette_DunsparceOldPreevo),
    SPECIES_PAL(DUDUNSPARCE_EVO, gMonPalette_DudunsparceEvo),
    SPECIES_PAL(GOROCHU, gMonPalette_Gorochu),
    SPECIES_PAL(WARTILLERY, gMonPalette_Wartillery),
    SPECIES_PAL(QWOLTFISH, gMonPalette_Qwoltfish),
	...
	SPECIES_PAL(GYARADOSZ, gMonPalette_GyaradosZ),
	SPECIES_PAL(PORYGON31, gMonPalette_Porygon31),
