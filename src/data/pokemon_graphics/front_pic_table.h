const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(EONEON, gMonFrontPic_Eoneon),
    SPECIES_SPRITE(TRXATU, gMonFrontPic_Trxatu),
    SPECIES_SPRITE(ELECTRODE_Y, gMonFrontPic_ElectrodeY),
    SPECIES_SPRITE(TAUROS_X, gMonFrontPic_TaurosX),
    SPECIES_SPRITE(PORYGON3, gMonFrontPic_Porygon3),
    SPECIES_SPRITE(ELECTIVIRE_X, gMonFrontPic_ElectivireX),
    SPECIES_SPRITE(MAGMORTAR_Y, gMonFrontPic_MagmortarY),
    SPECIES_SPRITE(NIDOQUEEN_Y, gMonFrontPic_NidoqueenY),
    SPECIES_SPRITE(NIDOKING_X, gMonFrontPic_NidokingX),
    SPECIES_SPRITE(PORYGONZ_X, gMonFrontPic_PorygonZX),
    SPECIES_SPRITE(PORYGONZ_Y, gMonFrontPic_PorygonZY),
    SPECIES_SPRITE(NIDOGOD, gMonFrontPic_Nidogod),
    SPECIES_SPRITE(AERODACTYL_SKEL, gMonFrontPic_AerodactylSkel),
    SPECIES_SPRITE(CRADILY_Y, gMonFrontPic_CradilyY),
    SPECIES_SPRITE(RAMPARDOS_X, gMonFrontPic_RampardosX),
    SPECIES_SPRITE(BASTIODON_X, gMonFrontPic_BastiodonX),
    SPECIES_SPRITE(TYRANTRUM_X, gMonFrontPic_TyrantrumX),
    SPECIES_SPRITE(ARCHEOPS_X, gMonFrontPic_ArcheopsX),
    SPECIES_SPRITE(REGIROCK_X, gMonFrontPic_RegirockX),
    SPECIES_SPRITE(REGICE_Y, gMonFrontPic_RegiceY),
    SPECIES_SPRITE(REGISTEEL_Z, gMonFrontPic_RegisteelZ),
    SPECIES_SPRITE(DEOXYS_ATTACK_Y, gMonFrontPic_DeoxysAttackY),
    SPECIES_SPRITE(DEOXYS_SPEED_Y, gMonFrontPic_DeoxysSpeedY),
    SPECIES_SPRITE(MEWTWO_ARM, gMonFrontPic_MewtwoArm),
    SPECIES_SPRITE(GENESECT_X, gMonFrontPic_GenesectX),
    SPECIES_SPRITE(GENESECT_Y, gMonFrontPic_GenesectY),
    SPECIES_SPRITE(ULTIMATE_PROYECT, gMonFrontPic_UltimateProyect),
    SPECIES_SPRITE(POLIWRATH_BOND, gMonFrontPic_PoliwrathBond),
    SPECIES_SPRITE(BUTTERFREE_BOND, gMonFrontPic_ButterfreeBond),
    SPECIES_SPRITE(FERALIGATR_BOND, gMonFrontPic_FeraligatrBond),
    SPECIES_SPRITE(RAPIDASH_BOND, gMonFrontPic_RapidashBond),
    SPECIES_SPRITE(KINGDRA_BOND, gMonFrontPic_KingdraBond),
    SPECIES_SPRITE(SKARMORY_BOND, gMonFrontPic_SkarmoryBond),
    SPECIES_SPRITE(EEVEE_BOND, gMonFrontPic_EeveeBond),
    SPECIES_SPRITE(HYPNO_BOND, gMonFrontPic_HypnoBond),
    SPECIES_SPRITE(DUNSPARCE_OLD, gMonFrontPic_DunsparceOld),
    SPECIES_SPRITE(DELPHOX_BOND, gMonFrontPic_DelphoxBond),
    SPECIES_SPRITE(RHYPERIOR_BOND, gMonFrontPic_RhyperiorBond),
    SPECIES_SPRITE(LAPRAS_BOND, gMonFrontPic_LaprasBond),
    SPECIES_SPRITE(EMPOLEON_BOND, gMonFrontPic_EmpoleonBond),
    SPECIES_SPRITE(INFERNAPE_BOND, gMonFrontPic_InfernapeBond),
    SPECIES_SPRITE(MESPRIT_BOND, gMonFrontPic_MespritBond),
    SPECIES_SPRITE(SERPERIOR_BOND, gMonFrontPic_SerperiorBond),
    SPECIES_SPRITE(HAXORUS_BOND, gMonFrontPic_HaxorusBond),
    SPECIES_SPRITE(WEAVILE_BOND, gMonFrontPic_WeavileBond),
    SPECIES_SPRITE(AEGISLASH_BOND, gMonFrontPic_AegislashBond),
    SPECIES_SPRITE(VOLCARONA_BOND, gMonFrontPic_VolcaronaBond),
    SPECIES_SPRITE(GOODRA_BOND, gMonFrontPic_GoodraBond),
    SPECIES_SPRITE(HYDREIGON_BOND, gMonFrontPic_HydreigonBond),
    SPECIES_SPRITE(DRAGONITE_BOND, gMonFrontPic_DragoniteBond),
    SPECIES_SPRITE(MAROGHOST, gMonFrontPic_Maroghost),
    SPECIES_SPRITE(KABUTOPS_SKEL, gMonFrontPic_KabutopsSkel),
    SPECIES_SPRITE(DUDUNSPARCE, gMonFrontPic_Dudunsparce),
    SPECIES_SPRITE(GHOST, gMonFrontPic_Ghost),
    SPECIES_SPRITE(UNOWN_GOLD, gMonFrontPic_UnownGold),
    SPECIES_SPRITE(UNOWN_KING, gMonFrontPic_UnownKing),
    SPECIES_SPRITE(ARTICUNO_PRIMAL, gMonFrontPic_ArticunoPrimal),
    SPECIES_SPRITE(ZAPDOS_PRIMAL, gMonFrontPic_ZapdosPrimal),
    SPECIES_SPRITE(MOLTRES_PRIMAL, gMonFrontPic_MoltresPrimal),
    SPECIES_SPRITE(RAIKOU_BOND, gMonFrontPic_RaikouBond),
    SPECIES_SPRITE(ENTEI_BOND, gMonFrontPic_EnteiBond),
    SPECIES_SPRITE(SUICUNE_BOND, gMonFrontPic_SuicuneBond),
    SPECIES_SPRITE(KURUSU, gMonFrontPic_Kurusu),
    SPECIES_SPRITE(AKUA, gMonFrontPic_Akua),
    SPECIES_SPRITE(AKUERIA, gMonFrontPic_Akueria),
    SPECIES_SPRITE(BOOHOO, gMonFrontPic_Boohoo),
    SPECIES_SPRITE(IKARY, gMonFrontPic_Ikary),
    SPECIES_SPRITE(PURAKKUSU, gMonFrontPic_Purakkusu),
    SPECIES_SPRITE(TAABAN, gMonFrontPic_Taaban),
    SPECIES_SPRITE(BOMUSHIKAA, gMonFrontPic_Bomushikaa),
    SPECIES_SPRITE(MADAAMU, gMonFrontPic_Madaamu),
    SPECIES_SPRITE(SUI, gMonFrontPic_Sui),
    SPECIES_SPRITE(RAI, gMonFrontPic_Rai),
    SPECIES_SPRITE(EN, gMonFrontPic_En),
    SPECIES_SPRITE(SACRED_DRAGON, gMonFrontPic_SacredDragon),
    SPECIES_SPRITE(ORIGINAL_DRAGON, gMonFrontPic_OriginalDragon),
    SPECIES_SPRITE(ARCEUS_PRIMAL, gMonFrontPic_ArceusPrimal),
    ...
    SPECIES_SPRITE(DUSKNOIR_MEGA, gMonFrontPic_DusknoirMega),
    ...
    SPECIES_SPRITE(NOIVERN_MEGA, gMonFrontPic_NoivernMega),
    SPECIES_SPRITE(MILOTIC_MEGA, gMonFrontPic_MiloticMega),
    SPECIES_SPRITE(PORYGON_Z_MEGA, gMonFrontPic_PorygonZMega),
    SPECIES_SPRITE(COFAGRIGUS_MEGA, gMonFrontPic_CofagrigusMega),
    SPECIES_SPRITE(DURALUDON_MEGA, gMonFrontPic_DuraludonMega),
    ...
    SPECIES_SPRITE(DARKRAI_PRIMAL, gMonFrontPic_DarkraiPrimal),
    SPECIES_SPRITE(HO_OH_PRIMAL, gMonFrontPic_HoOhPrimal),
    SPECIES_SPRITE(LUGIA_PRIMAL, gMonFrontPic_LugiaPrimal),
    SPECIES_SPRITE(CELEBI_PRIMAL, gMonFrontPic_CelebiPrimal),
    SPECIES_SPRITE(JIRACHI_PRIMAL, gMonFrontPic_JirachiPrimal),
    SPECIES_SPRITE(VICTINI_PRIMAL, gMonFrontPic_VictiniPrimal),
    SPECIES_SPRITE(REGIGIGAS_PRIMAL, gMonFrontPic_RegigigasPrimal),
    SPECIES_SPRITE(DIALGA_PRIMAL, gMonFrontPic_DialgaPrimal),
    SPECIES_SPRITE(PALKIA_PRIMAL, gMonFrontPic_PalkiaPrimal),
    SPECIES_SPRITE(KYUREM_PRIMAL, gMonFrontPic_KyuremPrimal),
    ...
    SPECIES_SPRITE(AERODACTYL_PRIMAL, gMonFrontPic_AerodactylPrimal),
    SPECIES_SPRITE(CROBAT_BOND, gMonFrontPic_CrobatBond),
    SPECIES_SPRITE(CROBAT2_BOND, gMonFrontPic_Crobat2Bond),
    SPECIES_SPRITE(KABUTOPS_PRIMAL, gMonFrontPic_KabutopsPrimal),
    SPECIES_SPRITE(GHOST_PRIMAL, gMonFrontPic_GhostPrimal),
    SPECIES_SPRITE(MAMOSWINE_BOND, gMonFrontPic_MamoswineBond),
    ...
    SPECIES_SPRITE(WOOPER_PALDEA, gMonFrontPic_WooperPaldea),
    ...
    SPECIES_SPRITE(TAUROS_PALDEA_COMBAT, gMonFrontPic_TaurosPaldeaCombat),
    SPECIES_SPRITE(TAUROS_PALDEA_BLAZE, gMonFrontPic_TaurosPaldeaBlaze),
    SPECIES_SPRITE(TAUROS_PALDEA_AQUA, gMonFrontPic_TaurosPaldeaAqua),
    ...
    SPECIES_SPRITE(NINETALES_BOND, gMonFrontPic_NinetalesBond),
    SPECIES_SPRITE(FINIZEN, gMonFrontPic_Finizen),
    SPECIES_SPRITE(PALAFIN, gMonFrontPic_Palafin),
    SPECIES_SPRITE(TOXTRICITY_MEGA, gMonFrontPic_ToxtricityMega),
    SPECIES_SPRITE(DUNSPARCE_OLD_PREEVO, gMonFrontPic_DunsparceOldPreevo),
    SPECIES_SPRITE(DUDUNSPARCE_EVO, gMonFrontPic_DudunsparceEvo),
...
const struct CompressedSpriteSheet gMonFrontPicTableFemale[] =
{
    ...
    SPECIES_SPRITE(DUNSPARCE_OLD, gMonFrontPic_DunsparceOldF),
};
