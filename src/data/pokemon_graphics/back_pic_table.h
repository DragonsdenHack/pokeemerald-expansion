const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(EONEON, gMonBackPic_Eoneon),
    SPECIES_SPRITE(TRXATU, gMonBackPic_Trxatu),
    SPECIES_SPRITE(ELECTRODE_Y, gMonBackPic_ElectrodeY),
    SPECIES_SPRITE(TAUROS_X, gMonBackPic_TaurosX),
    SPECIES_SPRITE(PORYGON3, gMonBackPic_Porygon3),
    SPECIES_SPRITE(ELECTIVIRE_X, gMonBackPic_ElectivireX),
    SPECIES_SPRITE(MAGMORTAR_Y, gMonBackPic_MagmortarY),
    SPECIES_SPRITE(NIDOQUEEN_Y, gMonBackPic_NidoqueenY),
    SPECIES_SPRITE(NIDOKING_X, gMonBackPic_NidokingX),
    SPECIES_SPRITE(PORYGONZ_X, gMonBackPic_PorygonZX),
    SPECIES_SPRITE(PORYGONZ_Y, gMonBackPic_PorygonZY),
    SPECIES_SPRITE(NIDOGOD, gMonBackPic_Nidogod),
    SPECIES_SPRITE(AERODACTYL_SKEL, gMonBackPic_AerodactylSkel),
    SPECIES_SPRITE(CRADILY_Y, gMonBackPic_CradilyY),
    SPECIES_SPRITE(RAMPARDOS_X, gMonBackPic_RampardosX),
    SPECIES_SPRITE(BASTIODON_X, gMonBackPic_BastiodonX),
    SPECIES_SPRITE(TYRANTRUM_X, gMonBackPic_TyrantrumX),
    SPECIES_SPRITE(ARCHEOPS_X, gMonBackPic_ArcheopsX),
    SPECIES_SPRITE(REGIROCK_X, gMonBackPic_RegirockX),
    SPECIES_SPRITE(REGICE_Y, gMonBackPic_RegiceY),
    SPECIES_SPRITE(REGISTEEL_Z, gMonBackPic_RegisteelZ),
    SPECIES_SPRITE(DEOXYS_ATTACK_Y, gMonBackPic_DeoxysAttackY),
    SPECIES_SPRITE(DEOXYS_SPEED_Y, gMonBackPic_DeoxysSpeedY),
    SPECIES_SPRITE(MEWTWO_ARM, gMonBackPic_MewtwoArm),
    SPECIES_SPRITE(GENESECT_X, gMonBackPic_GenesectX),
    SPECIES_SPRITE(GENESECT_Y, gMonBackPic_GenesectY),
    SPECIES_SPRITE(ULTIMATE_PROYECT, gMonBackPic_UltimateProyect),
    SPECIES_SPRITE(POLIWRATH_BOND, gMonBackPic_PoliwrathBond),
    SPECIES_SPRITE(BUTTERFREE_BOND, gMonBackPic_ButterfreeBond),
    SPECIES_SPRITE(FERALIGATR_BOND, gMonBackPic_FeraligatrBond),
    SPECIES_SPRITE(RAPIDASH_BOND, gMonBackPic_RapidashBond),
    SPECIES_SPRITE(KINGDRA_BOND, gMonBackPic_KingdraBond),
    SPECIES_SPRITE(SKARMORY_BOND, gMonBackPic_SkarmoryBond),
    SPECIES_SPRITE(EEVEE_BOND, gMonBackPic_EeveeBond),
    SPECIES_SPRITE(HYPNO_BOND, gMonBackPic_HypnoBond),
    SPECIES_SPRITE(DUNSPARCE_OLD, gMonBackPic_DunsparceOld),
    SPECIES_SPRITE(DELPHOX_BOND, gMonBackPic_DelphoxBond),
    SPECIES_SPRITE(RHYPERIOR_BOND, gMonBackPic_RhyperiorBond),
    SPECIES_SPRITE(LAPRAS_BOND, gMonBackPic_LaprasBond),
    SPECIES_SPRITE(EMPOLEON_BOND, gMonBackPic_EmpoleonBond),
    SPECIES_SPRITE(INFERNAPE_BOND, gMonBackPic_InfernapeBond),
    SPECIES_SPRITE(MESPRIT_BOND, gMonBackPic_MespritBond),
    SPECIES_SPRITE(SERPERIOR_BOND, gMonBackPic_SerperiorBond),
    SPECIES_SPRITE(HAXORUS_BOND, gMonBackPic_HaxorusBond),
    SPECIES_SPRITE(WEAVILE_BOND, gMonBackPic_WeavileBond),
    SPECIES_SPRITE(AEGISLASH_BOND, gMonBackPic_AegislashBond),
    SPECIES_SPRITE(VOLCARONA_BOND, gMonBackPic_VolcaronaBond),
    SPECIES_SPRITE(GOODRA_BOND, gMonBackPic_GoodraBond),
    SPECIES_SPRITE(HYDREIGON_BOND, gMonBackPic_HydreigonBond),
    SPECIES_SPRITE(DRAGONITE_BOND, gMonBackPic_DragoniteBond),
    SPECIES_SPRITE(MAROGHOST, gMonBackPic_Maroghost),
    SPECIES_SPRITE(KABUTOPS_SKEL, gMonBackPic_KabutopsSkel),
    SPECIES_SPRITE(DUDUNSPARCE, gMonBackPic_Dudunsparce),
    SPECIES_SPRITE(GHOST, gMonBackPic_Ghost),
    SPECIES_SPRITE(UNOWN_GOLD, gMonBackPic_UnownGold),
    SPECIES_SPRITE(UNOWN_KING, gMonBackPic_UnownKing),
    SPECIES_SPRITE(ARTICUNO_PRIMAL, gMonBackPic_ArticunoPrimal),
    SPECIES_SPRITE(ZAPDOS_PRIMAL, gMonBackPic_ZapdosPrimal),
    SPECIES_SPRITE(MOLTRES_PRIMAL, gMonBackPic_MoltresPrimal),
    SPECIES_SPRITE(RAIKOU_BOND, gMonBackPic_RaikouBond),
    SPECIES_SPRITE(ENTEI_BOND, gMonBackPic_EnteiBond),
    SPECIES_SPRITE(SUICUNE_BOND, gMonBackPic_SuicuneBond),
    SPECIES_SPRITE(KURUSU, gMonBackPic_Kurusu),
    SPECIES_SPRITE(AKUA, gMonBackPic_Akua),
    SPECIES_SPRITE(AKUERIA, gMonBackPic_Akueria),
    SPECIES_SPRITE(BOOHOO, gMonBackPic_Boohoo),
    SPECIES_SPRITE(IKARY, gMonBackPic_Ikary),
    SPECIES_SPRITE(PURAKKUSU, gMonBackPic_Purakkusu),
    SPECIES_SPRITE(TAABAN, gMonBackPic_Taaban),
    SPECIES_SPRITE(BOMUSHIKAA, gMonBackPic_Bomushikaa),
    SPECIES_SPRITE(MADAAMU, gMonBackPic_Madaamu),
    SPECIES_SPRITE(SUI, gMonBackPic_Sui),
    SPECIES_SPRITE(RAI, gMonBackPic_Rai),
    SPECIES_SPRITE(EN, gMonBackPic_En),
    SPECIES_SPRITE(SACRED_DRAGON, gMonBackPic_SacredDragon),
    SPECIES_SPRITE(ORIGINAL_DRAGON, gMonBackPic_OriginalDragon),
    SPECIES_SPRITE(ARCEUS_PRIMAL, gMonBackPic_ArceusPrimal),
    ...
    SPECIES_SPRITE(DUSKNOIR_MEGA, gMonBackPic_DusknoirMega),
    ...
    SPECIES_SPRITE(NOIVERN_MEGA, gMonBackPic_NoivernMega),
    SPECIES_SPRITE(MILOTIC_MEGA, gMonBackPic_MiloticMega),
    SPECIES_SPRITE(PORYGON_Z_MEGA, gMonBackPic_PorygonZMega),
    SPECIES_SPRITE(COFAGRIGUS_MEGA, gMonBackPic_CofagrigusMega),
    SPECIES_SPRITE(DURALUDON_MEGA, gMonBackPic_DuraludonMega),
    ...
    SPECIES_SPRITE(DARKRAI_PRIMAL, gMonBackPic_DarkraiPrimal),
    SPECIES_SPRITE(HO_OH_PRIMAL, gMonBackPic_HoOhPrimal),
    SPECIES_SPRITE(LUGIA_PRIMAL, gMonBackPic_LugiaPrimal),
    SPECIES_SPRITE(CELEBI_PRIMAL, gMonBackPic_CelebiPrimal),
    SPECIES_SPRITE(JIRACHI_PRIMAL, gMonBackPic_JirachiPrimal),
    SPECIES_SPRITE(VICTINI_PRIMAL, gMonBackPic_VictiniPrimal),
    SPECIES_SPRITE(REGIGIGAS_PRIMAL, gMonBackPic_RegigigasPrimal),
    SPECIES_SPRITE(DIALGA_PRIMAL, gMonBackPic_DialgaPrimal),
    SPECIES_SPRITE(PALKIA_PRIMAL, gMonBackPic_PalkiaPrimal),
    SPECIES_SPRITE(KYUREM_PRIMAL, gMonBackPic_KyuremPrimal),
    ...
    SPECIES_SPRITE(AERODACTYL_PRIMAL, gMonBackPic_AerodactylPrimal),
    SPECIES_SPRITE(CROBAT_BOND, gMonBackPic_CrobatBond),
    SPECIES_SPRITE(CROBAT2_BOND, gMonBackPic_Crobat2Bond),
    SPECIES_SPRITE(KABUTOPS_PRIMAL, gMonBackPic_KabutopsPrimal),
    SPECIES_SPRITE(GHOST_PRIMAL, gMonBackPic_GhostPrimal),
    SPECIES_SPRITE(MAMOSWINE_BOND, gMonBackPic_MamoswineBond),
    SPECIES_SPRITE(DECIDUEYE_HISUI, gMonBackPic_DecidueyeHisui),
    SPECIES_SPRITE(TYPHLOSION_HISUI, gMonBackPic_TyphlosionHisui),
    SPECIES_SPRITE(SAMUROTT_HISUI, gMonBackPic_SamurottHisui),
    SPECIES_SPRITE(WYRDEER, gMonBackPic_Wyrdeer),
    SPECIES_SPRITE(KLEAVOR, gMonBackPic_Kleavor),
    SPECIES_SPRITE(QWILFISH_HISUI, gMonBackPic_QwilfishHisui),
    SPECIES_SPRITE(OVERQWIL, gMonBackPic_Overqwil),
    SPECIES_SPRITE(LILLIGANT_HISUI, gMonBackPic_LilligantHisui),
    ...
    SPECIES_SPRITE(VOLTORB_HISUI, gMonBackPic_VoltorbHisui),
    SPECIES_SPRITE(ELECTRODE_HISUI, gMonBackPic_ElectrodeHisui),
    SPECIES_SPRITE(SNEASEL_HISUI, gMonBackPic_SneaselHisui),
    SPECIES_SPRITE(SNEASLER, gMonBackPic_Sneasler),
    SPECIES_SPRITE(AVALUGG_HISUI, gMonBackPic_AvaluggHisui),
    SPECIES_SPRITE(ZORUA_HISUI, gMonBackPic_ZoruaHisui),
    SPECIES_SPRITE(ZOROARK_HISUI, gMonBackPic_ZoroarkHisui),
    SPECIES_SPRITE(BRAVIARY_HISUI, gMonBackPic_BraviaryHisui),
    ...
    SPECIES_SPRITE(WOOPER_PALDEA, gMonBackPic_WooperPaldea),
    ...
    SPECIES_SPRITE(TAUROS_PALDEA_COMBAT, gMonBackPic_TaurosPaldeaCombat),
    SPECIES_SPRITE(TAUROS_PALDEA_BLAZE, gMonBackPic_TaurosPaldeaBlaze),
    SPECIES_SPRITE(TAUROS_PALDEA_AQUA, gMonBackPic_TaurosPaldeaAqua),
    ...
    SPECIES_SPRITE(NINETALES_BOND, gMonBackPic_NinetalesBond),
    SPECIES_SPRITE(FINIZEN, gMonBackPic_Finizen),
    SPECIES_SPRITE(PALAFIN, gMonBackPic_Palafin),
    SPECIES_SPRITE(TOXTRICITY_MEGA, gMonBackPic_ToxtricityMega),
    SPECIES_SPRITE(DUNSPARCE_OLD_PREEVO, gMonBackPic_DunsparceOldPreevo),
    SPECIES_SPRITE(DUDUNSPARCE_EVO, gMonBackPic_DudunsparceEvo),
    SPECIES_SPRITE(GOROCHU, gMonBackPic_Gorochu),
    SPECIES_SPRITE(WARTILLERY, gMonBackPic_Wartillery),
    SPECIES_SPRITE(QWOLTFISH, gMonBackPic_Qwoltfish),
	...
	SPECIES_SPRITE(GYARADOSZ, gMonBackPic_GyaradosZ),
	SPECIES_SPRITE(PORYGON31, gMonBackPic_Porygon31),
...
const struct CompressedSpriteSheet gMonBackPicTableFemale[] =
{
    ...
    SPECIES_SPRITE(DUNSPARCE_OLD, gMonBackPic_DunsparceOldF),
};
