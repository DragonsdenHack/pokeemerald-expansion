const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(EONEON, gMonShinyPalette_Eoneon),
    SPECIES_SHINY_PAL(TRXATU, gMonShinyPalette_Trxatu),
    SPECIES_SHINY_PAL(ELECTRODE_Y, gMonShinyPalette_ElectrodeY),
    SPECIES_SHINY_PAL(TAUROS_X, gMonShinyPalette_TaurosX),
    SPECIES_SHINY_PAL(PORYGON3, gMonShinyPalette_Porygon3),
    SPECIES_SHINY_PAL(ELECTIVIRE_X, gMonShinyPalette_ElectivireX),
    SPECIES_SHINY_PAL(MAGMORTAR_Y, gMonShinyPalette_MagmortarY),
    SPECIES_SHINY_PAL(NIDOQUEEN_Y, gMonShinyPalette_NidoqueenY),
    SPECIES_SHINY_PAL(NIDOKING_X, gMonShinyPalette_NidokingX),
    SPECIES_SHINY_PAL(PORYGONZ_X, gMonShinyPalette_PorygonZX),
    SPECIES_SHINY_PAL(PORYGONZ_Y, gMonShinyPalette_PorygonZY),
    SPECIES_SHINY_PAL(NIDOGOD, gMonShinyPalette_Nidogod),
    SPECIES_SHINY_PAL(AERODACTYL_SKEL, gMonShinyPalette_AerodactylSkel),
    SPECIES_SHINY_PAL(CRADILY_Y, gMonShinyPalette_CradilyY),
    SPECIES_SHINY_PAL(RAMPARDOS_X, gMonShinyPalette_RampardosX),
    SPECIES_SHINY_PAL(BASTIODON_X, gMonShinyPalette_BastiodonX),
    SPECIES_SHINY_PAL(TYRANTRUM_X, gMonShinyPalette_TyrantrumX),
    SPECIES_SHINY_PAL(ARCHEOPS_X, gMonShinyPalette_ArcheopsX),
    SPECIES_SHINY_PAL(REGIROCK_X, gMonShinyPalette_RegirockX),
    SPECIES_SHINY_PAL(REGICE_Y, gMonShinyPalette_RegiceY),
    SPECIES_SHINY_PAL(REGISTEEL_Z, gMonShinyPalette_RegisteelZ),
    SPECIES_SHINY_PAL(DEOXYS_ATTACK_Y, gMonShinyPalette_DeoxysAttackY),
    SPECIES_SHINY_PAL(DEOXYS_SPEED_Y, gMonShinyPalette_DeoxysSpeedY),
    SPECIES_SHINY_PAL(MEWTWO_ARM, gMonShinyPalette_MewtwoArm),
    SPECIES_SHINY_PAL(GENESECT_X, gMonShinyPalette_GenesectX),
    SPECIES_SHINY_PAL(GENESECT_Y, gMonShinyPalette_GenesectY),
    SPECIES_SHINY_PAL(ULTIMATE_PROYECT, gMonShinyPalette_UltimateProyect),
    SPECIES_SHINY_PAL(POLIWRATH_BOND, gMonShinyPalette_PoliwrathBond),
    SPECIES_SHINY_PAL(BUTTERFREE_BOND, gMonShinyPalette_ButterfreeBond),
    SPECIES_SHINY_PAL(FERALIGATR_BOND, gMonShinyPalette_FeraligatrBond),
    SPECIES_SHINY_PAL(RAPIDASH_BOND, gMonShinyPalette_RapidashBond),
    SPECIES_SHINY_PAL(KINGDRA_BOND, gMonShinyPalette_KingdraBond),
    SPECIES_SHINY_PAL(SKARMORY_BOND, gMonShinyPalette_SkarmoryBond),
    SPECIES_SHINY_PAL(EEVEE_BOND, gMonShinyPalette_EeveeBond),
    SPECIES_SHINY_PAL(HYPNO_BOND, gMonShinyPalette_HypnoBond),
    SPECIES_SHINY_PAL(DUNSPARCE_OLD, gMonShinyPalette_DunsparceOld),
    SPECIES_SHINY_PAL(DELPHOX_BOND, gMonShinyPalette_DelphoxBond),
    SPECIES_SHINY_PAL(RHYPERIOR_BOND, gMonShinyPalette_RhyperiorBond),
    SPECIES_SHINY_PAL(LAPRAS_BOND, gMonShinyPalette_LaprasBond),
    SPECIES_SHINY_PAL(EMPOLEON_BOND, gMonShinyPalette_EmpoleonBond),
    SPECIES_SHINY_PAL(INFERNAPE_BOND, gMonShinyPalette_InfernapeBond),
    SPECIES_SHINY_PAL(MESPRIT_BOND, gMonShinyPalette_MespritBond),
    SPECIES_SHINY_PAL(SERPERIOR_BOND, gMonShinyPalette_SerperiorBond),
    SPECIES_SHINY_PAL(HAXORUS_BOND, gMonShinyPalette_HaxorusBond),
    SPECIES_SHINY_PAL(WEAVILE_BOND, gMonShinyPalette_WeavileBond),
    SPECIES_SHINY_PAL(AEGISLASH_BOND, gMonShinyPalette_AegislashBond),
    SPECIES_SHINY_PAL(VOLCARONA_BOND, gMonShinyPalette_VolcaronaBond),
    SPECIES_SHINY_PAL(GOODRA_BOND, gMonShinyPalette_GoodraBond),
    SPECIES_SHINY_PAL(HYDREIGON_BOND, gMonShinyPalette_HydreigonBond),
    SPECIES_SHINY_PAL(DRAGONITE_BOND, gMonShinyPalette_DragoniteBond),
    SPECIES_SHINY_PAL(MAROGHOST, gMonShinyPalette_Maroghost),
    SPECIES_SHINY_PAL(KABUTOPS_SKEL, gMonShinyPalette_KabutopsSkel),
    SPECIES_SHINY_PAL(DUDUNSPARCE, gMonShinyPalette_Dudunsparce),
    SPECIES_SHINY_PAL(GHOST, gMonShinyPalette_Ghost),
    SPECIES_SHINY_PAL(UNOWN_GOLD, gMonShinyPalette_UnownGold),
    SPECIES_SHINY_PAL(UNOWN_KING, gMonShinyPalette_UnownKing),
    SPECIES_SHINY_PAL(ARTICUNO_PRIMAL, gMonShinyPalette_ArticunoPrimal),
    SPECIES_SHINY_PAL(ZAPDOS_PRIMAL, gMonShinyPalette_ZapdosPrimal),
    SPECIES_SHINY_PAL(MOLTRES_PRIMAL, gMonShinyPalette_MoltresPrimal),
    SPECIES_SHINY_PAL(RAIKOU_BOND, gMonShinyPalette_RaikouBond),
    SPECIES_SHINY_PAL(ENTEI_BOND, gMonShinyPalette_EnteiBond),
    SPECIES_SHINY_PAL(SUICUNE_BOND, gMonShinyPalette_SuicuneBond),
    SPECIES_SHINY_PAL(KURUSU, gMonShinyPalette_Kurusu),
    SPECIES_SHINY_PAL(AKUA, gMonShinyPalette_Akua),
    SPECIES_SHINY_PAL(AKUERIA, gMonShinyPalette_Akueria),
    SPECIES_SHINY_PAL(BOOHOO, gMonShinyPalette_Boohoo),
    SPECIES_SHINY_PAL(IKARY, gMonShinyPalette_Ikary),
    SPECIES_SHINY_PAL(PURAKKUSU, gMonShinyPalette_Purakkusu),
    SPECIES_SHINY_PAL(TAABAN, gMonShinyPalette_Taaban),
    SPECIES_SHINY_PAL(BOMUSHIKAA, gMonShinyPalette_Bomushikaa),
    SPECIES_SHINY_PAL(MADAAMU, gMonShinyPalette_Madaamu),
    SPECIES_SHINY_PAL(SUI, gMonShinyPalette_Sui),
    SPECIES_SHINY_PAL(RAI, gMonShinyPalette_Rai),
    SPECIES_SHINY_PAL(EN, gMonShinyPalette_En),
    SPECIES_SHINY_PAL(SACRED_DRAGON, gMonShinyPalette_SacredDragon),
    SPECIES_SHINY_PAL(ORIGINAL_DRAGON, gMonShinyPalette_OriginalDragon),
    SPECIES_SHINY_PAL(ARCEUS_PRIMAL, gMonShinyPalette_ArceusPrimal),
    ...
    SPECIES_SHINY_PAL(DUSKNOIR_MEGA, gMonShinyPalette_DusknoirMega),
    ...
    SPECIES_SHINY_PAL(NOIVERN_MEGA, gMonShinyPalette_NoivernMega),
    SPECIES_SHINY_PAL(MILOTIC_MEGA, gMonShinyPalette_MiloticMega),
    SPECIES_SHINY_PAL(PORYGON_Z_MEGA, gMonShinyPalette_PorygonZMega),
    SPECIES_SHINY_PAL(COFAGRIGUS_MEGA, gMonShinyPalette_CofagrigusMega),
    SPECIES_SHINY_PAL(DURALUDON_MEGA, gMonShinyPalette_DuraludonMega),
    ...
    SPECIES_SHINY_PAL(DARKRAI_PRIMAL, gMonShinyPalette_DarkraiPrimal),
    SPECIES_SHINY_PAL(HO_OH_PRIMAL, gMonShinyPalette_HoOhPrimal),
    SPECIES_SHINY_PAL(LUGIA_PRIMAL, gMonShinyPalette_LugiaPrimal),
    SPECIES_SHINY_PAL(CELEBI_PRIMAL, gMonShinyPalette_CelebiPrimal),
    SPECIES_SHINY_PAL(JIRACHI_PRIMAL, gMonShinyPalette_JirachiPrimal),
    SPECIES_SHINY_PAL(VICTINI_PRIMAL, gMonShinyPalette_VictiniPrimal),
    SPECIES_SHINY_PAL(REGIGIGAS_PRIMAL, gMonShinyPalette_RegigigasPrimal),
    ...
    SPECIES_SHINY_PAL(KYUREM_PRIMAL, gMonShinyPalette_KyuremPrimal),
    ...
    SPECIES_SHINY_PAL(AERODACTYL_PRIMAL, gMonShinyPalette_AerodactylPrimal),
    SPECIES_SHINY_PAL(CROBAT_BOND, gMonShinyPalette_CrobatBond),
    SPECIES_SHINY_PAL(CROBAT2_BOND, gMonShinyPalette_Crobat2Bond),
    SPECIES_SHINY_PAL(KABUTOPS_PRIMAL, gMonShinyPalette_KabutopsPrimal),
    SPECIES_SHINY_PAL(GHOST_PRIMAL, gMonShinyPalette_GhostPrimal),
    SPECIES_SHINY_PAL(MAMOSWINE_BOND, gMonShinyPalette_MamoswineBond),
    SPECIES_SHINY_PAL(DECIDUEYE_HISUI, gMonShinyPalette_DecidueyeHisui),
    SPECIES_SHINY_PAL(TYPHLOSION_HISUI, gMonShinyPalette_TyphlosionHisui),
    SPECIES_SHINY_PAL(SAMUROTT_HISUI, gMonShinyPalette_SamurottHisui),
    SPECIES_SHINY_PAL(WYRDEER, gMonShinyPalette_Wyrdeer),
    SPECIES_SHINY_PAL(KLEAVOR, gMonShinyPalette_Kleavor),
    SPECIES_SHINY_PAL(QWILFISH_HISUI, gMonShinyPalette_QwilfishHisui),
    SPECIES_SHINY_PAL(OVERQWIL, gMonShinyPalette_Overqwil),
    SPECIES_SHINY_PAL(LILLIGANT_HISUI, gMonShinyPalette_LilligantHisui),
    SPECIES_SHINY_PAL(URSALUNA, gMonShinyPalette_Ursaluna),
    SPECIES_SHINY_PAL(SLIGGOO_HISUI, gMonShinyPalette_SliggooHisui),
    SPECIES_SHINY_PAL(GOODRA_HISUI, gMonShinyPalette_GoodraHisui),
    SPECIES_SHINY_PAL(GROWLITHE_HISUI, gMonShinyPalette_GrowlitheHisui),
    SPECIES_SHINY_PAL(ARCANINE_HISUI, gMonShinyPalette_ArcanineHisui),
    ...
    SPECIES_SHINY_PAL(VOLTORB_HISUI, gMonShinyPalette_VoltorbHisui),
    SPECIES_SHINY_PAL(ELECTRODE_HISUI, gMonShinyPalette_ElectrodeHisui),
    SPECIES_SHINY_PAL(SNEASEL_HISUI, gMonShinyPalette_SneaselHisui),
    SPECIES_SHINY_PAL(SNEASLER, gMonShinyPalette_Sneasler),
    SPECIES_SHINY_PAL(AVALUGG_HISUI, gMonShinyPalette_AvaluggHisui),
    SPECIES_SHINY_PAL(ZORUA_HISUI, gMonShinyPalette_ZoruaHisui),
    SPECIES_SHINY_PAL(ZOROARK_HISUI, gMonShinyPalette_ZoroarkHisui),
    SPECIES_SHINY_PAL(BRAVIARY_HISUI, gMonShinyPalette_BraviaryHisui),
    ...
    SPECIES_SHINY_PAL(WOOPER_PALDEA, gMonShinyPalette_WooperPaldea),
    ...
    SPECIES_SHINY_PAL(TAUROS_PALDEA_COMBAT, gMonShinyPalette_TaurosPaldeaCombat),
    SPECIES_SHINY_PAL(TAUROS_PALDEA_BLAZE, gMonShinyPalette_TaurosPaldeaBlaze),
    SPECIES_SHINY_PAL(TAUROS_PALDEA_AQUA, gMonShinyPalette_TaurosPaldeaAqua),
    ...
    SPECIES_SHINY_PAL(NINETALES_BOND, gMonShinyPalette_NinetalesBond),
    SPECIES_SHINY_PAL(FINIZEN, gMonShinyPalette_Finizen),
    SPECIES_SHINY_PAL(PALAFIN, gMonShinyPalette_Palafin),
    SPECIES_SHINY_PAL(TOXTRICITY_MEGA, gMonShinyPalette_ToxtricityMega),
    SPECIES_SHINY_PAL(DUNSPARCE_OLD_PREEVO, gMonShinyPalette_DunsparceOldPreevo),
    SPECIES_SHINY_PAL(DUDUNSPARCE_EVO, gMonShinyPalette_DudunsparceEvo),
    SPECIES_SHINY_PAL(GOROCHU, gMonShinyPalette_Gorochu),
    SPECIES_SHINY_PAL(WARTILLERY, gMonShinyPalette_Wartillery),
    SPECIES_SHINY_PAL(QWOLTFISH, gMonShinyPalette_Qwoltfish),
	SPECIES_SHINY_PAL(GUARDIA, gMonShinyPalette_Guardia),
	SPECIES_SHINY_PAL(ARMALDO_PRIMAL, gMonShinyPalette_ArmaldoPrimal),
	SPECIES_SHINY_PAL(RELICANTH_PRIMAL, gMonShinyPalette_RelicanthPrimal),
	SPECIES_SHINY_PAL(MILOTICBOND, gMonShinyPalette_MiloticBond),
	SPECIES_SHINY_PAL(GYARADOSZ, gMonShinyPalette_GyaradosZ),
	SPECIES_SHINY_PAL(PORYGON31, gMonShinyPalette_Porygon31),
