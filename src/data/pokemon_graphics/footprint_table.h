const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_EONEON] = gMonFootprint_Eoneon,
    [SPECIES_TRXATU] = gMonFootprint_Trxatu,
    [SPECIES_ELECTRODE_Y] = gMonFootprint_ElectrodeY,
    [SPECIES_TAUROS_X] = gMonFootprint_TaurosX,
    [SPECIES_PORYGON3] = gMonFootprint_Porygon3,
    [SPECIES_ELECTIVIRE_X] = gMonFootprint_ElectivireX,
    [SPECIES_MAGMORTAR_Y] = gMonFootprint_MagmortarY,
    [SPECIES_NIDOQUEEN_Y] = gMonFootprint_NidoqueenY,
    [SPECIES_NIDOKING_X] = gMonFootprint_NidokingX,
    [SPECIES_PORYGONZ_X] = gMonFootprint_PorygonZX,
    [SPECIES_PORYGONZ_Y] = gMonFootprint_PorygonZY,
    [SPECIES_NIDOGOD] = gMonFootprint_Nidogod,
    [SPECIES_AERODACTYL_SKEL] = gMonFootprint_AerodactylSkel,
    [SPECIES_CRADILY_Y] = gMonFootprint_CradilyY,
    [SPECIES_RAMPARDOS_X] = gMonFootprint_RampardosX,
    [SPECIES_BASTIODON_X] = gMonFootprint_BastiodonX,
    [SPECIES_TYRANTRUM_X] = gMonFootprint_TyrantrumX,
    [SPECIES_ARCHEOPS_X] = gMonFootprint_ArcheopsX,
    [SPECIES_REGIROCK_X] = gMonFootprint_RegirockX,
    [SPECIES_REGICE_Y] = gMonFootprint_RegiceY,
    [SPECIES_REGISTEEL_Z] = gMonFootprint_RegisteelZ,
    [SPECIES_DEOXYS_ATTACK_Y] = gMonFootprint_DeoxysAttackY,
    [SPECIES_DEOXYS_SPEED_Y] = gMonFootprint_DeoxysSpeedY,
    [SPECIES_MEWTWO_ARM] = gMonFootprint_MewtwoArm,
    [SPECIES_GENESECT_X] = gMonFootprint_GenesectX,
    [SPECIES_GENESECT_Y] = gMonFootprint_GenesectY,
    [SPECIES_ULTIMATE_PROYECT] = gMonFootprint_UltimateProyect,
    [SPECIES_POLIWRATH_BOND] = gMonFootprint_PoliwrathBond,
    [SPECIES_BUTTERFREE_BOND] = gMonFootprint_ButterfreeBond,
    [SPECIES_FERALIGATR_BOND] = gMonFootprint_FeraligatrBond,
    [SPECIES_RAPIDASH_BOND] = gMonFootprint_RapidashBond,
    [SPECIES_KINGDRA_BOND] = gMonFootprint_KingdraBond,
    [SPECIES_SKARMORY_BOND] = gMonFootprint_SkarmoryBond,
    [SPECIES_EEVEE_BOND] = gMonFootprint_EeveeBond,
    [SPECIES_HYPNO_BOND] = gMonFootprint_HypnoBond,
    [SPECIES_DUNSPARCE_OLD] = gMonFootprint_DunsparceOld,
    [SPECIES_DELPHOX_BOND] = gMonFootprint_DelphoxBond,
    [SPECIES_RHYPERIOR_BOND] = gMonFootprint_RhyperiorBond,
    [SPECIES_LAPRAS_BOND] = gMonFootprint_LaprasBond,
    [SPECIES_EMPOLEON_BOND] = gMonFootprint_EmpoleonBond,
    [SPECIES_INFERNAPE_BOND] = gMonFootprint_InfernapeBond,
    [SPECIES_MESPRIT_BOND] = gMonFootprint_MespritBond,
    [SPECIES_SERPERIOR_BOND] = gMonFootprint_SerperiorBond,
    [SPECIES_HAXORUS_BOND] = gMonFootprint_HaxorusBond,
    [SPECIES_WEAVILE_BOND] = gMonFootprint_WeavileBond,
    [SPECIES_AEGISLASH_BOND] = gMonFootprint_AegislashBond,
    [SPECIES_VOLCARONA_BOND] = gMonFootprint_VolcaronaBond,
    [SPECIES_GOODRA_BOND] = gMonFootprint_GoodraBond,
    [SPECIES_HYDREIGON_BOND] = gMonFootprint_HydreigonBond,
    [SPECIES_DRAGONITE_BOND] = gMonFootprint_DragoniteBond,
    [SPECIES_MAROGHOST] = gMonFootprint_Maroghost,
    [SPECIES_KABUTOPS_SKEL] = gMonFootprint_KabutopsSkel,
    [SPECIES_DUDUNSPARCE] = gMonFootprint_Dudunsparce,
    [SPECIES_GHOST] = gMonFootprint_Ghost,
    [SPECIES_UNOWN_GOLD] = gMonFootprint_UnownGold,
    [SPECIES_UNOWN_KING] = gMonFootprint_UnownKing,
    [SPECIES_ARTICUNO_PRIMAL] = gMonFootprint_ArticunoPrimal,
    [SPECIES_ZAPDOS_PRIMAL] = gMonFootprint_ZapdosPrimal,
    [SPECIES_MOLTRES_PRIMAL] = gMonFootprint_MoltresPrimal,
    [SPECIES_RAIKOU_BOND] = gMonFootprint_RaikouBond,
    [SPECIES_ENTEI_BOND] = gMonFootprint_EnteiBond,
    [SPECIES_SUICUNE_BOND] = gMonFootprint_SuicuneBond,
    [SPECIES_KURUSU] = gMonFootprint_Kurusu,
    [SPECIES_AKUA] = gMonFootprint_Akua,
    [SPECIES_AKUERIA] = gMonFootprint_Akueria,
    [SPECIES_BOOHOO] = gMonFootprint_Boohoo,
    [SPECIES_IKARY] = gMonFootprint_Ikary,
    [SPECIES_PURAKKUSU] = gMonFootprint_Purakkusu,
    [SPECIES_RAICHU_EVO] = gMonFootprint_Raichu,
    [SPECIES_OCTILLERY_EVO] = gMonFootprint_Octillery,
    [SPECIES_QWILFISH_EVO] = gMonFootprint_Qwilfish,
    [SPECIES_TAABAN] = gMonFootprint_Taaban,
    [SPECIES_BOMUSHIKAA] = gMonFootprint_Bomushikaa,
    [SPECIES_MADAAMU] = gMonFootprint_Madaamu,
    [SPECIES_SUI] = gMonFootprint_Sui,
    [SPECIES_RAI] = gMonFootprint_Rai,
    [SPECIES_EN] = gMonFootprint_En,
    [SPECIES_SACRED_DRAGON] = gMonFootprint_SacredDragon,
    [SPECIES_ORIGINAL_DRAGON] = gMonFootprint_OriginalDragon,
    [SPECIES_ARCEUS_PRIMAL] = gMonFootprint_ArceusPrimal,
    [SPECIES_MISSINGNO] = gMonFootprint_MissingNo,
    [SPECIES_DUSKNOIR_MEGA] = gMonFootprint_DusknoirMega,
    [SPECIES_FLYGON_MEGA] = gMonFootprint_FlygonMega,
    [SPECIES_STARMIE_MEGA] = gMonFootprint_StarmieMega,
    [SPECIES_BUTTERFREE_MEGA] = gMonFootprint_ButterfreeMega,
    [SPECIES_NOIVERN_MEGA] = gMonFootprint_NoivernMega,
    [SPECIES_MILOTIC_MEGA] = gMonFootprint_MiloticMega,
    [SPECIES_PORYGON_Z_MEGA] = gMonFootprint_PorygonZMega,
    [SPECIES_COFAGRIGUS_MEGA] = gMonFootprint_CofagrigusMega,
    [SPECIES_DURALUDON_MEGA] = gMonFootprint_DuraludonMega,
    [SPECIES_DARKRAI_PRIMAL] = gMonFootprint_DarkraiPrimal,
    [SPECIES_HO_OH_PRIMAL] = gMonFootprint_HoOhPrimal,
    [SPECIES_LUGIA_PRIMAL] = gMonFootprint_LugiaPrimal,
    [SPECIES_CELEBI_PRIMAL] = gMonFootprint_CelebiPrimal,
    [SPECIES_JIRACHI_PRIMAL] = gMonFootprint_JirachiPrimal,
    [SPECIES_VICTINI_PRIMAL] = gMonFootprint_VictiniPrimal,
    [SPECIES_REGIGIGAS_PRIMAL] = gMonFootprint_RegigigasPrimal,
    [SPECIES_DIALGA_PRIMAL] = gMonFootprint_DialgaPrimal,
    [SPECIES_PALKIA_PRIMAL] = gMonFootprint_PalkiaPrimal,
    [SPECIES_KYUREM_PRIMAL] = gMonFootprint_KyuremPrimal,
    [SPECIES_AERODACTYL_PRIMAL] = gMonFootprint_AerodactylPrimal,
    [SPECIES_CROBAT_BOND] = gMonFootprint_CrobatBond,
    [SPECIES_CROBAT2_BOND] = gMonFootprint_Crobat2Bond,
    [SPECIES_KABUTOPS_PRIMAL] = gMonFootprint_KabutopsPrimal,
    [SPECIES_GHOST_PRIMAL] = gMonFootprint_GhostPrimal,
    [SPECIES_MAMOSWINE_BOND] = gMonFootprint_MamoswineBond,
    [SPECIES_DECIDUEYE_HISUI] = gMonFootprint_DecidueyeHisui,
    [SPECIES_TYPHLOSION_HISUI] = gMonFootprint_TyphlosionHisui,
    [SPECIES_SAMUROTT_HISUI] = gMonFootprint_SamurottHisui,
    [SPECIES_WYRDEER] = gMonFootprint_Wyrdeer,
    [SPECIES_KLEAVOR] = gMonFootprint_Kleavor,
    [SPECIES_QWILFISH_HISUI] = gMonFootprint_QwilfishHisui,
    [SPECIES_OVERQWIL] = gMonFootprint_Overqwil,
    [SPECIES_LILLIGANT_HISUI] = gMonFootprint_LilligantHisui,
    [SPECIES_URSALUNA] = gMonFootprint_Ursaluna,
    [SPECIES_SLIGGOO_HISUI] = gMonFootprint_SliggooHisui,
    [SPECIES_GOODRA_HISUI] = gMonFootprint_GoodraHisui,
    [SPECIES_GROWLITHE_HISUI] = gMonFootprint_GrowlitheHisui,
    [SPECIES_ARCANINE_HISUI] = gMonFootprint_ArcanineHisui,
    [SPECIES_BASCULIN_WHITE_STRIPED] = gMonFootprint_BasculinWhiteStriped,
    [SPECIES_BASCULEGION] = gMonFootprint_Basculegion,
    [SPECIES_BASCULEGION_FEMALE] = gMonFootprint_BasculegionFemale,
    [SPECIES_VOLTORB_HISUI] = gMonFootprint_VoltorbHisui,
    [SPECIES_ELECTRODE_HISUI] = gMonFootprint_ElectrodeHisui,
    [SPECIES_SNEASEL_HISUI] = gMonFootprint_SneaselHisui,
    [SPECIES_SNEASLER] = gMonFootprint_Sneasler,
    [SPECIES_AVALUGG_HISUI] = gMonFootprint_AvaluggHisui,
    [SPECIES_ZORUA_HISUI] = gMonFootprint_ZoruaHisui,
    [SPECIES_ZOROARK_HISUI] = gMonFootprint_ZoroarkHisui,
    [SPECIES_BRAVIARY_HISUI] = gMonFootprint_BraviaryHisui,
    [SPECIES_ENAMORUS] = gMonFootprint_Enamorus,
    [SPECIES_ENAMORUS_THERIAN] = gMonFootprint_EnamorusTherian,
    [SPECIES_DIALGA_ORIGIN] = gMonFootprint_DialgaOrigin,
    [SPECIES_PALKIA_ORIGIN] = gMonFootprint_PalkiaOrigin,
    [SPECIES_WOOPER_PALDEA] = gMonFootprint_WooperPaldea,
    ...
    [SPECIES_TAUROS_PALDEA_COMBAT] = gMonFootprint_TaurosPaldeaCombat,
    [SPECIES_TAUROS_PALDEA_BLAZE] = gMonFootprint_TaurosPaldeaBlaze,
    [SPECIES_TAUROS_PALDEA_AQUA] = gMonFootprint_TaurosPaldeaAqua,
