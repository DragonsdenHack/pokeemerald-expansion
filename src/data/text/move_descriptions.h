...
static const u8 sViseGripDescription[] = _(
    "Stringe il nemico in una\n"
    "morsa di forti tenaglie.");
...
static const u8 sJumpKickDescription[] = _(
    "Potente calcio in volo che\n"
    "può danneggiare chi lo usa.");

static const u8 sRollingKickDescription[] = _(
    "Un rapido calcio con una rtzne.\n"
    "Può far tentennare il nemico.");

static const u8 sSandAttackDescription[] = _(
    "Getta sabbia in faccia e\n"
...
static const u8 sHornAttackDescription[] = _(
    "Corna affilate infilzano\n"
    "il nemico.");

static const u8 sFuryAttackDescription[] = _(
    "Corna affilate infilzano\n"
    " il nemico da 2 a 5 volte.");

static const u8 sHornDrillDescription[] = _(
    "Devastante attacco di trivella.\n"
    "50% di danni da rinculo.");
...
static const u8 sDrillPeckDescription[] = _(
    "Attacco con un becco aguzzo\n"
    "che fa da trapano.");

static const u8 sSubmissionDescription[] = _(
    "Riceve un danno da\n"
    "contraccolpo pari al 25%.");
...
static const u8 sCounterDescription[] = _(
    "Ripara qualsiasi colpo fisico\n"
    "con una potenza doppia.");

static const u8 sSeismicTossDescription[] = _(
    "Infligge un danno pari\n"
    "al livello di chi la usa.");

static const u8 sStrengthDescription[] = _(
    "Colpisce con la massima\n"
    "energia.");
...
static const u8 sLeechSeedDescription[] = _(
    ...
    "per rubare HP a ogni turno.");

static const u8 sGrowthDescription[] = _(
    "Provoca la crescita del\n"
    "corpo e aumenta l'Att. Spec.");

static const u8 sRazorLeafDescription[] = _(
    "Foglie taglienti sferzano i\n"
    "nemici intorno. +1 br.colpo.");

static const u8 sSolarBeamDescription[] = _(
    "Al primo turno assorbe energia\n"
    "e attacca nel successivo.");

static const u8 sPoisonPowderDescription[] = _(
    "Una nube di polvere può\n"
    "avvelenare il bersaglio.");

static const u8 sStunSporeDescription[] = _(
    "Investe con una nuvola\n"
    "di polvere che paralizza.");
...
static const u8 sStringShotDescription[] = _(
    "Lega il nemico con una\n"
    "corda per ridurne la velocità.");
...
static const u8 sFireSpinDescription[] = _(
    ...
    "anello di fuoco per 2-5 turni.");

static const u8 sThunderShockDescription[] = _(
    "Danneggia il bersaglio\n"
    "con una scarica elettrica.");

static const u8 sThunderboltDescription[] = _(
    "Potente attacco elettrico\n"
    "che può (10%) causare paralisi.");

static const u8 sThunderWaveDescription[] = _(
    "Una debole scarica di elettri-\n"
    "cità che paralizza il nemico.");
...
static const u8 sRockThrowDescription[] = _(
    "Solleva una roccia e la\n"
    "lancia contro il nemico.");

static const u8 sEarthquakeDescription[] = _(
    "Potente sisma, che non ha\n"
    "effetto sui nemici volanti.");
...
static const u8 sHypnosisDescription[] = _(
    "Suggestione ipnotica per\n"
    "far addormentare il nemico.");

static const u8 sMeditateDescription[] = _(
    "Medita in modo pacifico\n"
    "per aumentare l'Attacco.");

static const u8 sAgilityDescription[] = _(
    "Rilassa il corpo per\n"
    "aumentare (+2) la velocità.");
...
static const u8 sMimicDescription[] = _(
    "Copia una delle mosse usate\n"
    "dal nemico durante la lotta.");
...
static const u8 sDoubleTeamDescription[] = _(
    "Copie illusorie\n"
    "aumentano l'elusione.");

static const u8 sRecoverDescription[] = _(
    "Ripresa ripristina il 50%\n"
    "dei PS massimi.");

static const u8 sHardenDescription[] = _(
    "Irrigidisce i muscoli del\n"
    "corpo per aumentare la difesa.");

static const u8 sMinimizeDescription[] = _(
    "Chi la usa si rimpicciolisce\n"
    "aumentando l'elusione.");

static const u8 sSmokescreenDescription[] = _(
    "Fumo o inchiostro riducono\n"
    "la precisione del nemico.");

static const u8 sConfuseRayDescription[] = _(
    "Il nemico è colpito da un raggio\n"
    "sinistro che lo confonde.");
...
static const u8 sWaterfallDescription[] = _(
    ...
    "per scalare le cascate.");

static const u8 sClampDescription[] = _(
    "Intrappola e schiaccia il\n"
    "nemico per 2-5 turni.");

static const u8 sSwiftDescription[] = _(
    "Raggi a forma di stella:\n"
    "infallibili.");

static const u8 sSkullBashDescription[] = _(
    "Abbassa la testa per\n"
    "attaccare dopo un turno.");
...
static const u8 sConstrictDescription[] = _(
    "Impedimento che danneggia\n"
    "e può ridurre la Velocità.");
...
static const u8 sHighJumpKickDescription[] = _(
    "Colpisce il nemico con\n"
    "una ginocchiata in volo.");

static const u8 sGlareDescription[] = _(
    "Intimidisce e spaventa il\n"
    "nemico fino a paralizzarlo.");

static const u8 sDreamEaterDescription[] = _(
    "Riceve metà dei PS solo\n"
    "su un nemico che dorme.");
...
static const u8 sBarrageDescription[] = _(
    "Scaglia oggetti rotondi contro\n"
    "il nemico da 2 a 5 volte.");
...
static const u8 sLovelyKissDescription[] = _(
    "Un bacio rubato che può\n"
    "costringere al sonno.");

static const u8 sSkyAttackDescription[] = _(
    "Attacco in due turni e\n"
    "probabile brutto colpo.");

static const u8 sTransformDescription[] = _(
    "Chi la usa si trasforma in\n"
    "una copia esatta del bersaglio.");

static const u8 sBubbleDescription[] = _(
    "Bolle che possono (10%) ridurre\n"
    "la Velocità del nemico.");

static const u8 sDizzyPunchDescription[] = _(
    "Sequenza di pugni che\n"
    "può (20%) anche confonderlo.");

static const u8 sSporeDescription[] = _(
    "Nube di spore che fa\n"
    "sempre addormentare.");

static const u8 sFlashDescription[] = _(
    "Lampo rapido che assorbe\n"
    "il 75% dei danni inflitti.");
...
static const u8 sBonemerangDescription[] = _(
    "Lancia un boomerang d'osso\n"
    "che colpisce due volte.");

static const u8 sRestDescription[] = _(
    "Si addormenta per due turni\n"
    "per curare tutti i PS.");

static const u8 sRockSlideDescription[] = _(
    "Grandi massi lanciati sul\n"
    "nemico, che può tentennare.");

static const u8 sHyperFangDescription[] = _(
    "Attacco con denti affilati,\n"
    "che può far tentennare.");

static const u8 sSharpenDescription[] = _(
    "Riduce i poligoni per\n"
    "aumentare l'Attacco.");

static const u8 sConversionDescription[] = _(
    "Il tipo di chi la usa muta\n"
    "in quello di una sua mossa.");
...
static const u8 sFlailDescription[] = _(
    "Arreca danni maggiori se i\n"
    "PS di chi la usa sono bassi.");

static const u8 sConversion2Description[] = _(
    "Chi la usa si fa resistente\n"
...
static const u8 sCottonSporeDescription[] = _(
    "Spore si aggrappano al nemico,\n"
    "riducendo drasticamente la vel.");
...
static const u8 sSpiteDescription[] = _(
    "Toglie da 2 a 5 PP all'ultima\n"
    "mossa del nemico.");

static const u8 sPowderSnowDescription[] = _(
    "Raffica di neve farinosa.\n"
    "10% di congelare.");

static const u8 sProtectDescription[] = _(
    "Elude gli attacchi: se usata\n"
    "ripetutamente può fallire.");

static const u8 sMachPunchDescription[] = _(
    "Un pugno rapidissimo,\n"
    "che colpisce per primo.");

static const u8 sScaryFaceDescription[] = _(
    "Spaventa il nemico e ne\n"
    "riduce di molto la Velocità.");

static const u8 sFeintAttackDescription[] = _(
    "Avvicina il nemico, lo\n"
    "colpisce senza sbagliare.");

static const u8 sSweetKissDescription[] = _(
    "Bacia il nemico con una dolc-\n"
    "ezza angelica, confondendolo.");

static const u8 sBellyDrumDescription[] = _(
    "Aumenta l'Attacco sacrificando\n"
    "metà dei PS massimi.");
...
static const u8 sMudSlapDescription[] = _(
    "Scaglia del fango in faccia al\n"
    "nemico per ridurne la prcsne.");

static const u8 sOctazookaDescription[] = _(
    "Spara un grumo di inchstr per\n"
    "danneggiare e tagliare la prcsn.");

static const u8 sSpikesDescription[] = _(
    "Imposta punte che feriscono\n"
...
static const u8 sForesightDescription[] = _(
    "Vanifica l'aumento di\n"
    "elusione del nemico.");

static const u8 sDestinyBondDescription[] = _(
    "Se chi la usa va KO il colpo\n"
    "da KO fa la stessa fine.");

static const u8 sPerishSongDescription[] = _(
    "Ogni Pkmn che sente questa\n"
...
static const u8 sLockOnDescription[] = _(
    "Localizza il nemico: la mossa\n"
    "successiva andrà a segno.");
...
static const u8 sSandstormDescription[] = _(
    "Causa una tempesta di\n"
    "sabbia per cinque turni.");
...
static const u8 sEndureDescription[] = _(
    "Resta con un PS anche\n"
    "se subisce un colpo da KO.");

static const u8 sCharmDescription[] = _(
    "Ammalia il nemico, riduce\n"
    "molto l'Attacco.");

static const u8 sRolloutDescription[] = _(
    "Attacco che dura 5 turni\n"
...
static const u8 sSwaggerDescription[] = _(
    "Confonde il nemico ma ne\n"
    "aumenta di molto l'Attacco.");

static const u8 sMilkDrinkDescription[] = _(
    "Chi la usa recupera fino\n"
    "a metà dei PS massimi.");
...
static const u8 sSteelWingDescription[] = _(
    "Colpisce il nemico con ali\n"
    "d'acciaio. 10% +Difesa.");

static const u8 sMeanLookDescription[] = _(
    "Sguardo sinistro che impedisce\n"
    "al nemico di fuggire.");

static const u8 sAttractDescription[] = _(
    "Nemici del sesso opposto\n"
    "attaccano meno facilmente.");

static const u8 sSleepTalkDescription[] = _(
    "Utilizza una mossa disponibile\n"
    "durante il sonno.");

static const u8 sHealBellDescription[] = _(
    "Fa suonare le campane\n"
    "per curare tutta la squadra.");

static const u8 sReturnDescription[] = _(
    "Aumenta di potenza con\n"
    "l'amicizia.");

static const u8 sPresentDescription[] = _(
    "Un dono sotto forma di bomba.\n"
    "Può ripristinare gli PS.");

static const u8 sFrustrationDescription[] = _(
    "Più potente se chi la usa\n"
    "non ama il suo Allenatore.");

static const u8 sSafeguardDescription[] = _(
    "Una forza mistica previene\n"
    "tutti i problemi di stato.");

static const u8 sPainSplitDescription[] = _(
    "Somma i PS dei 2 avversari\n"
    "ridistribuendoli equamente.");

static const u8 sSacredFireDescription[] = _(
    "Fuoco mistico di enorme\n"
    "intensità, 50% scottatura.");

static const u8 sMagnitudeDescription[] = _(
    "Attacco di intensità casuale\n"
    "che scuote il terreno.");

static const u8 sDynamicPunchDescription[] = _(
    "Pugno davvero forte.\n"
    "Se va a segno, confonde.");

static const u8 sMegahornDescription[] = _(
    "Utilizza il suo corno per\n"
    "montare con grande forza.");

static const u8 sDragonBreathDescription[] = _(
    "Raffica potentissima, 30%\n"
    "di paralizzare.");

static const u8 sBatonPassDescription[] = _(
    "Consente di escludere l'utente\n"
    "mantenendo gli effetti in gioco.");

static const u8 sEncoreDescription[] = _(
    "Fa ripetere al nemico la sua\n"
    "ultima mossa di 2-6 turni.");
...
static const u8 sMetalClawDescription[] = _(
    "Può (10%) anche aumentare\n"
    "l'Attacco di chi la usa.");

static const u8 sVitalThrowDescription[] = _(
    "Attacca per ultimo, ma il\n"
    "colpo è sempre infallibile.");

static const u8 sMorningSunDescription[] = _(
    "Ridà un numero di PS\n"
    "in base al tempo che fa.");
...
static const u8 sHiddenPowerDescription[] = _(
    "L'efficacia e il tipo\n"
    "dipendono da chi la usa.");
...
static const u8 sTwisterDescription[] = _(
    "Un potente tornado.\n"
    "Può (20%) far tentennare.");

static const u8 sRainDanceDescription[] = _(
    "Aumenta la potenza delle\n"
    "mosse di T.Acqua per 5 turni.");

static const u8 sSunnyDayDescription[] = _(
    "Aumenta la potenza delle\n"
    "mosse di T.Fuoco per 5 turni.");

static const u8 sCrunchDescription[] = _(
    "Denti affilati, può (20%)\n"
    "ridurne la Difesa.");

static const u8 sMirrorCoatDescription[] = _(
    "Replica ogni attacco spcle,\n"
    "arrecando il doppio del danno.");
...
static const u8 sShadowBallDescription[] = _(
    "Sfera nera che può ridurre\n"
    "la Dif. Sp. del nemico.");

static const u8 sFutureSightDescription[] = _(
    "Aumenta il potere interiore\n"
    "per colpire 2 turni dopo.");

static const u8 sRockSmashDescription[] = _(
    "Attacco schiacciasassi che\n"
    "può (50%) abbassare la Difesa.");

static const u8 sWhirlpoolDescription[] = _(
    "Intrappola il nemico per\n"
    "quattro o cinque turni.");

static const u8 sBeatUpDescription[] = _(
    "Chiama in aiuto i Pokémon\n"
    "della squadra.");

static const u8 sFakeOutDescription[] = _(
    "Primo colpo al primo\n"
    "turno: può far tentennare.");

static const u8 sUproarDescription[] = _(
    "Frastuono che dura da 2 a\n"
    "5 turni e non fa dormire.");

static const u8 sStockpileDescription[] = _(
    "Accumula energia da usare più\n"
    "tardi. Si può utilizzr tre vlt.");

static const u8 sSpitUpDescription[] = _(
    "Rilascia l'energia accumulata\n"
    "(più ce n'è meglio è).");

static const u8 sSwallowDescription[] = _(
    "Assorbe l'energia\n"
    "accumulata restituendo PS.");

static const u8 sHeatWaveDescription[] = _(
    "Investe i nemici con una\n"
    "folata di vento caldo.");

static const u8 sHailDescription[] = _(
    "Causa una grandinata che\n"
    "dura cinque turni.");

static const u8 sTormentDescription[] = _(
    "Il nemico non può più usare\n"
    "l'ultima mossa utilizzata.");

static const u8 sFlatterDescription[] = _(
    "Adula il bersaglio e lo\n"
    "confonde, +Attacco Speciale.");

static const u8 sWillOWispDescription[] = _(
    "Infligge un'ustione al\n"
    "nemico con un fuoco intenso.");

static const u8 sMementoDescription[] = _(
    "Chi la usa va KO. -2\n"
    "l'At e l'At.Spc del nemico.");

static const u8 sFacadeDescription[] = _(
    "Più potente se il nemico è\n"
    "scottato, avvlnto o parlzzto.");

static const u8 sFocusPunchDescription[] = _(
    "Colpisce per ultima. Chi\n"
    "la usa tentenna se colpito.");

static const u8 sSmellingSaltsDescription[] = _(
    "Forte contro nemici\n"
    "paralizzati, ma li cura.");
...
static const u8 sNaturePowerDescription[] = _(
    "Il tipo di questo attacco\n"
    "varia secondo il luogo.");

static const u8 sChargeDescription[] = _(
    "Potenzia la mossa di tipo\n"
    "Elettro usata subito dopo.");

static const u8 sTauntDescription[] = _(
    "Induce il nemico ad usare\n"
    "solo mosse d'attacco.");

static const u8 sHelpingHandDescription[] = _(
    "Aumenta la potenza delle\n"
    "mosse di chi la riceve.");

static const u8 sTrickDescription[] = _(
    "Induce il nemico a scambiare\n"
    "gli oggetti posseduti.");

static const u8 sRolePlayDescription[] = _(
    "Mima in tutto il bersaglio,\n"
    "copiandone l'abilità.");

static const u8 sWishDescription[] = _(
    "Fa recuperare metà dei PS\n"
    "massimi al turno successivo.");

static const u8 sAssistDescription[] = _(
    "Attacca usando una a caso\n"
    "delle mosse della squadra.");

static const u8 sIngrainDescription[] = _(
    "Radici che ripristinano gli PS.\n"
...
static const u8 sCamouflageDescription[] = _(
    "Modifica il tipo del Pokémon\n"
    "secondo il luogo.");

static const u8 sTailGlowDescription[] = _(
    "Fissa una luce forte per\n"
    "aumentare moltissimo l'At.Sp.");

static const u8 sLusterPurgeDescription[] = _(
    "Attacca con un'esplosione di\n"
    "luce. Può abbassare la Dif.Spcl.");

static const u8 sMistBallDescription[] = _(
    "Può (50%) anche ridurre\n"
    "l'Attacco Speciale.");
...
static const u8 sTeeterDanceDescription[] = _(
    "Danza goffa che confonde\n"
    "tutti i Pokémon attorno.");

static const u8 sBlazeKickDescription[] = _(
    "Probabile brutto colpo. Può\n"
    "(10%) causare una scottatura.");

static const u8 sMudSportDescription[] = _(
    "Dimezza i danni inflitti\n"
    "dalle mosse di tipo Elettro.");
...
static const u8 sMeteorMashDescription[] = _(
    "Colpisce il nemico con\n"
    "un pugno veloce. 20% +At.");

static const u8 sAstonishDescription[] = _(
    "Verso terrificante, ha il\n"
    "30% di tentennare.");

static const u8 sWeatherBallDescription[] = _(
    "Cui tipo e la cui potenza\n"
    "variano in base alle c.atm.");

static const u8 sAromatherapyDescription[] = _(
    "Cura tutti problemi di stato\n"
    "propri e degli alleati.");

static const u8 sFakeTearsDescription[] = _(
    "Riduce di molto la Difesa\n"
    "Speciale.");
...
static const u8 sOdorSleuthDescription[] = _(
    ...
    "per aumentare l'evasività.");

static const u8 sRockTombDescription[] = _(
    "Colpisce il nemico con rocce.\n"
    "Inoltre, lo rallenta -1 Vel.");
...
static const u8 sMetalSoundDescription[] = _(
    "Riduce di molto la Dif.Spc\n"
    "del nemico.");

static const u8 sGrassWhistleDescription[] = _(
    "Dolce melodia, fa addormentare\n"
    "il bersaglio.");

static const u8 sTickleDescription[] = _(
    "Riduce l'Attacco e la Difesa\n"
    "del bersaglio.");

static const u8 sCosmicPowerDescription[] = _(
    "Incrementa la Difesa e la\n"
    "Dif.Speciale di chi la usa.");
...
static const u8 sSignalBeamDescription[] = _(
    "Infligge danno e ha il 10%\n"
    "di confondere il bersaglio.");

static const u8 sShadowPunchDescription[] = _(
    "Pugno proveniente dalle tenebre.\n"
...
static const u8 sSkyUppercutDescription[] = _(
    "Montante che può arrivare\n"
    "fino in cielo.");

static const u8 sSandTombDescription[] = _(
    "Intrppla in un turbine di sabbia\n"
    "per quattro o cinque turni.");
...
static const u8 sMuddyWaterDescription[] = _(
    "Getto di fango che può (30%)\n"
    "ridurre la precsne dei nemici.");

static const u8 sBulletSeedDescription[] = _(
    "Spara da due a cinque\n"
    "raffiche di semi.");
...
static const u8 sBulkUpDescription[] = _(
    "Incrementa l'Attacco e la\n"
    "Difesa di chi la usa.");

static const u8 sBounceDescription[] = _(
    "Balza in alto e ricade\n"
    "sul nemico dopo un turno.");

static const u8 sMudShotDescription[] = _(
    "Attacca lanciando fango.\n"
    "Riduce anche la Velocità.");
...
static const u8 sCalmMindDescription[] = _(
    "Concentrazione: aumentano\n"
    "l'Att. Sp. e la Dif. Sp.");

static const u8 sLeafBladeDescription[] = _(
    "Foglia affilata come una\n"
    "spada. Probabile brutto colpo.");

static const u8 sDragonDanceDescription[] = _(
    "Danza mistica e vigorosa\n"
    "che aumenta l'Att e la Vel.");

static const u8 sRockBlastDescription[] = _(
    "Colpisce tra 2-5 volte per\n"
    "ogni utilizzo.");
...
static const u8 sSwitcherooDescription[] = _(
    "Scambia in maniera fulminea il\n"
    "prpro oggetto con qllo del nmco.");

static const u8 sNastyPlotDescription[] = _(
    "Aumenta l'Attacco Speciale\n"
    "dell'utilzztre di due livelli.");
...
static const u8 sShadowSneakDescription[] = _(
    "Estende la sua ombra e\n"
    "attacca ad alta priorità.");

static const u8 sMudBombDescription[] = _(
    "30% di diminuire la precisione\n"
    "del bersaglio.");

static const u8 sPsychoCutDescription[] = _(
    "Ha un'elevata probabilità di\n"
...
static const u8 sFlashCannonDescription[] = _(
    "Attacca raccogliendo e\n"
    "rilasciando energia luminosa.");
...
static const u8 sTrickRoomDescription[] = _(
    "Pokémon più lenti si muovono\n"
    "per primi per cinque turni.");
...
static const u8 sDischargeDescription[] = _(
    "Bagliore elettrico. 30% di\n"
    "paralizzare ogni bersaglio.");

static const u8 sPowerWhipDescription[] = _(
    "Agita violentemente liane\n"
...
static const u8 sGunkShotDescription[] = _(
    "Rifiuti sudici. 30% di\n"
    "avvelenare il bersaglio.");

static const u8 sIronHeadDescription[] = _(
    "Testa dura come l'acciaio.\n"
    "30% di far tentennare.");

static const u8 sMagnetBombDescription[] = _(
    "Bombe d'acciaio.\n"
    "Una mossa infallibile.");
...
static const u8 sCaptivateDescription[] = _(
    "Diminuisce l'At.Speciale del\n"
    "bersaglio di 2 livelli.");

static const u8 sStealthRockDescription[] = _(
    "Piazza una trappola di rocce\n"
    "levitanti intorno al Pkmn avvrsr.");

static const u8 sGrassKnotDescription[] = _(
    "Potenza è tanto maggiore quanto\n"
    "più grande è il peso del bers.");

static const u8 sChatterDescription[] = _(
    "Attacca creando un'onda\n"
    "sonora con le parole imparate.");

static const u8 sJudgmentDescription[] = _(
    "Chi la usa rilascia numerosi\n"
    "colpi di luce.");
...
static const u8 sBurnUpDescription[] = _(
    "Scongela se è congelato, causa\n"
    "la perdita del tipo Fuoco.");

static const u8 sSpeedSwapDescription[] = _(
    "Scambia la propria Velocità\n"
    "con quella del bersaglio.");

static const u8 sSmartStrikeDescription[] = _(
    "Corno appuntito. Questa\n"
    "mossa va sempre a segno.");

static const u8 sPurifyDescription[] = _(
    "Ripristina 50% dei PS massimi.\n"
    "Guarisce il bersaglio p.d.stato.");

static const u8 sRevelationDanceDescription[] = _(
    "Il suo tipo dipende dal\n"
    "tipo primario dell'utilizztre.");

static const u8 sCoreEnforcerDescription[] = _(
    "Se ha già agito nel turno,\n"
    "perde la sua abilità.");
...
static const u8 sSpectralThiefDescription[] = _(
    "Ruba la statistiche del\n"
    "bersaglio, poi attacca.");

static const u8 sSunsteelStrikeDescription[] = _(
    "Questo attacco ignora\n"
    "l'abilità del bersaglio.");
...
static const u8 sGlitzyGlowDescription[] = _(
    "Attiva Schermoluce dal\n"
    "dal lato dell'utilizzatore.");

static const u8 sBaddyBadDescription[] = _(
    "Attiva Riflesso dal lato del\n"
    "campo dell'utilizzatore.");

static const u8 sSappySeedDescription[] = _(
    "Infligge danno e attiva\n"
    "Parassiseme sul bersaglio.");

static const u8 sFreezyFrostDescription[] = _(
    "Annulla tutte le modifiche\n"
    "alle statistiche in campo.");
