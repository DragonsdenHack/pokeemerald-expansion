...
static const u8 sRoostDescription[] = _(
    "Le lanceur atterrit, restaure\n"
    "jusqu'à la moitié de ses PV.");

static const u8 sGravityDescription[] = _(
    "Gravité agmnt pendant 5\n"
    "tours, annule Lévitation.");

static const u8 sMiracleEyeDescription[] = _(
    "Permet de toucher un Pokémon\n"
    "et de un ennemi insaisissable.");

static const u8 sWakeUpSlapDescription[] = _(
    "Cette atq inflige d'importants\n"
    "dégâts à un ennemi endormi.");

static const u8 sHammerArmDescription[] = _(
    "Lâche puissant coup de poing\n"
    "Réduit la Vitesse du lanceur.");

static const u8 sGyroBallDescription[] = _(
    "Plus le lanceur est lent,\n"
    "plus il fait de dégâts.");

static const u8 sHealingWishDescription[] = _(
    "Le lanceur tombe K.O. pour\n"
    "le Pkmn qui passe après lui.");

static const u8 sBrineDescription[] = _(
    "Fois plus puissante lrsq l'en.\n"
    "a moins de la moitié de ses PV.");

static const u8 sNaturalGiftDescription[] = _(
    "La Baie détermine le type\n"
    "et la puissance.");

static const u8 sFeintDescription[] = _(
    "Capable de toucher un ennemi\n"
    "qui Détection ou Abri.");

static const u8 sPluckDescription[] = _(
    "S'il tient une Baie, le lncr\n"
    "s'en empr et prft de ses efts.");

static const u8 sTailwindDescription[] = _(
    "x2 Vitesse des Pokémon de\n"
    "l'équipe pendant 3 tours.");

static const u8 sAcupressureDescription[] = _(
    "Effectue des prssns pour aug-\n"
    "menter frtmnt l'une de ses sts.");

static const u8 sMetalBurstDescription[] = _(
    "Att le dernr ennemi à l'avoir\n"
    "blessé en frappant plus fort.");

static const u8 sUTurnDescription[] = _(
    "Après avoir attaqué, le\n"
    "lanceur change de place.");

static const u8 sCloseCombatDescription[] = _(
    "Baisse aussi sa Défense\n"
    "et sa Déf. Spé.");

static const u8 sPaybackDescription[] = _(
    "La puissance est doublée si\n"
    "cela suit une cpcté ennemie.");

static const u8 sAssuranceDescription[] = _(
    "Est deux fois plus efficace\n"
    "si l'ennemi a déjà été blessé.");
...
static const u8 sFlingDescription[] = _(
    "La puissance et les eff-\n"
    "ets dépendent de l'objet.");
...
static const u8 sTrumpCardDescription[] = _(
    "Moins ce coup possède de\n"
    "PP, plus il est puissant.");
...
static const u8 sPowerSwapDescription[] = _(
    "Échange les modifications de\n"
    "l'Atq. Spé. et de l'Attaque.");

static const u8 sGuardSwapDescription[] = _(
    "Échange les modifications de\n"
    "la Déf. Spé. et de la Défense");

static const u8 sPunishmentDescription[] = _(
    "Plus puissante plus l'ennemi a\n"
    "utilisé des agmntatns de stats.");

static const u8 sLastResortDescription[] = _(
    "Util. Après que le lanceur a\n"
    "utilisé toutes les autres.");

static const u8 sWorrySeedDescription[] = _(
    "Pemplace l'ennemi capacité\n"
    "spéciale par Insomnia.");

static const u8 sSuckerPunchDescription[] = _(
    "+1 priorité. Échoue si l'ennemi\n"
    "ne prépare pas une attaque.");

static const u8 sToxicSpikesDescription[] = _(
    "Empoisonnent les ennemis\n"
    "qui entrent au combat.");

static const u8 sHeartSwapDescription[] = _(
    "Échanger ses changements de\n"
    "stats avec l'ennemi.");

static const u8 sAquaRingDescription[] = _(
    "Voile liquide, récupère des\n"
    "PV à chaque tour.");

static const u8 sMagnetRiseDescription[] = _(
    "Le lanceur lévite durant\n"
    "5 tours.");

static const u8 sFlareBlitzDescription[] = _(
    "Charge l'ennemi. Le choc blesse\n"
    "gravement le lanceur aussi.");

static const u8 sForcePalmDescription[] = _(
    "Onde de choc frappe l'ennemi.\n"
    "Peut aussi paralyser la cible.");

static const u8 sAuraSphereDescription[] = _(
    "Le lanceur dégage une aura.\n"
    "N'échoue jamais.");
...
static const u8 sPoisonJabDescription[] = _(
    ...
    "poison. Peut aussi l'empoisnnr.");

static const u8 sDarkPulseDescription[] = _(
    "Horrible aura chargée d'idées\n"
    "noires. Peut apeurer l'ennemi.");

static const u8 sNightSlashDescription[] = _(
    "Le lanceur lacère l'ennemi,\n"
    "taux de critiques élevé.");

static const u8 sAquaTailDescription[] = _(
    "Balançant sa queue comme une\n"
    "lame de fond en pleine tempête.");

static const u8 sSeedBombDescription[] = _(
    "Pleuvoir un déluge de graines\n"
    "solides sur l'ennemi.");

static const u8 sAirSlashDescription[] = _(
    "Lame d'air qui fend tout.\n"
    "Peut aussi apeurer l'ennemi.");

static const u8 sXScissorDescription[] = _(
    "taillade l'ennemi en utilisant\n"
    "ses faux comme ciseaux.");

static const u8 sBugBuzzDescription[] = _(
    "Vibre ses ailes pour lancer une\n"
    "vague soniq. Peut bssr la D.Spé.");
...
static const u8 sFlashCannonDescription[] = _(
    "Concentre énergie lumineuse et\n"
    "la fait exploser. 10% -Déf. Spé.");

static const u8 sRockClimbDescription[] = _(
    "Charge pouvant rendre\n"
    "l'ennemi confus.");

static const u8 sDefogDescription[] = _(
    "Diminue l'esquive de\n"
    "l'adversaire et Hazards.");

static const u8 sTrickRoomDescription[] = _(
    "Zone étrange où les Pkmn les\n"
    "plus lents frappent en 1er.");

static const u8 sDracoMeteorDescription[] = _(
    "Invoque des comètes. Le contrecp\n"
    "réduit fortement son Atq. Spé.");

static const u8 sDischargeDescription[] = _(
    "Un flamboiement d'électricité.\n"
    "Peut aussi paralyser (30%).");

static const u8 sPowerWhipDescription[] = _(
    "Fait virevolter violemment\n"
    "pour fouetter l'ennemi.");

static const u8 sCrossPoisonDescription[] = _(
    "Coup tranchant qui peut empois-\n"
    "onner. Taux de critiques élevé.");
...
static const u8 sIronHeadDescription[] = _(
    "Heurte l'ennemi avec sa tête\n"
    "Peut (20%) apeurer l'ennemi.");

static const u8 sMagnetBombDescription[] = _(
    "Projette des bombes d'acier.\n"
    "N'échoue jamais.");

static const u8 sStoneEdgeDescription[] = _(
    "Surgir des pierres aiguisées.\n"
    "Taux de critiques élevé.");

static const u8 sCaptivateDescription[] = _(
    "Si sexe opposé au lanceur, sa\n"
    "stat Atq. Spé. baisse fortement.");

static const u8 sStealthRockDescription[] = _(
    "Pierres flottantes qui blessent\n"
    "tout ennemi entrant au combat.");

static const u8 sGrassKnotDescription[] = _(
    "Dans de l'herbe, qui le fait\n"
    "trébucher. +Lourd, +Dégâts.");

static const u8 sChatterDescription[] = _(
    "Onde musicale en récitant des\n"
    "mots. Peut confus.");

static const u8 sJudgmentDescription[] = _(
    "Le type varie selon la Plaque\n"
    "que tient le lanceur.");

static const u8 sChargeBeamDescription[] = _(
    "Rayon chargé d'électricité. Peut\n"
    "(70%) augmenter son Atq. Spé.");

static const u8 sWoodHammerDescription[] = _(
    "Heurte l'ennemi de son corps\n"
    "robuste. 1/3 recul.");

static const u8 sAquaJetDescription[] = _(
    "Propulse sur l'eau et\n"
    "frappe en premier.");

static const u8 sAttackOrderDescription[] = _(
    "Appelle ses sous-fifres pour\n"
    "frppr l'ennemi. Tdcrit élevé.");

static const u8 sDefendOrderDescription[] = _(
    "Appelle ses sous-fifres et\n"
    "augmente sa Déf et sa Déf.Spé.");
...
static const u8 sSpacialRendDescription[] = _(
    "Déchire l'ennemi et l'espace\n"
    "Taux de critques élevé.");

static const u8 sMagmaStormDescription[] = _(
    "Tourbillon de feu qui\n"
    "dure de 2 à 5 tours.");

static const u8 sDarkVoidDescription[] = _(
    "L'ennemi tombe dans un\n"
    "profond sommeil.");

static const u8 sSeedFlareDescription[] = _(
    "Onde de choc qui Peut bssr\n"
    "la Déf. Spé. de la cible.");

static const u8 sOminousWindDescription[] = _(
    "Violente bourrasque. Peut\n"
...
static const u8 sEntrainmentDescription[] = _(
    "Dance sur l'ennemi et\n"
    "adopte sa capacité spéciale.");

static const u8 sAfterYouDescription[] = _(
    "Permet à sa cible d'utiliser\n"
    "une capacité juste après lui.");

static const u8 sRoundDescription[] = _(
    "+Pkmn déclenchent cette\n"
    "attaque l'effet augmente.");
...
static const u8 sFinalGambitDescription[] = _(
    "Perd tous ses PV restants et\n"
    "inflg autant de dgts à l'ennm.");
...
static const u8 sLeafTornadoDescription[] = _(
    "Tourbillon de flls acérées.\n"
    "Peut baisser la Précision.");

static const u8 sSteamrollerDescription[] = _(
    "Le lanceur écrase son ennemi.\n"
    "Peut aussi apeurer l'ennemi.");

static const u8 sCottonGuardDescription[] = _(
    "Le lanceur augmente (+3)\n"
    "sa Défense fortement.");

static const u8 sNightDazeDescription[] = _(
    "Onde de choc ténébreuse.\n"
    "Peut baisser la Précision.");

static const u8 sHurricaneDescription[] = _(
    "Vents violents qui s'abat\n"
    "sur l'ennemi. 30% confus");

static const u8 sHeadChargeDescription[] = _(
    "Coup avec la tête crnnée d'une\n"
    "fière crinière. 1/4 recul.");
...
static const u8 sVCreateDescription[] = _(
    "Flamme ardente, Baisse la Déf,\n"
    "la Déf. Spé. et la Vitesse.");
...
static const u8 sFreezeDryDescription[] = _(
    "Super efficace sur les Pkmn\n"
    "de type Eau. 10% geler.");
...
static const u8 sDrainingKissDescription[] = _(
    "Rend un nombre de PV supérieur\n"
    "des dégâts infligés.");

static const u8 sCraftyShieldDescription[] = _(
    "Protéger l'équipe des\n"
    "attaques de statut.");
...
static const u8 sGrassyTerrainDescription[] = _(
    "Pendant cinq tours, le terrn\n"
    "se transforme en gazon.");
...
static const u8 sElectrifyDescription[] = _(
    "Électrf l'ennemi, rendant son\n"
    "prochain mouvement de t.élec.");

static const u8 sPlayRoughDescription[] = _(
    "Attaque l'ennemi avec un\n"
    "câlin. 10% diminuer Att.");

static const u8 sFairyWindDescription[] = _(
    "Déchaîne un vent magique\n"
    "qui cingle l'ennemi.");
...
static const u8 sBoomburstDescription[] = _(
    "Onde sonore assrdssnt qui\n"
    "détruit tout sur son passage.");

static const u8 sFairyLockDescription[] = _(
    "empêchant tous les Pkmn de\n"
    "fuir au prochain tour.");

static const u8 sKingsShieldDescription[] = _(
    "Evite les dégâts, et réduit\n"
    "l'attaque en cas de coup.");

static const u8 sPlayNiceDescription[] = _(
    "L'ennemi perd sa combativité,\n"
    "diminuant son Attaque.");

static const u8 sConfideDescription[] = _(
    "L'ennemi qui perd sa concen-\n"
    "trtn et voit son At.S diminuer.");

static const u8 sDiamondStormDescription[] = _(
    "Tempête de diamants qui\n"
    "Peut (50%) augmenter la Déf.");

static const u8 sSteamEruptionDescription[] = _(
    "Plonge l'ennemi dans une chal-\n"
    "eur étouffante. 30% brûler.");
...
static const u8 sWaterShurikenDescription[] = _(
    "Frappe deux à cinq fois\n"
    "d'affilée et toujours en prmr.");

static const u8 sMysticalFireDescription[] = _(
    "Flammes brûlantes qui\n"
    "fire. Lowers Sp. Atk.");

static const u8 sSpikyShieldDescription[] = _(
    "Protège des attaques, et diminue\n"
    "les PV si entre en contact.");

static const u8 sAromaticMistDescription[] = _(
    "Grâce à un parfum et augmente\n"
    "la Déf.Spéciale d'un allié.");

static const u8 sEerieImpulseDescription[] = _(
    "Diminue fortement l'Attaque\n"
    "Spéciale de l'ennemi.");

static const u8 sVenomDrenchDescription[] = _(
    "Diminue l'Att, l'Att.Spc et\n"
    "la Vitesse de l'ennemi.");
...
static const u8 sGeomancyDescription[] = _(
    "Absorbe énergie au 1ºtour.\n"
    "+2 At.S, D.S et Vit au second.");

static const u8 sMagneticFluxDescription[] = _(
    "Manipule les champs magnétiques\n"
    "pour Plus ou Minus.");
...
static const u8 sGearUpDescription[] = _(
    "+1 Att et Att.Sp des alliés\n"
    "aynt les tlnts Plus ou Minus.");

static const u8 sThroatChopDescription[] = _(
    "Ne peut plus émettre de\n"
...
static const u8 sBeakBlastDescription[] = _(
    "Le lanceur fait chauffer\n"
    "son bec avant d'attaquer.");
...
static const u8 sBrutalSwingDescription[] = _(
    "Pivote pour prendre de\n"
    "l'élan et inflgr des dégâts.");

static const u8 sAuroraVeilDescription[] = _(
    "5 tours x2 Def et Def.Sp.\n"
    "Npt être utls que lrsq'l grêle.");

static const u8 sShellTrapDescription[] = _(
    "La carapace explose et\n"
    "lui inflige des dégâts.");

static const u8 sFleurCannonDescription[] = _(
    "Envoie un rayon laser dévsttr.\n"
    "-2 Att.Spc du lanceur.");
...
static const u8 sMoongeistBeamDescription[] = _(
    "Rayon de lumière que\n"
    "ignore le talent de l'ennemi.");

static const u8 sTearfulLookDescription[] = _(
    "Voit Att et Att.Spc baisser.\n"
...
static const u8 sMindBlownDescription[] = _(
    "Fait exploser sa tête pour att\n"
    "toutes les cibles autour de lui.");

static const u8 sPlasmaFistsDescription[] = _(
    "Convertit les capacités de\n"
    "t.Normal en t.Électrik.");

static const u8 sPhotonGeyserDescription[] = _(
    "Compare l'Att et l'AttSpc, ut\n"
    "qui inflgr le plus de dégâts.");
...
static const u8 sSplishySplashDescription[] = _(
    "Géante chargée d'électricité.\n"
    "Peut (30%) paralyser l'ennemi.");

static const u8 sFloatyFallDescription[] = _(
    "fondre sur son adversaire.\n"
    "Peut (30%) apeurer l'ennemi.");
...
static const u8 sBuzzyBuzzDescription[] = _(
    "Une attaque qui foudroie\n"
    "et paralyse l'adversaire.");

static const u8 sSizzlySlideDescription[] = _(
    "Percute violemment l'adversaire.\n"
    "Brûle aussi l'ennemi.");

static const u8 sGlitzyGlowDescription[] = _(
    "Divise par deux la puissance\n"
    "des cap.spéciales adverses.");

static const u8 sBaddyBadDescription[] = _(
    "Divise par deux la puissance\n"
    "des cap.physiques adverses.");
...
static const u8 sDragonDartsDescription[] = _(
    "Le lanceur attaque en\n"
    "propulsant deux Fantyrm.");
    
static const u8 sTeatimeDescription[] = _(
    "Ceux qui tiennent une\n"
    "Baie la mangent.");
    
static const u8 sOctolockDescription[] = _(
    "Baisse la Déf et la Déf.Sp\n"
    "à chaque tour qui passe.");
    
static const u8 sBoltBeakDescription[] = _(
    "Infligera deux fois plus de\n"
    "dégâts si frappe en premier.");
...
static const u8 sBurningJealousyDescription[] = _(
    "Brûle tout Pokémon dont\n"
    "les stats ont augmenté.");

static const u8 sLashOutDescription[] = _(
    "Si les stats diminué,\n"
    "la puissance est doublée.");

static const u8 sPoltergeistDescription[] = _(
    "Cette capacité échoue\n"
    "si celle-ci ne tient rien.");

static const u8 sCorrosiveGasDescription[] = _(
    "Enveloppe tous les Pokémon\n"
    "et dissout les objets");

static const u8 sCoachingDescription[] = _(
    "Coache ses alliés, augmentant\n"
    "leur Attaque et leur Défense.");
