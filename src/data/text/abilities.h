...
static const u8 sAngerPointDescription[] = _("Massimizza l'Att dopo un brutto colpo.");
static const u8 sUnburdenDescription[] = _("Sale Vel se lo strumento si perde.");
static const u8 sHeatproofDescription[] = _("Indebolisce l'eff di mosse di tipo Fuoco.");
static const u8 sSimpleDescription[] = _("Raddoppia le modifiche alle statistiche.");
static const u8 sDrySkinDescription[] = _("Riduce PS se fa caldo. L'acqua ridà PS.");
static const u8 sDownloadDescription[] = _("Regola la potenza in base al nemico.");
static const u8 sIronFistDescription[] = _("Potenzia le mosse che utilizzano pugni.");
static const u8 sPoisonHealDescription[] = _("Ridà PS se il Pokémon è avvelenato.");
static const u8 sAdaptabilityDescription[] = _("Potenzia le mosse del tipo del Pokémon.");
static const u8 sSkillLinkDescription[] = _("Aumenta la frequenza di mosse multicolpo.");
static const u8 sHydrationDescription[] = _("Cura i problemi di stato se piove.");
static const u8 sSolarPowerDescription[] = _("Aumenta l'Att.Sp. - PS se c'è il sole.");
static const u8 sQuickFeetDescription[] = _("Aumenta la Vel se c'è un problema di stato.");
static const u8 sNormalizeDescription[] = _("Le mosse del Pkmn diventano di tipo Nor.");
static const u8 sSniperDescription[] = _("Potenzia le mosse se diventano brutti colpi.");
static const u8 sMagicGuardDescription[] = _("Il Pokémon subisce danni solo dagli att.");
static const u8 sNoGuardDescription[] = _("Gli attacchi dei Pokémon vanno a buon fine.");
