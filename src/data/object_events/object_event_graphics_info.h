...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_AdminPokeball = {TAG_NONE, OBJ_EVENT_PAL_TAG_NPC_WHITE, OBJ_EVENT_PAL_TAG_NONE, 256, 16, 32, 4, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT, &gObjectEventBaseOam_16x32, sOamTables_16x32, sAnimTable_Standard, sPicTable_Adminpokeball, gDummySpriteAffineAnimTable};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_KingUnown = {TAG_NONE, OBJ_EVENT_PAL_TAG_REYUNOWN, OBJ_EVENT_PAL_TAG_NONE, 2048, 64, 64, 4, SHADOW_SIZE_M, FALSE, TRUE, TRACKS_FOOT, &gObjectEventBaseOam_64x64, sOamTables_64x64, sAnimTable_Standard, sPicTable_ReyUnown, gDummySpriteAffineAnimTable};
