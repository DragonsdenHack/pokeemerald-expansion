...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Andra_AltoRango = {TAG_NONE, OBJ_EVENT_PAL_TAG_ANDRA_ALTO_RANGO, OBJ_EVENT_PAL_TAG_NONE, 256, 16, 32, 4, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT, &gObjectEventBaseOam_16x32, sOamTables_16x32, sAnimTable_Standard, sPicTable_Prota_AltoRango, gDummySpriteAffineAnimTable};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Andra_Ejecutivo = {TAG_NONE, OBJ_EVENT_PAL_TAG_ANDRA_EJECUTIVA, OBJ_EVENT_PAL_TAG_NONE, 256, 16, 32, 4, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT, &gObjectEventBaseOam_16x32, sOamTables_16x32, sAnimTable_Standard, sPicTable_Prota_Ejecutivo, gDummySpriteAffineAnimTable};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Andra_Admin = {TAG_NONE, OBJ_EVENT_PAL_TAG_ANDRA_ADMIN, OBJ_EVENT_PAL_TAG_NONE, 256, 16, 32, 4, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT, &gObjectEventBaseOam_16x32, sOamTables_16x32, sAnimTable_Standard, sPicTable_Prota_Admin, gDummySpriteAffineAnimTable};
