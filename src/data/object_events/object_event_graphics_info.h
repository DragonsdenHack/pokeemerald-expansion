...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Petrel = {TAG_NONE, OBJ_EVENT_PAL_TAG_NPC_PETREL, OBJ_EVENT_PAL_TAG_NONE, 256, 16, 32, 4, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT, &gObjectEventBaseOam_16x32, sOamTables_16x32, sAnimTable_Standard, sPicTable_Petrel, gDummySpriteAffineAnimTable};
