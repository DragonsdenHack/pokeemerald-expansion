...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Rocket_AdminJefe_Bici = {TAG_NONE, OBJ_EVENT_PAL_TAG_PLAYER_ADMIN_JEFE_BICI_SURF_RUNNING_FIELDMOVE, OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION, 512, 32, 32, 0, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_BIKE_TIRE, &gObjectEventBaseOam_32x32, sOamTables_32x32, sAnimTable_Standard, sPicTable_Prota_Admin_Jefe_Bike, gDummySpriteAffineAnimTable};
