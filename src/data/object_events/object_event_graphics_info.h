...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Andra_AltoRango = {TAG_NONE, OBJ_EVENT_PAL_TAG_ANDRA_ALTO_RANGO, OBJ_EVENT_PAL_TAG_NONE, 256, 16, 32, 4, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT, &gObjectEventBaseOam_16x32, sOamTables_16x32, sAnimTable_Standard, sPicTable_Andra, gDummySpriteAffineAnimTable};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Andra_Ejecutivo = {TAG_NONE, OBJ_EVENT_PAL_TAG_ANDRA_ALTO_RANGO, OBJ_EVENT_PAL_TAG_NONE, 256, 16, 32, 4, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT, &gObjectEventBaseOam_16x32, sOamTables_16x32, sAnimTable_Standard, sPicTable_Andra, gDummySpriteAffineAnimTable};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Andra_Admin = {TAG_NONE, OBJ_EVENT_PAL_TAG_ANDRA_ALTO_RANGO, OBJ_EVENT_PAL_TAG_NONE, 256, 16, 32, 4, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT, &gObjectEventBaseOam_16x32, sOamTables_16x32, sAnimTable_Standard, sPicTable_Andra, gDummySpriteAffineAnimTable};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Andra_Admin_Jefe = {TAG_NONE, OBJ_EVENT_PAL_TAG_ANDRA_ALTO_RANGO, OBJ_EVENT_PAL_TAG_NONE, 256, 16, 32, 4, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT, &gObjectEventBaseOam_16x32, sOamTables_16x32, sAnimTable_Standard, sPicTable_Andra, gDummySpriteAffineAnimTable};
