const struct BattleMove gBattleMoves[MOVES_COUNT_Z] =
{
    ...
    [MOVE_BLAST_BURN] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_HIGH_CRIT | FLAG_KINGS_ROCK_AFFECTED,
        .split = SPLIT_SPECIAL,
        .zMovePower = 200,
        .zMoveEffect = Z_EFFECT_NONE,
    },
    ...
    [MOVE_STEEL_BEAM] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_RECKLESS_BOOST,
        .split = SPLIT_SPECIAL,
        .zMovePower = 195,
        .zMoveEffect = Z_EFFECT_NONE,
    },
