...
static const u8 sMapName_RocketHideoutJohto[] = _("GUARIDA ROCKET");
...
static const u8 sMapName_WhirpoolIsland[] = _("ISLA REMOLINO");
...
static const u8 sMapName_TinTower[] = _("TORRE IRIS");
