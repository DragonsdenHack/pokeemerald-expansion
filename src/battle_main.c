...
const struct TrainerMoney gTrainerMoneyTable[] =
{
    ...
    {TRAINER_CLASS_POKEFAN_2, 8}, // nuevos a partir de aquí
    {TRAINER_CLASS_MAESTRA, 10},
    {TRAINER_CLASS_COLEGIAL, 2},
    {TRAINER_CLASS_MAESTRO_TORRE, 30},
    ...
    {TRAINER_CLASS_MIRTO, 50},
    {TRAINER_CLASS_EXPERIMENTO, 0},
    {TRAINER_CLASS_SALVAJE, 0},
    {TRAINER_CLASS_POLICIAHOENN, 9},
    {TRAINER_CLASS_CIENTIFICOJOHTO, 11},
    {TRAINER_CLASS_MOTORISTAJOHTO, 5},
    {TRAINER_CLASS_MAESTRO, 40},
    {TRAINER_CLASS_CIENTIFICOHOENN, 11},
    {TRAINER_CLASS_MONTANEROHOENN, 10},
    {TRAINER_CLASS_FARERO, 22},
    {TRAINER_CLASS_COMEFUEGO, 6},
    {TRAINER_CLASS_KIMONO, 19},
    {TRAINER_CLASS_ELM, 42},
    {TRAINER_CLASS_CHICAFUERTEJOHTO, 6},
    {TRAINER_CLASS_NADADORAJOHTO, 2},
    {TRAINER_CLASS_MARINEROJOHTO, 8},
    {TRAINER_CLASS_PINTORAJOHTO, 7},
    {TRAINER_CLASS_MENTALISTAJOHTO, 6},
    {TRAINER_CLASS_CRIAPOKEMONJOHTO, 10},
    {TRAINER_CLASS_PAREJAJOHTO, 8},
    {TRAINER_CLASS_MALABARISTAJOHTO, 7},
    {TRAINER_CLASS_CHICAJOHTO, 4},
    {TRAINER_CLASS_BELLAJOHTO, 16},
    {TRAINER_CLASS_CABALLEROJOHTO, 20},
    {TRAINER_CLASS_SUPERNECIOJOHTO, 14},
    {TRAINER_CLASS_CALVOJOHTO, 7},
    {TRAINER_CLASS_RICO, 50},
    {TRAINER_CLASS_NADADORJOHTO, 2},
    {TRAINER_CLASS_RUINAMANIACOJOHTO, 15},
    {TRAINER_CLASS_MECANICOJOHTO, 14},
    {TRAINER_CLASS_PENSADOR, 9},
    {TRAINER_CLASS_CAZABICHOSJOHTO, 4},
    {TRAINER_CLASS_JUGONJOHTO, 8},
    {TRAINER_CLASS_MALABARISTA, 7},
    {TRAINER_CLASS_POKEGUARDAJOHTO, 12},
    {TRAINER_CLASS_PINTORA, 7},
    {TRAINER_CLASS_DAMISELA, 50},
    {TRAINER_CLASS_POKEGUARDA, 12},
    {TRAINER_CLASS_CRIAPOKEMON, 10},
    {TRAINER_CLASS_PLAYERA, 1},
    {TRAINER_CLASS_CHICAFUERTE, 6},
    {TRAINER_CLASS_RUINAMANIACO, 15},
    {TRAINER_CLASS_HERMANOS, 3},
    {TRAINER_CLASS_DUOFUERTE, 8},
    {TRAINER_CLASS_PAREJAJOVEN, 8},
    {TRAINER_CLASS_GEMELAS, 3},
    {TRAINER_CLASS_DOMINGUERAJOHTO, 4},
    {TRAINER_CLASS_ORNITOLOGOJOHTO, 8},
    ...
    {TRAINER_CLASS_ORNITOLOGO, 8},
    {TRAINER_CLASS_JUGLAR, 7},
    {TRAINER_CLASS_ROCKERO, 8},
    {TRAINER_CLASS_MEDIUM, 6},
    {TRAINER_CLASS_NADADORA, 2},
    {TRAINER_CLASS_BELLA, 20},
    {TRAINER_CLASS_JUGADOR, 10},
    {TRAINER_CLASS_GUAYJOHTO, 12},
    {TRAINER_CLASS_CALVO, 7},
    {TRAINER_CLASS_NADADOR, 2},
    {TRAINER_CLASS_INGENIERO, 14},
    {TRAINER_CLASS_SABIO, 17},
    {TRAINER_CLASS_LADRON, 16},
    {TRAINER_CLASS_LADRONJOHTO, 16},
    {TRAINER_CLASS_MOTORISTA, 5},
    {TRAINER_CLASS_SUPERNECIO, 14},
    {TRAINER_CLASS_DOMINGUERA, 4},
    {TRAINER_CLASS_CAMPISTA, 4},
    {TRAINER_CLASS_NINJA, 3},
    {TRAINER_CLASS_CHICA, 4},
    {TRAINER_CLASS_CAZABICHOS, 4},
    {TRAINER_CLASS_JOVEN, 4},
    {TRAINER_CLASS_EXCULTISTA, 11},
    {TRAINER_CLASS_POKECOLECTOR, 15},
    {TRAINER_CLASS_EXORCISTA, 6},
    {TRAINER_CLASS_ORNITOLOGA, 8},
    {TRAINER_CLASS_TRABAJADOR, 14},
    {TRAINER_CLASS_CIENTIFICO, 11},
    {TRAINER_CLASS_PAREJAGUAY, 12},
    {TRAINER_CLASS_FUJI, 24},
    {TRAINER_CLASS_GUAY, 12},
    {TRAINER_CLASS_PESCADOR, 10},
    {TRAINER_CLASS_DOMADOR, 11},
    {TRAINER_CLASS_POLICIA, 9},
    {TRAINER_CLASS_ANCIENT, 0},
    {TRAINER_CLASS_BILL, 44},
    {TRAINER_CLASS_SINGULAR, 20},
    {TRAINER_CLASS_LIDER, 25},
    {TRAINER_CLASS_CAMPEON, 50},
    {TRAINER_CLASS_EXCAMPEON, 50},
    {TRAINER_CLASS_CAPITAN, 30},
    {TRAINER_CLASS_AVES, 0},
    {TRAINER_CLASS_ESENCIA, 0},
    {TRAINER_CLASS_RIVALES, 35},
    {TRAINER_CLASS_DIOS, 75},
    {TRAINER_CLASS_JONES, 55},
