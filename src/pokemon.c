...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(EONEON),
    SPECIES_TO_NATIONAL(TRXATU),
    SPECIES_TO_NATIONAL(PORYGON3),
    SPECIES_TO_NATIONAL(NIDOGOD),
    SPECIES_TO_NATIONAL(AERODACTYL_SKEL),
    SPECIES_TO_NATIONAL(MEWTWO_ARM),
    SPECIES_TO_NATIONAL(ULTIMATE_PROYECT),
    SPECIES_TO_NATIONAL(DUNSPARCE_OLD),
    SPECIES_TO_NATIONAL(MAROGHOST),
    SPECIES_TO_NATIONAL(KABUTOPS_SKEL),
    SPECIES_TO_NATIONAL(DUDUNSPARCE),
    SPECIES_TO_NATIONAL(GHOST),
    SPECIES_TO_NATIONAL(KURUSU),
    SPECIES_TO_NATIONAL(AKUA),
    SPECIES_TO_NATIONAL(AKUERIA),
    SPECIES_TO_NATIONAL(BOOHOO),
    SPECIES_TO_NATIONAL(IKARY),
    SPECIES_TO_NATIONAL(PURAKKUSU),
    SPECIES_TO_NATIONAL(TAABAN),
    SPECIES_TO_NATIONAL(BOMUSHIKAA),
    SPECIES_TO_NATIONAL(MADAAMU),
    SPECIES_TO_NATIONAL(SUI),
    SPECIES_TO_NATIONAL(RAI),
    SPECIES_TO_NATIONAL(EN),
    SPECIES_TO_NATIONAL(SACRED_DRAGON),
    SPECIES_TO_NATIONAL(ORIGINAL_DRAGON),
    ...
    [SPECIES_TAUROS_X - 1] = NATIONAL_DEX_TAUROS,
    [SPECIES_ELECTIVIRE_X - 1] = NATIONAL_DEX_ELECTIVIRE,
    [SPECIES_MAGMORTAR_Y - 1] = NATIONAL_DEX_MAGMORTAR,
    [SPECIES_NIDOQUEEN_Y - 1] = NATIONAL_DEX_NIDOQUEEN,
    [SPECIES_NIDOKING_X - 1] = NATIONAL_DEX_NIDOKING,
    [SPECIES_PORYGONZ_X - 1] = NATIONAL_DEX_PORYGON_Z,
    [SPECIES_PORYGONZ_Y - 1] = NATIONAL_DEX_PORYGON_Z,
    [SPECIES_CRADILY_Y - 1] = NATIONAL_DEX_CRADILY,
    [SPECIES_RAMPARDOS_X - 1] = NATIONAL_DEX_RAMPARDOS,
    [SPECIES_BASTIODON_X - 1] = NATIONAL_DEX_BASTIODON,
    [SPECIES_TYRANTRUM_X - 1] = NATIONAL_DEX_TYRANTRUM,
    [SPECIES_ARCHEOPS_X - 1] = NATIONAL_DEX_ARCHEOPS,
    [SPECIES_REGIROCK_X - 1] = NATIONAL_DEX_REGIROCK,
    [SPECIES_REGICE_Y - 1] = NATIONAL_DEX_REGICE,
    [SPECIES_REGISTEEL_Z - 1] = NATIONAL_DEX_REGISTEEL,
    [SPECIES_DEOXYS_ATTACK_Y - 1] = NATIONAL_DEX_DEOXYS,
    [SPECIES_DEOXYS_SPEED_Y - 1] = NATIONAL_DEX_DEOXYS,
    [SPECIES_GENESECT_X - 1] = NATIONAL_DEX_GENESECT,
    [SPECIES_GENESECT_Y - 1] = NATIONAL_DEX_GENESECT,
    [SPECIES_POLIWRATH_BOND - 1] = NATIONAL_DEX_POLIWRATH,
    [SPECIES_BUTTERFREE_BOND - 1] = NATIONAL_DEX_BUTTERFREE,
    [SPECIES_FERALIGATR_BOND - 1] = NATIONAL_DEX_FERALIGATR,
    [SPECIES_RAPIDASH_BOND - 1] = NATIONAL_DEX_RAPIDASH,
    [SPECIES_KINGDRA_BOND - 1] = NATIONAL_DEX_KINGDRA,
    [SPECIES_SKARMORY_BOND - 1] = NATIONAL_DEX_SKARMORY,
    [SPECIES_EEVEE_BOND - 1] = NATIONAL_DEX_EEVEE,
    [SPECIES_HYPNO_BOND - 1] = NATIONAL_DEX_HYPNO,
    [SPECIES_DELPHOX_BOND - 1] = NATIONAL_DEX_DELPHOX,
    [SPECIES_RHYPERIOR_BOND - 1] = NATIONAL_DEX_RHYPERIOR,
    [SPECIES_LAPRAS_BOND - 1] = NATIONAL_DEX_LAPRAS,
    [SPECIES_EMPOLEON_BOND - 1] = NATIONAL_DEX_EMPOLEON,
    [SPECIES_INFERNAPE_BOND - 1] = NATIONAL_DEX_INFERNAPE,
    [SPECIES_MESPRIT_BOND - 1] = NATIONAL_DEX_MESPRIT,
    [SPECIES_SERPERIOR_BOND - 1] = NATIONAL_DEX_SERPERIOR,
    [SPECIES_HAXORUS_BOND - 1] = NATIONAL_DEX_HAXORUS,
    [SPECIES_WEAVILE_BOND - 1] = NATIONAL_DEX_WEAVILE,
    [SPECIES_AEGISLASH_BOND - 1] = NATIONAL_DEX_AEGISLASH,
    [SPECIES_VOLCARONA_BOND - 1] = NATIONAL_DEX_VOLCARONA,
    [SPECIES_GOODRA_BOND - 1] = NATIONAL_DEX_GOODRA,
    [SPECIES_HYDREIGON_BOND - 1] = NATIONAL_DEX_HYDREIGON,
    [SPECIES_DRAGONITE_BOND - 1] = NATIONAL_DEX_DRAGONITE,
    [SPECIES_UNOWN_GOLD - 1] = NATIONAL_DEX_UNOWN,
    [SPECIES_UNOWN_KING - 1] = NATIONAL_DEX_UNOWN,
    [SPECIES_ARTICUNO_PRIMAL - 1] = NATIONAL_DEX_ARTICUNO,
    [SPECIES_ZAPDOS_PRIMAL - 1] = NATIONAL_DEX_ZAPDOS,
    [SPECIES_MOLTRES_PRIMAL - 1] = NATIONAL_DEX_MOLTRES,
    [SPECIES_RAIKOU_BOND - 1] = NATIONAL_DEX_RAIKOU,
    [SPECIES_ENTEI_BOND - 1] = NATIONAL_DEX_ENTEI,
    [SPECIES_SUICUNE_BOND - 1] = NATIONAL_DEX_SUICUNE,
    [SPECIES_ARCEUS_PRIMAL - 1] = NATIONAL_DEX_ARCEUS,
    ...
    [SPECIES_DUSKNOIR_MEGA - 1] = NATIONAL_DEX_DUSKNOIR,
    [SPECIES_FLYGON_MEGA - 1] = NATIONAL_DEX_FLYGON,
    [SPECIES_STARMIE_MEGA - 1] = NATIONAL_DEX_STARMIE,
    [SPECIES_BUTTERFREE_MEGA - 1] = NATIONAL_DEX_BUTTERFREE,
    [SPECIES_NOIVERN_MEGA - 1] = NATIONAL_DEX_NOIVERN,
    [SPECIES_MILOTIC_MEGA - 1] = NATIONAL_DEX_MILOTIC,
    [SPECIES_PORYGON_Z_MEGA - 1] = NATIONAL_DEX_PORYGON_Z,
    [SPECIES_COFAGRIGUS_MEGA - 1] = NATIONAL_DEX_COFAGRIGUS,
    [SPECIES_DURALUDON_MEGA - 1] = NATIONAL_DEX_DURALUDON,
    ...
    [SPECIES_DARKRAI_PRIMAL - 1] = NATIONAL_DEX_DARKRAI,
    [SPECIES_HO_OH_PRIMAL - 1] = NATIONAL_DEX_HO_OH,
    [SPECIES_LUGIA_PRIMAL - 1] = NATIONAL_DEX_LUGIA,
    [SPECIES_CELEBI_PRIMAL - 1] = NATIONAL_DEX_CELEBI,
    [SPECIES_JIRACHI_PRIMAL - 1] = NATIONAL_DEX_JIRACHI,
    [SPECIES_VICTINI_PRIMAL - 1] = NATIONAL_DEX_VICTINI,
    [SPECIES_REGIGIGAS_PRIMAL - 1] = NATIONAL_DEX_REGIGIGAS,
    [SPECIES_DIALGA_PRIMAL - 1] = NATIONAL_DEX_DIALGA,
    [SPECIES_PALKIA_PRIMAL - 1] = NATIONAL_DEX_PALKIA,
    [SPECIES_KYUREM_PRIMAL - 1] = NATIONAL_DEX_KYUREM,
    // Alolan Forms
    ...
    [SPECIES_AERODACTYL_PRIMAL - 1] = NATIONAL_DEX_AERODACTYL,
    [SPECIES_CROBAT_BOND - 1] = NATIONAL_DEX_CROBAT,
    [SPECIES_CROBAT2_BOND - 1] = NATIONAL_DEX_CROBAT,
    [SPECIES_KABUTOPS_PRIMAL - 1] = NATIONAL_DEX_KABUTOPS,
    [SPECIES_GHOST_PRIMAL - 1] = NATIONAL_DEX_GHOST,
    [SPECIES_MAMOSWINE_BOND - 1] = NATIONAL_DEX_MAMOSWINE,
    ...
    [SPECIES_TAUROS_PALDEA_COMBAT - 1] = NATIONAL_DEX_TAUROS,
    [SPECIES_TAUROS_PALDEA_BLAZE - 1] = NATIONAL_DEX_TAUROS,
    [SPECIES_TAUROS_PALDEA_AQUA - 1] = NATIONAL_DEX_TAUROS,
    [SPECIES_NINETALES_BOND - 1] = NATIONAL_DEX_NINETALES,
};
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_EONEON - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TRXATU - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ELECTRODE_Y - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TAUROS_X - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PORYGON3 - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ELECTIVIRE_X - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MAGMORTAR_Y - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NIDOQUEEN_Y - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NIDOKING_X - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PORYGONZ_X - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PORYGONZ_Y - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NIDOGOD - 1]          = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_AERODACTYL_SKEL - 1]  = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CRADILY_Y - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_RAMPARDOS_X - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BASTIODON_X - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TYRANTRUM_X - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ARCHEOPS_X - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_REGIROCK_X - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_REGICE_Y - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_REGISTEEL_Z - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DEOXYS_ATTACK_Y - 1]  = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DEOXYS_SPEED_Y - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MEWTWO_ARM - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GENESECT_X - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GENESECT_Y - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ULTIMATE_PROYECT - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_POLIWRATH_BOND - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BUTTERFREE_BOND - 1]  = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FERALIGATR_BOND - 1]  = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_RAPIDASH_BOND - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KINGDRA_BOND - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SKARMORY_BOND - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_EEVEE_BOND - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HYPNO_BOND - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUNSPARCE_OLD - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DELPHOX_BOND - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_RHYPERIOR_BOND - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LAPRAS_BOND - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_EMPOLEON_BOND - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_INFERNAPE_BOND - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MESPRIT_BOND - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SERPERIOR_BOND - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HAXORUS_BOND - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WEAVILE_BOND - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_AEGISLASH_BOND - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_VOLCARONA_BOND - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GOODRA_BOND - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HYDREIGON_BOND - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DRAGONITE_BOND - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MAROGHOST - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KABUTOPS_SKEL - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUDUNSPARCE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GHOST - 1]            = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_UNOWN_GOLD - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_UNOWN_KING - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ARTICUNO_PRIMAL - 1]  = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ZAPDOS_PRIMAL - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MOLTRES_PRIMAL - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_RAIKOU_BOND - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ENTEI_BOND - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SUICUNE_BOND - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KURUSU - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_AKUA - 1]             = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_AKUERIA - 1]          = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BOOHOO - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_IKARY - 1]            = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PURAKKUSU - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_RAICHU_EVO - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_OCTILLERY_EVO - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_QWILFISH_EVO - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TAABAN - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BOMUSHIKAA - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MADAAMU - 1]          = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SUI - 1]              = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_RAI - 1]              = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_EN - 1]               = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SACRED_DRAGON - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ORIGINAL_DRAGON - 1]  = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ARCEUS_PRIMAL - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MISSINGNO - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    // Forms
    [SPECIES_DUSKNOIR_MEGA - 1]          = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FLYGON_MEGA - 1]            = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_STARMIE_MEGA - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BUTTERFREE_MEGA - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NOIVERN_MEGA - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MILOTIC_MEGA - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PORYGON_Z_MEGA - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_COFAGRIGUS_MEGA - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DURALUDON_MEGA - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DARKRAI_PRIMAL - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HO_OH_PRIMAL - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LUGIA_PRIMAL - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CELEBI_PRIMAL - 1]          = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_JIRACHI_PRIMAL - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_VICTINI_PRIMAL - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_REGIGIGAS_PRIMAL - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DIALGA_PRIMAL - 1]          = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PALKIA_PRIMAL - 1]          = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KYUREM_PRIMAL - 1]          = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_AERODACTYL_PRIMAL - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CROBAT_BOND - 1]            = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CROBAT2_BOND - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KABUTOPS_PRIMAL - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GHOST_PRIMAL - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MAMOSWINE_BOND - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_BASCULIN_WHITE_STRIPED - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_WOOPER_PALDEA - 1]          = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_TAUROS_PALDEA_COMBAT - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TAUROS_PALDEA_BLAZE - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TAUROS_PALDEA_AQUA - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_DUNSPARCE_OLD_PREEVO - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUDUNSPARCE_EVO - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
};
...
bool8 TryIncrementMonLevel(struct Pokemon *mon)
{
    ...
    if (nextLevel > MAX_LEVEL || expPoints < gExperienceTables[gBaseStats[species].growthRate][nextLevel] || (nextLevel > 100 && FlagGet(FLAG_EXPAND_MAX_LEVEL) == FALSE))
    {
        return FALSE;
    }
    else
