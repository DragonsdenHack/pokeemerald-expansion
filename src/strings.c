...
const u8 gText_WithdrawPokemon[] = _("Dejar Pokémon");
...
const u8 gText_MenuSave[] = _("Cambiar");
...
const u8 gText_SpAtk[] = _("Ataque Especial");
const u8 gText_SpDef[] = _("Defensa Especial");
