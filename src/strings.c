...
const u8 gText_Version[] = _("VERSION 1.0");
...
const u8 gText_Espurr[] = _("ESPURR        ¥30,000");
const u8 gText_Wooloo[] = _("WOOLOO        ¥40,000");
const u8 gText_Toxel[] =  _("TOXEL          ¥57,000");
const u8 gText_Ferroseed[] = _("FERROSEED  ¥60,000");
const u8 gText_Grookey[] = _("GROOKEY      ¥80,000");
const u8 gText_Cryogonal[] = _("CRYOGONAL  ¥105,000");
const u8 gText_Cramorant[] = _("CRAMORANT ¥110,000");
const u8 gText_Gible[] = _("GIBLE         ¥175,000");
const u8 gText_Rockruff[] = _("ROCKRUFF     ¥15,000");
const u8 gText_Drilbur[] = _("DRILBUR       ¥22,500");
const u8 gText_Timburr[] = _("TIMBURR       ¥30,000");
const u8 gText_Frosmoth[] = _("FROSMOTH     ¥48,000");
const u8 gText_Bouffalant[] = _("BOUFFALANT ¥60,000");
const u8 gText_Oshawott[] = _("OSHAWOTT     ¥68,000");
const u8 gText_Chimchar[] = _("CHIMCHAR     82,000");
const u8 gText_Jangmo[] = _("JANGMO-O     ¥168,000");
const u8 gText_Fletching[] = _("FLETCHLING  ¥18,000");
const u8 gText_Mudbray[] = _("MUDBRAY        ¥32,000");
const u8 gText_Pincurchin[] = _("PINCURCHIN  ¥52,000");
const u8 gText_Pawniard[] = _("PAWNIARD      ¥65,000");
const u8 gText_Turtwig[] = _("TURTWIG        ¥75,000");
const u8 gText_Popplio[] = _("POPPLIO        ¥76,000");
const u8 gText_Spiritomb[] = _("SPIRITOMB    ¥108,108");
const u8 gText_Axew[] = _("AXEW              ¥140,000");
const u8 gText_Rattata[] = _("RATTATA   ¥3,000");
const u8 gText_Mankey[] = _("MANKEY     ¥8,000");
const u8 gText_Koffing[] = _("KOFFING  ¥11,000");
const u8 gText_Voltorb[] = _("VOLTORB  ¥9,000");
const u8 gText_NidoranF[] = _("NIDORAN♀     ¥12,000");
const u8 gText_Shellder[] = _("SHELLDER     ¥17,500");
const u8 gText_Rhyhorn[] = _("RHYHORN       ¥35,000");
const u8 gText_Nidorino[] = _("NIDORINO     ¥42,000");
const u8 gText_Electabuzz[] = _("ELECTABUZZ ¥80,000");
const u8 gText_Sneasel[] = _("SNEASEL       ¥55,000");
...
const u8 gText_Llamasfera[] = _("FLAME ORB             1.000 COINS");
const u8 gText_Cxperto[] = _("EXPERT BELT         2.400 COINS");
const u8 gText_Chaleco[] = _("ASSAULT VEST       2.800 COINS");
const u8 gText_Gafas[] = _("CHOICE SPECS       3.000 COINS");
const u8 gText_Lupa[] = _("WIDE LENS                    800 COINS");
const u8 gText_Toxisfera[] = _("TOXIC ORB                1.000 COINS");
const u8 gText_Casco[] = _("ROCKY HELMET          1.000 COINS");
const u8 gText_Vidasfera[] = _("LIFE ORB                  2.800 COINS");
const u8 gText_Cinta[] = _("CHOICE BAND            3.000 COINS");
...
const u8 gText_Hitmontop[] = _("HITMONTOP     4.500 COINS");
const u8 gText_Prima[] = _("ONE ISLAND");
const u8 gText_Secunda[] = _("TWO ISLAND");
...
const u8 gText_MasterBall[] = _("MASTER BALL           ¥300,000");
const u8 gText_PiedraRocket[] = _("ROCKET STONE     ¥2,500,000");
const u8 gText_Buneary[] = _("BUNEARY        ¥14,000");
const u8 gText_Croagunk[] = _("CROAGUNK      ¥25,000");
const u8 gText_Budew[] = _("BUDEW            ¥29,000");
const u8 gText_Hippopotas[] = _("HIPPOPOTAS  ¥33,000");
const u8 gText_Shieldon[] = _("SHIELDON      ¥110,000");
const u8 gText_Larvitar[] = _("LARVITAR      ¥170,000");
const u8 gText_Trubbish[] = _("TRUBBISH      1.200 COINS");
const u8 gText_Glameow[] = _("GLAMEOW        1.500 COINS");
const u8 gText_Stunky[] = _("STUNKY          1.800 COINS");
const u8 gText_Blitzle[] = _("BLITZLE        2.500 COINS");
const u8 gText_Purrloin[] = _("PURRLOIN      3.000 COINS");
const u8 gText_Treecko[] = _("TREECKO        8.000 COINS");
const u8 gText_Recluta[] = _("GRUNT");
const u8 gText_AltoRango[] = _("HIGH RANK GRUNT");
const u8 gText_Ejecutivo[] = _("EXECUTIVE");
const u8 gText_Admin[] = _("ADMINISTRATOR");
const u8 gText_AdminJefe[] = _("CHIEF.ADMIN");
const u8 gText_Jefe[] = _("CHIEF.ADMIN JOHTO&HOENN");
//#endif