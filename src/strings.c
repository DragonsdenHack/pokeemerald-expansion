...
const u8 gText_ExpandedPlaceholder_Empty[] = _("");
    ...
    const u8 gText_ThisIsAPokemon[] = _("Esto...{PAUSE 96}\p");
...
ALIGNED(4) const u8 gText_WonderCards[] = _("Kanto");
    ...
    ALIGNED(4) const u8 gText_DontHaveCardNewOneInput[] = _("Hola y bienvenido/a a Efemérides Rocket.\nElige dónde te gustaría comenzar.");
...
const u8 gText_Spiritomb[] = _("SPIRITOMB    115000¥");
