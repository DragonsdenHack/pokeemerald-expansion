...
#include "item_menu.h"
	...
	ALIGNED(4) const u8 gText_PostgameKanto[] = _("At this point, KANTO events are finished.\nHere the changes list:");
	ALIGNED(4) const u8 gText_PostgameKanto2[] = _("-Trainers defeated (until this point).\n-All event POKÉMON at the PC.");
	ALIGNED(4) const u8 gText_PostgameKanto3[] = _("-Your current team will be deleted, then\nyou could choose between ten LV.63 PKMN.");
	ALIGNED(4) const u8 gText_PostgameKanto4[] = _("Watch out! This action is permanent.\nContinue?");
	ALIGNED(4) const u8 gText_PostgameKanto5[] = _("At this point, JOHTO events starts.\nHere the changes list:");
	ALIGNED(4) const u8 gText_PostgameKanto6[] = _("-Your current team will be deleted, then\nyou could choose between ten LV.77 PKMN.");
	ALIGNED(4) const u8 gText_PostgameKanto7[] = _("At this point, JOHTO events are finished.\nNow we'll live the KANTO-JOHTO changes.");
	ALIGNED(4) const u8 gText_PostgameKanto8[] = _("-Your current team will be deleted, then\nyou could choose between ten LV.98 PKMN.");
	ALIGNED(4) const u8 gText_Final[] = _("Operation done…\nTo continue, go to GIOVANNI's office.");
	ALIGNED(4) const u8 gText_ComoFunciona2[] = _("There are differents packs,\nwith different style teams.");
	ALIGNED(4) const u8 gText_ComoFunciona3[] = _("All POKÉMON have been\nselected carefully,");
	ALIGNED(4) const u8 gText_ComoFunciona4[] = _("with an egg or special move,\na TM move,");
	ALIGNED(4) const u8 gText_ComoFunciona5[] = _("a special move and\na risky move.");
	ALIGNED(4) const u8 gText_ComoFunciona6[] = _("Depending on the game point, selected\nPOKÉMON would have different");
	ALIGNED(4) const u8 gText_ComoFunciona7[] = _("moves.\nChoose your ideal timeline!");
...
const u8 gText_MainMenuMysteryGift[] = _("Rocket Historical events");
const u8 gText_MainMenuMysteryGift2[] = _("Rocket Historical events");
const u8 gText_MainMenuMysteryEvents[] = _("Rocket Historical events");
...
const u8 gText_Trapinch[] = _("TRAPINCH      1.200 COINS");
const u8 gText_Bagon[] = _("BAGON            6.000 COINS");
const u8 gText_Deino[] = _("DEINO            6.000 COINS");
const u8 gText_Beldum[] = _("BELDUM          6.000 COINS");
const u8 gText_Wishiwashi[] = _("WISHIWASHI  7.500 COINS");
const u8 gText_Llamasfera[] = _("LLAMASFERA   1.000 COINS");
const u8 gText_Cxperto[] = _("C.XPERTO         2.400 COINS");
const u8 gText_Chaleco[] = _("CHAL.ASALTO    2.800 COINS");
const u8 gText_Gafas[] = _("G.ELEGIDAS       3.000 COINS");
const u8 gText_Lupa[] = _("LUPA                    800 COINS");
const u8 gText_Toxisfera[] = _("TOXISFERA          1.000 COINS");
const u8 gText_Casco[] = _("CASCO DENTADO    1.000 COINS");
const u8 gText_Vidasfera[] = _("VIDASFERA          2.800 COINS");
const u8 gText_Cinta[] = _("CINTA ELEGIDA    3.000 COINS");
const u8 gText_Teddiursa[] = _("TEDDIURSA     500 COINS");
const u8 gText_Shuckle[] = _("SHUCKLE        1.250 COINS");
const u8 gText_Sudowoodo[] = _("SUDOWOODO    2.400 COINS");
const u8 gText_Cyndaquil[] = _("CYNDAQUIL    4.200 COINS");
const u8 gText_Larvitar[] = _("LARVITAR     5.500 COINS");
const u8 gText_Prima[] = _("FIRST ISLAND");
const u8 gText_Secunda[] = _("SECOND ISLAND");
const u8 gText_Tera[] = _("THREE ISLAND");
const u8 gText_Mas[] = _("OTHER");
const u8 gText_Cuarta[] = _("FOUR ISLAND");
const u8 gText_Inta[] = _("FIVE ISLAND");
