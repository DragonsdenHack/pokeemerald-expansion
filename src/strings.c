...
ALIGNED(4) const u8 gText_DontHaveCardNewOneInput[] = _("Bienvenido/a a Efémerides Rocket.\nElige donde comenzar.");
...
const u8 gText_TeachWhichMoveToPkmn[] = _("¿Aprender movimiento a {STR_VAR_1}?");
const u8 gText_MoveRelearnerTeachMoveConfirm[] = _("¿Aprender {STR_VAR_2}?");
