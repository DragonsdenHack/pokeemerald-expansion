...
#include "item_menu.h"
	...
	ALIGNED(4) const u8 gText_PostgameKanto[] = _("At this point, the Kanto events have ended.\nHere is a list of the changes:");
	ALIGNED(4) const u8 gText_PostgameKanto2[] = _("-Trainers defeated up to this point.\n-Obtainable POKéMON up to this point in PC.");
	ALIGNED(4) const u8 gText_PostgameKanto3[] = _("-Your POKéMON team will be deleted, allowing you\n to pick 10 custom POKéMON, level 63.");
	ALIGNED(4) const u8 gText_PostgameKanto4[] = _("Keep in mind this action\ncannot be undone, alright?");
	ALIGNED(4) const u8 gText_PostgameKanto5[] = _("At this point, the Johto events will begin.\nHere is a list of the changes:");
	ALIGNED(4) const u8 gText_PostgameKanto6[] = _("-Your POKéMON team will be deleted, allowing you\n to pick 10 custom POKéMON, level 77.");
	ALIGNED(4) const u8 gText_PostgameKanto7[] = _("These events take place after Johto's journey.\nWe'll discover a new Kanto and Johto.");
	ALIGNED(4) const u8 gText_PostgameKanto8[] = _("-Your POKéMON team will be deleted, allowing you\n to pick 10 custom POKéMON, level 98.");
	ALIGNED(4) const u8 gText_PostgameKanto9[] = _("At this point, we'll uncover the other Hoenn.\nHere is a list of the changes:");
	ALIGNED(4) const u8 gText_PostgameKanto10[] = _("-Your POKéMON team will be deleted, allowing you\n to pick 10 custom POKéMON, level 110.");
	ALIGNED(4) const u8 gText_Final[] = _("Process completed…\nRemember to visit Giovanni's office.");
	ALIGNED(4) const u8 gText_ComoFunciona2[] = _("Different packs are available to you\nwith a POKéMON-themed design.");
	ALIGNED(4) const u8 gText_ComoFunciona3[] = _("All POKéMON have been carefully chosen\nfor a great experience.");
	ALIGNED(4) const u8 gText_ComoFunciona4[] = _("Each will have an egg or special move,\none move by TM.");
	ALIGNED(4) const u8 gText_ComoFunciona5[] = _("a characteristic move of its species and\na risky move.");
	ALIGNED(4) const u8 gText_ComoFunciona6[] = _("Additionally, depending on which point\nyou choose to start,moves");
	ALIGNED(4) const u8 gText_ComoFunciona7[] = _("will vary.\nFind your ideal starting point!");
...
const u8 gText_MainMenuMysteryGift[] = _("EPHEMERIS ROCKET");
const u8 gText_MainMenuMysteryGift2[] = _("EPHEMERIS ROCKET");
...
const u8 gText_ThisIsAPokemon[] = _("This… {PAUSE 140}");
...
const u8 gText_DadsAdvice[] = _("GIOVANNI's advice…\n{PLAYER}, there's a time and place for\leverything!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TreasuresPocket[] = _("POW{UP_ARROW} {PKMN}");
...
const u8 gText_AnythingElseICanHelp[] = _("Can I help you with anything else?$");
...
const u8 gText_NextFusionMon[] = _("Throw away this\n{STR_VAR_1}?");
...
const u8 gText_TreeckoDollAndPrice[] = _("TREECKO DOLL 1,000 MÜNZEN");
const u8 gText_TorchicDollAndPrice[] = _("TORCHIC DOLL 1,000 MÜNZEN");
const u8 gText_MudkipDollAndPrice[] = _("MUDKIP DOLL   1,000 MÜNZEN");
...
const u8 gText_Treasures[] = _("POW{UP_ARROW} {PKMN}");
...
const u8 gText_Version[] = _("Version 1.2");
...
const u8 gText_MenuOptionExit[] = _("ZÜRUCK");
...
const u8 gText_OptionFontFireRed[] = _("FR/LG");        //tx_optionsPlus
...
const u8 gText_MenuExit[] = _("ZÜRUCK");
...
ALIGNED(4) const u8 gText_Exit3[] = _("ZÜRUCK");
...
ALIGNED(4) const u8 gText_DontHaveCardNewOneInput[] = _("Welcome to Ephemeris Rocket.\nChoose to start.");
...
ALIGNED(4) const u8 gText_MysteryGift[] = _("EPHEMERIS ROCKET");
...
const u8 gText_YouveGot9999Coins[] = _("You've got 9,999 MÜNZEN.");
const u8 gText_YouveRunOutOfCoins[] = _("You've run out of MÜNZEN.\nGame over!");
const u8 gText_YouDontHaveThreeCoins[] = _("You don't have three MÜNZEN.");
...
const u8 gText_Espurr[] = _("PSIAU        30,000¥");
const u8 gText_Wooloo[] = _("WOLLY        40,000¥");
const u8 gText_Toxel[] =  _("TOXEL          57,000¥");
const u8 gText_Ferroseed[] = _("KASTADUR  60,000¥");
const u8 gText_Grookey[] = _("CHIMPEP      80,000¥");
const u8 gText_Cryogonal[] = _("FRIGOMETRI  105,000¥");
const u8 gText_Cramorant[] = _("URGL 110,000¥");
const u8 gText_Gible[] = _("KAUMALAT         175,000¥");
const u8 gText_Rockruff[] = _("WUFFELS     15,000¥");
const u8 gText_Drilbur[] = _("ROTOMURF       22,500¥");
const u8 gText_Timburr[] = _("PRAKTIBALK       30,000¥");
const u8 gText_Frosmoth[] = _("MOTTINEVA     48,000¥");
const u8 gText_Bouffalant[] = _("BISOFANK 60,000¥");
const u8 gText_Oshawott[] = _("OTTARO     68,000¥");
const u8 gText_Chimchar[] = _("PANFLAM     82,000¥");
const u8 gText_Jangmo[] = _("MINIRAS     168,000¥");
const u8 gText_Fletching[] = _("DARTIRI  18,000¥");
const u8 gText_Mudbray[] = _("PAMPULI        32,000¥");
const u8 gText_Pincurchin[] = _("BRITZIGEL  52,000¥");
const u8 gText_Pawniard[] = _("GLADIANTRI      65,000¥");
const u8 gText_Turtwig[] = _("CHELAST        75,000¥");
const u8 gText_Popplio[] = _("ROBBALL        76,000¥");
const u8 gText_Spiritomb[] = _("KRYPPUK    108,108¥");
const u8 gText_Axew[] = _("MILZA              140,000¥");
const u8 gText_Rattata[] = _("RATTFRATZ   3,000¥");
const u8 gText_Mankey[] = _("MENKI     8,000¥");
const u8 gText_Koffing[] = _("SMOGON  11,000¥");
const u8 gText_Voltorb[] = _("VOLTOBAL  9,000¥");
const u8 gText_NidoranF[] = _("NIDORAN♀     12,000¥");
const u8 gText_Shellder[] = _("MUSCHAS     17,500¥");
const u8 gText_Rhyhorn[] = _("RIHORN       35,000¥");
const u8 gText_Nidorino[] = _("NIDORINO     42,000¥");
const u8 gText_Electabuzz[] = _("ELEKTEK 80,000¥");
const u8 gText_Sneasel[] = _("SNIEBEL       55,000¥");
const u8 gText_Trapinch[] = _("KNACKLION      1.200 MÜNZEN");
const u8 gText_Bagon[] = _("KINDWURM            6.000 MÜNZEN");
const u8 gText_Deino[] = _("KAPUNO            6.000 MÜNZEN");
const u8 gText_Beldum[] = _("TANHEL          6.000 MÜNZEN");
const u8 gText_Wishiwashi[] = _("LUSARDIN  7.500 MÜNZEN");
const u8 gText_Llamasfera[] = _("HEISS-ORB             1.000 MÜNZEN");
const u8 gText_Cxperto[] = _("EXPERTENGURT         2.400 MÜNZEN");
const u8 gText_Chaleco[] = _("OFFENSIVWESTE       2.800 MÜNZEN");
const u8 gText_Gafas[] = _("WAHLBRILLE       3.000 MÜNZEN");
const u8 gText_Lupa[] = _("GROSSLINSE                    800 MÜNZEN");
const u8 gText_Toxisfera[] = _("TOXIK-ORB                1.000 MÜNZEN");
const u8 gText_Casco[] = _("BEULENHELM          1.000 MÜNZEN");
const u8 gText_Vidasfera[] = _("LEBEN-ORB                  2.800 MÜNZEN");
const u8 gText_Cinta[] = _("WAHLBAND            3.000 MÜNZEN");
const u8 gText_Teddiursa[] = _("TEDDIURSA         500 MÜNZEN");
const u8 gText_Shuckle[] = _("POTTROTT         1.250 MÜNZEN");
const u8 gText_Sudowoodo[] = _("MOGELBAUM     2.400 MÜNZEN");
const u8 gText_Cyndaquil[] = _("FEURIGEL     4.200 MÜNZEN");
const u8 gText_Hitmontop[] = _("KAPOERA     4.500 MÜNZEN");
const u8 gText_Prima[] = _("EILAND EINS");
const u8 gText_Secunda[] = _("EILAND ZWEI");
const u8 gText_Tera[] = _("EILAND DREI");
const u8 gText_Mas[] = _("WEITERE HAFEN");
const u8 gText_Cuarta[] = _("EILAND VIER");
const u8 gText_Inta[] = _("EILAND FÜNF");
const u8 gText_Exta[] = _("EILAND SECHS");
const u8 gText_Setima[] = _("EILAND SIEBEN");
const u8 gText_Carmin[] = _("ORANIA");
const u8 gText_Mas2[] = _("WEITERE HAFEN");	
const u8 gText_MasterBall[] = _("MEISTERBALL           300,000¥");
const u8 gText_PiedraRocket[] = _("ROCKETSTEIN     2,500,000¥");
const u8 gText_Buneary[] = _("HASPIROR        14,000¥");
const u8 gText_Croagunk[] = _("GLIBUNKEL      25,000¥");
const u8 gText_Budew[] = _("KNOSPI            29,000¥");
const u8 gText_Hippopotas[] = _("HIPPOPOTAS  33,000¥");
const u8 gText_Shieldon[] = _("SCHILTERUS      110,000¥");
const u8 gText_Larvitar[] = _("LARVITAR      170,000¥");
const u8 gText_Trubbish[] = _("UNRATÜTOX      1.200 MÜNZEN");
const u8 gText_Glameow[] = _("CHARMIAN        1.500 MÜNZEN");
const u8 gText_Stunky[] = _("SKUNKAPUH          1.800 MÜNZEN");
const u8 gText_Blitzle[] = _("ELEZEBA        2.500 MÜNZEN");
const u8 gText_Purrloin[] = _("FELILOU      3.000 MÜNZEN");
const u8 gText_Treecko[] = _("GECKARBOR        8.000 MÜNZEN");
const u8 gText_Recluta[] = _("RÜPEL");
const u8 gText_AltoRango[] = _("HOCHR.RÜPEL");
const u8 gText_Ejecutivo[] = _("OFFIZIER");
const u8 gText_Admin[] = _("ADMINISTRATOR");
const u8 gText_AdminJefe[] = _("CHEF-ADMINISTRATOR");
const u8 gText_Jefe[] = _("CHEF-ADMIN JOHTO&HOENN");
//#endif