...
static void DarPokemonRocketAdmin(u8 opcion)
{
		...
		case 2:
			...
			ScriptGiveCustomMon(SPECIES_MAGMORTAR,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_MACH_PUNCH, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);
