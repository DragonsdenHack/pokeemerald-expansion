...
static void DarPokemonRareTeam(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_BLASTOISE,108,ITEM_MYSTIC_WATER,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MIRROR_COAT, MOVE_AQUA_RING,MOVE_IRON_DEFENSE,MOVE_HYDRO_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,108,ITEM_CHARCOAL,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_ANCIENT_POWER, MOVE_DRAGON_PULSE,MOVE_AIR_SLASH,MOVE_BLAST_BURN,0); 
		...
		ScriptGiveCustomMon(SPECIES_TRXATU,108,ITEM_SHARP_BEAK,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_ROOST, MOVE_PSYCHIC,MOVE_HEAT_WAVE,MOVE_AEROBLAST,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLISSEY,108,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TOGEKISS,108,ITEM_SHARP_BEAK,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_YAWN, MOVE_AIR_SLASH,MOVE_MYSTICAL_FIRE,MOVE_NASTY_PLOT,0);
