...
static void DarPokemonBasicosKanto(u8 opcion){
	switch (opcion)
	{
		...
		case 2: //johto
			...
			ScriptGiveCustomMon(SPECIES_HITMONCHAN,98,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_HIGH_JUMP_KICK, MOVE_DRAIN_PUNCH,MOVE_REVENGE,MOVE_CLOSE_COMBAT,0);
