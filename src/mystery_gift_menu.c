...
static void DarPokemonBasicosKanto(u8 opcion){
	...
	switch (opcion)
	{
		...
		ScriptGiveCustomMon(SPECIES_HOUNDOOM,108,ITEM_CHARCOAL,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_SUCKER_PUNCH, MOVE_SLUDGE_BOMB,MOVE_FLAMETHROWER,MOVE_FIRE_BLAST,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAROWAK,108,ITEM_THICK_CLUB,26,NATURE_ADAMANT,0, 0, (u8*)31, MOVE_BELLY_DRUM, MOVE_EARTHQUAKE,MOVE_THRASH,MOVE_DOUBLE_EDGE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_AERODACTYL,108,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CURSE, MOVE_STEALTH_ROCK,MOVE_ROCK_SLIDE,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENUSAUR,108,ITEM_MIRACLE_SEED,26,NATURE_HARDY,2, 0, (u8*)31, MOVE_GRASSY_TERRAIN, MOVE_ENERGY_BALL,MOVE_PETAL_BLIZZARD,MOVE_PETAL_DANCE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON,108,ITEM_UPGRADE,26,NATURE_JOLLY,1, 0, (u8*)31, MOVE_MAGNET_RISE, MOVE_SHADOW_BALL,MOVE_TRI_ATTACK,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_OMASTAR,108,ITEM_MYSTIC_WATER,26,NATURE_MODEST,0, 0, (u8*)31, MOVE_REFLECT_TYPE, MOVE_SURF,MOVE_ANCIENT_POWER,MOVE_HYDRO_PUMP,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KABUTOPS,108,ITEM_HARD_STONE,26,NATURE_ADAMANT,2, 0, (u8*)31, MOVE_CONFUSE_RAY, MOVE_ROCK_SLIDE,MOVE_AQUA_JET,MOVE_NIGHT_SLASH,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PINSIR,108,ITEM_SILVER_POWDER,26,NATURE_ADAMANT,2, 0, (u8*)31, MOVE_BUG_BITE, MOVE_EARTHQUAKE,MOVE_X_SCISSOR,MOVE_THRASH,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,108,ITEM_SUN_STONE,26,NATURE_JOLLY,1, 0, (u8*)31, MOVE_STORED_POWER, MOVE_ECHOED_VOICE,MOVE_SWIFT,MOVE_TRUMP_CARD,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,108,ITEM_MOON_STONE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CURSE, MOVE_CRUNCH,MOVE_TOXIC,MOVE_MOONLIGHT,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,108,ITEM_THUNDER_STONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_WISH, MOVE_SUBSTITUTE,MOVE_SWIFT,MOVE_REFRESH,0);

		memcpy(evs, (u8[]){6, 0, 252, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,108,ITEM_WATER_STONE,26,NATURE_BOLD,1, 0, (u8*)31, MOVE_ENDURE, MOVE_RAIN_DANCE,MOVE_SWIFT,MOVE_BATON_PASS,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,108,ITEM_FIRE_STONE,26,NATURE_ADAMANT,1, 0, (u8*)31, MOVE_SING, MOVE_FACADE,MOVE_BITE,MOVE_DOUBLE_EDGE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARTICUNO,108,ITEM_LUM_BERRY,26,NATURE_CALM,0xFF, 0, (u8*)31, MOVE_HEAL_BELL, MOVE_FROST_BREATH,MOVE_ICE_BEAM,MOVE_SHEER_COLD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ZAPDOS,108,ITEM_LUM_BERRY,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_BATON_PASS, MOVE_ROOST,MOVE_THUNDERBOLT,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MOLTRES,108,ITEM_LUM_BERRY,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_MORNING_SUN, MOVE_ROOST,MOVE_FLAMETHROWER,MOVE_BURN_UP,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ENTEI,108,ITEM_LUM_BERRY,26,NATURE_MILD,0xFF, 0, (u8*)31, MOVE_FLARE_BLITZ, MOVE_STOMPING_TANTRUM,MOVE_SACRED_FIRE,MOVE_ERUPTION,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 6, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SUICUNE,108,ITEM_LUM_BERRY,26,NATURE_CALM,0xFF, 0, (u8*)31, MOVE_AIR_SLASH, MOVE_ICE_BEAM,MOVE_CALM_MIND,MOVE_HYDRO_PUMP,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAIKOU,108,ITEM_LUM_BERRY,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ZAP_CANNON, MOVE_THUNDERBOLT,MOVE_EXTRASENSORY,MOVE_REFLECT,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BRAVIARY,108,ITEM_SILK_SCARF,26,NATURE_JOLLY,2, 0, (u8*)31, MOVE_ROCK_SLIDE, MOVE_BRAVE_BIRD,MOVE_SUPERPOWER,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VIKAVOLT,108,ITEM_CHOICE_SPECS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MUD_SHOT, MOVE_THUNDERBOLT,MOVE_BUG_BUZZ,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MANDIBUZZ,108,ITEM_LEFTOVERS,26,NATURE_IMPISH,1, 0, (u8*)31, MOVE_FOUL_PLAY, MOVE_TAUNT,MOVE_DARK_PULSE,MOVE_NASTY_PLOT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PROBOPASS,108,ITEM_LIFE_ORB,26,NATURE_QUIET,2, 0, (u8*)31, MOVE_EXPLOSION, MOVE_DAZZLING_GLEAM,MOVE_POWER_GEM,MOVE_MAGNETIC_FLUX,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SLAKING,108,ITEM_CHOICE_BAND,26,NATURE_NAUGHTY,2, 0, (u8*)31, MOVE_NIGHT_SLASH, MOVE_POWER_UP_PUNCH,MOVE_SLASH,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){6, 252, 252, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HITMONCHAN,108,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HIGH_JUMP_KICK, MOVE_DRAIN_PUNCH,MOVE_REVENGE,MOVE_CLOSE_COMBAT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLASTOISE,108,ITEM_WATER_GEM,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_HYDRO_CANNON, MOVE_ICE_BEAM,MOVE_FLASH_CANNON,MOVE_HYDRO_PUMP,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LUCARIO,108,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HIGH_JUMP_KICK, MOVE_EXTREME_SPEED,MOVE_METEOR_MASH,MOVE_REVERSAL,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEWEAR,108,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_FORCE_PALM, MOVE_THRASH,MOVE_DRAIN_PUNCH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){6, 0, 252, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_FLORGES,108,ITEM_LUM_BERRY,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ENDEAVOR, MOVE_PETAL_DANCE,MOVE_CALM_MIND,MOVE_AROMATHERAPY,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BAXCALIBUR,108,ITEM_CHOICE_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_ICICLE_SPEAR, MOVE_CRUNCH,MOVE_DRAGON_DANCE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EMPOLEON,108,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_AQUA_RING, MOVE_STEALTH_ROCK,MOVE_HYDRO_PUMP,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_INFERNAPE,108,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_FAKE_OUT, MOVE_ACROBATICS,MOVE_CLOSE_COMBAT,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGAPULT,108,ITEM_POWER_HERB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SUCKER_PUNCH, MOVE_DRAGON_DANCE,MOVE_DRAGON_DARTS,MOVE_SHADOW_FORCE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEOXYS,108,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_COSMIC_POWER, MOVE_PSYCHIC,MOVE_PSYCHO_BOOST,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGIROCK,108,ITEM_NONE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_ROCK_POLISH, MOVE_STONE_EDGE,MOVE_STEALTH_ROCK,MOVE_SELF_DESTRUCT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGICE,108,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_AMNESIA, MOVE_ICE_BEAM,MOVE_ZAP_CANNON,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGISTEEL,108,ITEM_NONE,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_AMNESIA, MOVE_STEEL_BEAM,MOVE_THUNDER_WAVE,MOVE_SEISMIC_TOSS,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HO_OH,108,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_RECOVER, MOVE_SACRED_FIRE,MOVE_BRAVE_BIRD,MOVE_EARTHQUAKE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LUGIA,108,ITEM_NONE,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_RECOVER, MOVE_AEROBLAST,MOVE_PSYCHO_BOOST,MOVE_ORIGIN_PULSE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MEWTWO,108,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_RECOVER, MOVE_PSYCHO_BOOST,MOVE_PSYSTRIKE,MOVE_ME_FIRST,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SILVALLY,108,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MULTI_ATTACK, MOVE_FLAME_CHARGE,MOVE_U_TURN,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ZAPDOS_PRIMAL,108,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_HEAT_WAVE, MOVE_THUNDERBOLT,MOVE_DARK_PULSE,MOVE_ROOST,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EMBOAR,108,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_SUCKER_PUNCH, MOVE_FLAME_CHARGE,MOVE_HEAD_SMASH,MOVE_FLARE_BLITZ,0);	

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_AKUERIA,108,ITEM_NONE,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_HYDRO_PUMP, MOVE_FIRE_BLAST,MOVE_DRACO_METEOR,MOVE_BLIZZARD,0);	
		break;
	};
}
...
static void DarPokemonClassicKanto(u8 opcion){
	...
	switch(opcion)
	{
		...
		ScriptGiveCustomMon(SPECIES_GENGAR,108,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_DISABLE, MOVE_SHADOW_BALL,MOVE_HYPNOSIS,MOVE_FOCUS_BLAST,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ALAKAZAM,108,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_FUTURE_SIGHT, MOVE_PSYCHIC,MOVE_RECOVER,MOVE_BARRIER,0); 

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MACHAMP,108,ITEM_EXPERT_BELT,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_BULLET_PUNCH, MOVE_DYNAMIC_PUNCH,MOVE_KNOCK_OFF,MOVE_METRONOME,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAICHU,108,ITEM_FOCUS_SASH,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_WISH, MOVE_NUZZLE,MOVE_THUNDERBOLT,MOVE_SUBMISSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGLER,108,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HAMMER_ARM, MOVE_CRABHAMMER,MOVE_ROCK_SLIDE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 6, 0, 252, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,108,ITEM_ASSAULT_VEST,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN,MOVE_SLUDGE_BOMB,MOVE_LEAF_STORM,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MUK,108,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SHADOW_PUNCH, MOVE_GUNK_SHOT,MOVE_ACID_ARMOR,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLEM,108,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HAMMER_ARM, MOVE_ROCK_BLAST,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DODRIO,108,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SKY_ATTACK, MOVE_DRILL_RUN,MOVE_DRILL_PECK,MOVE_JUMP_KICK,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGONITE,108,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);
		break;
	}
}
...
static void DarPokemonRocketGrunt(u8 opcion)
{
	...
	switch(opcion)
	{
		...
		ScriptGiveCustomMon(SPECIES_RATICATE,108,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_REVERSAL, MOVE_HYPER_FANG,MOVE_SUCKER_PUNCH,MOVE_SWORDS_DANCE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SANDSLASH,108,ITEM_SOFT_SAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HONE_CLAWS, MOVE_EARTHQUAKE,MOVE_STONE_EDGE,MOVE_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DUGTRIO,108,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_MEMENTO, MOVE_GIGA_IMPACT,MOVE_EARTHQUAKE,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PERSIAN,108,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_FAKE_OUT,MOVE_SLASH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEEDRILL,108,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_KNOCK_OFF, MOVE_TOXIC_SPIKES,MOVE_ACROBATICS,MOVE_U_TURN,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARBOK,108,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SUCKER_PUNCH, MOVE_GLARE,MOVE_COIL,MOVE_GUNK_SHOT,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PRIMEAPE,108,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_COUNTER, MOVE_CLOSE_COMBAT,MOVE_U_TURN,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HYPNO,108,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_BARRIER, MOVE_PSYCHIC,MOVE_THUNDER_WAVE,MOVE_FOUL_PLAY,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_QWILFISH,108,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SELF_DESTRUCT, MOVE_TOXIC_SPIKES,MOVE_SPIKES,MOVE_AQUA_TAIL,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GRANBULL,108,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_RETALIATE, MOVE_PLAY_ROUGH,MOVE_CRUNCH,MOVE_CLOSE_COMBAT,0);
		break;
	}	
}
...
static void DarPokemonRocketScientist(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_MAGNEZONE,108,ITEM_MAGNET,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ELECTROWEB, MOVE_DISCHARGE,MOVE_IRON_DEFENSE,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON2,108,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CONVERSION, MOVE_TRI_ATTACK,MOVE_PSYSHOCK,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGNETON,108,ITEM_EVIOLITE,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_CHARGE_BEAM, MOVE_THUNDERBOLT,MOVE_FLASH_CANNON,MOVE_TELEPORT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ESPEON,108,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_WISH, MOVE_PSYCHIC,MOVE_DAZZLING_GLEAM,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DITTO,108,ITEM_CHOICE_SCARF,26,NATURE_HARDY,1, 0, (u8*)31, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTABUZZ,108,ITEM_MAGNET,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CROSS_CHOP, MOVE_THUNDER_PUNCH,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,108,ITEM_LIGHT_CLAY,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHANSEY,108,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JYNX,108,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_WISH, MOVE_LOVELY_KISS,MOVE_PSYCHIC,MOVE_BLIZZARD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENOMOTH,108,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_BUG_BUZZ,MOVE_QUIVER_DANCE,0);
		break;
	}
}
...
static void DarPokemonRocketAdmin(u8 opcion)
{
	...
	u8 ivs[6] = {0};
		...
		ScriptGiveCustomMon(SPECIES_RHYPERIOR,108,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_METAL_BURST, MOVE_ROCK_POLISH,MOVE_EARTHQUAKE,MOVE_ROCK_WRECKER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOKING,108,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HEAD_SMASH, MOVE_POISON_JAB,MOVE_EARTHQUAKE,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOQUEEN,108,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_COUNTER, MOVE_TOXIC_SPIKES,MOVE_EARTH_POWER,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TAUROS,108,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_ENDEAVOR, MOVE_BODY_SLAM,MOVE_CLOSE_COMBAT,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEEZING,108,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, 0, (u8*)31, MOVE_PAIN_SPLIT, MOVE_WILL_O_WISP,MOVE_SLUDGE_BOMB,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KANGASKHAN,108,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HAMMER_ARM, MOVE_FAKE_OUT,MOVE_DOUBLE_EDGE,MOVE_SUCKER_PUNCH,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTIVIRE,108,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CROSS_CHOP, MOVE_WILD_CHARGE,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMORTAR,108,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MACH_PUNCH, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEAVILE,108,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_FAKE_OUT, MOVE_NIGHT_SLASH,MOVE_ICICLE_CRASH,MOVE_TAUNT,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HONCHKROW,108,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SUCKER_PUNCH, MOVE_DRILL_PECK,MOVE_U_TURN,MOVE_SKY_ATTACK,0);
		break;
	}
}
...
static void DarPokemonRainTeam(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_POLITOED,108,ITEM_DAMP_ROCK,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ENDEAVOR, MOVE_HYDRO_PUMP,MOVE_AMNESIA,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGDRA,108,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_DISABLE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_STARMIE,108,ITEM_LIGHT_CLAY,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_REFRESH, MOVE_REFLECT,MOVE_LIGHT_SCREEN,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLDUCK,108,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_PSYCHIC,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TENTACRUEL,108,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, 0, (u8*)31, MOVE_MIRROR_COAT, MOVE_BARRIER,MOVE_SURF,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GYARADOS,108,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_BOUNCE, MOVE_THRASH,MOVE_AQUA_TAIL,MOVE_DRAGON_RUSH,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HELIOLISK,108,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_SURF, MOVE_VOLT_SWITCH,MOVE_HYPER_VOICE,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LAPRAS,108,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CURSE, MOVE_LIQUIDATION,MOVE_ICE_SHARD,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEWGONG,108,ITEM_SITRUS_BERRY,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_STOCKPILE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LANTURN,108,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_HEAL_BELL, MOVE_THUNDER,MOVE_SURF,MOVE_RAIN_DANCE,0);
		break;
	}
}
...
static void DarPokemonSunTeam(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_NINETALES,108,ITEM_HEAT_ROCK,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_FLAMETHROWER,MOVE_SOLAR_BEAM,MOVE_WILL_O_WISP,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMAR,108,ITEM_EVIOLITE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_CLEAR_SMOG, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HELIOLISK,108,ITEM_LIFE_ORB,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_SURF, MOVE_VOLT_SWITCH,MOVE_HYPER_VOICE,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TORKOAL,108,ITEM_HEAT_ROCK,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_RAPID_SPIN, MOVE_LAVA_PLUME,MOVE_CLEAR_SMOG,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DARMANITAN,108,ITEM_LIFE_ORB,26,NATURE_HARDY, 0xFF, 0, (u8*)31, MOVE_HAMMER_ARM, MOVE_YAWN,MOVE_GIGA_IMPACT,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JUMPLUFF,108,ITEM_LEFTOVERS,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_COTTON_GUARD, MOVE_SLEEP_POWDER,MOVE_SOLAR_BEAM,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,108,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_SLEEP_POWDER, MOVE_SOLAR_BEAM,MOVE_FUTURE_SIGHT,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,108,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM,MOVE_ANCIENT_POWER,MOVE_BLAST_BURN,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VICTREEBEL,108,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_SOLAR_BEAM,MOVE_SYNTHESIS,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VOLCARONA,108,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);
		break;
	}
}
...
static void DarPokemonRareTeam(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_DRAGONITE,108,ITEM_DRAGON_FANG,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MILOTIC,108,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);
			ScriptGiveCustomMon(SPECIES_BLASTOISE,108,ITEM_MYSTIC_WATER,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_MIRROR_COAT, MOVE_AQUA_RING,MOVE_IRON_DEFENSE,MOVE_HYDRO_CANNON,0);
			ScriptGiveCustomMon(SPECIES_CHARIZARD,108,ITEM_CHARCOAL,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_ANCIENT_POWER, MOVE_DRAGON_PULSE,MOVE_AIR_SLASH,MOVE_BLAST_BURN,0); 
			ScriptGiveCustomMon(SPECIES_VOLCARONA,108,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);
			ScriptGiveCustomMon(SPECIES_TRXATU,108,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_ROOST, MOVE_PSYCHIC,MOVE_HEAT_WAVE,MOVE_AEROBLAST,0);
			ScriptGiveCustomMon(SPECIES_BLISSEY,108,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);
			ScriptGiveCustomMon(SPECIES_TOGEKISS,108,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_YAWN, MOVE_AIR_SLASH,MOVE_MYSTICAL_FIRE,MOVE_NASTY_PLOT,0);
			ScriptGiveCustomMon(SPECIES_TYRANITAR,108,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CRUNCH, MOVE_STONE_EDGE,MOVE_EARTHQUAKE,MOVE_GIGA_IMPACT,0);
			ScriptGiveCustomMon(SPECIES_DUNSPARCE_OLD,108,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_CURSE, MOVE_EARTH_POWER,MOVE_ROOST,MOVE_BOOMBURST,0);
		break;
	}
}
...
static void DarPokemonPopularTeam(u8 opcion)
{
	switch(opcion){
		...
		case 3:
			...
			ScriptGiveCustomMon(SPECIES_MAGMORTAR,108,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MACH_PUNCH, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);
			ScriptGiveCustomMon(SPECIES_RHYPERIOR,108,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_METAL_BURST, MOVE_ROCK_POLISH,MOVE_EARTHQUAKE,MOVE_ROCK_WRECKER,0);
			ScriptGiveCustomMon(SPECIES_MILOTIC,108,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);
			ScriptGiveCustomMon(SPECIES_FURRET,108,ITEM_NONE,26,NATURE_HARDY, 0xFF, 0, (u8*)31, MOVE_SLASH, MOVE_COIL,MOVE_AQUA_TAIL,MOVE_AMNESIA,0);
			ScriptGiveCustomMon(SPECIES_ELECTRODE,108,ITEM_LIGHT_CLAY,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0); 
			ScriptGiveCustomMon(SPECIES_METAGROSS,108,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_BULLET_PUNCH, MOVE_METEOR_MASH,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);
			ScriptGiveCustomMon(SPECIES_SCIZOR,108,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_COUNTER, MOVE_X_SCISSOR,MOVE_CLOSE_COMBAT,MOVE_PSYCHO_CUT,0);
			ScriptGiveCustomMon(SPECIES_VOLCARONA,108,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);
			ScriptGiveCustomMon(SPECIES_GYARADOS,108,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_BOUNCE, MOVE_THRASH,MOVE_AQUA_TAIL,MOVE_DRAGON_RUSH,0);
		break;
	}
...
static void DarPokemonWeakTeam(u8 opcion){
	switch(opcion){
		...
		break;
		case 3:
			ScriptGiveCustomMon(SPECIES_MAGIKARP,108,ITEM_WATER_GEM,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HYDRO_PUMP, MOVE_DRAGON_RAGE,MOVE_BOUNCE,MOVE_FLAIL,1);
			ScriptGiveCustomMon(SPECIES_TOGEPI,108,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_TRI_ATTACK, MOVE_DAZZLING_GLEAM,MOVE_METRONOME,MOVE_WISH,0);
			ScriptGiveCustomMon(SPECIES_SMEARGLE,108,ITEM_NONE,26,NATURE_JOLLY,0xFF, 0, (u8*)31, MOVE_SKETCH, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_FEEBAS,108,ITEM_QUICK_CLAW,26,NATURE_CALM,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_WATER_PULSE,MOVE_TACKLE,MOVE_FLAIL,0);
			ScriptGiveCustomMon(SPECIES_DITTO,108,ITEM_NONE,26,NATURE_HARDY,0xFF, 0, (u8*)31, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_RIOLU,108,ITEM_BLACK_BELT,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_AGILITY, MOVE_POWER_UP_PUNCH,MOVE_FORCE_PALM,MOVE_REVERSAL,0); 
			ScriptGiveCustomMon(SPECIES_SMOOCHUM,108,ITEM_CHOICE_SPECS,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_MIRACLE_EYE, MOVE_RAIN_DANCE,MOVE_PSYCHIC,MOVE_PERISH_SONG,0);
			ScriptGiveCustomMon(SPECIES_FARFETCHD,108,ITEM_LEEK,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_LEAF_BLADE, MOVE_U_TURN,MOVE_SLASH,MOVE_AIR_CUTTER,0);
			ScriptGiveCustomMon(SPECIES_TAILLOW,108,ITEM_TOXIC_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_BOOMBURST, MOVE_FACADE,MOVE_BRAVE_BIRD,MOVE_REVERSAL,0);
			ScriptGiveCustomMon(SPECIES_TYROGUE,108,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_TACKLE, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
		break;
	}
}
...
static void DarPokemonRandomTeam(u8 opcion)
{
	switch(opcion)
	{
		...
		break;
		case 3:
			ScriptGiveMon(generarSpeciesAleatoria(),108,ITEM_NONE,0,0,0);
			ScriptGiveMon(generarSpeciesAleatoria(),108,ITEM_NONE,0,0,0);
			ScriptGiveMon(generarSpeciesAleatoria(),108,ITEM_NONE,0,0,0);
			ScriptGiveMon(generarSpeciesAleatoria(),108,ITEM_NONE,0,0,0);
			ScriptGiveMon(generarSpeciesAleatoria(),108,ITEM_NONE,0,0,0);
...
////HOENN
	...
	if (VarGet(VAR_HAS_ENTERED_BATTLE_FRONTIER) == 10) {
		...
		break;
			...
			{
case BULBASAUR:
	ScriptGiveMon(SPECIES_BULBASAUR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case IVYSAUR:
	ScriptGiveMon(SPECIES_IVYSAUR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VENUSAUR:
	ScriptGiveMon(SPECIES_VENUSAUR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHARMANDER:
	ScriptGiveMon(SPECIES_CHARMANDER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHARMELEON:
	ScriptGiveMon(SPECIES_CHARMELEON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHARIZARD:
	ScriptGiveMon(SPECIES_CHARIZARD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SQUIRTLE:
	ScriptGiveMon(SPECIES_SQUIRTLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WARTORTLE:
	ScriptGiveMon(SPECIES_WARTORTLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BLASTOISE:
	ScriptGiveMon(SPECIES_BLASTOISE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CATERPIE:
	ScriptGiveMon(SPECIES_CATERPIE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case METAPOD:
	ScriptGiveMon(SPECIES_METAPOD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BUTTERFREE:
	ScriptGiveMon(SPECIES_BUTTERFREE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WEEDLE:
	ScriptGiveMon(SPECIES_WEEDLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KAKUNA:
	ScriptGiveMon(SPECIES_KAKUNA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BEEDRILL:
	ScriptGiveMon(SPECIES_BEEDRILL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIDGEY:
	ScriptGiveMon(SPECIES_PIDGEY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIDGEOTTO:
	ScriptGiveMon(SPECIES_PIDGEOTTO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIDGEOT:
	ScriptGiveMon(SPECIES_PIDGEOT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RATTATA:
	ScriptGiveMon(SPECIES_RATTATA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RATICATE:
	ScriptGiveMon(SPECIES_RATICATE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPEAROW:
	ScriptGiveMon(SPECIES_SPEAROW,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FEAROW:
	ScriptGiveMon(SPECIES_FEAROW,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EKANS:
	ScriptGiveMon(SPECIES_EKANS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARBOK:
	ScriptGiveMon(SPECIES_ARBOK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIKACHU:
	ScriptGiveMon(SPECIES_PIKACHU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RAICHU:
	ScriptGiveMon(SPECIES_RAICHU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SANDSHREW:
	ScriptGiveMon(SPECIES_SANDSHREW,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SANDSLASH:
	ScriptGiveMon(SPECIES_SANDSLASH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NIDORAN_F:
	ScriptGiveMon(SPECIES_NIDORAN_F,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NIDORINA:
	ScriptGiveMon(SPECIES_NIDORINA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NIDOQUEEN:
	ScriptGiveMon(SPECIES_NIDOQUEEN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NIDORAN_M:
	ScriptGiveMon(SPECIES_NIDORAN_M,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NIDORINO:
	ScriptGiveMon(SPECIES_NIDORINO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NIDOKING:
	ScriptGiveMon(SPECIES_NIDOKING,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLEFAIRY:
	ScriptGiveMon(SPECIES_CLEFAIRY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLEFABLE:
	ScriptGiveMon(SPECIES_CLEFABLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VULPIX:
	ScriptGiveMon(SPECIES_VULPIX,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NINETALES:
	ScriptGiveMon(SPECIES_NINETALES,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JIGGLYPUFF:
	ScriptGiveMon(SPECIES_JIGGLYPUFF,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WIGGLYTUFF:
	ScriptGiveMon(SPECIES_WIGGLYTUFF,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZUBAT:
	ScriptGiveMon(SPECIES_ZUBAT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLBAT:
	ScriptGiveMon(SPECIES_GOLBAT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ODDISH:
	ScriptGiveMon(SPECIES_ODDISH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GLOOM:
	ScriptGiveMon(SPECIES_GLOOM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VILEPLUME:
	ScriptGiveMon(SPECIES_VILEPLUME,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PARAS:
	ScriptGiveMon(SPECIES_PARAS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PARASECT:
	ScriptGiveMon(SPECIES_PARASECT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VENONAT:
	ScriptGiveMon(SPECIES_VENONAT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VENOMOTH:
	ScriptGiveMon(SPECIES_VENOMOTH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DIGLETT:
	ScriptGiveMon(SPECIES_DIGLETT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUGTRIO:
	ScriptGiveMon(SPECIES_DUGTRIO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MEOWTH:
	ScriptGiveMon(SPECIES_MEOWTH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PERSIAN:
	ScriptGiveMon(SPECIES_PERSIAN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PSYDUCK:
	ScriptGiveMon(SPECIES_PSYDUCK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLDUCK:
	ScriptGiveMon(SPECIES_GOLDUCK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MANKEY:
	ScriptGiveMon(SPECIES_MANKEY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PRIMEAPE:
	ScriptGiveMon(SPECIES_PRIMEAPE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GROWLITHE:
	ScriptGiveMon(SPECIES_GROWLITHE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARCANINE:
	ScriptGiveMon(SPECIES_ARCANINE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POLIWAG:
	ScriptGiveMon(SPECIES_POLIWAG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POLIWHIRL:
	ScriptGiveMon(SPECIES_POLIWHIRL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POLIWRATH:
	ScriptGiveMon(SPECIES_POLIWRATH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ABRA:
	ScriptGiveMon(SPECIES_ABRA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KADABRA:
	ScriptGiveMon(SPECIES_KADABRA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ALAKAZAM:
	ScriptGiveMon(SPECIES_ALAKAZAM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MACHOP:
	ScriptGiveMon(SPECIES_MACHOP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MACHOKE:
	ScriptGiveMon(SPECIES_MACHOKE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MACHAMP:
	ScriptGiveMon(SPECIES_MACHAMP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BELLSPROUT:
	ScriptGiveMon(SPECIES_BELLSPROUT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WEEPINBELL:
	ScriptGiveMon(SPECIES_WEEPINBELL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VICTREEBEL:
	ScriptGiveMon(SPECIES_VICTREEBEL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TENTACOOL:
	ScriptGiveMon(SPECIES_TENTACOOL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TENTACRUEL:
	ScriptGiveMon(SPECIES_TENTACRUEL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GEODUDE:
	ScriptGiveMon(SPECIES_GEODUDE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRAVELER:
	ScriptGiveMon(SPECIES_GRAVELER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLEM:
	ScriptGiveMon(SPECIES_GOLEM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PONYTA:
	ScriptGiveMon(SPECIES_PONYTA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RAPIDASH:
	ScriptGiveMon(SPECIES_RAPIDASH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLOWPOKE:
	ScriptGiveMon(SPECIES_SLOWPOKE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLOWBRO:
	ScriptGiveMon(SPECIES_SLOWBRO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGNEMITE:
	ScriptGiveMon(SPECIES_MAGNEMITE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGNETON:
	ScriptGiveMon(SPECIES_MAGNETON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FARFETCHD:
	ScriptGiveMon(SPECIES_FARFETCHD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DODUO:
	ScriptGiveMon(SPECIES_DODUO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DODRIO:
	ScriptGiveMon(SPECIES_DODRIO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEEL:
	ScriptGiveMon(SPECIES_SEEL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DEWGONG:
	ScriptGiveMon(SPECIES_DEWGONG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRIMER:
	ScriptGiveMon(SPECIES_GRIMER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUK:
	ScriptGiveMon(SPECIES_MUK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHELLDER:
	ScriptGiveMon(SPECIES_SHELLDER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLOYSTER:
	ScriptGiveMon(SPECIES_CLOYSTER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GASTLY:
	ScriptGiveMon(SPECIES_GASTLY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HAUNTER:
	ScriptGiveMon(SPECIES_HAUNTER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GENGAR:
	ScriptGiveMon(SPECIES_GENGAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ONIX:
	ScriptGiveMon(SPECIES_ONIX,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DROWZEE:
	ScriptGiveMon(SPECIES_DROWZEE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HYPNO:
	ScriptGiveMon(SPECIES_HYPNO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KRABBY:
	ScriptGiveMon(SPECIES_KRABBY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KINGLER:
	ScriptGiveMon(SPECIES_KINGLER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VOLTORB:
	ScriptGiveMon(SPECIES_VOLTORB,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELECTRODE:
	ScriptGiveMon(SPECIES_ELECTRODE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EXEGGCUTE:
	ScriptGiveMon(SPECIES_EXEGGCUTE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EXEGGUTOR:
	ScriptGiveMon(SPECIES_EXEGGUTOR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CUBONE:
	ScriptGiveMon(SPECIES_CUBONE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAROWAK:
	ScriptGiveMon(SPECIES_MAROWAK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HITMONLEE:
	ScriptGiveMon(SPECIES_HITMONLEE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HITMONCHAN:
	ScriptGiveMon(SPECIES_HITMONCHAN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LICKITUNG:
	ScriptGiveMon(SPECIES_LICKITUNG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KOFFING:
	ScriptGiveMon(SPECIES_KOFFING,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WEEZING:
	ScriptGiveMon(SPECIES_WEEZING,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RHYHORN:
	ScriptGiveMon(SPECIES_RHYHORN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RHYDON:
	ScriptGiveMon(SPECIES_RHYDON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHANSEY:
	ScriptGiveMon(SPECIES_CHANSEY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TANGELA:
	ScriptGiveMon(SPECIES_TANGELA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KANGASKHAN:
	ScriptGiveMon(SPECIES_KANGASKHAN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HORSEA:
	ScriptGiveMon(SPECIES_HORSEA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEADRA:
	ScriptGiveMon(SPECIES_SEADRA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLDEEN:
	ScriptGiveMon(SPECIES_GOLDEEN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEAKING:
	ScriptGiveMon(SPECIES_SEAKING,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STARYU:
	ScriptGiveMon(SPECIES_STARYU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STARMIE:
	ScriptGiveMon(SPECIES_STARMIE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MR_MIME:
	ScriptGiveMon(SPECIES_MR_MIME,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCYTHER:
	ScriptGiveMon(SPECIES_SCYTHER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JYNX:
	ScriptGiveMon(SPECIES_JYNX,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELECTABUZZ:
	ScriptGiveMon(SPECIES_ELECTABUZZ,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGMAR:
	ScriptGiveMon(SPECIES_MAGMAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PINSIR:
	ScriptGiveMon(SPECIES_PINSIR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TAUROS:
	ScriptGiveMon(SPECIES_TAUROS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGIKARP:
	ScriptGiveMon(SPECIES_MAGIKARP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GYARADOS:
	ScriptGiveMon(SPECIES_GYARADOS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LAPRAS:
	ScriptGiveMon(SPECIES_LAPRAS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DITTO:
	ScriptGiveMon(SPECIES_DITTO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EEVEE:
	ScriptGiveMon(SPECIES_EEVEE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VAPOREON:
	ScriptGiveMon(SPECIES_VAPOREON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JOLTEON:
	ScriptGiveMon(SPECIES_JOLTEON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLAREON:
	ScriptGiveMon(SPECIES_FLAREON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PORYGON:
	ScriptGiveMon(SPECIES_PORYGON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case OMANYTE:
	ScriptGiveMon(SPECIES_OMANYTE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case OMASTAR:
	ScriptGiveMon(SPECIES_OMASTAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KABUTO:
	ScriptGiveMon(SPECIES_KABUTO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KABUTOPS:
	ScriptGiveMon(SPECIES_KABUTOPS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AERODACTYL:
	ScriptGiveMon(SPECIES_AERODACTYL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNORLAX:
	ScriptGiveMon(SPECIES_SNORLAX,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRATINI:
	ScriptGiveMon(SPECIES_DRATINI,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAGONAIR:
	ScriptGiveMon(SPECIES_DRAGONAIR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAGONITE:
	ScriptGiveMon(SPECIES_DRAGONITE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHIKORITA:
	ScriptGiveMon(SPECIES_CHIKORITA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BAYLEEF:
	ScriptGiveMon(SPECIES_BAYLEEF,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MEGANIUM:
	ScriptGiveMon(SPECIES_MEGANIUM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CYNDAQUIL:
	ScriptGiveMon(SPECIES_CYNDAQUIL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case QUILAVA:
	ScriptGiveMon(SPECIES_QUILAVA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYPHLOSION:
	ScriptGiveMon(SPECIES_TYPHLOSION,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOTODILE:
	ScriptGiveMon(SPECIES_TOTODILE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CROCONAW:
	ScriptGiveMon(SPECIES_CROCONAW,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FERALIGATR:
	ScriptGiveMon(SPECIES_FERALIGATR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SENTRET:
	ScriptGiveMon(SPECIES_SENTRET,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FURRET:
	ScriptGiveMon(SPECIES_FURRET,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HOOTHOOT:
	ScriptGiveMon(SPECIES_HOOTHOOT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NOCTOWL:
	ScriptGiveMon(SPECIES_NOCTOWL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LEDYBA:
	ScriptGiveMon(SPECIES_LEDYBA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LEDIAN:
	ScriptGiveMon(SPECIES_LEDIAN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPINARAK:
	ScriptGiveMon(SPECIES_SPINARAK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARIADOS:
	ScriptGiveMon(SPECIES_ARIADOS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CROBAT:
	ScriptGiveMon(SPECIES_CROBAT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHINCHOU:
	ScriptGiveMon(SPECIES_CHINCHOU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LANTURN:
	ScriptGiveMon(SPECIES_LANTURN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PICHU:
	ScriptGiveMon(SPECIES_PICHU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLEFFA:
	ScriptGiveMon(SPECIES_CLEFFA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case IGGLYBUFF:
	ScriptGiveMon(SPECIES_IGGLYBUFF,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOGEPI:
	ScriptGiveMon(SPECIES_TOGEPI,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOGETIC:
	ScriptGiveMon(SPECIES_TOGETIC,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NATU:
	ScriptGiveMon(SPECIES_NATU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case XATU:
	ScriptGiveMon(SPECIES_XATU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAREEP:
	ScriptGiveMon(SPECIES_MAREEP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLAAFFY:
	ScriptGiveMon(SPECIES_FLAAFFY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AMPHAROS:
	ScriptGiveMon(SPECIES_AMPHAROS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BELLOSSOM:
	ScriptGiveMon(SPECIES_BELLOSSOM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MARILL:
	ScriptGiveMon(SPECIES_MARILL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AZUMARILL:
	ScriptGiveMon(SPECIES_AZUMARILL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SUDOWOODO:
	ScriptGiveMon(SPECIES_SUDOWOODO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POLITOED:
	ScriptGiveMon(SPECIES_POLITOED,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HOPPIP:
	ScriptGiveMon(SPECIES_HOPPIP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKIPLOOM:
	ScriptGiveMon(SPECIES_SKIPLOOM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JUMPLUFF:
	ScriptGiveMon(SPECIES_JUMPLUFF,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AIPOM:
	ScriptGiveMon(SPECIES_AIPOM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SUNKERN:
	ScriptGiveMon(SPECIES_SUNKERN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SUNFLORA:
	ScriptGiveMon(SPECIES_SUNFLORA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case YANMA:
	ScriptGiveMon(SPECIES_YANMA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WOOPER:
	ScriptGiveMon(SPECIES_WOOPER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case QUAGSIRE:
	ScriptGiveMon(SPECIES_QUAGSIRE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ESPEON:
	ScriptGiveMon(SPECIES_ESPEON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case UMBREON:
	ScriptGiveMon(SPECIES_UMBREON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MURKROW:
	ScriptGiveMon(SPECIES_MURKROW,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLOWKING:
	ScriptGiveMon(SPECIES_SLOWKING,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MISDREAVUS:
	ScriptGiveMon(SPECIES_MISDREAVUS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case UNOWN:
	ScriptGiveMon(SPECIES_UNOWN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WOBBUFFET:
	ScriptGiveMon(SPECIES_WOBBUFFET,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GIRAFARIG:
	ScriptGiveMon(SPECIES_GIRAFARIG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PINECO:
	ScriptGiveMon(SPECIES_PINECO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FORRETRESS:
	ScriptGiveMon(SPECIES_FORRETRESS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUNSPARCE:
	ScriptGiveMon(SPECIES_DUNSPARCE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GLIGAR:
	ScriptGiveMon(SPECIES_GLIGAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STEELIX:
	ScriptGiveMon(SPECIES_STEELIX,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNUBBULL:
	ScriptGiveMon(SPECIES_SNUBBULL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRANBULL:
	ScriptGiveMon(SPECIES_GRANBULL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case QWILFISH:
	ScriptGiveMon(SPECIES_QWILFISH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCIZOR:
	ScriptGiveMon(SPECIES_SCIZOR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHUCKLE:
	ScriptGiveMon(SPECIES_SHUCKLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HERACROSS:
	ScriptGiveMon(SPECIES_HERACROSS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNEASEL:
	ScriptGiveMon(SPECIES_SNEASEL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TEDDIURSA:
	ScriptGiveMon(SPECIES_TEDDIURSA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case URSARING:
	ScriptGiveMon(SPECIES_URSARING,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLUGMA:
	ScriptGiveMon(SPECIES_SLUGMA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGCARGO:
	ScriptGiveMon(SPECIES_MAGCARGO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWINUB:
	ScriptGiveMon(SPECIES_SWINUB,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PILOSWINE:
	ScriptGiveMon(SPECIES_PILOSWINE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CORSOLA:
	ScriptGiveMon(SPECIES_CORSOLA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case REMORAID:
	ScriptGiveMon(SPECIES_REMORAID,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case OCTILLERY:
	ScriptGiveMon(SPECIES_OCTILLERY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DELIBIRD:
	ScriptGiveMon(SPECIES_DELIBIRD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MANTINE:
	ScriptGiveMon(SPECIES_MANTINE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKARMORY:
	ScriptGiveMon(SPECIES_SKARMORY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HOUNDOUR:
	ScriptGiveMon(SPECIES_HOUNDOUR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HOUNDOOM:
	ScriptGiveMon(SPECIES_HOUNDOOM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KINGDRA:
	ScriptGiveMon(SPECIES_KINGDRA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PHANPY:
	ScriptGiveMon(SPECIES_PHANPY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DONPHAN:
	ScriptGiveMon(SPECIES_DONPHAN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PORYGON2:
	ScriptGiveMon(SPECIES_PORYGON2,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STANTLER:
	ScriptGiveMon(SPECIES_STANTLER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SMEARGLE:
	ScriptGiveMon(SPECIES_SMEARGLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYROGUE:
	ScriptGiveMon(SPECIES_TYROGUE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HITMONTOP:
	ScriptGiveMon(SPECIES_HITMONTOP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SMOOCHUM:
	ScriptGiveMon(SPECIES_SMOOCHUM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELEKID:
	ScriptGiveMon(SPECIES_ELEKID,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGBY:
	ScriptGiveMon(SPECIES_MAGBY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MILTANK:
	ScriptGiveMon(SPECIES_MILTANK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BLISSEY:
	ScriptGiveMon(SPECIES_BLISSEY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RAIKOU:
	ScriptGiveMon(SPECIES_RAIKOU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ENTEI:
	ScriptGiveMon(SPECIES_ENTEI,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SUICUNE:
	ScriptGiveMon(SPECIES_SUICUNE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LARVITAR:
	ScriptGiveMon(SPECIES_LARVITAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PUPITAR:
	ScriptGiveMon(SPECIES_PUPITAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYRANITAR:
	ScriptGiveMon(SPECIES_TYRANITAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TREECKO:
	ScriptGiveMon(SPECIES_TREECKO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GROVYLE:
	ScriptGiveMon(SPECIES_GROVYLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCEPTILE:
	ScriptGiveMon(SPECIES_SCEPTILE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TORCHIC:
	ScriptGiveMon(SPECIES_TORCHIC,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COMBUSKEN:
	ScriptGiveMon(SPECIES_COMBUSKEN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BLAZIKEN:
	ScriptGiveMon(SPECIES_BLAZIKEN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUDKIP:
	ScriptGiveMon(SPECIES_MUDKIP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MARSHTOMP:
	ScriptGiveMon(SPECIES_MARSHTOMP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWAMPERT:
	ScriptGiveMon(SPECIES_SWAMPERT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POOCHYENA:
	ScriptGiveMon(SPECIES_POOCHYENA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MIGHTYENA:
	ScriptGiveMon(SPECIES_MIGHTYENA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZIGZAGOON:
	ScriptGiveMon(SPECIES_ZIGZAGOON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LINOONE:
	ScriptGiveMon(SPECIES_LINOONE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WURMPLE:
	ScriptGiveMon(SPECIES_WURMPLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SILCOON:
	ScriptGiveMon(SPECIES_SILCOON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BEAUTIFLY:
	ScriptGiveMon(SPECIES_BEAUTIFLY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CASCOON:
	ScriptGiveMon(SPECIES_CASCOON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUSTOX:
	ScriptGiveMon(SPECIES_DUSTOX,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LOTAD:
	ScriptGiveMon(SPECIES_LOTAD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LOMBRE:
	ScriptGiveMon(SPECIES_LOMBRE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUDICOLO:
	ScriptGiveMon(SPECIES_LUDICOLO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEEDOT:
	ScriptGiveMon(SPECIES_SEEDOT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NUZLEAF:
	ScriptGiveMon(SPECIES_NUZLEAF,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHIFTRY:
	ScriptGiveMon(SPECIES_SHIFTRY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TAILLOW:
	ScriptGiveMon(SPECIES_TAILLOW,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWELLOW:
	ScriptGiveMon(SPECIES_SWELLOW,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WINGULL:
	ScriptGiveMon(SPECIES_WINGULL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PELIPPER:
	ScriptGiveMon(SPECIES_PELIPPER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RALTS:
	ScriptGiveMon(SPECIES_RALTS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KIRLIA:
	ScriptGiveMon(SPECIES_KIRLIA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GARDEVOIR:
	ScriptGiveMon(SPECIES_GARDEVOIR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SURSKIT:
	ScriptGiveMon(SPECIES_SURSKIT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MASQUERAIN:
	ScriptGiveMon(SPECIES_MASQUERAIN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHROOMISH:
	ScriptGiveMon(SPECIES_SHROOMISH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRELOOM:
	ScriptGiveMon(SPECIES_BRELOOM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLAKOTH:
	ScriptGiveMon(SPECIES_SLAKOTH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VIGOROTH:
	ScriptGiveMon(SPECIES_VIGOROTH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLAKING:
	ScriptGiveMon(SPECIES_SLAKING,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NINCADA:
	ScriptGiveMon(SPECIES_NINCADA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NINJASK:
	ScriptGiveMon(SPECIES_NINJASK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHEDINJA:
	ScriptGiveMon(SPECIES_SHEDINJA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WHISMUR:
	ScriptGiveMon(SPECIES_WHISMUR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LOUDRED:
	ScriptGiveMon(SPECIES_LOUDRED,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EXPLOUD:
	ScriptGiveMon(SPECIES_EXPLOUD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAKUHITA:
	ScriptGiveMon(SPECIES_MAKUHITA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HARIYAMA:
	ScriptGiveMon(SPECIES_HARIYAMA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AZURILL:
	ScriptGiveMon(SPECIES_AZURILL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NOSEPASS:
	ScriptGiveMon(SPECIES_NOSEPASS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKITTY:
	ScriptGiveMon(SPECIES_SKITTY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DELCATTY:
	ScriptGiveMon(SPECIES_DELCATTY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SABLEYE:
	ScriptGiveMon(SPECIES_SABLEYE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAWILE:
	ScriptGiveMon(SPECIES_MAWILE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARON:
	ScriptGiveMon(SPECIES_ARON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LAIRON:
	ScriptGiveMon(SPECIES_LAIRON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AGGRON:
	ScriptGiveMon(SPECIES_AGGRON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MEDITITE:
	ScriptGiveMon(SPECIES_MEDITITE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MEDICHAM:
	ScriptGiveMon(SPECIES_MEDICHAM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELECTRIKE:
	ScriptGiveMon(SPECIES_ELECTRIKE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MANECTRIC:
	ScriptGiveMon(SPECIES_MANECTRIC,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PLUSLE:
	ScriptGiveMon(SPECIES_PLUSLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MINUN:
	ScriptGiveMon(SPECIES_MINUN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VOLBEAT:
	ScriptGiveMon(SPECIES_VOLBEAT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ILLUMISE:
	ScriptGiveMon(SPECIES_ILLUMISE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROSELIA:
	ScriptGiveMon(SPECIES_ROSELIA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GULPIN:
	ScriptGiveMon(SPECIES_GULPIN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWALOT:
	ScriptGiveMon(SPECIES_SWALOT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CARVANHA:
	ScriptGiveMon(SPECIES_CARVANHA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHARPEDO:
	ScriptGiveMon(SPECIES_SHARPEDO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WAILMER:
	ScriptGiveMon(SPECIES_WAILMER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WAILORD:
	ScriptGiveMon(SPECIES_WAILORD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NUMEL:
	ScriptGiveMon(SPECIES_NUMEL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CAMERUPT:
	ScriptGiveMon(SPECIES_CAMERUPT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TORKOAL:
	ScriptGiveMon(SPECIES_TORKOAL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPOINK:
	ScriptGiveMon(SPECIES_SPOINK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRUMPIG:
	ScriptGiveMon(SPECIES_GRUMPIG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPINDA:
	ScriptGiveMon(SPECIES_SPINDA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TRAPINCH:
	ScriptGiveMon(SPECIES_TRAPINCH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VIBRAVA:
	ScriptGiveMon(SPECIES_VIBRAVA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLYGON:
	ScriptGiveMon(SPECIES_FLYGON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CACNEA:
	ScriptGiveMon(SPECIES_CACNEA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CACTURNE:
	ScriptGiveMon(SPECIES_CACTURNE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWABLU:
	ScriptGiveMon(SPECIES_SWABLU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ALTARIA:
	ScriptGiveMon(SPECIES_ALTARIA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZANGOOSE:
	ScriptGiveMon(SPECIES_ZANGOOSE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEVIPER:
	ScriptGiveMon(SPECIES_SEVIPER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUNATONE:
	ScriptGiveMon(SPECIES_LUNATONE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SOLROCK:
	ScriptGiveMon(SPECIES_SOLROCK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BARBOACH:
	ScriptGiveMon(SPECIES_BARBOACH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WHISCASH:
	ScriptGiveMon(SPECIES_WHISCASH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CORPHISH:
	ScriptGiveMon(SPECIES_CORPHISH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRAWDAUNT:
	ScriptGiveMon(SPECIES_CRAWDAUNT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BALTOY:
	ScriptGiveMon(SPECIES_BALTOY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLAYDOL:
	ScriptGiveMon(SPECIES_CLAYDOL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LILEEP:
	ScriptGiveMon(SPECIES_LILEEP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRADILY:
	ScriptGiveMon(SPECIES_CRADILY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ANORITH:
	ScriptGiveMon(SPECIES_ANORITH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARMALDO:
	ScriptGiveMon(SPECIES_ARMALDO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FEEBAS:
	ScriptGiveMon(SPECIES_FEEBAS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MILOTIC:
	ScriptGiveMon(SPECIES_MILOTIC,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CASTFORM:
	ScriptGiveMon(SPECIES_CASTFORM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KECLEON:
	ScriptGiveMon(SPECIES_KECLEON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHUPPET:
	ScriptGiveMon(SPECIES_SHUPPET,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BANETTE:
	ScriptGiveMon(SPECIES_BANETTE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUSKULL:
	ScriptGiveMon(SPECIES_DUSKULL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUSCLOPS:
	ScriptGiveMon(SPECIES_DUSCLOPS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TROPIUS:
	ScriptGiveMon(SPECIES_TROPIUS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHIMECHO:
	ScriptGiveMon(SPECIES_CHIMECHO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ABSOL:
	ScriptGiveMon(SPECIES_ABSOL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WYNAUT:
	ScriptGiveMon(SPECIES_WYNAUT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNORUNT:
	ScriptGiveMon(SPECIES_SNORUNT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GLALIE:
	ScriptGiveMon(SPECIES_GLALIE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPHEAL:
	ScriptGiveMon(SPECIES_SPHEAL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEALEO:
	ScriptGiveMon(SPECIES_SEALEO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WALREIN:
	ScriptGiveMon(SPECIES_WALREIN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLAMPERL:
	ScriptGiveMon(SPECIES_CLAMPERL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HUNTAIL:
	ScriptGiveMon(SPECIES_HUNTAIL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOREBYSS:
	ScriptGiveMon(SPECIES_GOREBYSS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RELICANTH:
	ScriptGiveMon(SPECIES_RELICANTH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUVDISC:
	ScriptGiveMon(SPECIES_LUVDISC,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BAGON:
	ScriptGiveMon(SPECIES_BAGON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHELGON:
	ScriptGiveMon(SPECIES_SHELGON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SALAMENCE:
	ScriptGiveMon(SPECIES_SALAMENCE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BELDUM:
	ScriptGiveMon(SPECIES_BELDUM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case METANG:
	ScriptGiveMon(SPECIES_METANG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case METAGROSS:
	ScriptGiveMon(SPECIES_METAGROSS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TURTWIG:
	ScriptGiveMon(SPECIES_TURTWIG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GROTLE:
	ScriptGiveMon(SPECIES_GROTLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TORTERRA:
	ScriptGiveMon(SPECIES_TORTERRA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHIMCHAR:
	ScriptGiveMon(SPECIES_CHIMCHAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MONFERNO:
	ScriptGiveMon(SPECIES_MONFERNO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case INFERNAPE:
	ScriptGiveMon(SPECIES_INFERNAPE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIPLUP:
	ScriptGiveMon(SPECIES_PIPLUP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PRINPLUP:
	ScriptGiveMon(SPECIES_PRINPLUP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EMPOLEON:
	ScriptGiveMon(SPECIES_EMPOLEON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STARLY:
	ScriptGiveMon(SPECIES_STARLY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STARAVIA:
	ScriptGiveMon(SPECIES_STARAVIA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STARAPTOR:
	ScriptGiveMon(SPECIES_STARAPTOR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BIDOOF:
	ScriptGiveMon(SPECIES_BIDOOF,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BIBAREL:
	ScriptGiveMon(SPECIES_BIBAREL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KRICKETOT:
	ScriptGiveMon(SPECIES_KRICKETOT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KRICKETUNE:
	ScriptGiveMon(SPECIES_KRICKETUNE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHINX:
	ScriptGiveMon(SPECIES_SHINX,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUXIO:
	ScriptGiveMon(SPECIES_LUXIO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUXRAY:
	ScriptGiveMon(SPECIES_LUXRAY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BUDEW:
	ScriptGiveMon(SPECIES_BUDEW,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROSERADE:
	ScriptGiveMon(SPECIES_ROSERADE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRANIDOS:
	ScriptGiveMon(SPECIES_CRANIDOS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RAMPARDOS:
	ScriptGiveMon(SPECIES_RAMPARDOS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHIELDON:
	ScriptGiveMon(SPECIES_SHIELDON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BASTIODON:
	ScriptGiveMon(SPECIES_BASTIODON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BURMY:
	ScriptGiveMon(SPECIES_BURMY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WORMADAM:
	ScriptGiveMon(SPECIES_WORMADAM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MOTHIM:
	ScriptGiveMon(SPECIES_MOTHIM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COMBEE:
	ScriptGiveMon(SPECIES_COMBEE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VESPIQUEN:
	ScriptGiveMon(SPECIES_VESPIQUEN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PACHIRISU:
	ScriptGiveMon(SPECIES_PACHIRISU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BUIZEL:
	ScriptGiveMon(SPECIES_BUIZEL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLOATZEL:
	ScriptGiveMon(SPECIES_FLOATZEL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHERUBI:
	ScriptGiveMon(SPECIES_CHERUBI,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHERRIM:
	ScriptGiveMon(SPECIES_CHERRIM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHELLOS:
	ScriptGiveMon(SPECIES_SHELLOS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GASTRODON:
	ScriptGiveMon(SPECIES_GASTRODON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AMBIPOM:
	ScriptGiveMon(SPECIES_AMBIPOM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRIFLOON:
	ScriptGiveMon(SPECIES_DRIFLOON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRIFBLIM:
	ScriptGiveMon(SPECIES_DRIFBLIM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BUNEARY:
	ScriptGiveMon(SPECIES_BUNEARY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LOPUNNY:
	ScriptGiveMon(SPECIES_LOPUNNY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MISMAGIUS:
	ScriptGiveMon(SPECIES_MISMAGIUS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HONCHKROW:
	ScriptGiveMon(SPECIES_HONCHKROW,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GLAMEOW:
	ScriptGiveMon(SPECIES_GLAMEOW,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PURUGLY:
	ScriptGiveMon(SPECIES_PURUGLY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHINGLING:
	ScriptGiveMon(SPECIES_CHINGLING,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STUNKY:
	ScriptGiveMon(SPECIES_STUNKY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKUNTANK:
	ScriptGiveMon(SPECIES_SKUNTANK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRONZOR:
	ScriptGiveMon(SPECIES_BRONZOR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRONZONG:
	ScriptGiveMon(SPECIES_BRONZONG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BONSLY:
	ScriptGiveMon(SPECIES_BONSLY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MIME_JR:
	ScriptGiveMon(SPECIES_MIME_JR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HAPPINY:
	ScriptGiveMon(SPECIES_HAPPINY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHATOT:
	ScriptGiveMon(SPECIES_CHATOT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPIRITOMB:
	ScriptGiveMon(SPECIES_SPIRITOMB,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GIBLE:
	ScriptGiveMon(SPECIES_GIBLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GABITE:
	ScriptGiveMon(SPECIES_GABITE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GARCHOMP:
	ScriptGiveMon(SPECIES_GARCHOMP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUNCHLAX:
	ScriptGiveMon(SPECIES_MUNCHLAX,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RIOLU:
	ScriptGiveMon(SPECIES_RIOLU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUCARIO:
	ScriptGiveMon(SPECIES_LUCARIO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HIPPOPOTAS:
	ScriptGiveMon(SPECIES_HIPPOPOTAS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HIPPOWDON:
	ScriptGiveMon(SPECIES_HIPPOWDON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKORUPI:
	ScriptGiveMon(SPECIES_SKORUPI,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAPION:
	ScriptGiveMon(SPECIES_DRAPION,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CROAGUNK:
	ScriptGiveMon(SPECIES_CROAGUNK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOXICROAK:
	ScriptGiveMon(SPECIES_TOXICROAK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CARNIVINE:
	ScriptGiveMon(SPECIES_CARNIVINE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FINNEON:
	ScriptGiveMon(SPECIES_FINNEON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUMINEON:
	ScriptGiveMon(SPECIES_LUMINEON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MANTYKE:
	ScriptGiveMon(SPECIES_MANTYKE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNOVER:
	ScriptGiveMon(SPECIES_SNOVER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ABOMASNOW:
	ScriptGiveMon(SPECIES_ABOMASNOW,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WEAVILE:
	ScriptGiveMon(SPECIES_WEAVILE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGNEZONE:
	ScriptGiveMon(SPECIES_MAGNEZONE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LICKILICKY:
	ScriptGiveMon(SPECIES_LICKILICKY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RHYPERIOR:
	ScriptGiveMon(SPECIES_RHYPERIOR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TANGROWTH:
	ScriptGiveMon(SPECIES_TANGROWTH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELECTIVIRE:
	ScriptGiveMon(SPECIES_ELECTIVIRE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGMORTAR:
	ScriptGiveMon(SPECIES_MAGMORTAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOGEKISS:
	ScriptGiveMon(SPECIES_TOGEKISS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case YANMEGA:
	ScriptGiveMon(SPECIES_YANMEGA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LEAFEON:
	ScriptGiveMon(SPECIES_LEAFEON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GLACEON:
	ScriptGiveMon(SPECIES_GLACEON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GLISCOR:
	ScriptGiveMon(SPECIES_GLISCOR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAMOSWINE:
	ScriptGiveMon(SPECIES_MAMOSWINE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PORYGON_Z:
	ScriptGiveMon(SPECIES_PORYGON_Z,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GALLADE:
	ScriptGiveMon(SPECIES_GALLADE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PROBOPASS:
	ScriptGiveMon(SPECIES_PROBOPASS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUSKNOIR:
	ScriptGiveMon(SPECIES_DUSKNOIR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FROSLASS:
	ScriptGiveMon(SPECIES_FROSLASS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROTOM:
	ScriptGiveMon(SPECIES_ROTOM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNIVY:
	ScriptGiveMon(SPECIES_SNIVY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SERVINE:
	ScriptGiveMon(SPECIES_SERVINE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SERPERIOR:
	ScriptGiveMon(SPECIES_SERPERIOR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TEPIG:
	ScriptGiveMon(SPECIES_TEPIG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIGNITE:
	ScriptGiveMon(SPECIES_PIGNITE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EMBOAR:
	ScriptGiveMon(SPECIES_EMBOAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case OSHAWOTT:
	ScriptGiveMon(SPECIES_OSHAWOTT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DEWOTT:
	ScriptGiveMon(SPECIES_DEWOTT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SAMUROTT:
	ScriptGiveMon(SPECIES_SAMUROTT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PATRAT:
	ScriptGiveMon(SPECIES_PATRAT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WATCHOG:
	ScriptGiveMon(SPECIES_WATCHOG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LILLIPUP:
	ScriptGiveMon(SPECIES_LILLIPUP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HERDIER:
	ScriptGiveMon(SPECIES_HERDIER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STOUTLAND:
	ScriptGiveMon(SPECIES_STOUTLAND,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PURRLOIN:
	ScriptGiveMon(SPECIES_PURRLOIN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LIEPARD:
	ScriptGiveMon(SPECIES_LIEPARD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PANSAGE:
	ScriptGiveMon(SPECIES_PANSAGE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SIMISAGE:
	ScriptGiveMon(SPECIES_SIMISAGE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PANSEAR:
	ScriptGiveMon(SPECIES_PANSEAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SIMISEAR:
	ScriptGiveMon(SPECIES_SIMISEAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PANPOUR:
	ScriptGiveMon(SPECIES_PANPOUR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SIMIPOUR:
	ScriptGiveMon(SPECIES_SIMIPOUR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUNNA:
	ScriptGiveMon(SPECIES_MUNNA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUSHARNA:
	ScriptGiveMon(SPECIES_MUSHARNA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIDOVE:
	ScriptGiveMon(SPECIES_PIDOVE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TRANQUILL:
	ScriptGiveMon(SPECIES_TRANQUILL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case UNFEZANT:
	ScriptGiveMon(SPECIES_UNFEZANT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BLITZLE:
	ScriptGiveMon(SPECIES_BLITZLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZEBSTRIKA:
	ScriptGiveMon(SPECIES_ZEBSTRIKA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROGGENROLA:
	ScriptGiveMon(SPECIES_ROGGENROLA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BOLDORE:
	ScriptGiveMon(SPECIES_BOLDORE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GIGALITH:
	ScriptGiveMon(SPECIES_GIGALITH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WOOBAT:
	ScriptGiveMon(SPECIES_WOOBAT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWOOBAT:
	ScriptGiveMon(SPECIES_SWOOBAT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRILBUR:
	ScriptGiveMon(SPECIES_DRILBUR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EXCADRILL:
	ScriptGiveMon(SPECIES_EXCADRILL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AUDINO:
	ScriptGiveMon(SPECIES_AUDINO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TIMBURR:
	ScriptGiveMon(SPECIES_TIMBURR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GURDURR:
	ScriptGiveMon(SPECIES_GURDURR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CONKELDURR:
	ScriptGiveMon(SPECIES_CONKELDURR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYMPOLE:
	ScriptGiveMon(SPECIES_TYMPOLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PALPITOAD:
	ScriptGiveMon(SPECIES_PALPITOAD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEISMITOAD:
	ScriptGiveMon(SPECIES_SEISMITOAD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case THROH:
	ScriptGiveMon(SPECIES_THROH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SAWK:
	ScriptGiveMon(SPECIES_SAWK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEWADDLE:
	ScriptGiveMon(SPECIES_SEWADDLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWADLOON:
	ScriptGiveMon(SPECIES_SWADLOON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LEAVANNY:
	ScriptGiveMon(SPECIES_LEAVANNY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VENIPEDE:
	ScriptGiveMon(SPECIES_VENIPEDE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WHIRLIPEDE:
	ScriptGiveMon(SPECIES_WHIRLIPEDE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCOLIPEDE:
	ScriptGiveMon(SPECIES_SCOLIPEDE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COTTONEE:
	ScriptGiveMon(SPECIES_COTTONEE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WHIMSICOTT:
	ScriptGiveMon(SPECIES_WHIMSICOTT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PETILIL:
	ScriptGiveMon(SPECIES_PETILIL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LILLIGANT:
	ScriptGiveMon(SPECIES_LILLIGANT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BASCULIN:
	ScriptGiveMon(SPECIES_BASCULIN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SANDILE:
	ScriptGiveMon(SPECIES_SANDILE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KROKOROK:
	ScriptGiveMon(SPECIES_KROKOROK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KROOKODILE:
	ScriptGiveMon(SPECIES_KROOKODILE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DARUMAKA:
	ScriptGiveMon(SPECIES_DARUMAKA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DARMANITAN:
	ScriptGiveMon(SPECIES_DARMANITAN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MARACTUS:
	ScriptGiveMon(SPECIES_MARACTUS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DWEBBLE:
	ScriptGiveMon(SPECIES_DWEBBLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRUSTLE:
	ScriptGiveMon(SPECIES_CRUSTLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCRAGGY:
	ScriptGiveMon(SPECIES_SCRAGGY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCRAFTY:
	ScriptGiveMon(SPECIES_SCRAFTY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SIGILYPH:
	ScriptGiveMon(SPECIES_SIGILYPH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case YAMASK:
	ScriptGiveMon(SPECIES_YAMASK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COFAGRIGUS:
	ScriptGiveMon(SPECIES_COFAGRIGUS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TIRTOUGA:
	ScriptGiveMon(SPECIES_TIRTOUGA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CARRACOSTA:
	ScriptGiveMon(SPECIES_CARRACOSTA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARCHEN:
	ScriptGiveMon(SPECIES_ARCHEN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARCHEOPS:
	ScriptGiveMon(SPECIES_ARCHEOPS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TRUBBISH:
	ScriptGiveMon(SPECIES_TRUBBISH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GARBODOR:
	ScriptGiveMon(SPECIES_GARBODOR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZORUA:
	ScriptGiveMon(SPECIES_ZORUA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZOROARK:
	ScriptGiveMon(SPECIES_ZOROARK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MINCCINO:
	ScriptGiveMon(SPECIES_MINCCINO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CINCCINO:
	ScriptGiveMon(SPECIES_CINCCINO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOTHITA:
	ScriptGiveMon(SPECIES_GOTHITA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOTHORITA:
	ScriptGiveMon(SPECIES_GOTHORITA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOTHITELLE:
	ScriptGiveMon(SPECIES_GOTHITELLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SOLOSIS:
	ScriptGiveMon(SPECIES_SOLOSIS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUOSION:
	ScriptGiveMon(SPECIES_DUOSION,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case REUNICLUS:
	ScriptGiveMon(SPECIES_REUNICLUS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUCKLETT:
	ScriptGiveMon(SPECIES_DUCKLETT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWANNA:
	ScriptGiveMon(SPECIES_SWANNA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VANILLITE:
	ScriptGiveMon(SPECIES_VANILLITE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VANILLISH:
	ScriptGiveMon(SPECIES_VANILLISH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VANILLUXE:
	ScriptGiveMon(SPECIES_VANILLUXE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DEERLING:
	ScriptGiveMon(SPECIES_DEERLING,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SAWSBUCK:
	ScriptGiveMon(SPECIES_SAWSBUCK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EMOLGA:
	ScriptGiveMon(SPECIES_EMOLGA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KARRABLAST:
	ScriptGiveMon(SPECIES_KARRABLAST,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ESCAVALIER:
	ScriptGiveMon(SPECIES_ESCAVALIER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FOONGUS:
	ScriptGiveMon(SPECIES_FOONGUS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AMOONGUSS:
	ScriptGiveMon(SPECIES_AMOONGUSS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FRILLISH:
	ScriptGiveMon(SPECIES_FRILLISH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JELLICENT:
	ScriptGiveMon(SPECIES_JELLICENT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ALOMOMOLA:
	ScriptGiveMon(SPECIES_ALOMOMOLA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JOLTIK:
	ScriptGiveMon(SPECIES_JOLTIK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GALVANTULA:
	ScriptGiveMon(SPECIES_GALVANTULA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FERROSEED:
	ScriptGiveMon(SPECIES_FERROSEED,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FERROTHORN:
	ScriptGiveMon(SPECIES_FERROTHORN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KLINK:
	ScriptGiveMon(SPECIES_KLINK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KLANG:
	ScriptGiveMon(SPECIES_KLANG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KLINKLANG:
	ScriptGiveMon(SPECIES_KLINKLANG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYNAMO:
	ScriptGiveMon(SPECIES_TYNAMO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EELEKTRIK:
	ScriptGiveMon(SPECIES_EELEKTRIK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EELEKTROSS:
	ScriptGiveMon(SPECIES_EELEKTROSS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELGYEM:
	ScriptGiveMon(SPECIES_ELGYEM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BEHEEYEM:
	ScriptGiveMon(SPECIES_BEHEEYEM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LITWICK:
	ScriptGiveMon(SPECIES_LITWICK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LAMPENT:
	ScriptGiveMon(SPECIES_LAMPENT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHANDELURE:
	ScriptGiveMon(SPECIES_CHANDELURE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AXEW:
	ScriptGiveMon(SPECIES_AXEW,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FRAXURE:
	ScriptGiveMon(SPECIES_FRAXURE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HAXORUS:
	ScriptGiveMon(SPECIES_HAXORUS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CUBCHOO:
	ScriptGiveMon(SPECIES_CUBCHOO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BEARTIC:
	ScriptGiveMon(SPECIES_BEARTIC,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRYOGONAL:
	ScriptGiveMon(SPECIES_CRYOGONAL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHELMET:
	ScriptGiveMon(SPECIES_SHELMET,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ACCELGOR:
	ScriptGiveMon(SPECIES_ACCELGOR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STUNFISK:
	ScriptGiveMon(SPECIES_STUNFISK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MIENFOO:
	ScriptGiveMon(SPECIES_MIENFOO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MIENSHAO:
	ScriptGiveMon(SPECIES_MIENSHAO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRUDDIGON:
	ScriptGiveMon(SPECIES_DRUDDIGON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLETT:
	ScriptGiveMon(SPECIES_GOLETT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLURK:
	ScriptGiveMon(SPECIES_GOLURK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PAWNIARD:
	ScriptGiveMon(SPECIES_PAWNIARD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BISHARP:
	ScriptGiveMon(SPECIES_BISHARP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BOUFFALANT:
	ScriptGiveMon(SPECIES_BOUFFALANT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RUFFLET:
	ScriptGiveMon(SPECIES_RUFFLET,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRAVIARY:
	ScriptGiveMon(SPECIES_BRAVIARY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VULLABY:
	ScriptGiveMon(SPECIES_VULLABY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MANDIBUZZ:
	ScriptGiveMon(SPECIES_MANDIBUZZ,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HEATMOR:
	ScriptGiveMon(SPECIES_HEATMOR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DURANT:
	ScriptGiveMon(SPECIES_DURANT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DEINO:
	ScriptGiveMon(SPECIES_DEINO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZWEILOUS:
	ScriptGiveMon(SPECIES_ZWEILOUS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HYDREIGON:
	ScriptGiveMon(SPECIES_HYDREIGON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LARVESTA:
	ScriptGiveMon(SPECIES_LARVESTA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VOLCARONA:
	ScriptGiveMon(SPECIES_VOLCARONA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHESPIN:
	ScriptGiveMon(SPECIES_CHESPIN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case QUILLADIN:
	ScriptGiveMon(SPECIES_QUILLADIN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHESNAUGHT:
	ScriptGiveMon(SPECIES_CHESNAUGHT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FENNEKIN:
	ScriptGiveMon(SPECIES_FENNEKIN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRAIXEN:
	ScriptGiveMon(SPECIES_BRAIXEN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DELPHOX:
	ScriptGiveMon(SPECIES_DELPHOX,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FROAKIE:
	ScriptGiveMon(SPECIES_FROAKIE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FROGADIER:
	ScriptGiveMon(SPECIES_FROGADIER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRENINJA:
	ScriptGiveMon(SPECIES_GRENINJA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BUNNELBY:
	ScriptGiveMon(SPECIES_BUNNELBY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DIGGERSBY:
	ScriptGiveMon(SPECIES_DIGGERSBY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLETCHLING:
	ScriptGiveMon(SPECIES_FLETCHLING,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLETCHINDER:
	ScriptGiveMon(SPECIES_FLETCHINDER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TALONFLAME:
	ScriptGiveMon(SPECIES_TALONFLAME,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCATTERBUG:
	ScriptGiveMon(SPECIES_SCATTERBUG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPEWPA:
	ScriptGiveMon(SPECIES_SPEWPA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VIVILLON:
	ScriptGiveMon(SPECIES_VIVILLON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LITLEO:
	ScriptGiveMon(SPECIES_LITLEO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PYROAR:
	ScriptGiveMon(SPECIES_PYROAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLABEBE:
	ScriptGiveMon(SPECIES_FLABEBE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLOETTE:
	ScriptGiveMon(SPECIES_FLOETTE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLORGES:
	ScriptGiveMon(SPECIES_FLORGES,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKIDDO:
	ScriptGiveMon(SPECIES_SKIDDO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOGOAT:
	ScriptGiveMon(SPECIES_GOGOAT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PANCHAM:
	ScriptGiveMon(SPECIES_PANCHAM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PANGORO:
	ScriptGiveMon(SPECIES_PANGORO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FURFROU:
	ScriptGiveMon(SPECIES_FURFROU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ESPURR:
	ScriptGiveMon(SPECIES_ESPURR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MEOWSTIC:
	ScriptGiveMon(SPECIES_MEOWSTIC,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HONEDGE:
	ScriptGiveMon(SPECIES_HONEDGE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DOUBLADE:
	ScriptGiveMon(SPECIES_DOUBLADE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AEGISLASH:
	ScriptGiveMon(SPECIES_AEGISLASH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPRITZEE:
	ScriptGiveMon(SPECIES_SPRITZEE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AROMATISSE:
	ScriptGiveMon(SPECIES_AROMATISSE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWIRLIX:
	ScriptGiveMon(SPECIES_SWIRLIX,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLURPUFF:
	ScriptGiveMon(SPECIES_SLURPUFF,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case INKAY:
	ScriptGiveMon(SPECIES_INKAY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MALAMAR:
	ScriptGiveMon(SPECIES_MALAMAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BINACLE:
	ScriptGiveMon(SPECIES_BINACLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BARBARACLE:
	ScriptGiveMon(SPECIES_BARBARACLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKRELP:
	ScriptGiveMon(SPECIES_SKRELP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAGALGE:
	ScriptGiveMon(SPECIES_DRAGALGE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLAUNCHER:
	ScriptGiveMon(SPECIES_CLAUNCHER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLAWITZER:
	ScriptGiveMon(SPECIES_CLAWITZER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HELIOPTILE:
	ScriptGiveMon(SPECIES_HELIOPTILE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HELIOLISK:
	ScriptGiveMon(SPECIES_HELIOLISK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYRUNT:
	ScriptGiveMon(SPECIES_TYRUNT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYRANTRUM:
	ScriptGiveMon(SPECIES_TYRANTRUM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AMAURA:
	ScriptGiveMon(SPECIES_AMAURA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AURORUS:
	ScriptGiveMon(SPECIES_AURORUS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SYLVEON:
	ScriptGiveMon(SPECIES_SYLVEON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HAWLUCHA:
	ScriptGiveMon(SPECIES_HAWLUCHA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DEDENNE:
	ScriptGiveMon(SPECIES_DEDENNE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CARBINK:
	ScriptGiveMon(SPECIES_CARBINK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOOMY:
	ScriptGiveMon(SPECIES_GOOMY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLIGGOO:
	ScriptGiveMon(SPECIES_SLIGGOO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOODRA:
	ScriptGiveMon(SPECIES_GOODRA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KLEFKI:
	ScriptGiveMon(SPECIES_KLEFKI,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PHANTUMP:
	ScriptGiveMon(SPECIES_PHANTUMP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TREVENANT:
	ScriptGiveMon(SPECIES_TREVENANT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PUMPKABOO:
	ScriptGiveMon(SPECIES_PUMPKABOO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOURGEIST:
	ScriptGiveMon(SPECIES_GOURGEIST,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BERGMITE:
	ScriptGiveMon(SPECIES_BERGMITE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AVALUGG:
	ScriptGiveMon(SPECIES_AVALUGG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NOIBAT:
	ScriptGiveMon(SPECIES_NOIBAT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NOIVERN:
	ScriptGiveMon(SPECIES_NOIVERN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROWLET:
	ScriptGiveMon(SPECIES_ROWLET,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DARTRIX:
	ScriptGiveMon(SPECIES_DARTRIX,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DECIDUEYE:
	ScriptGiveMon(SPECIES_DECIDUEYE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LITTEN:
	ScriptGiveMon(SPECIES_LITTEN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TORRACAT:
	ScriptGiveMon(SPECIES_TORRACAT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case INCINEROAR:
	ScriptGiveMon(SPECIES_INCINEROAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POPPLIO:
	ScriptGiveMon(SPECIES_POPPLIO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRIONNE:
	ScriptGiveMon(SPECIES_BRIONNE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PRIMARINA:
	ScriptGiveMon(SPECIES_PRIMARINA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIKIPEK:
	ScriptGiveMon(SPECIES_PIKIPEK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TRUMBEAK:
	ScriptGiveMon(SPECIES_TRUMBEAK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOUCANNON:
	ScriptGiveMon(SPECIES_TOUCANNON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case YUNGOOS:
	ScriptGiveMon(SPECIES_YUNGOOS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GUMSHOOS:
	ScriptGiveMon(SPECIES_GUMSHOOS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRUBBIN:
	ScriptGiveMon(SPECIES_GRUBBIN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHARJABUG:
	ScriptGiveMon(SPECIES_CHARJABUG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VIKAVOLT:
	ScriptGiveMon(SPECIES_VIKAVOLT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRABRAWLER:
	ScriptGiveMon(SPECIES_CRABRAWLER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRABOMINABLE:
	ScriptGiveMon(SPECIES_CRABOMINABLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ORICORIO:
	ScriptGiveMon(SPECIES_ORICORIO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CUTIEFLY:
	ScriptGiveMon(SPECIES_CUTIEFLY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RIBOMBEE:
	ScriptGiveMon(SPECIES_RIBOMBEE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROCKRUFF:
	ScriptGiveMon(SPECIES_ROCKRUFF,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LYCANROC:
	ScriptGiveMon(SPECIES_LYCANROC,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WISHIWASHI:
	ScriptGiveMon(SPECIES_WISHIWASHI,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAREANIE:
	ScriptGiveMon(SPECIES_MAREANIE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOXAPEX:
	ScriptGiveMon(SPECIES_TOXAPEX,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUDBRAY:
	ScriptGiveMon(SPECIES_MUDBRAY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUDSDALE:
	ScriptGiveMon(SPECIES_MUDSDALE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DEWPIDER:
	ScriptGiveMon(SPECIES_DEWPIDER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARAQUANID:
	ScriptGiveMon(SPECIES_ARAQUANID,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FOMANTIS:
	ScriptGiveMon(SPECIES_FOMANTIS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LURANTIS:
	ScriptGiveMon(SPECIES_LURANTIS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MORELULL:
	ScriptGiveMon(SPECIES_MORELULL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHIINOTIC:
	ScriptGiveMon(SPECIES_SHIINOTIC,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SALANDIT:
	ScriptGiveMon(SPECIES_SALANDIT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SALAZZLE:
	ScriptGiveMon(SPECIES_SALAZZLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STUFFUL:
	ScriptGiveMon(SPECIES_STUFFUL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BEWEAR:
	ScriptGiveMon(SPECIES_BEWEAR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BOUNSWEET:
	ScriptGiveMon(SPECIES_BOUNSWEET,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STEENEE:
	ScriptGiveMon(SPECIES_STEENEE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TSAREENA:
	ScriptGiveMon(SPECIES_TSAREENA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COMFEY:
	ScriptGiveMon(SPECIES_COMFEY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ORANGURU:
	ScriptGiveMon(SPECIES_ORANGURU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PASSIMIAN:
	ScriptGiveMon(SPECIES_PASSIMIAN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WIMPOD:
	ScriptGiveMon(SPECIES_WIMPOD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLISOPOD:
	ScriptGiveMon(SPECIES_GOLISOPOD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SANDYGAST:
	ScriptGiveMon(SPECIES_SANDYGAST,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PALOSSAND:
	ScriptGiveMon(SPECIES_PALOSSAND,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PYUKUMUKU:
	ScriptGiveMon(SPECIES_PYUKUMUKU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYPE_NULL:
	ScriptGiveMon(SPECIES_TYPE_NULL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SILVALLY:
	ScriptGiveMon(SPECIES_SILVALLY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MINIOR:
	ScriptGiveMon(SPECIES_MINIOR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KOMALA:
	ScriptGiveMon(SPECIES_KOMALA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TURTONATOR:
	ScriptGiveMon(SPECIES_TURTONATOR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOGEDEMARU:
	ScriptGiveMon(SPECIES_TOGEDEMARU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MIMIKYU:
	ScriptGiveMon(SPECIES_MIMIKYU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRUXISH:
	ScriptGiveMon(SPECIES_BRUXISH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAMPA:
	ScriptGiveMon(SPECIES_DRAMPA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DHELMISE:
	ScriptGiveMon(SPECIES_DHELMISE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JANGMO_O:
	ScriptGiveMon(SPECIES_JANGMO_O,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HAKAMO_O:
	ScriptGiveMon(SPECIES_HAKAMO_O,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KOMMO_O:
	ScriptGiveMon(SPECIES_KOMMO_O,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TAPU_KOKO:
	ScriptGiveMon(SPECIES_TAPU_KOKO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TAPU_LELE:
	ScriptGiveMon(SPECIES_TAPU_LELE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TAPU_BULU:
	ScriptGiveMon(SPECIES_TAPU_BULU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TAPU_FINI:
	ScriptGiveMon(SPECIES_TAPU_FINI,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GROOKEY:
	ScriptGiveMon(SPECIES_GROOKEY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case THWACKEY:
	ScriptGiveMon(SPECIES_THWACKEY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RILLABOOM:
	ScriptGiveMon(SPECIES_RILLABOOM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCORBUNNY:
	ScriptGiveMon(SPECIES_SCORBUNNY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RABOOT:
	ScriptGiveMon(SPECIES_RABOOT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CINDERACE:
	ScriptGiveMon(SPECIES_CINDERACE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SOBBLE:
	ScriptGiveMon(SPECIES_SOBBLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRIZZILE:
	ScriptGiveMon(SPECIES_DRIZZILE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case INTELEON:
	ScriptGiveMon(SPECIES_INTELEON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKWOVET:
	ScriptGiveMon(SPECIES_SKWOVET,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GREEDENT:
	ScriptGiveMon(SPECIES_GREEDENT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROOKIDEE:
	ScriptGiveMon(SPECIES_ROOKIDEE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CORVISQUIRE:
	ScriptGiveMon(SPECIES_CORVISQUIRE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CORVIKNIGHT:
	ScriptGiveMon(SPECIES_CORVIKNIGHT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BLIPBUG:
	ScriptGiveMon(SPECIES_BLIPBUG,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DOTTLER:
	ScriptGiveMon(SPECIES_DOTTLER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ORBEETLE:
	ScriptGiveMon(SPECIES_ORBEETLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NICKIT:
	ScriptGiveMon(SPECIES_NICKIT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case THIEVUL:
	ScriptGiveMon(SPECIES_THIEVUL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOSSIFLEUR:
	ScriptGiveMon(SPECIES_GOSSIFLEUR,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELDEGOSS:
	ScriptGiveMon(SPECIES_ELDEGOSS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WOOLOO:
	ScriptGiveMon(SPECIES_WOOLOO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUBWOOL:
	ScriptGiveMon(SPECIES_DUBWOOL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHEWTLE:
	ScriptGiveMon(SPECIES_CHEWTLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DREDNAW:
	ScriptGiveMon(SPECIES_DREDNAW,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case YAMPER:
	ScriptGiveMon(SPECIES_YAMPER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BOLTUND:
	ScriptGiveMon(SPECIES_BOLTUND,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROLYCOLY:
	ScriptGiveMon(SPECIES_ROLYCOLY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CARKOL:
	ScriptGiveMon(SPECIES_CARKOL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COALOSSAL:
	ScriptGiveMon(SPECIES_COALOSSAL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case APPLIN:
	ScriptGiveMon(SPECIES_APPLIN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLAPPLE:
	ScriptGiveMon(SPECIES_FLAPPLE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case APPLETUN:
	ScriptGiveMon(SPECIES_APPLETUN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SILICOBRA:
	ScriptGiveMon(SPECIES_SILICOBRA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SANDACONDA:
	ScriptGiveMon(SPECIES_SANDACONDA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRAMORANT:
	ScriptGiveMon(SPECIES_CRAMORANT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARROKUDA:
	ScriptGiveMon(SPECIES_ARROKUDA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BARRASKEWDA:
	ScriptGiveMon(SPECIES_BARRASKEWDA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOXEL:
	ScriptGiveMon(SPECIES_TOXEL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOXTRICITY:
	ScriptGiveMon(SPECIES_TOXTRICITY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SIZZLIPEDE:
	ScriptGiveMon(SPECIES_SIZZLIPEDE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CENTISKORCH:
	ScriptGiveMon(SPECIES_CENTISKORCH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLOBBOPUS:
	ScriptGiveMon(SPECIES_CLOBBOPUS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRAPPLOCT:
	ScriptGiveMon(SPECIES_GRAPPLOCT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SINISTEA:
	ScriptGiveMon(SPECIES_SINISTEA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POLTEAGEIST:
	ScriptGiveMon(SPECIES_POLTEAGEIST,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HATENNA:
	ScriptGiveMon(SPECIES_HATENNA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HATTREM:
	ScriptGiveMon(SPECIES_HATTREM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HATTERENE:
	ScriptGiveMon(SPECIES_HATTERENE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case IMPIDIMP:
	ScriptGiveMon(SPECIES_IMPIDIMP,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MORGREM:
	ScriptGiveMon(SPECIES_MORGREM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRIMMSNARL:
	ScriptGiveMon(SPECIES_GRIMMSNARL,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case OBSTAGOON:
	ScriptGiveMon(SPECIES_OBSTAGOON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PERRSERKER:
	ScriptGiveMon(SPECIES_PERRSERKER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CURSOLA:
	ScriptGiveMon(SPECIES_CURSOLA,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SIRFETCHD:
	ScriptGiveMon(SPECIES_SIRFETCHD,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MR_RIME:
	ScriptGiveMon(SPECIES_MR_RIME,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RUNERIGUS:
	ScriptGiveMon(SPECIES_RUNERIGUS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MILCERY:
	ScriptGiveMon(SPECIES_MILCERY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ALCREMIE:
	ScriptGiveMon(SPECIES_ALCREMIE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FALINKS:
	ScriptGiveMon(SPECIES_FALINKS,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PINCURCHIN:
	ScriptGiveMon(SPECIES_PINCURCHIN,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNOM:
	ScriptGiveMon(SPECIES_SNOM,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FROSMOTH:
	ScriptGiveMon(SPECIES_FROSMOTH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STONJOURNER:
	ScriptGiveMon(SPECIES_STONJOURNER,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EISCUE:
	ScriptGiveMon(SPECIES_EISCUE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case INDEEDEE:
	ScriptGiveMon(SPECIES_INDEEDEE,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MORPEKO:
	ScriptGiveMon(SPECIES_MORPEKO,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CUFANT:
	ScriptGiveMon(SPECIES_CUFANT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COPPERAJAH:
	ScriptGiveMon(SPECIES_COPPERAJAH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRACOZOLT:
	ScriptGiveMon(SPECIES_DRACOZOLT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARCTOZOLT:
	ScriptGiveMon(SPECIES_ARCTOZOLT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRACOVISH:
	ScriptGiveMon(SPECIES_DRACOVISH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARCTOVISH:
	ScriptGiveMon(SPECIES_ARCTOVISH,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DURALUDON:
	ScriptGiveMon(SPECIES_DURALUDON,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DREEPY:
	ScriptGiveMon(SPECIES_DREEPY,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAKLOAK:
	ScriptGiveMon(SPECIES_DRAKLOAK,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAGAPULT:
	ScriptGiveMon(SPECIES_DRAGAPULT,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TRXATU:
	ScriptGiveMon(SPECIES_TRXATU,108,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;
	}
