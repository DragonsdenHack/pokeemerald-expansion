...
static void DarPokemonBasicosKanto(u8 opcion){
	switch (opcion)
	{
		...
		case 3: //dlc
			...
			/*posibles pokes que te regalan*/
			ScriptGiveCustomMon(SPECIES_REGIELEKI,110,ITEM_NONE,26,NATURE_HASTY,0xFF, 0, (u8*)31, MOVE_AMNESIA, MOVE_THUNDER,MOVE_THUNDER_WAVE,MOVE_SEISMIC_TOSS,0);
			...
			ScriptGiveCustomMon(SPECIES_CALYREX,110,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_RECOVER, MOVE_PSYCHO_BOOST,MOVE_PSYSTRIKE,MOVE_ME_FIRST,0);
			ScriptGiveCustomMon(SPECIES_ZAPDOS_PRIMAL,110,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_RECOVER, MOVE_PSYCHO_BOOST,MOVE_PSYSTRIKE,MOVE_ME_FIRST,0);
			ScriptGiveCustomMon(SPECIES_EMBOAR,110,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_RECOVER, MOVE_PSYCHO_BOOST,MOVE_PSYSTRIKE,MOVE_ME_FIRST,0);
		break;
	};
}
