...
static void DarPokemonBasicosKanto(u8 opcion){
	...
	switch (opcion)
	{
		...
		ScriptGiveCustomMon(SPECIES_CROBAT,65,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_NASTY_PLOT, MOVE_FLY,MOVE_CROSS_POISON,MOVE_CONFUSE_RAY,0);
		...
		ScriptGiveCustomMon(SPECIES_CROBAT,79,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_CURSE, MOVE_TAILWIND,MOVE_POISON_FANG,MOVE_FLY,0);
		...
		ScriptGiveCustomMon(SPECIES_OMASTAR,77,ITEM_MYSTIC_WATER,26,NATURE_QUIET,2, 0, (u8*)20, MOVE_SPIKES, MOVE_ICE_BEAM,MOVE_SHELL_SMASH,MOVE_BRINE,0);
		...
		ScriptGiveCustomMon(SPECIES_HITMONCHAN,77,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_HIGH_JUMP_KICK, MOVE_DRAIN_PUNCH,MOVE_REVENGE,MOVE_CLOSE_COMBAT,0);                  //FALTANTE
		...
		ScriptGiveCustomMon(SPECIES_CROBAT_BOND,100,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_ZEN_HEADBUTT, MOVE_SUPER_FANG,MOVE_GUNK_SHOT,MOVE_FLY,0);
		...
		ScriptGiveCustomMon(SPECIES_KABUTOPS,98,ITEM_HARD_STONE,26,NATURE_ADAMANT,2, 0, (u8*)31, MOVE_SHELL_SMASH, MOVE_ROCK_SLIDE,MOVE_AQUA_JET,MOVE_NIGHT_SLASH,0);
		...
		ScriptGiveCustomMon(SPECIES_HITMONCHAN,98,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HIGH_JUMP_KICK, MOVE_DRAIN_PUNCH,MOVE_REVENGE,MOVE_CLOSE_COMBAT,0);
		...
		ScriptGiveCustomMon(SPECIES_LUCARIO,98,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HIGH_JUMP_KICK, MOVE_EXTREME_SPEED,MOVE_METEOR_MASH,MOVE_REVERSAL,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEWEAR,98,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_FORCE_PALM, MOVE_THRASH,MOVE_DRAIN_PUNCH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){6, 0, 252, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_FLORGES,98,ITEM_LUM_BERRY,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ENDEAVOR, MOVE_PETAL_DANCE,MOVE_CALM_MIND,MOVE_AROMATHERAPY,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BAXCALIBUR,98,ITEM_CHOICE_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_ICICLE_SPEAR, MOVE_CRUNCH,MOVE_DRAGON_DANCE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EMPOLEON,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_AQUA_RING, MOVE_STEALTH_ROCK,MOVE_HYDRO_PUMP,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_INFERNAPE,98,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_FAKE_OUT, MOVE_ACROBATICS,MOVE_CLOSE_COMBAT,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGAPULT,98,ITEM_POWER_HERB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SUCKER_PUNCH, MOVE_DRAGON_DANCE,MOVE_DRAGON_DARTS,MOVE_SHADOW_FORCE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEOXYS,98,ITEM_WHITE_HERB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_COSMIC_POWER, MOVE_PSYCHIC,MOVE_PSYCHO_BOOST,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGIROCK,98,ITEM_NONE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_ROCK_POLISH, MOVE_STONE_EDGE,MOVE_STEALTH_ROCK,MOVE_SELF_DESTRUCT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGICE,98,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_AMNESIA, MOVE_ICE_BEAM,MOVE_ZAP_CANNON,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGISTEEL,98,ITEM_NONE,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_AMNESIA, MOVE_STEEL_BEAM,MOVE_THUNDER_WAVE,MOVE_SEISMIC_TOSS,0);
		break;
		case 3: //dlc
		...
		ScriptGiveCustomMon(SPECIES_CROBAT_BOND,112,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_ZEN_HEADBUTT, MOVE_SUPER_FANG,MOVE_GUNK_SHOT,MOVE_FLY,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HOUNDOOM,110,ITEM_CHARCOAL,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_SUCKER_PUNCH, MOVE_SLUDGE_BOMB,MOVE_FLAMETHROWER,MOVE_FIRE_BLAST,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAROWAK,110,ITEM_THICK_CLUB,26,NATURE_ADAMANT,0, 0, (u8*)31, MOVE_BELLY_DRUM, MOVE_EARTHQUAKE,MOVE_THRASH,MOVE_DOUBLE_EDGE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_AERODACTYL,110,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CURSE, MOVE_STEALTH_ROCK,MOVE_ROCK_SLIDE,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENUSAUR,110,ITEM_MIRACLE_SEED,26,NATURE_HARDY,2, 0, (u8*)31, MOVE_GRASSY_TERRAIN, MOVE_ENERGY_BALL,MOVE_PETAL_BLIZZARD,MOVE_PETAL_DANCE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON,110,ITEM_UPGRADE,26,NATURE_JOLLY,1, 0, (u8*)31, MOVE_MAGNET_RISE, MOVE_SHADOW_BALL,MOVE_TRI_ATTACK,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_OMASTAR,110,ITEM_MYSTIC_WATER,26,NATURE_MODEST,0, 0, (u8*)31, MOVE_REFLECT_TYPE, MOVE_SURF,MOVE_ANCIENT_POWER,MOVE_HYDRO_PUMP,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KABUTOPS,110,ITEM_HARD_STONE,26,NATURE_ADAMANT,2, 0, (u8*)31, MOVE_CONFUSE_RAY, MOVE_ROCK_SLIDE,MOVE_AQUA_JET,MOVE_NIGHT_SLASH,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PINSIR,110,ITEM_SILVER_POWDER,26,NATURE_ADAMANT,2, 0, (u8*)31, MOVE_BUG_BITE, MOVE_EARTHQUAKE,MOVE_X_SCISSOR,MOVE_THRASH,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,110,ITEM_SUN_STONE,26,NATURE_JOLLY,1, 0, (u8*)31, MOVE_STORED_POWER, MOVE_ECHOED_VOICE,MOVE_SWIFT,MOVE_TRUMP_CARD,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,110,ITEM_MOON_STONE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CURSE, MOVE_CRUNCH,MOVE_TOXIC,MOVE_MOONLIGHT,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,110,ITEM_THUNDER_STONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_WISH, MOVE_SUBSTITUTE,MOVE_SWIFT,MOVE_REFRESH,0);

		memcpy(evs, (u8[]){6, 0, 252, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,110,ITEM_WATER_STONE,26,NATURE_BOLD,1, 0, (u8*)31, MOVE_ENDURE, MOVE_RAIN_DANCE,MOVE_SWIFT,MOVE_BATON_PASS,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,110,ITEM_FIRE_STONE,26,NATURE_ADAMANT,1, 0, (u8*)31, MOVE_SING, MOVE_FACADE,MOVE_BITE,MOVE_DOUBLE_EDGE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARTICUNO,110,ITEM_LUM_BERRY,26,NATURE_CALM,0xFF, 0, (u8*)31, MOVE_HEAL_BELL, MOVE_FROST_BREATH,MOVE_ICE_BEAM,MOVE_SHEER_COLD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ZAPDOS,110,ITEM_LUM_BERRY,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_BATON_PASS, MOVE_ROOST,MOVE_THUNDERBOLT,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MOLTRES,110,ITEM_LUM_BERRY,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_MORNING_SUN, MOVE_ROOST,MOVE_FLAMETHROWER,MOVE_BURN_UP,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ENTEI,110,ITEM_LUM_BERRY,26,NATURE_MILD,0xFF, 0, (u8*)31, MOVE_FLARE_BLITZ, MOVE_STOMPING_TANTRUM,MOVE_SACRED_FIRE,MOVE_ERUPTION,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 6, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SUICUNE,110,ITEM_LUM_BERRY,26,NATURE_CALM,0xFF, 0, (u8*)31, MOVE_AIR_SLASH, MOVE_ICE_BEAM,MOVE_CALM_MIND,MOVE_HYDRO_PUMP,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAIKOU,110,ITEM_LUM_BERRY,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ZAP_CANNON, MOVE_THUNDERBOLT,MOVE_EXTRASENSORY,MOVE_REFLECT,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BRAVIARY,110,ITEM_SILK_SCARF,26,NATURE_JOLLY,2, 0, (u8*)31, MOVE_ROCK_SLIDE, MOVE_BRAVE_BIRD,MOVE_SUPERPOWER,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VIKAVOLT,110,ITEM_CHOICE_SPECS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MUD_SHOT, MOVE_THUNDERBOLT,MOVE_BUG_BUZZ,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MANDIBUZZ,110,ITEM_LEFTOVERS,26,NATURE_IMPISH,1, 0, (u8*)31, MOVE_FOUL_PLAY, MOVE_TAUNT,MOVE_DARK_PULSE,MOVE_NASTY_PLOT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PROBOPASS,110,ITEM_LIFE_ORB,26,NATURE_QUIET,2, 0, (u8*)31, MOVE_EXPLOSION, MOVE_DAZZLING_GLEAM,MOVE_POWER_GEM,MOVE_MAGNETIC_FLUX,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SLAKING,110,ITEM_CHOICE_BAND,26,NATURE_NAUGHTY,2, 0, (u8*)31, MOVE_NIGHT_SLASH, MOVE_POWER_UP_PUNCH,MOVE_SLASH,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){6, 252, 252, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HITMONCHAN,110,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HIGH_JUMP_KICK, MOVE_DRAIN_PUNCH,MOVE_REVENGE,MOVE_CLOSE_COMBAT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLASTOISE,110,ITEM_WATER_GEM,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_HYDRO_CANNON, MOVE_ICE_BEAM,MOVE_FLASH_CANNON,MOVE_HYDRO_PUMP,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LUCARIO,110,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HIGH_JUMP_KICK, MOVE_EXTREME_SPEED,MOVE_METEOR_MASH,MOVE_REVERSAL,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEWEAR,110,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_FORCE_PALM, MOVE_THRASH,MOVE_DRAIN_PUNCH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){6, 0, 252, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_FLORGES,110,ITEM_LUM_BERRY,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ENDEAVOR, MOVE_PETAL_DANCE,MOVE_CALM_MIND,MOVE_AROMATHERAPY,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BAXCALIBUR,110,ITEM_CHOICE_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_ICICLE_SPEAR, MOVE_CRUNCH,MOVE_DRAGON_DANCE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EMPOLEON,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_AQUA_RING, MOVE_STEALTH_ROCK,MOVE_HYDRO_PUMP,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_INFERNAPE,110,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_FAKE_OUT, MOVE_ACROBATICS,MOVE_CLOSE_COMBAT,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGAPULT,110,ITEM_POWER_HERB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SUCKER_PUNCH, MOVE_DRAGON_DANCE,MOVE_DRAGON_DARTS,MOVE_SHADOW_FORCE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEOXYS,110,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_COSMIC_POWER, MOVE_PSYCHIC,MOVE_PSYCHO_BOOST,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGIROCK,110,ITEM_NONE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_ROCK_POLISH, MOVE_STONE_EDGE,MOVE_STEALTH_ROCK,MOVE_SELF_DESTRUCT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGICE,110,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_AMNESIA, MOVE_ICE_BEAM,MOVE_ZAP_CANNON,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGISTEEL,110,ITEM_NONE,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_AMNESIA, MOVE_STEEL_BEAM,MOVE_THUNDER_WAVE,MOVE_SEISMIC_TOSS,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HO_OH,110,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_RECOVER, MOVE_SACRED_FIRE,MOVE_BRAVE_BIRD,MOVE_EARTHQUAKE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LUGIA,110,ITEM_NONE,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_RECOVER, MOVE_AEROBLAST,MOVE_PSYCHO_BOOST,MOVE_ORIGIN_PULSE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MEWTWO,110,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_RECOVER, MOVE_PSYCHO_BOOST,MOVE_PSYSTRIKE,MOVE_ME_FIRST,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SILVALLY,110,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MULTI_ATTACK, MOVE_FLAME_CHARGE,MOVE_U_TURN,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ZAPDOS_PRIMAL,110,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_HEAT_WAVE, MOVE_THUNDERBOLT,MOVE_DARK_PULSE,MOVE_ROOST,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EMBOAR,110,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_SUCKER_PUNCH, MOVE_FLAME_CHARGE,MOVE_HEAD_SMASH,MOVE_FLARE_BLITZ,0);	

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_AKUERIA,110,ITEM_NONE,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_HYDRO_PUMP, MOVE_FIRE_BLAST,MOVE_DRACO_METEOR,MOVE_BLIZZARD,0);	
		break;
	};
}
...
static void DarPokemonClassicKanto(u8 opcion){
	...
	switch(opcion)
	{
		...
		ScriptGiveCustomMon(SPECIES_GENGAR,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_DISABLE, MOVE_SHADOW_BALL,MOVE_HYPNOSIS,MOVE_FOCUS_BLAST,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ALAKAZAM,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_FUTURE_SIGHT, MOVE_PSYCHIC,MOVE_RECOVER,MOVE_BARRIER,0); 

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);
			ScriptGiveCustomMon(SPECIES_MACHAMP,63,ITEM_EXPERT_BELT,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_BULLET_PUNCH, MOVE_DYNAMIC_PUNCH,MOVE_KNOCK_OFF,MOVE_METRONOME,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAICHU,63,ITEM_FOCUS_SASH,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_WISH, MOVE_NUZZLE,MOVE_THUNDERBOLT,MOVE_SUBMISSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGLER,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_HAMMER_ARM, MOVE_CRABHAMMER,MOVE_ROCK_SLIDE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 6, 0, 252, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,63,ITEM_ASSAULT_VEST,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN,MOVE_SLUDGE_BOMB,MOVE_LEAF_STORM,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MUK,63,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_SHADOW_PUNCH, MOVE_GUNK_SHOT,MOVE_ACID_ARMOR,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLEM,63,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_HAMMER_ARM, MOVE_ROCK_BLAST,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DODRIO,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_SKY_ATTACK, MOVE_DRILL_RUN,MOVE_DRILL_PECK,MOVE_JUMP_KICK,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGONITE,63,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_GENGAR,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_DISABLE, MOVE_SHADOW_BALL,MOVE_HYPNOSIS,MOVE_FOCUS_BLAST,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ALAKAZAM,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_FUTURE_SIGHT, MOVE_PSYCHIC,MOVE_RECOVER,MOVE_BARRIER,0); 

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MACHAMP,77,ITEM_EXPERT_BELT,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_BULLET_PUNCH, MOVE_DYNAMIC_PUNCH,MOVE_KNOCK_OFF,MOVE_METRONOME,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAICHU,77,ITEM_FOCUS_SASH,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_WISH, MOVE_NUZZLE,MOVE_THUNDERBOLT,MOVE_SUBMISSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGLER,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_HAMMER_ARM, MOVE_CRABHAMMER,MOVE_ROCK_SLIDE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 6, 0, 252, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,77,ITEM_ASSAULT_VEST,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN,MOVE_SLUDGE_BOMB,MOVE_LEAF_STORM,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MUK,77,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_SHADOW_PUNCH, MOVE_GUNK_SHOT,MOVE_ACID_ARMOR,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLEM,77,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_HAMMER_ARM, MOVE_ROCK_BLAST,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DODRIO,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_SKY_ATTACK, MOVE_DRILL_RUN,MOVE_DRILL_PECK,MOVE_JUMP_KICK,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGONITE,77,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_GENGAR,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_DISABLE, MOVE_SHADOW_BALL,MOVE_HYPNOSIS,MOVE_FOCUS_BLAST,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ALAKAZAM,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_FUTURE_SIGHT, MOVE_PSYCHIC,MOVE_RECOVER,MOVE_BARRIER,0); 

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MACHAMP,98,ITEM_EXPERT_BELT,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_BULLET_PUNCH, MOVE_DYNAMIC_PUNCH,MOVE_KNOCK_OFF,MOVE_METRONOME,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAICHU,98,ITEM_FOCUS_SASH,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_WISH, MOVE_NUZZLE,MOVE_THUNDERBOLT,MOVE_SUBMISSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGLER,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HAMMER_ARM, MOVE_CRABHAMMER,MOVE_ROCK_SLIDE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 6, 0, 252, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,98,ITEM_ASSAULT_VEST,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN,MOVE_SLUDGE_BOMB,MOVE_LEAF_STORM,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MUK,98,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SHADOW_PUNCH, MOVE_GUNK_SHOT,MOVE_ACID_ARMOR,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLEM,98,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HAMMER_ARM, MOVE_ROCK_BLAST,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DODRIO,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SKY_ATTACK, MOVE_DRILL_RUN,MOVE_DRILL_PECK,MOVE_JUMP_KICK,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGONITE,98,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_GENGAR,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_DISABLE, MOVE_SHADOW_BALL,MOVE_HYPNOSIS,MOVE_FOCUS_BLAST,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ALAKAZAM,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_FUTURE_SIGHT, MOVE_PSYCHIC,MOVE_RECOVER,MOVE_BARRIER,0); 

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MACHAMP,110,ITEM_EXPERT_BELT,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_BULLET_PUNCH, MOVE_DYNAMIC_PUNCH,MOVE_KNOCK_OFF,MOVE_METRONOME,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAICHU,110,ITEM_FOCUS_SASH,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_WISH, MOVE_NUZZLE,MOVE_THUNDERBOLT,MOVE_SUBMISSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGLER,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HAMMER_ARM, MOVE_CRABHAMMER,MOVE_ROCK_SLIDE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 6, 0, 252, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,110,ITEM_ASSAULT_VEST,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN,MOVE_SLUDGE_BOMB,MOVE_LEAF_STORM,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MUK,110,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SHADOW_PUNCH, MOVE_GUNK_SHOT,MOVE_ACID_ARMOR,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLEM,110,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HAMMER_ARM, MOVE_ROCK_BLAST,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DODRIO,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SKY_ATTACK, MOVE_DRILL_RUN,MOVE_DRILL_PECK,MOVE_JUMP_KICK,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGONITE,110,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);
		break;
	}
}
...
static void DarPokemonRocketGrunt(u8 opcion)
{
	...
	switch(opcion)
	{
		...
		ScriptGiveCustomMon(SPECIES_RATICATE,63,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_REVERSAL, MOVE_HYPER_FANG,MOVE_SUCKER_PUNCH,MOVE_SWORDS_DANCE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SANDSLASH,63,ITEM_SOFT_SAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_HONE_CLAWS, MOVE_EARTHQUAKE,MOVE_STONE_EDGE,MOVE_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DUGTRIO,63,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_MEMENTO, MOVE_GIGA_IMPACT,MOVE_EARTHQUAKE,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PERSIAN,63,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_HYPNOSIS, MOVE_FAKE_OUT,MOVE_SLASH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEEDRILL,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_KNOCK_OFF, MOVE_TOXIC_SPIKES,MOVE_ACROBATICS,MOVE_U_TURN,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARBOK,63,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_SUCKER_PUNCH, MOVE_GLARE,MOVE_COIL,MOVE_GUNK_SHOT,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PRIMEAPE,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_COUNTER, MOVE_CLOSE_COMBAT,MOVE_U_TURN,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HYPNO,63,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_BARRIER, MOVE_PSYCHIC,MOVE_THUNDER_WAVE,MOVE_FOUL_PLAY,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_QWILFISH,63,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_SELF_DESTRUCT, MOVE_TOXIC_SPIKES,MOVE_SPIKES,MOVE_AQUA_TAIL,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PARASECT,63,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_SPORE, MOVE_LEECH_LIFE,MOVE_KNOCK_OFF,MOVE_SUBSTITUTE,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_RATICATE,77,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_REVERSAL, MOVE_HYPER_FANG,MOVE_SUCKER_PUNCH,MOVE_SWORDS_DANCE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SANDSLASH,77,ITEM_SOFT_SAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_HONE_CLAWS, MOVE_EARTHQUAKE,MOVE_STONE_EDGE,MOVE_SPIKES,0);

 		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DUGTRIO,77,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_MEMENTO, MOVE_GIGA_IMPACT,MOVE_EARTHQUAKE,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PERSIAN,77,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_HYPNOSIS, MOVE_FAKE_OUT,MOVE_SLASH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEEDRILL,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_KNOCK_OFF, MOVE_TOXIC_SPIKES,MOVE_ACROBATICS,MOVE_U_TURN,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARBOK,77,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_SUCKER_PUNCH, MOVE_GLARE,MOVE_COIL,MOVE_GUNK_SHOT,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PRIMEAPE,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_COUNTER, MOVE_CLOSE_COMBAT,MOVE_U_TURN,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HYPNO,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_BARRIER, MOVE_PSYCHIC,MOVE_THUNDER_WAVE,MOVE_FOUL_PLAY,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_QWILFISH,77,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_SELF_DESTRUCT, MOVE_TOXIC_SPIKES,MOVE_SPIKES,MOVE_AQUA_TAIL,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GRANBULL,77,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_RETALIATE, MOVE_PLAY_ROUGH,MOVE_CRUNCH,MOVE_CLOSE_COMBAT,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_RATICATE,98,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_REVERSAL, MOVE_HYPER_FANG,MOVE_SUCKER_PUNCH,MOVE_SWORDS_DANCE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SANDSLASH,98,ITEM_SOFT_SAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HONE_CLAWS, MOVE_EARTHQUAKE,MOVE_STONE_EDGE,MOVE_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DUGTRIO,98,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_MEMENTO, MOVE_GIGA_IMPACT,MOVE_EARTHQUAKE,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PERSIAN,98,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_FAKE_OUT,MOVE_SLASH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEEDRILL,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_KNOCK_OFF, MOVE_TOXIC_SPIKES,MOVE_ACROBATICS,MOVE_U_TURN,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARBOK,98,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SUCKER_PUNCH, MOVE_GLARE,MOVE_COIL,MOVE_GUNK_SHOT,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PRIMEAPE,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_COUNTER, MOVE_CLOSE_COMBAT,MOVE_U_TURN,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HYPNO,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_BARRIER, MOVE_PSYCHIC,MOVE_THUNDER_WAVE,MOVE_FOUL_PLAY,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_QWILFISH,98,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SELF_DESTRUCT, MOVE_TOXIC_SPIKES,MOVE_SPIKES,MOVE_AQUA_TAIL,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GRANBULL,98,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_RETALIATE, MOVE_PLAY_ROUGH,MOVE_CRUNCH,MOVE_CLOSE_COMBAT,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_RATICATE,110,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_REVERSAL, MOVE_HYPER_FANG,MOVE_SUCKER_PUNCH,MOVE_SWORDS_DANCE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SANDSLASH,110,ITEM_SOFT_SAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HONE_CLAWS, MOVE_EARTHQUAKE,MOVE_STONE_EDGE,MOVE_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DUGTRIO,110,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_MEMENTO, MOVE_GIGA_IMPACT,MOVE_EARTHQUAKE,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PERSIAN,110,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_FAKE_OUT,MOVE_SLASH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEEDRILL,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_KNOCK_OFF, MOVE_TOXIC_SPIKES,MOVE_ACROBATICS,MOVE_U_TURN,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARBOK,110,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SUCKER_PUNCH, MOVE_GLARE,MOVE_COIL,MOVE_GUNK_SHOT,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PRIMEAPE,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_COUNTER, MOVE_CLOSE_COMBAT,MOVE_U_TURN,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HYPNO,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_BARRIER, MOVE_PSYCHIC,MOVE_THUNDER_WAVE,MOVE_FOUL_PLAY,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_QWILFISH,110,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SELF_DESTRUCT, MOVE_TOXIC_SPIKES,MOVE_SPIKES,MOVE_AQUA_TAIL,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GRANBULL,110,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_RETALIATE, MOVE_PLAY_ROUGH,MOVE_CRUNCH,MOVE_CLOSE_COMBAT,0);
		break;
	}	
}
...
static void DarPokemonRocketScientist(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_MAGNEZONE,63,ITEM_MAGNET,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_ELECTROWEB, MOVE_DISCHARGE,MOVE_IRON_DEFENSE,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON2,63,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_CONVERSION, MOVE_TRI_ATTACK,MOVE_PSYSHOCK,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGNETON,63,ITEM_EVIOLITE,26,NATURE_BOLD,0xFF, 0, (u8*)15, MOVE_CHARGE_BEAM, MOVE_THUNDERBOLT,MOVE_FLASH_CANNON,MOVE_TELEPORT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ESPEON,63,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_WISH, MOVE_PSYCHIC,MOVE_DAZZLING_GLEAM,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DITTO,63,ITEM_CHOICE_SCARF,26,NATURE_HARDY,1, 0, (u8*)15, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTABUZZ,63,ITEM_MAGNET,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_CROSS_CHOP, MOVE_THUNDER_PUNCH,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,63,ITEM_LIGHT_CLAY,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHANSEY,63,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)15, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JYNX,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_WISH, MOVE_LOVELY_KISS,MOVE_PSYCHIC,MOVE_BLIZZARD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENOMOTH,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_BUG_BUZZ,MOVE_QUIVER_DANCE,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_MAGNEZONE,77,ITEM_MAGNET,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_ELECTROWEB, MOVE_DISCHARGE,MOVE_IRON_DEFENSE,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON2,77,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_CONVERSION, MOVE_TRI_ATTACK,MOVE_PSYSHOCK,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGNETON,77,ITEM_EVIOLITE,26,NATURE_BOLD,0xFF, 0, (u8*)20, MOVE_CHARGE_BEAM, MOVE_THUNDERBOLT,MOVE_FLASH_CANNON,MOVE_TELEPORT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ESPEON,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_WISH, MOVE_PSYCHIC,MOVE_DAZZLING_GLEAM,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DITTO,77,ITEM_CHOICE_SCARF,26,NATURE_HARDY,1, 0, (u8*)20, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTABUZZ,77,ITEM_MAGNET,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_CROSS_CHOP, MOVE_THUNDER_PUNCH,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,77,ITEM_LIGHT_CLAY,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHANSEY,77,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)20, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JYNX,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_WISH, MOVE_LOVELY_KISS,MOVE_PSYCHIC,MOVE_BLIZZARD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENOMOTH,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_BUG_BUZZ,MOVE_QUIVER_DANCE,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_MAGNEZONE,98,ITEM_MAGNET,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ELECTROWEB, MOVE_DISCHARGE,MOVE_IRON_DEFENSE,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON2,98,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CONVERSION, MOVE_TRI_ATTACK,MOVE_PSYSHOCK,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGNETON,98,ITEM_EVIOLITE,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_CHARGE_BEAM, MOVE_THUNDERBOLT,MOVE_FLASH_CANNON,MOVE_TELEPORT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ESPEON,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_WISH, MOVE_PSYCHIC,MOVE_DAZZLING_GLEAM,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DITTO,98,ITEM_CHOICE_SCARF,26,NATURE_HARDY,1, 0, (u8*)31, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTABUZZ,98,ITEM_MAGNET,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CROSS_CHOP, MOVE_THUNDER_PUNCH,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,98,ITEM_LIGHT_CLAY,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHANSEY,98,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JYNX,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_WISH, MOVE_LOVELY_KISS,MOVE_PSYCHIC,MOVE_BLIZZARD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENOMOTH,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_BUG_BUZZ,MOVE_QUIVER_DANCE,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_MAGNEZONE,110,ITEM_MAGNET,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ELECTROWEB, MOVE_DISCHARGE,MOVE_IRON_DEFENSE,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON2,110,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CONVERSION, MOVE_TRI_ATTACK,MOVE_PSYSHOCK,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGNETON,110,ITEM_EVIOLITE,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_CHARGE_BEAM, MOVE_THUNDERBOLT,MOVE_FLASH_CANNON,MOVE_TELEPORT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ESPEON,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_WISH, MOVE_PSYCHIC,MOVE_DAZZLING_GLEAM,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DITTO,110,ITEM_CHOICE_SCARF,26,NATURE_HARDY,1, 0, (u8*)31, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTABUZZ,110,ITEM_MAGNET,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CROSS_CHOP, MOVE_THUNDER_PUNCH,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,110,ITEM_LIGHT_CLAY,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHANSEY,110,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JYNX,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_WISH, MOVE_LOVELY_KISS,MOVE_PSYCHIC,MOVE_BLIZZARD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENOMOTH,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_BUG_BUZZ,MOVE_QUIVER_DANCE,0);
		break;
	}
}
...
static void DarPokemonRocketAdmin(u8 opcion)
{
	...
	u8 ivs[6] = {0};
		...
		ScriptGiveCustomMon(SPECIES_RHYPERIOR,63,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_METAL_BURST, MOVE_ROCK_POLISH,MOVE_EARTHQUAKE,MOVE_ROCK_WRECKER,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOKING,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_HEAD_SMASH, MOVE_POISON_JAB,MOVE_EARTHQUAKE,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOQUEEN,63,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_COUNTER, MOVE_TOXIC_SPIKES,MOVE_EARTH_POWER,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TAUROS,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_ENDEAVOR, MOVE_BODY_SLAM,MOVE_CLOSE_COMBAT,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEEZING,63,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, 0, (u8*)15, MOVE_PAIN_SPLIT, MOVE_WILL_O_WISP,MOVE_SLUDGE_BOMB,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KANGASKHAN,63,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_HAMMER_ARM, MOVE_FAKE_OUT,MOVE_DOUBLE_EDGE,MOVE_SUCKER_PUNCH,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTIVIRE,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_CROSS_CHOP, MOVE_WILD_CHARGE,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMORTAR,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_MACH_PUNCH, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEAVILE,63,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_FAKE_OUT, MOVE_NIGHT_SLASH,MOVE_ICICLE_CRASH,MOVE_TAUNT,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HONCHKROW,63,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_SUCKER_PUNCH, MOVE_DRILL_PECK,MOVE_U_TURN,MOVE_SKY_ATTACK,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_RHYPERIOR,77,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_METAL_BURST, MOVE_ROCK_POLISH,MOVE_EARTHQUAKE,MOVE_ROCK_WRECKER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOKING,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_HEAD_SMASH, MOVE_POISON_JAB,MOVE_EARTHQUAKE,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOQUEEN,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_COUNTER, MOVE_TOXIC_SPIKES,MOVE_EARTH_POWER,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TAUROS,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_ENDEAVOR, MOVE_BODY_SLAM,MOVE_CLOSE_COMBAT,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEEZING,77,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, 0, (u8*)20, MOVE_PAIN_SPLIT, MOVE_WILL_O_WISP,MOVE_SLUDGE_BOMB,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KANGASKHAN,77,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_HAMMER_ARM, MOVE_FAKE_OUT,MOVE_DOUBLE_EDGE,MOVE_SUCKER_PUNCH,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTIVIRE,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_CROSS_CHOP, MOVE_WILD_CHARGE,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMORTAR,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_MACH_PUNCH, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEAVILE,77,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_FAKE_OUT, MOVE_NIGHT_SLASH,MOVE_ICICLE_CRASH,MOVE_TAUNT,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HONCHKROW,77,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_SUCKER_PUNCH, MOVE_DRILL_PECK,MOVE_U_TURN,MOVE_SKY_ATTACK,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_RHYPERIOR,98,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_METAL_BURST, MOVE_ROCK_POLISH,MOVE_EARTHQUAKE,MOVE_ROCK_WRECKER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOKING,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HEAD_SMASH, MOVE_POISON_JAB,MOVE_EARTHQUAKE,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOQUEEN,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_COUNTER, MOVE_TOXIC_SPIKES,MOVE_EARTH_POWER,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TAUROS,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_ENDEAVOR, MOVE_BODY_SLAM,MOVE_CLOSE_COMBAT,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEEZING,98,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, 0, (u8*)31, MOVE_PAIN_SPLIT, MOVE_WILL_O_WISP,MOVE_SLUDGE_BOMB,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KANGASKHAN,98,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HAMMER_ARM, MOVE_FAKE_OUT,MOVE_DOUBLE_EDGE,MOVE_SUCKER_PUNCH,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTIVIRE,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CROSS_CHOP, MOVE_WILD_CHARGE,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMORTAR,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MACH_PUNCH, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEAVILE,98,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_FAKE_OUT, MOVE_NIGHT_SLASH,MOVE_ICICLE_CRASH,MOVE_TAUNT,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HONCHKROW,98,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SUCKER_PUNCH, MOVE_DRILL_PECK,MOVE_U_TURN,MOVE_SKY_ATTACK,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_RHYPERIOR,110,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_METAL_BURST, MOVE_ROCK_POLISH,MOVE_EARTHQUAKE,MOVE_ROCK_WRECKER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOKING,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HEAD_SMASH, MOVE_POISON_JAB,MOVE_EARTHQUAKE,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOQUEEN,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_COUNTER, MOVE_TOXIC_SPIKES,MOVE_EARTH_POWER,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TAUROS,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_ENDEAVOR, MOVE_BODY_SLAM,MOVE_CLOSE_COMBAT,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEEZING,110,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, 0, (u8*)31, MOVE_PAIN_SPLIT, MOVE_WILL_O_WISP,MOVE_SLUDGE_BOMB,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KANGASKHAN,110,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HAMMER_ARM, MOVE_FAKE_OUT,MOVE_DOUBLE_EDGE,MOVE_SUCKER_PUNCH,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTIVIRE,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CROSS_CHOP, MOVE_WILD_CHARGE,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMORTAR,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MACH_PUNCH, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEAVILE,110,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_FAKE_OUT, MOVE_NIGHT_SLASH,MOVE_ICICLE_CRASH,MOVE_TAUNT,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HONCHKROW,110,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_SUCKER_PUNCH, MOVE_DRILL_PECK,MOVE_U_TURN,MOVE_SKY_ATTACK,0);
		break;
	}
}
...
static void DarPokemonRainTeam(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_POLITOED,63,ITEM_DAMP_ROCK,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_ENDEAVOR, MOVE_HYDRO_PUMP,MOVE_AMNESIA,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGDRA,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_DISABLE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_STARMIE,63,ITEM_LIGHT_CLAY,26,NATURE_TIMID,0xFF, 0, (u8*)15, MOVE_REFRESH, MOVE_REFLECT,MOVE_LIGHT_SCREEN,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLDUCK,63,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_PSYCHIC,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TENTACRUEL,63,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, 0, (u8*)15, MOVE_MIRROR_COAT, MOVE_BARRIER,MOVE_SURF,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GYARADOS,63,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_BOUNCE, MOVE_THRASH,MOVE_AQUA_TAIL,MOVE_DRAGON_RUSH,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VAPOREON,63,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)15, MOVE_WISH, MOVE_ACID_ARMOR,MOVE_HYDRO_PUMP,MOVE_BATON_PASS,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LAPRAS,63,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_CURSE, MOVE_LIQUIDATION,MOVE_ICE_SHARD,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEWGONG,63,ITEM_SITRUS_BERRY,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_STOCKPILE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SEAKING,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_ACUPRESSURE, MOVE_LIQUIDATION,MOVE_MEGAHORN,MOVE_GIGA_IMPACT,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_POLITOED,77,ITEM_DAMP_ROCK,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_ENDEAVOR, MOVE_HYDRO_PUMP,MOVE_AMNESIA,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGDRA,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_DISABLE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_STARMIE,77,ITEM_LIGHT_CLAY,26,NATURE_TIMID,0xFF, 0, (u8*)20, MOVE_REFRESH, MOVE_REFLECT,MOVE_LIGHT_SCREEN,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLDUCK,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_PSYCHIC,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TENTACRUEL,77,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, 0, (u8*)20, MOVE_MIRROR_COAT, MOVE_BARRIER,MOVE_SURF,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GYARADOS,77,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_BOUNCE, MOVE_THRASH,MOVE_AQUA_TAIL,MOVE_DRAGON_RUSH,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VAPOREON,77,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)20, MOVE_WISH, MOVE_ACID_ARMOR,MOVE_HYDRO_PUMP,MOVE_BATON_PASS,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LAPRAS,77,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_CURSE, MOVE_LIQUIDATION,MOVE_ICE_SHARD,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEWGONG,77,ITEM_SITRUS_BERRY,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_STOCKPILE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LANTURN,77,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)20, MOVE_HEAL_BELL, MOVE_THUNDER,MOVE_SURF,MOVE_RAIN_DANCE,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_POLITOED,98,ITEM_DAMP_ROCK,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ENDEAVOR, MOVE_HYDRO_PUMP,MOVE_AMNESIA,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGDRA,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_DISABLE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_STARMIE,98,ITEM_LIGHT_CLAY,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_REFRESH, MOVE_REFLECT,MOVE_LIGHT_SCREEN,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLDUCK,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_PSYCHIC,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TENTACRUEL,98,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, 0, (u8*)31, MOVE_MIRROR_COAT, MOVE_BARRIER,MOVE_SURF,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GYARADOS,98,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_BOUNCE, MOVE_THRASH,MOVE_AQUA_TAIL,MOVE_DRAGON_RUSH,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);
	
		ScriptGiveCustomMon(SPECIES_HELIOLISK,98,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_SURF, MOVE_VOLT_SWITCH,MOVE_HYPER_VOICE,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LAPRAS,98,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CURSE, MOVE_LIQUIDATION,MOVE_ICE_SHARD,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEWGONG,98,ITEM_SITRUS_BERRY,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_STOCKPILE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LANTURN,98,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_HEAL_BELL, MOVE_THUNDER,MOVE_SURF,MOVE_RAIN_DANCE,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_POLITOED,110,ITEM_DAMP_ROCK,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ENDEAVOR, MOVE_HYDRO_PUMP,MOVE_AMNESIA,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGDRA,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_DISABLE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_STARMIE,110,ITEM_LIGHT_CLAY,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_REFRESH, MOVE_REFLECT,MOVE_LIGHT_SCREEN,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLDUCK,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_PSYCHIC,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TENTACRUEL,110,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, 0, (u8*)31, MOVE_MIRROR_COAT, MOVE_BARRIER,MOVE_SURF,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GYARADOS,110,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_BOUNCE, MOVE_THRASH,MOVE_AQUA_TAIL,MOVE_DRAGON_RUSH,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HELIOLISK,110,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_SURF, MOVE_VOLT_SWITCH,MOVE_HYPER_VOICE,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LAPRAS,110,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CURSE, MOVE_LIQUIDATION,MOVE_ICE_SHARD,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEWGONG,110,ITEM_SITRUS_BERRY,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_STOCKPILE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LANTURN,110,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_HEAL_BELL, MOVE_THUNDER,MOVE_SURF,MOVE_RAIN_DANCE,0);
		break;
	}
}
...
static void DarPokemonSunTeam(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_NINETALES,63,ITEM_HEAT_ROCK,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_HYPNOSIS, MOVE_FLAMETHROWER,MOVE_SOLAR_BEAM,MOVE_WILL_O_WISP,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMAR,63,ITEM_EVIOLITE,26,NATURE_BOLD,0xFF, 0, (u8*)15, MOVE_CLEAR_SMOG, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARCANINE,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_THRASH, MOVE_FLARE_BLITZ,MOVE_CLOSE_COMBAT,MOVE_WILD_CHARGE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_FLAREON,63,ITEM_TOXIC_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_FACADE, MOVE_FLARE_BLITZ,MOVE_SUPERPOWER,MOVE_QUICK_ATTACK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAPIDASH,63,ITEM_LIFE_ORB,26,NATURE_HARDY, 0xFF, 0, (u8*)15, MOVE_MORNING_SUN, MOVE_SMART_STRIKE,MOVE_MEGAHORN,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JUMPLUFF,63,ITEM_LEFTOVERS,26,NATURE_TIMID,0xFF, 0, (u8*)15, MOVE_COTTON_GUARD, MOVE_SLEEP_POWDER,MOVE_SOLAR_BEAM,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_SLEEP_POWDER, MOVE_SOLAR_BEAM,MOVE_FUTURE_SIGHT,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,63,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM,MOVE_ANCIENT_POWER,MOVE_BLAST_BURN,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VICTREEBEL,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_SOLAR_BEAM,MOVE_SYNTHESIS,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VILEPLUME,63,ITEM_BLACK_SLUDGE,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_SOLAR_BEAM,MOVE_SYNTHESIS,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_NINETALES,77,ITEM_HEAT_ROCK,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_HYPNOSIS, MOVE_FLAMETHROWER,MOVE_SOLAR_BEAM,MOVE_WILL_O_WISP,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMAR,77,ITEM_EVIOLITE,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_CLEAR_SMOG, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARCANINE,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_THRASH, MOVE_FLARE_BLITZ,MOVE_CLOSE_COMBAT,MOVE_WILD_CHARGE,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TORKOAL,77,ITEM_HEAT_ROCK,26,NATURE_BOLD,0xFF, 0, (u8*)20, MOVE_RAPID_SPIN, MOVE_LAVA_PLUME,MOVE_CLEAR_SMOG,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAPIDASH,77,ITEM_LIFE_ORB,26,NATURE_HARDY, 0xFF, 0, (u8*)20, MOVE_MORNING_SUN, MOVE_SMART_STRIKE,MOVE_MEGAHORN,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JUMPLUFF,77,ITEM_LEFTOVERS,26,NATURE_TIMID,0xFF, 0, (u8*)20, MOVE_COTTON_GUARD, MOVE_SLEEP_POWDER,MOVE_SOLAR_BEAM,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_SLEEP_POWDER, MOVE_SOLAR_BEAM,MOVE_FUTURE_SIGHT,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,77,ITEM_LEFTOVERS,26,NATURE_TIMID,0xFF, 0, (u8*)20, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM,MOVE_ANCIENT_POWER,MOVE_BLAST_BURN,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VICTREEBEL,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_SOLAR_BEAM,MOVE_SYNTHESIS,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VOLCARONA,77,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_NINETALES,98,ITEM_HEAT_ROCK,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_FLAMETHROWER,MOVE_SOLAR_BEAM,MOVE_WILL_O_WISP,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMAR,98,ITEM_EVIOLITE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_CLEAR_SMOG, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HELIOLISK,98,ITEM_LIFE_ORB,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_SURF, MOVE_VOLT_SWITCH,MOVE_HYPER_VOICE,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TORKOAL,98,ITEM_HEAT_ROCK,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_RAPID_SPIN, MOVE_LAVA_PLUME,MOVE_CLEAR_SMOG,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DARMANITAN,98,ITEM_LIFE_ORB,26,NATURE_HARDY, 0xFF, 0, (u8*)31, MOVE_HAMMER_ARM, MOVE_YAWN,MOVE_GIGA_IMPACT,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JUMPLUFF,98,ITEM_LEFTOVERS,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_COTTON_GUARD, MOVE_SLEEP_POWDER,MOVE_SOLAR_BEAM,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_SLEEP_POWDER, MOVE_SOLAR_BEAM,MOVE_FUTURE_SIGHT,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){6, 0, 0, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM,MOVE_ANCIENT_POWER,MOVE_BLAST_BURN,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VICTREEBEL,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_SOLAR_BEAM,MOVE_SYNTHESIS,0);

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VOLCARONA,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_NINETALES,110,ITEM_HEAT_ROCK,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_FLAMETHROWER,MOVE_SOLAR_BEAM,MOVE_WILL_O_WISP,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMAR,110,ITEM_EVIOLITE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_CLEAR_SMOG, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HELIOLISK,110,ITEM_LIFE_ORB,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_SURF, MOVE_VOLT_SWITCH,MOVE_HYPER_VOICE,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TORKOAL,110,ITEM_HEAT_ROCK,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_RAPID_SPIN, MOVE_LAVA_PLUME,MOVE_CLEAR_SMOG,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DARMANITAN,110,ITEM_LIFE_ORB,26,NATURE_HARDY, 0xFF, 0, (u8*)31, MOVE_HAMMER_ARM, MOVE_YAWN,MOVE_GIGA_IMPACT,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JUMPLUFF,110,ITEM_LEFTOVERS,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_COTTON_GUARD, MOVE_SLEEP_POWDER,MOVE_SOLAR_BEAM,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_SLEEP_POWDER, MOVE_SOLAR_BEAM,MOVE_FUTURE_SIGHT,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM,MOVE_ANCIENT_POWER,MOVE_BLAST_BURN,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VICTREEBEL,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_SOLAR_BEAM,MOVE_SYNTHESIS,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VOLCARONA,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);
		break;
	}
}
...
static void DarPokemonRareTeam(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_SNORLAX,63,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_CURSE, MOVE_BODY_SLAM,MOVE_CRUNCH,MOVE_REST,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLASTOISE,63,ITEM_MYSTIC_WATER,26,NATURE_BOLD,0xFF, 0, (u8*)15, MOVE_MIRROR_COAT, MOVE_AQUA_RING,MOVE_IRON_DEFENSE,MOVE_HYDRO_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,63,ITEM_CHARCOAL,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_ANCIENT_POWER, MOVE_DRAGON_PULSE,MOVE_AIR_SLASH,MOVE_BLAST_BURN,0);
		
		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LICKILICKY,63,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_THRASH, MOVE_POWER_WHIP,MOVE_KNOCK_OFF,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){252, 0, 0, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CLEFABLE,63,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)15, MOVE_WISH, MOVE_MOONBLAST,MOVE_MOONLIGHT,MOVE_COSMIC_POWER,0);
		...
		ScriptGiveCustomMon(SPECIES_TOGETIC,63,ITEM_EVIOLITE,26,NATURE_MODEST,0xFF, 0, (u8*)15, MOVE_YAWN, MOVE_AIR_SLASH,MOVE_MYSTICAL_FIRE,MOVE_NASTY_PLOT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HITMONTOP,63,ITEM_NONE,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_RAPID_SPIN, MOVE_HIGH_JUMP_KICK,MOVE_SUCKER_PUNCH,MOVE_FAKE_OUT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SCYTHER,63,ITEM_NONE,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_COUNTER, MOVE_X_SCISSOR,MOVE_CLOSE_COMBAT,MOVE_PSYCHO_CUT,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_DRAGONITE,77,ITEM_DRAGON_FANG,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MILOTIC,77,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)20, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLASTOISE,77,ITEM_MYSTIC_WATER,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_MIRROR_COAT, MOVE_AQUA_RING,MOVE_IRON_DEFENSE,MOVE_HYDRO_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,77,ITEM_CHARCOAL,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_ANCIENT_POWER, MOVE_DRAGON_PULSE,MOVE_AIR_SLASH,MOVE_BLAST_BURN,0);

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VOLCARONA,77,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)20, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TRXATU,77,ITEM_SHARP_BEAK,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_ROOST, MOVE_PSYCHIC,MOVE_HEAT_WAVE,MOVE_AEROBLAST,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLISSEY,77,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)20, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TOGEKISS,77,ITEM_SHARP_BEAK,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_YAWN, MOVE_AIR_SLASH,MOVE_MYSTICAL_FIRE,MOVE_NASTY_PLOT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TYRANITAR,77,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_CRUNCH, MOVE_STONE_EDGE,MOVE_EARTHQUAKE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SCIZOR,77,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_COUNTER, MOVE_X_SCISSOR,MOVE_CLOSE_COMBAT,MOVE_BULLET_PUNCH,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_DRAGONITE,98,ITEM_DRAGON_FANG,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MILOTIC,98,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLASTOISE,98,ITEM_MYSTIC_WATER,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MIRROR_COAT, MOVE_AQUA_RING,MOVE_IRON_DEFENSE,MOVE_HYDRO_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,98,ITEM_CHARCOAL,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ANCIENT_POWER, MOVE_DRAGON_PULSE,MOVE_AIR_SLASH,MOVE_BLAST_BURN,0); 

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VOLCARONA,98,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TRXATU,98,ITEM_SHARP_BEAK,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_ROOST, MOVE_PSYCHIC,MOVE_HEAT_WAVE,MOVE_AEROBLAST,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLISSEY,98,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TOGEKISS,98,ITEM_SHARP_BEAK,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_YAWN, MOVE_AIR_SLASH,MOVE_MYSTICAL_FIRE,MOVE_NASTY_PLOT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TYRANITAR,98,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CRUNCH, MOVE_STONE_EDGE,MOVE_EARTHQUAKE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);
			ScriptGiveCustomMon(SPECIES_DUNSPARCE,98,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_CURSE, MOVE_EARTH_POWER,MOVE_ROOST,MOVE_BOOMBURST,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_MILOTIC,110,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLASTOISE,110,ITEM_MYSTIC_WATER,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MIRROR_COAT, MOVE_AQUA_RING,MOVE_IRON_DEFENSE,MOVE_HYDRO_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,110,ITEM_CHARCOAL,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_ANCIENT_POWER, MOVE_DRAGON_PULSE,MOVE_AIR_SLASH,MOVE_BLAST_BURN,0); 

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VOLCARONA,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TRXATU,110,ITEM_SHARP_BEAK,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_ROOST, MOVE_PSYCHIC,MOVE_HEAT_WAVE,MOVE_AEROBLAST,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLISSEY,110,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TOGEKISS,110,ITEM_SHARP_BEAK,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_YAWN, MOVE_AIR_SLASH,MOVE_MYSTICAL_FIRE,MOVE_NASTY_PLOT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TYRANITAR,110,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_CRUNCH, MOVE_STONE_EDGE,MOVE_EARTHQUAKE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DUNSPARCE_OLD,110,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_CURSE, MOVE_EARTH_POWER,MOVE_ROOST,MOVE_BOOMBURST,0);
		break;
	}
}
...
static void DarPokemonPopularTeam(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_FURRET,63,ITEM_SITRUS_BERRY,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_SLASH, MOVE_COIL,MOVE_AQUA_TAIL,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TYRANITAR,63,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_CRUNCH, MOVE_STONE_EDGE,MOVE_EARTHQUAKE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,63,ITEM_LIGHT_CLAY,26,NATURE_BOLD,0xFF, 0, (u8*)15, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);
		...
		ScriptGiveCustomMon(SPECIES_RHYDON,63,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_METAL_BURST, MOVE_ROCK_POLISH,MOVE_EARTHQUAKE,MOVE_ROCK_WRECKER,0);
		...
		ScriptGiveCustomMon(SPECIES_SWELLOW,63,ITEM_TOXIC_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_BRAVE_BIRD, MOVE_FACADE,MOVE_U_TURN,MOVE_GIGA_IMPACT,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_VOLCARONA,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);
		...
		ScriptGiveCustomMon(SPECIES_FURRET,77,ITEM_NONE,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_SLASH, MOVE_COIL,MOVE_AQUA_TAIL,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,77,ITEM_LIGHT_CLAY,26,NATURE_BOLD,0xFF, 0, (u8*)20, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GYARADOS,77,ITEM_CHOICE_BAND,26,NATURE_HARDY, 0xFF, 0, (u8*)20, MOVE_BOUNCE, MOVE_THRASH,MOVE_AQUA_TAIL,MOVE_DRAGON_RUSH,0);
		...
		ScriptGiveCustomMon(SPECIES_MILOTIC,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SCIZOR,77,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_COUNTER, MOVE_X_SCISSOR,MOVE_CLOSE_COMBAT,MOVE_PSYCHO_CUT,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_MILOTIC,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_FURRET,98,ITEM_NONE,26,NATURE_HARDY, 0xFF, 0, (u8*)31, MOVE_SLASH, MOVE_COIL,MOVE_AQUA_TAIL,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,98,ITEM_LIGHT_CLAY,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_METAGROSS,98,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_BULLET_PUNCH, MOVE_METEOR_MASH,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SCIZOR,98,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_COUNTER, MOVE_X_SCISSOR,MOVE_CLOSE_COMBAT,MOVE_PSYCHO_CUT,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VOLCARONA,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);
		...
		ScriptGiveCustomMon(SPECIES_MILOTIC,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_FURRET,110,ITEM_NONE,26,NATURE_HARDY, 0xFF, 0, (u8*)31, MOVE_SLASH, MOVE_COIL,MOVE_AQUA_TAIL,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,110,ITEM_LIGHT_CLAY,26,NATURE_BOLD,0xFF, 0, (u8*)31, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0); 

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_METAGROSS,110,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_BULLET_PUNCH, MOVE_METEOR_MASH,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SCIZOR,110,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_COUNTER, MOVE_X_SCISSOR,MOVE_CLOSE_COMBAT,MOVE_PSYCHO_CUT,0);
...
static void DarPokemonWeakTeam(u8 opcion){
	switch(opcion){
		case 0:
			ScriptGiveCustomMon(SPECIES_MAGIKARP,63,ITEM_WATER_GEM,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_HYDRO_PUMP, MOVE_DRAGON_RAGE,MOVE_SPLASH,MOVE_FLAIL,1);
			ScriptGiveCustomMon(SPECIES_DELIBIRD,63,ITEM_CHOICE_BAND,26,NATURE_JOLLY,0xFF, 0, (u8*)15, MOVE_DESTINY_BOND, MOVE_AERIAL_ACE,MOVE_DRILL_PECK,MOVE_PRESENT,0);
			ScriptGiveCustomMon(SPECIES_SMEARGLE,63,ITEM_NONE,26,NATURE_JOLLY,0xFF, 0, (u8*)15, MOVE_SKETCH, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			...
			ScriptGiveCustomMon(SPECIES_DITTO,63,ITEM_NONE,26,NATURE_HARDY,0xFF, 0, (u8*)15, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			...
			ScriptGiveCustomMon(SPECIES_WYNAUT,63,ITEM_CUSTAP_BERRY,26,NATURE_BOLD,0xFF, 0, (u8*)15, MOVE_ENCORE, MOVE_COUNTER,MOVE_MIRROR_COAT,MOVE_DESTINY_BOND,0);
			ScriptGiveCustomMon(SPECIES_PUMPKABOO,63,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_DESTINY_BOND, MOVE_TRICK_ROOM,MOVE_TRICK,MOVE_PAIN_SPLIT,0);
			ScriptGiveCustomMon(SPECIES_WIMPOD,63,ITEM_BRIGHT_POWDER,26,NATURE_ADAMANT,0xFF, 0, (u8*)15, MOVE_AQUA_JET, MOVE_DOUBLE_TEAM,MOVE_SAND_ATTACK,MOVE_STRUGGLE_BUG,0);
		break;
		case 1:
			ScriptGiveCustomMon(SPECIES_MAGIKARP,77,ITEM_WATER_GEM,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_HYDRO_PUMP, MOVE_DRAGON_RAGE,MOVE_BOUNCE,MOVE_FLAIL,1);
			ScriptGiveCustomMon(SPECIES_DELIBIRD,77,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_FAKE_OUT, MOVE_POWER_UP_PUNCH,MOVE_DRILL_PECK,MOVE_PRESENT,0);
			ScriptGiveCustomMon(SPECIES_SMEARGLE,77,ITEM_NONE,26,NATURE_JOLLY,0xFF, 0, (u8*)20, MOVE_SKETCH, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			...
			ScriptGiveCustomMon(SPECIES_DITTO,77,ITEM_NONE,26,NATURE_HARDY,0xFF, 0, (u8*)0xFF, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_IGGLYBUFF,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, (u8*)20, MOVE_PERISH_SONG, MOVE_WATER_PULSE,MOVE_COPYCAT,MOVE_SWEET_KISS,0);
			ScriptGiveCustomMon(SPECIES_CLEFFA,77,ITEM_TOXIC_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_BELLY_DRUM, MOVE_FACADE,MOVE_SWEET_KISS,MOVE_ENCORE,0);
			ScriptGiveCustomMon(SPECIES_WYNAUT,77,ITEM_CUSTAP_BERRY,26,NATURE_CALM,0xFF, 0, (u8*)20, MOVE_ENCORE, MOVE_COUNTER,MOVE_MIRROR_COAT,MOVE_TICKLE,0);
			ScriptGiveCustomMon(SPECIES_TYROGUE,77,ITEM_BRIGHT_POWDER,26,NATURE_HARDY,0xFF, 0, (u8*)20, MOVE_MACH_PUNCH, MOVE_RETALIATE,MOVE_FAKE_OUT,MOVE_FORESIGHT,0);
			ScriptGiveCustomMon(SPECIES_MUNCHLAX,77,ITEM_STARF_BERRY,26,NATURE_ADAMANT,0xFF, 0, (u8*)20, MOVE_SELF_DESTRUCT, MOVE_SECRET_POWER,MOVE_CHIP_AWAY,MOVE_RECYCLE,0);
		break;
		case 2:
			ScriptGiveCustomMon(SPECIES_MAGIKARP,98,ITEM_WATER_GEM,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HYDRO_PUMP, MOVE_DRAGON_RAGE,MOVE_BOUNCE,MOVE_FLAIL,1);
			ScriptGiveCustomMon(SPECIES_TOGEPI,98,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_TRI_ATTACK, MOVE_DAZZLING_GLEAM,MOVE_METRONOME,MOVE_WISH,0);
			ScriptGiveCustomMon(SPECIES_SMEARGLE,98,ITEM_NONE,26,NATURE_JOLLY,0xFF, 0, (u8*)31, MOVE_SKETCH, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_FEEBAS,98,ITEM_QUICK_CLAW,26,NATURE_CALM,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_WATER_PULSE,MOVE_TACKLE,MOVE_FLAIL,0);
			ScriptGiveCustomMon(SPECIES_DITTO,98,ITEM_NONE,26,NATURE_HARDY,0xFF, 0, (u8*)31, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_RIOLU,98,ITEM_BLACK_BELT,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_AGILITY, MOVE_POWER_UP_PUNCH,MOVE_FORCE_PALM,MOVE_REVERSAL,0); 
			ScriptGiveCustomMon(SPECIES_SMOOCHUM,98,ITEM_CHOICE_SPECS,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_MIRACLE_EYE, MOVE_RAIN_DANCE,MOVE_PSYCHIC,MOVE_PERISH_SONG,0);
			ScriptGiveCustomMon(SPECIES_FARFETCHD,98,ITEM_LEEK,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_LEAF_BLADE, MOVE_U_TURN,MOVE_SLASH,MOVE_AIR_CUTTER,0);
			ScriptGiveCustomMon(SPECIES_TAILLOW,98,ITEM_TOXIC_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_BOOMBURST, MOVE_FACADE,MOVE_BRAVE_BIRD,MOVE_REVERSAL,0);
		...
		break;
		case 3:
			ScriptGiveCustomMon(SPECIES_MAGIKARP,110,ITEM_WATER_GEM,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_HYDRO_PUMP, MOVE_DRAGON_RAGE,MOVE_BOUNCE,MOVE_FLAIL,1);
			ScriptGiveCustomMon(SPECIES_TOGEPI,110,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, (u8*)31, MOVE_TRI_ATTACK, MOVE_DAZZLING_GLEAM,MOVE_METRONOME,MOVE_WISH,0);
			ScriptGiveCustomMon(SPECIES_SMEARGLE,110,ITEM_NONE,26,NATURE_JOLLY,0xFF, 0, (u8*)31, MOVE_SKETCH, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_FEEBAS,110,ITEM_QUICK_CLAW,26,NATURE_CALM,0xFF, 0, (u8*)31, MOVE_HYPNOSIS, MOVE_WATER_PULSE,MOVE_TACKLE,MOVE_FLAIL,0);
			ScriptGiveCustomMon(SPECIES_DITTO,110,ITEM_NONE,26,NATURE_HARDY,0xFF, 0, (u8*)31, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_RIOLU,110,ITEM_BLACK_BELT,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_AGILITY, MOVE_POWER_UP_PUNCH,MOVE_FORCE_PALM,MOVE_REVERSAL,0); 
			ScriptGiveCustomMon(SPECIES_SMOOCHUM,110,ITEM_CHOICE_SPECS,26,NATURE_TIMID,0xFF, 0, (u8*)31, MOVE_MIRACLE_EYE, MOVE_RAIN_DANCE,MOVE_PSYCHIC,MOVE_PERISH_SONG,0);
			ScriptGiveCustomMon(SPECIES_FARFETCHD,110,ITEM_LEEK,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_LEAF_BLADE, MOVE_U_TURN,MOVE_SLASH,MOVE_AIR_CUTTER,0);
			ScriptGiveCustomMon(SPECIES_TAILLOW,110,ITEM_TOXIC_ORB,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_BOOMBURST, MOVE_FACADE,MOVE_BRAVE_BIRD,MOVE_REVERSAL,0);
			ScriptGiveCustomMon(SPECIES_TYROGUE,110,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, (u8*)31, MOVE_TACKLE, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
		break;
	}
}
