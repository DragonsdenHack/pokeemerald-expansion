...
extern const u8 EventScript_SetHoenn[];
...
static void DarPokemonBasicosKanto(u8 opcion){
	...
	switch (opcion)
	{
		...
		memcpy(evs, (u8[]){6, 252, 0, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CROBAT,65,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_NASTY_PLOT, MOVE_FLY,MOVE_CROSS_POISON,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HOUNDOOM,63,ITEM_CHARCOAL,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_DESTINY_BOND, MOVE_DARK_PULSE,MOVE_FLAMETHROWER,MOVE_NASTY_PLOT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAROWAK,63,ITEM_THICK_CLUB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_IRON_HEAD, MOVE_EARTHQUAKE,MOVE_THRASH,MOVE_ENDEAVOR,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_AERODACTYL,63,ITEM_SHARP_BEAK,26,NATURE_JOLLY,0xFF, evs, ivs, MOVE_WIDE_GUARD, MOVE_SKY_ATTACK,MOVE_ROCK_SLIDE,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENUSAUR,63,ITEM_MIRACLE_SEED,26,NATURE_HARDY,2, evs, ivs, MOVE_LEAF_STORM, MOVE_BULLDOZE,MOVE_SOLAR_BEAM,MOVE_SUNNY_DAY,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON,63,ITEM_UPGRADE,26,NATURE_QUIET,1, evs, ivs, MOVE_SIGNAL_BEAM, MOVE_TRICK_ROOM,MOVE_TRI_ATTACK,MOVE_CONVERSION_2,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_OMASTAR,63,ITEM_MYSTIC_WATER,26,NATURE_QUIET,0, evs, ivs, MOVE_TOXIC_SPIKES, MOVE_SURF,MOVE_ANCIENT_POWER,MOVE_SHELL_SMASH,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KABUTOPS,63,ITEM_HARD_STONE,26,NATURE_ADAMANT,2, evs, ivs, MOVE_CONFUSE_RAY, MOVE_ROCK_SLIDE,MOVE_AQUA_JET,MOVE_NIGHT_SLASH,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PINSIR,63,ITEM_SILVER_POWDER,26,NATURE_ADAMANT,2, evs, ivs, MOVE_ME_FIRST, MOVE_ROCK_TOMB,MOVE_X_SCISSOR,MOVE_SUPERPOWER,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,63,ITEM_SUN_STONE,26,NATURE_MODEST,1, evs, ivs, MOVE_STORED_POWER, MOVE_ECHOED_VOICE,MOVE_SWIFT,MOVE_TRUMP_CARD,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,63,ITEM_MOON_STONE,26,NATURE_CAREFUL,0xFF, evs, ivs, MOVE_FAKE_TEARS, MOVE_TOXIC,MOVE_SWIFT,MOVE_HIDDEN_POWER,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,63,ITEM_THUNDER_STONE,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_WISH, MOVE_SHADOW_BALL, MOVE_SWIFT, MOVE_BATON_PASS,0);

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,63,ITEM_WATER_STONE,26,NATURE_CALM,1, evs, ivs, MOVE_YAWN, MOVE_RAIN_DANCE,MOVE_SWIFT,MOVE_REFRESH,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,63,ITEM_FIRE_STONE,26,NATURE_ADAMANT,1, evs, ivs, MOVE_CURSE, MOVE_FACADE,MOVE_BITE,MOVE_DOUBLE_EDGE,0);
		break;
		case 1: //sevii
		...
		ScriptGiveCustomMon(SPECIES_CROBAT,79,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CURSE, MOVE_TAILWIND,MOVE_POISON_FANG,MOVE_FLY,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HOUNDOOM,77,ITEM_CHARCOAL,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_COUNTER, MOVE_FIRE_BLAST,MOVE_FLAMETHROWER,MOVE_INFERNO,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAROWAK,77,ITEM_THICK_CLUB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_PERISH_SONG, MOVE_EARTHQUAKE,MOVE_STOMPING_TANTRUM,MOVE_RETALIATE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_AERODACTYL,77,ITEM_SHARP_BEAK,26,NATURE_JOLLY,0xFF, evs, ivs, MOVE_ROOST, MOVE_FLY,MOVE_ROCK_SLIDE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENUSAUR,77,ITEM_MIRACLE_SEED,26,NATURE_HARDY,2, evs, ivs, MOVE_WEATHER_BALL, MOVE_FRENZY_PLANT,MOVE_SOLAR_BEAM,MOVE_DOUBLE_EDGE,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON,77,ITEM_UPGRADE,26,NATURE_MODEST,1, evs, ivs, MOVE_RECYCLE, MOVE_PSYCHIC,MOVE_TRI_ATTACK,MOVE_CONVERSION,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_OMASTAR,77,ITEM_MYSTIC_WATER,26,NATURE_QUIET,2, evs, ivs, MOVE_SPIKES, MOVE_ICE_BEAM,MOVE_SHELL_SMASH,MOVE_BRINE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KABUTOPS,77,ITEM_HARD_STONE,26,NATURE_ADAMANT,2, evs, ivs, MOVE_FLAIL, MOVE_ROCK_SLIDE,MOVE_AQUA_JET,MOVE_WRING_OUT,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PINSIR,77,ITEM_SILVER_POWDER,26,NATURE_ADAMANT,2, evs, ivs, MOVE_CLOSE_COMBAT, MOVE_ROCK_SLIDE,MOVE_STORM_THROW,MOVE_GUILLOTINE,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,77,ITEM_SUN_STONE,26,NATURE_MODEST,1, evs, ivs, MOVE_STORED_POWER, MOVE_ECHOED_VOICE,MOVE_SWIFT,MOVE_TRUMP_CARD,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,77,ITEM_MOON_STONE,26,NATURE_CAREFUL,0xFF, evs, ivs, MOVE_FAKE_TEARS, MOVE_TOXIC,MOVE_SWIFT,MOVE_HIDDEN_POWER,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,77,ITEM_THUNDER_STONE,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_WISH, MOVE_SHADOW_BALL,MOVE_SWIFT,MOVE_BATON_PASS,0);

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,77,ITEM_WATER_STONE,26,NATURE_CALM,1, evs, ivs, MOVE_YAWN, MOVE_RAIN_DANCE,MOVE_SWIFT,MOVE_REFRESH,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,77,ITEM_FIRE_STONE,26,NATURE_ADAMANT,1, evs, ivs, MOVE_CURSE, MOVE_FACADE,MOVE_BITE,MOVE_DOUBLE_EDGE,0);

		memcpy(evs, (u8[]){0, 252, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HITMONCHAN,77,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HIGH_JUMP_KICK, MOVE_DRAIN_PUNCH,MOVE_REVENGE,MOVE_CLOSE_COMBAT,0);                  //FALTANTE

		memcpy(evs, (u8[]){252, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLASTOISE,77,ITEM_NONE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYDRO_CANNON, MOVE_ICE_BEAM,MOVE_FLASH_CANNON,MOVE_HYDRO_PUMP,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARTICUNO,77,ITEM_LUM_BERRY,26,NATURE_CALM,0xFF, evs, ivs, MOVE_EXTRASENSORY, MOVE_WATER_PULSE,MOVE_ICE_BEAM,MOVE_SHEER_COLD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ZAPDOS,77,ITEM_LUM_BERRY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_EXTRASENSORY, MOVE_CHARGE_BEAM,MOVE_THUNDERBOLT,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MOLTRES,77,ITEM_LUM_BERRY,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_EXTRASENSORY, MOVE_FLAME_CHARGE,MOVE_FLAMETHROWER,MOVE_BURN_UP,0);	
		break;
		case 2: //johto
		...
		ScriptGiveCustomMon(SPECIES_CROBAT_BOND,100,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_ZEN_HEADBUTT, MOVE_SUPER_FANG,MOVE_GUNK_SHOT,MOVE_FLY,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HOUNDOOM,98,ITEM_CHARCOAL,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SUCKER_PUNCH, MOVE_SLUDGE_BOMB,MOVE_FLAMETHROWER,MOVE_FIRE_BLAST,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAROWAK,98,ITEM_THICK_CLUB,26,NATURE_ADAMANT,0, evs, ivs, MOVE_BELLY_DRUM, MOVE_EARTHQUAKE,MOVE_THRASH,MOVE_DOUBLE_EDGE,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_AERODACTYL,98,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CURSE, MOVE_STEALTH_ROCK,MOVE_ROCK_SLIDE,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENUSAUR,98,ITEM_MIRACLE_SEED,26,NATURE_HARDY,2, evs, ivs, MOVE_GRASSY_TERRAIN, MOVE_ENERGY_BALL,MOVE_PETAL_BLIZZARD,MOVE_PETAL_DANCE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON,98,ITEM_UPGRADE,26,NATURE_JOLLY,1, evs, ivs, MOVE_MAGNET_RISE, MOVE_SHADOW_BALL,MOVE_TRI_ATTACK,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_OMASTAR,98,ITEM_MYSTIC_WATER,26,NATURE_MODEST,0, evs, ivs, MOVE_REFLECT_TYPE, MOVE_SURF,MOVE_ANCIENT_POWER,MOVE_HYDRO_PUMP,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KABUTOPS,98,ITEM_HARD_STONE,26,NATURE_ADAMANT,2, evs, ivs, MOVE_SHELL_SMASH, MOVE_ROCK_SLIDE,MOVE_AQUA_JET,MOVE_NIGHT_SLASH,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PINSIR,98,ITEM_SILVER_POWDER,26,NATURE_ADAMANT,2, evs, ivs, MOVE_BUG_BITE, MOVE_EARTHQUAKE,MOVE_X_SCISSOR,MOVE_THRASH,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,98,ITEM_SUN_STONE,26,NATURE_JOLLY,1, evs, ivs, MOVE_STORED_POWER, MOVE_ECHOED_VOICE,MOVE_SWIFT,MOVE_TRUMP_CARD,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,98,ITEM_MOON_STONE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CURSE, MOVE_SHADOW_BALL,MOVE_SWIFT,MOVE_HIDDEN_POWER,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,98,ITEM_THUNDER_STONE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_SUBSTITUTE,MOVE_SWIFT,MOVE_REFRESH,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,98,ITEM_WATER_STONE,26,NATURE_BOLD,1, evs, ivs, MOVE_ENDURE, MOVE_RAIN_DANCE,MOVE_SWIFT,MOVE_BATON_PASS,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,98,ITEM_FIRE_STONE,26,NATURE_ADAMANT,1, evs, ivs, MOVE_SING, MOVE_FACADE,MOVE_BITE,MOVE_DOUBLE_EDGE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARTICUNO,98,ITEM_LUM_BERRY,26,NATURE_CALM,0xFF, evs, ivs, MOVE_HEAL_BELL, MOVE_FROST_BREATH,MOVE_ICE_BEAM,MOVE_SHEER_COLD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ZAPDOS,98,ITEM_AIR_BALLOON,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_BATON_PASS, MOVE_ROOST,MOVE_THUNDERBOLT,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MOLTRES,98,ITEM_LUM_BERRY,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_MORNING_SUN, MOVE_ROOST,MOVE_FLAMETHROWER,MOVE_BURN_UP,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ENTEI,98,ITEM_LUM_BERRY,26,NATURE_MILD,0xFF, evs, ivs, MOVE_FLARE_BLITZ, MOVE_STOMPING_TANTRUM,MOVE_SACRED_FIRE,MOVE_ERUPTION,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);
		
		ScriptGiveCustomMon(SPECIES_SUICUNE,98,ITEM_LUM_BERRY,26,NATURE_CALM,0xFF, evs, ivs, MOVE_AIR_SLASH, MOVE_ICE_BEAM,MOVE_CALM_MIND,MOVE_HYDRO_PUMP,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAIKOU,98,ITEM_LUM_BERRY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ZAP_CANNON, MOVE_THUNDERBOLT,MOVE_EXTRASENSORY,MOVE_REFLECT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BRAVIARY,98,ITEM_SILK_SCARF,26,NATURE_JOLLY,2, evs, ivs, MOVE_ROCK_SLIDE, MOVE_BRAVE_BIRD,MOVE_SUPERPOWER,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VIKAVOLT,98,ITEM_CHOICE_SPECS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MUD_SHOT, MOVE_THUNDERBOLT,MOVE_BUG_BUZZ,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MANDIBUZZ,98,ITEM_LEFTOVERS,26,NATURE_IMPISH,1, evs, ivs, MOVE_FOUL_PLAY, MOVE_TAUNT,MOVE_DARK_PULSE,MOVE_NASTY_PLOT,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PROBOPASS,98,ITEM_LIFE_ORB,26,NATURE_QUIET,2, evs, ivs, MOVE_EXPLOSION, MOVE_DAZZLING_GLEAM,MOVE_POWER_GEM,MOVE_MAGNETIC_FLUX,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SLAKING,98,ITEM_CHOICE_BAND,26,NATURE_NAUGHTY,2, evs, ivs, MOVE_NIGHT_SLASH, MOVE_POWER_UP_PUNCH,MOVE_SLASH,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){0, 252, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HITMONCHAN,98,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HIGH_JUMP_KICK, MOVE_DRAIN_PUNCH,MOVE_REVENGE,MOVE_CLOSE_COMBAT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLASTOISE,98,ITEM_WATER_GEM,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYDRO_CANNON, MOVE_ICE_BEAM,MOVE_FLASH_CANNON,MOVE_HYDRO_PUMP,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LUCARIO,98,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HIGH_JUMP_KICK, MOVE_EXTREME_SPEED,MOVE_METEOR_MASH,MOVE_REVERSAL,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEWEAR,98,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_FORCE_PALM, MOVE_THRASH,MOVE_DRAIN_PUNCH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){6, 0, 252, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_FLORGES,98,ITEM_LUM_BERRY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ENDEAVOR, MOVE_PETAL_DANCE,MOVE_CALM_MIND,MOVE_AROMATHERAPY,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BAXCALIBUR,98,ITEM_CHOICE_SCARF,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_ICICLE_SPEAR, MOVE_CRUNCH,MOVE_DRAGON_DANCE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EMPOLEON,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_AQUA_RING, MOVE_STEALTH_ROCK,MOVE_HYDRO_PUMP,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_INFERNAPE,98,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_FAKE_OUT, MOVE_ACROBATICS,MOVE_CLOSE_COMBAT,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGAPULT,98,ITEM_POWER_HERB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SUCKER_PUNCH, MOVE_DRAGON_DANCE,MOVE_DRAGON_DARTS,MOVE_SHADOW_FORCE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEOXYS,98,ITEM_WHITE_HERB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_COSMIC_POWER, MOVE_PSYCHIC,MOVE_PSYCHO_BOOST,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGIROCK,98,ITEM_NONE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_ROCK_POLISH, MOVE_STONE_EDGE,MOVE_STEALTH_ROCK,MOVE_SELF_DESTRUCT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGICE,98,ITEM_NONE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_AMNESIA, MOVE_ICE_BEAM,MOVE_ZAP_CANNON,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGISTEEL,98,ITEM_NONE,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_AMNESIA, MOVE_STEEL_BEAM,MOVE_THUNDER_WAVE,MOVE_SEISMIC_TOSS,0);
		break;
		case 3: //dlc
		...
		ScriptGiveCustomMon(SPECIES_HOUNDOOM,110,ITEM_CHARCOAL,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SUCKER_PUNCH, MOVE_SLUDGE_BOMB,MOVE_FLAMETHROWER,MOVE_FIRE_BLAST,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAROWAK,110,ITEM_THICK_CLUB,26,NATURE_ADAMANT,0, evs, ivs, MOVE_BELLY_DRUM, MOVE_EARTHQUAKE,MOVE_THRASH,MOVE_DOUBLE_EDGE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_AERODACTYL,110,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CURSE, MOVE_STEALTH_ROCK,MOVE_ROCK_SLIDE,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENUSAUR,110,ITEM_MIRACLE_SEED,26,NATURE_HARDY,2, evs, ivs, MOVE_GRASSY_TERRAIN, MOVE_ENERGY_BALL,MOVE_PETAL_BLIZZARD,MOVE_PETAL_DANCE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON,110,ITEM_UPGRADE,26,NATURE_JOLLY,1, evs, ivs, MOVE_MAGNET_RISE, MOVE_SHADOW_BALL,MOVE_TRI_ATTACK,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_OMASTAR,110,ITEM_MYSTIC_WATER,26,NATURE_MODEST,0, evs, ivs, MOVE_REFLECT_TYPE, MOVE_SURF,MOVE_ANCIENT_POWER,MOVE_HYDRO_PUMP,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KABUTOPS,110,ITEM_HARD_STONE,26,NATURE_ADAMANT,2, evs, ivs, MOVE_CONFUSE_RAY, MOVE_ROCK_SLIDE,MOVE_AQUA_JET,MOVE_NIGHT_SLASH,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PINSIR,110,ITEM_SILVER_POWDER,26,NATURE_ADAMANT,2, evs, ivs, MOVE_BUG_BITE, MOVE_EARTHQUAKE,MOVE_X_SCISSOR,MOVE_THRASH,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,110,ITEM_SUN_STONE,26,NATURE_JOLLY,1, evs, ivs, MOVE_STORED_POWER, MOVE_ECHOED_VOICE,MOVE_SWIFT,MOVE_TRUMP_CARD,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,110,ITEM_MOON_STONE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CURSE, MOVE_CRUNCH,MOVE_TOXIC,MOVE_MOONLIGHT,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,110,ITEM_THUNDER_STONE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_SUBSTITUTE,MOVE_SWIFT,MOVE_REFRESH,0);

		memcpy(evs, (u8[]){6, 0, 252, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,110,ITEM_WATER_STONE,26,NATURE_BOLD,1, evs, ivs, MOVE_ENDURE, MOVE_RAIN_DANCE,MOVE_SWIFT,MOVE_BATON_PASS,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EEVEE,110,ITEM_FIRE_STONE,26,NATURE_ADAMANT,1, evs, ivs, MOVE_SING, MOVE_FACADE,MOVE_BITE,MOVE_DOUBLE_EDGE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARTICUNO,110,ITEM_LUM_BERRY,26,NATURE_CALM,0xFF, evs, ivs, MOVE_HEAL_BELL, MOVE_FROST_BREATH,MOVE_ICE_BEAM,MOVE_SHEER_COLD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ZAPDOS,110,ITEM_LUM_BERRY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_BATON_PASS, MOVE_ROOST,MOVE_THUNDERBOLT,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MOLTRES,110,ITEM_LUM_BERRY,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_MORNING_SUN, MOVE_ROOST,MOVE_FLAMETHROWER,MOVE_BURN_UP,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ENTEI,110,ITEM_LUM_BERRY,26,NATURE_MILD,0xFF, evs, ivs, MOVE_FLARE_BLITZ, MOVE_STOMPING_TANTRUM,MOVE_SACRED_FIRE,MOVE_ERUPTION,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 6, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SUICUNE,110,ITEM_LUM_BERRY,26,NATURE_CALM,0xFF, evs, ivs, MOVE_AIR_SLASH, MOVE_ICE_BEAM,MOVE_CALM_MIND,MOVE_HYDRO_PUMP,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAIKOU,110,ITEM_LUM_BERRY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ZAP_CANNON, MOVE_THUNDERBOLT,MOVE_EXTRASENSORY,MOVE_REFLECT,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BRAVIARY,110,ITEM_SILK_SCARF,26,NATURE_JOLLY,2, evs, ivs, MOVE_ROCK_SLIDE, MOVE_BRAVE_BIRD,MOVE_SUPERPOWER,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VIKAVOLT,110,ITEM_CHOICE_SPECS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MUD_SHOT, MOVE_THUNDERBOLT,MOVE_BUG_BUZZ,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MANDIBUZZ,110,ITEM_LEFTOVERS,26,NATURE_IMPISH,1, evs, ivs, MOVE_FOUL_PLAY, MOVE_TAUNT,MOVE_DARK_PULSE,MOVE_NASTY_PLOT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PROBOPASS,110,ITEM_LIFE_ORB,26,NATURE_QUIET,2, evs, ivs, MOVE_EXPLOSION, MOVE_DAZZLING_GLEAM,MOVE_POWER_GEM,MOVE_MAGNETIC_FLUX,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SLAKING,110,ITEM_CHOICE_BAND,26,NATURE_NAUGHTY,2, evs, ivs, MOVE_NIGHT_SLASH, MOVE_POWER_UP_PUNCH,MOVE_SLASH,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){6, 252, 252, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HITMONCHAN,110,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HIGH_JUMP_KICK, MOVE_DRAIN_PUNCH,MOVE_REVENGE,MOVE_CLOSE_COMBAT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLASTOISE,110,ITEM_WATER_GEM,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYDRO_CANNON, MOVE_ICE_BEAM,MOVE_FLASH_CANNON,MOVE_HYDRO_PUMP,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LUCARIO,110,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HIGH_JUMP_KICK, MOVE_EXTREME_SPEED,MOVE_METEOR_MASH,MOVE_REVERSAL,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEWEAR,110,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_FORCE_PALM, MOVE_THRASH,MOVE_DRAIN_PUNCH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){6, 0, 252, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_FLORGES,110,ITEM_LUM_BERRY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ENDEAVOR, MOVE_PETAL_DANCE,MOVE_CALM_MIND,MOVE_AROMATHERAPY,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BAXCALIBUR,110,ITEM_CHOICE_SCARF,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_ICICLE_SPEAR, MOVE_CRUNCH,MOVE_DRAGON_DANCE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EMPOLEON,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_AQUA_RING, MOVE_STEALTH_ROCK,MOVE_HYDRO_PUMP,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_INFERNAPE,110,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_FAKE_OUT, MOVE_ACROBATICS,MOVE_CLOSE_COMBAT,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGAPULT,110,ITEM_POWER_HERB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SUCKER_PUNCH, MOVE_DRAGON_DANCE,MOVE_DRAGON_DARTS,MOVE_SHADOW_FORCE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEOXYS,110,ITEM_NONE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_COSMIC_POWER, MOVE_PSYCHIC,MOVE_PSYCHO_BOOST,MOVE_ZAP_CANNON,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGIROCK,110,ITEM_NONE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_ROCK_POLISH, MOVE_STONE_EDGE,MOVE_STEALTH_ROCK,MOVE_SELF_DESTRUCT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_REGICE,110,ITEM_NONE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_AMNESIA, MOVE_ICE_BEAM,MOVE_ZAP_CANNON,MOVE_HYPER_BEAM,0);
		...
		ScriptGiveCustomMon(SPECIES_LUGIA,110,ITEM_NONE,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_RECOVER, MOVE_AEROBLAST,MOVE_PSYCHO_BOOST,MOVE_ORIGIN_PULSE,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MEWTWO,110,ITEM_NONE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_RECOVER, MOVE_PSYCHO_BOOST,MOVE_PSYSTRIKE,MOVE_ME_FIRST,0);
		...
		ScriptGiveCustomMon(SPECIES_ZAPDOS_PRIMAL,110,ITEM_NONE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HEAT_WAVE, MOVE_THUNDERBOLT,MOVE_DARK_PULSE,MOVE_ROOST,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EMBOAR,110,ITEM_NONE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SUCKER_PUNCH, MOVE_FLAME_CHARGE,MOVE_HEAD_SMASH,MOVE_FLARE_BLITZ,0);	

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_AKUERIA,110,ITEM_NONE,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_HYDRO_PUMP, MOVE_FIRE_BLAST,MOVE_DRACO_METEOR,MOVE_BLIZZARD,0);	
		break;
	};
}
...
static void DarPokemonClassicKanto(u8 opcion){
	...
	switch(opcion)
	{
		...
		ScriptGiveCustomMon(SPECIES_GENGAR,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_DISABLE, MOVE_SHADOW_BALL,MOVE_HYPNOSIS,MOVE_FOCUS_BLAST,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ALAKAZAM,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_FUTURE_SIGHT, MOVE_PSYCHIC,MOVE_RECOVER,MOVE_BARRIER,0); 

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);
			ScriptGiveCustomMon(SPECIES_MACHAMP,63,ITEM_EXPERT_BELT,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_BULLET_PUNCH, MOVE_DYNAMIC_PUNCH,MOVE_KNOCK_OFF,MOVE_METRONOME,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAICHU,63,ITEM_FOCUS_SASH,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_NUZZLE,MOVE_THUNDERBOLT,MOVE_SUBMISSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGLER,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_CRABHAMMER,MOVE_ROCK_SLIDE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 6, 0, 252, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,63,ITEM_ASSAULT_VEST,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN,MOVE_SLUDGE_BOMB,MOVE_LEAF_STORM,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MUK,63,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SHADOW_PUNCH, MOVE_GUNK_SHOT,MOVE_ACID_ARMOR,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLEM,63,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_ROCK_BLAST,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DODRIO,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SKY_ATTACK, MOVE_DRILL_RUN,MOVE_DRILL_PECK,MOVE_JUMP_KICK,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGONITE,63,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_GENGAR,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_DISABLE, MOVE_SHADOW_BALL,MOVE_HYPNOSIS,MOVE_FOCUS_BLAST,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ALAKAZAM,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_FUTURE_SIGHT, MOVE_PSYCHIC,MOVE_RECOVER,MOVE_BARRIER,0); 

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MACHAMP,77,ITEM_EXPERT_BELT,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_BULLET_PUNCH, MOVE_DYNAMIC_PUNCH,MOVE_KNOCK_OFF,MOVE_METRONOME,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAICHU,77,ITEM_FOCUS_SASH,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_NUZZLE,MOVE_THUNDERBOLT,MOVE_SUBMISSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGLER,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_CRABHAMMER,MOVE_ROCK_SLIDE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 6, 0, 252, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,77,ITEM_ASSAULT_VEST,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN,MOVE_SLUDGE_BOMB,MOVE_LEAF_STORM,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MUK,77,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SHADOW_PUNCH, MOVE_GUNK_SHOT,MOVE_ACID_ARMOR,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLEM,77,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_ROCK_BLAST,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DODRIO,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SKY_ATTACK, MOVE_DRILL_RUN,MOVE_DRILL_PECK,MOVE_JUMP_KICK,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGONITE,77,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_GENGAR,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_DISABLE, MOVE_SHADOW_BALL,MOVE_HYPNOSIS,MOVE_FOCUS_BLAST,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ALAKAZAM,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_FUTURE_SIGHT, MOVE_PSYCHIC,MOVE_RECOVER,MOVE_BARRIER,0); 

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MACHAMP,98,ITEM_EXPERT_BELT,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_BULLET_PUNCH, MOVE_DYNAMIC_PUNCH,MOVE_KNOCK_OFF,MOVE_METRONOME,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAICHU,98,ITEM_FOCUS_SASH,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_NUZZLE,MOVE_THUNDERBOLT,MOVE_SUBMISSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGLER,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_CRABHAMMER,MOVE_ROCK_SLIDE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 6, 0, 252, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,98,ITEM_ASSAULT_VEST,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN,MOVE_SLUDGE_BOMB,MOVE_LEAF_STORM,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MUK,98,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SHADOW_PUNCH, MOVE_GUNK_SHOT,MOVE_ACID_ARMOR,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLEM,98,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_ROCK_BLAST,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DODRIO,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SKY_ATTACK, MOVE_DRILL_RUN,MOVE_DRILL_PECK,MOVE_JUMP_KICK,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGONITE,98,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_GENGAR,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_DISABLE, MOVE_SHADOW_BALL,MOVE_HYPNOSIS,MOVE_FOCUS_BLAST,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ALAKAZAM,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_FUTURE_SIGHT, MOVE_PSYCHIC,MOVE_RECOVER,MOVE_BARRIER,0); 

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MACHAMP,110,ITEM_EXPERT_BELT,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_BULLET_PUNCH, MOVE_DYNAMIC_PUNCH,MOVE_KNOCK_OFF,MOVE_METRONOME,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAICHU,110,ITEM_FOCUS_SASH,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_NUZZLE,MOVE_THUNDERBOLT,MOVE_SUBMISSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGLER,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_CRABHAMMER,MOVE_ROCK_SLIDE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 6, 0, 252, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,110,ITEM_ASSAULT_VEST,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN,MOVE_SLUDGE_BOMB,MOVE_LEAF_STORM,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MUK,110,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SHADOW_PUNCH, MOVE_GUNK_SHOT,MOVE_ACID_ARMOR,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLEM,110,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_ROCK_BLAST,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DODRIO,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SKY_ATTACK, MOVE_DRILL_RUN,MOVE_DRILL_PECK,MOVE_JUMP_KICK,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DRAGONITE,110,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);
		break;
	}
}
...
static void DarPokemonRocketGrunt(u8 opcion)
{
	...
	switch(opcion)
	{
		...
		ScriptGiveCustomMon(SPECIES_RATICATE,63,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_REVERSAL, MOVE_HYPER_FANG,MOVE_SUCKER_PUNCH,MOVE_SWORDS_DANCE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SANDSLASH,63,ITEM_SOFT_SAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HONE_CLAWS, MOVE_EARTHQUAKE,MOVE_STONE_EDGE,MOVE_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DUGTRIO,63,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_MEMENTO, MOVE_GIGA_IMPACT,MOVE_EARTHQUAKE,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PERSIAN,63,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_FAKE_OUT,MOVE_SLASH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEEDRILL,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_KNOCK_OFF, MOVE_TOXIC_SPIKES,MOVE_ACROBATICS,MOVE_U_TURN,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARBOK,63,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SUCKER_PUNCH, MOVE_GLARE,MOVE_COIL,MOVE_GUNK_SHOT,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PRIMEAPE,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_COUNTER, MOVE_CLOSE_COMBAT,MOVE_U_TURN,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HYPNO,63,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_BARRIER, MOVE_PSYCHIC,MOVE_THUNDER_WAVE,MOVE_FOUL_PLAY,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_QWILFISH,63,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SELF_DESTRUCT, MOVE_TOXIC_SPIKES,MOVE_SPIKES,MOVE_AQUA_TAIL,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PARASECT,63,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SPORE, MOVE_LEECH_LIFE,MOVE_KNOCK_OFF,MOVE_SUBSTITUTE,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_RATICATE,77,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_REVERSAL, MOVE_HYPER_FANG,MOVE_SUCKER_PUNCH,MOVE_SWORDS_DANCE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SANDSLASH,77,ITEM_SOFT_SAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HONE_CLAWS, MOVE_EARTHQUAKE,MOVE_STONE_EDGE,MOVE_SPIKES,0);

 		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DUGTRIO,77,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_MEMENTO, MOVE_GIGA_IMPACT,MOVE_EARTHQUAKE,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PERSIAN,77,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_FAKE_OUT,MOVE_SLASH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEEDRILL,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_KNOCK_OFF, MOVE_TOXIC_SPIKES,MOVE_ACROBATICS,MOVE_U_TURN,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARBOK,77,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SUCKER_PUNCH, MOVE_GLARE,MOVE_COIL,MOVE_GUNK_SHOT,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PRIMEAPE,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_COUNTER, MOVE_CLOSE_COMBAT,MOVE_U_TURN,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HYPNO,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_BARRIER, MOVE_PSYCHIC,MOVE_THUNDER_WAVE,MOVE_FOUL_PLAY,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_QWILFISH,77,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SELF_DESTRUCT, MOVE_TOXIC_SPIKES,MOVE_SPIKES,MOVE_AQUA_TAIL,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GRANBULL,77,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_RETALIATE, MOVE_PLAY_ROUGH,MOVE_CRUNCH,MOVE_CLOSE_COMBAT,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_RATICATE,98,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_REVERSAL, MOVE_HYPER_FANG,MOVE_SUCKER_PUNCH,MOVE_SWORDS_DANCE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SANDSLASH,98,ITEM_SOFT_SAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HONE_CLAWS, MOVE_EARTHQUAKE,MOVE_STONE_EDGE,MOVE_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DUGTRIO,98,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_MEMENTO, MOVE_GIGA_IMPACT,MOVE_EARTHQUAKE,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PERSIAN,98,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_FAKE_OUT,MOVE_SLASH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEEDRILL,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_KNOCK_OFF, MOVE_TOXIC_SPIKES,MOVE_ACROBATICS,MOVE_U_TURN,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARBOK,98,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SUCKER_PUNCH, MOVE_GLARE,MOVE_COIL,MOVE_GUNK_SHOT,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PRIMEAPE,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_COUNTER, MOVE_CLOSE_COMBAT,MOVE_U_TURN,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HYPNO,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_BARRIER, MOVE_PSYCHIC,MOVE_THUNDER_WAVE,MOVE_FOUL_PLAY,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_QWILFISH,98,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SELF_DESTRUCT, MOVE_TOXIC_SPIKES,MOVE_SPIKES,MOVE_AQUA_TAIL,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GRANBULL,98,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_RETALIATE, MOVE_PLAY_ROUGH,MOVE_CRUNCH,MOVE_CLOSE_COMBAT,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_RATICATE,110,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_REVERSAL, MOVE_HYPER_FANG,MOVE_SUCKER_PUNCH,MOVE_SWORDS_DANCE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SANDSLASH,110,ITEM_SOFT_SAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HONE_CLAWS, MOVE_EARTHQUAKE,MOVE_STONE_EDGE,MOVE_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DUGTRIO,110,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_MEMENTO, MOVE_GIGA_IMPACT,MOVE_EARTHQUAKE,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PERSIAN,110,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_FAKE_OUT,MOVE_SLASH,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BEEDRILL,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_KNOCK_OFF, MOVE_TOXIC_SPIKES,MOVE_ACROBATICS,MOVE_U_TURN,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARBOK,110,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SUCKER_PUNCH, MOVE_GLARE,MOVE_COIL,MOVE_GUNK_SHOT,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PRIMEAPE,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_COUNTER, MOVE_CLOSE_COMBAT,MOVE_U_TURN,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HYPNO,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_BARRIER, MOVE_PSYCHIC,MOVE_THUNDER_WAVE,MOVE_FOUL_PLAY,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_QWILFISH,110,ITEM_BLACK_SLUDGE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SELF_DESTRUCT, MOVE_TOXIC_SPIKES,MOVE_SPIKES,MOVE_AQUA_TAIL,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GRANBULL,110,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_RETALIATE, MOVE_PLAY_ROUGH,MOVE_CRUNCH,MOVE_CLOSE_COMBAT,0);
		break;
	}	
}
...
static void DarPokemonRocketScientist(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_MAGNEZONE,63,ITEM_MAGNET,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ELECTROWEB, MOVE_DISCHARGE,MOVE_IRON_DEFENSE,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON2,63,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CONVERSION, MOVE_TRI_ATTACK,MOVE_PSYSHOCK,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGNETON,63,ITEM_EVIOLITE,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_CHARGE_BEAM, MOVE_THUNDERBOLT,MOVE_FLASH_CANNON,MOVE_TELEPORT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ESPEON,63,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_PSYCHIC,MOVE_DAZZLING_GLEAM,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DITTO,63,ITEM_CHOICE_SCARF,26,NATURE_HARDY,1, evs, ivs, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTABUZZ,63,ITEM_MAGNET,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CROSS_CHOP, MOVE_THUNDER_PUNCH,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,63,ITEM_LIGHT_CLAY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHANSEY,63,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JYNX,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_LOVELY_KISS,MOVE_PSYCHIC,MOVE_BLIZZARD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENOMOTH,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_BUG_BUZZ,MOVE_QUIVER_DANCE,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_MAGNEZONE,77,ITEM_MAGNET,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ELECTROWEB, MOVE_DISCHARGE,MOVE_IRON_DEFENSE,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON2,77,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CONVERSION, MOVE_TRI_ATTACK,MOVE_PSYSHOCK,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGNETON,77,ITEM_EVIOLITE,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_CHARGE_BEAM, MOVE_THUNDERBOLT,MOVE_FLASH_CANNON,MOVE_TELEPORT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ESPEON,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_PSYCHIC,MOVE_DAZZLING_GLEAM,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DITTO,77,ITEM_CHOICE_SCARF,26,NATURE_HARDY,1, evs, ivs, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTABUZZ,77,ITEM_MAGNET,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CROSS_CHOP, MOVE_THUNDER_PUNCH,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,77,ITEM_LIGHT_CLAY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHANSEY,77,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JYNX,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_LOVELY_KISS,MOVE_PSYCHIC,MOVE_BLIZZARD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENOMOTH,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_BUG_BUZZ,MOVE_QUIVER_DANCE,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_MAGNEZONE,98,ITEM_MAGNET,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ELECTROWEB, MOVE_DISCHARGE,MOVE_IRON_DEFENSE,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON2,98,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CONVERSION, MOVE_TRI_ATTACK,MOVE_PSYSHOCK,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGNETON,98,ITEM_EVIOLITE,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_CHARGE_BEAM, MOVE_THUNDERBOLT,MOVE_FLASH_CANNON,MOVE_TELEPORT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ESPEON,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_PSYCHIC,MOVE_DAZZLING_GLEAM,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DITTO,98,ITEM_CHOICE_SCARF,26,NATURE_HARDY,1, evs, ivs, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTABUZZ,98,ITEM_MAGNET,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CROSS_CHOP, MOVE_THUNDER_PUNCH,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,98,ITEM_LIGHT_CLAY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHANSEY,98,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JYNX,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_LOVELY_KISS,MOVE_PSYCHIC,MOVE_BLIZZARD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENOMOTH,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_BUG_BUZZ,MOVE_QUIVER_DANCE,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_MAGNEZONE,110,ITEM_MAGNET,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ELECTROWEB, MOVE_DISCHARGE,MOVE_IRON_DEFENSE,MOVE_STEEL_BEAM,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_PORYGON2,110,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CONVERSION, MOVE_TRI_ATTACK,MOVE_PSYSHOCK,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGNETON,110,ITEM_EVIOLITE,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_CHARGE_BEAM, MOVE_THUNDERBOLT,MOVE_FLASH_CANNON,MOVE_TELEPORT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ESPEON,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_PSYCHIC,MOVE_DAZZLING_GLEAM,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DITTO,110,ITEM_CHOICE_SCARF,26,NATURE_HARDY,1, evs, ivs, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTABUZZ,110,ITEM_MAGNET,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CROSS_CHOP, MOVE_THUNDER_PUNCH,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,110,ITEM_LIGHT_CLAY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHANSEY,110,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JYNX,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_WISH, MOVE_LOVELY_KISS,MOVE_PSYCHIC,MOVE_BLIZZARD,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VENOMOTH,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_BUG_BUZZ,MOVE_QUIVER_DANCE,0);
		break;
	}
}
...
static void DarPokemonRocketAdmin(u8 opcion)
{
	...
	u8 ivs[6] = {0};
		...
		ScriptGiveCustomMon(SPECIES_RHYPERIOR,63,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_METAL_BURST, MOVE_ROCK_POLISH,MOVE_EARTHQUAKE,MOVE_ROCK_WRECKER,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOKING,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HEAD_SMASH, MOVE_POISON_JAB,MOVE_EARTHQUAKE,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOQUEEN,63,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_COUNTER, MOVE_TOXIC_SPIKES,MOVE_EARTH_POWER,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TAUROS,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_ENDEAVOR, MOVE_BODY_SLAM,MOVE_CLOSE_COMBAT,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEEZING,63,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, evs, ivs, MOVE_PAIN_SPLIT, MOVE_WILL_O_WISP,MOVE_SLUDGE_BOMB,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KANGASKHAN,63,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_FAKE_OUT,MOVE_DOUBLE_EDGE,MOVE_SUCKER_PUNCH,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTIVIRE,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CROSS_CHOP, MOVE_WILD_CHARGE,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMORTAR,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_MACH_PUNCH, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEAVILE,63,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_FAKE_OUT, MOVE_NIGHT_SLASH,MOVE_ICICLE_CRASH,MOVE_TAUNT,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HONCHKROW,63,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SUCKER_PUNCH, MOVE_DRILL_PECK,MOVE_U_TURN,MOVE_SKY_ATTACK,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_RHYPERIOR,77,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_METAL_BURST, MOVE_ROCK_POLISH,MOVE_EARTHQUAKE,MOVE_ROCK_WRECKER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOKING,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HEAD_SMASH, MOVE_POISON_JAB,MOVE_EARTHQUAKE,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOQUEEN,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_COUNTER, MOVE_TOXIC_SPIKES,MOVE_EARTH_POWER,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TAUROS,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_ENDEAVOR, MOVE_BODY_SLAM,MOVE_CLOSE_COMBAT,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEEZING,77,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, evs, ivs, MOVE_PAIN_SPLIT, MOVE_WILL_O_WISP,MOVE_SLUDGE_BOMB,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KANGASKHAN,77,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_FAKE_OUT,MOVE_DOUBLE_EDGE,MOVE_SUCKER_PUNCH,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTIVIRE,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CROSS_CHOP, MOVE_WILD_CHARGE,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMORTAR,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_MACH_PUNCH, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEAVILE,77,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_FAKE_OUT, MOVE_NIGHT_SLASH,MOVE_ICICLE_CRASH,MOVE_TAUNT,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HONCHKROW,77,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SUCKER_PUNCH, MOVE_DRILL_PECK,MOVE_U_TURN,MOVE_SKY_ATTACK,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_RHYPERIOR,98,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_METAL_BURST, MOVE_ROCK_POLISH,MOVE_EARTHQUAKE,MOVE_ROCK_WRECKER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOKING,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HEAD_SMASH, MOVE_POISON_JAB,MOVE_EARTHQUAKE,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOQUEEN,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_COUNTER, MOVE_TOXIC_SPIKES,MOVE_EARTH_POWER,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TAUROS,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_ENDEAVOR, MOVE_BODY_SLAM,MOVE_CLOSE_COMBAT,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEEZING,98,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, evs, ivs, MOVE_PAIN_SPLIT, MOVE_WILL_O_WISP,MOVE_SLUDGE_BOMB,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KANGASKHAN,98,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_FAKE_OUT,MOVE_DOUBLE_EDGE,MOVE_SUCKER_PUNCH,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTIVIRE,98,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CROSS_CHOP, MOVE_WILD_CHARGE,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMORTAR,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MACH_PUNCH, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEAVILE,98,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_FAKE_OUT, MOVE_NIGHT_SLASH,MOVE_ICICLE_CRASH,MOVE_TAUNT,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HONCHKROW,98,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SUCKER_PUNCH, MOVE_DRILL_PECK,MOVE_U_TURN,MOVE_SKY_ATTACK,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_RHYPERIOR,110,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_METAL_BURST, MOVE_ROCK_POLISH,MOVE_EARTHQUAKE,MOVE_ROCK_WRECKER,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOKING,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HEAD_SMASH, MOVE_POISON_JAB,MOVE_EARTHQUAKE,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_NIDOQUEEN,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_COUNTER, MOVE_TOXIC_SPIKES,MOVE_EARTH_POWER,MOVE_HYPER_BEAM,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TAUROS,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_ENDEAVOR, MOVE_BODY_SLAM,MOVE_CLOSE_COMBAT,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEEZING,110,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, evs, ivs, MOVE_PAIN_SPLIT, MOVE_WILL_O_WISP,MOVE_SLUDGE_BOMB,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KANGASKHAN,110,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_FAKE_OUT,MOVE_DOUBLE_EDGE,MOVE_SUCKER_PUNCH,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTIVIRE,110,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CROSS_CHOP, MOVE_WILD_CHARGE,MOVE_BULK_UP,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMORTAR,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MACH_PUNCH, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_WEAVILE,110,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_FAKE_OUT, MOVE_NIGHT_SLASH,MOVE_ICICLE_CRASH,MOVE_TAUNT,0);

		memcpy(evs, (u8[]){252, 252, 0, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HONCHKROW,110,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SUCKER_PUNCH, MOVE_DRILL_PECK,MOVE_U_TURN,MOVE_SKY_ATTACK,0);
		break;
	}
}
...
static void DarPokemonRainTeam(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_POLITOED,63,ITEM_DAMP_ROCK,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ENDEAVOR, MOVE_HYDRO_PUMP,MOVE_AMNESIA,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGDRA,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_DISABLE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_STARMIE,63,ITEM_LIGHT_CLAY,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_REFRESH, MOVE_REFLECT,MOVE_LIGHT_SCREEN,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLDUCK,63,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_PSYCHIC,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TENTACRUEL,63,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_BARRIER,MOVE_SURF,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GYARADOS,63,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_BOUNCE, MOVE_THRASH,MOVE_AQUA_TAIL,MOVE_DRAGON_RUSH,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VAPOREON,63,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_WISH, MOVE_ACID_ARMOR,MOVE_HYDRO_PUMP,MOVE_BATON_PASS,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LAPRAS,63,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CURSE, MOVE_LIQUIDATION,MOVE_ICE_SHARD,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEWGONG,63,ITEM_SITRUS_BERRY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_STOCKPILE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SEAKING,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_ACUPRESSURE, MOVE_LIQUIDATION,MOVE_MEGAHORN,MOVE_GIGA_IMPACT,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_POLITOED,77,ITEM_DAMP_ROCK,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ENDEAVOR, MOVE_HYDRO_PUMP,MOVE_AMNESIA,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGDRA,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_DISABLE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_STARMIE,77,ITEM_LIGHT_CLAY,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_REFRESH, MOVE_REFLECT,MOVE_LIGHT_SCREEN,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLDUCK,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_PSYCHIC,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TENTACRUEL,77,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_BARRIER,MOVE_SURF,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GYARADOS,77,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_BOUNCE, MOVE_THRASH,MOVE_AQUA_TAIL,MOVE_DRAGON_RUSH,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VAPOREON,77,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_WISH, MOVE_ACID_ARMOR,MOVE_HYDRO_PUMP,MOVE_BATON_PASS,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LAPRAS,77,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CURSE, MOVE_LIQUIDATION,MOVE_ICE_SHARD,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEWGONG,77,ITEM_SITRUS_BERRY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_STOCKPILE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LANTURN,77,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_HEAL_BELL, MOVE_THUNDER,MOVE_SURF,MOVE_RAIN_DANCE,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_POLITOED,98,ITEM_DAMP_ROCK,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ENDEAVOR, MOVE_HYDRO_PUMP,MOVE_AMNESIA,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGDRA,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_DISABLE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_STARMIE,98,ITEM_LIGHT_CLAY,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_REFRESH, MOVE_REFLECT,MOVE_LIGHT_SCREEN,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLDUCK,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_PSYCHIC,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TENTACRUEL,98,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_BARRIER,MOVE_SURF,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GYARADOS,98,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_BOUNCE, MOVE_THRASH,MOVE_AQUA_TAIL,MOVE_DRAGON_RUSH,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);
	
		ScriptGiveCustomMon(SPECIES_HELIOLISK,98,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_SURF, MOVE_VOLT_SWITCH,MOVE_HYPER_VOICE,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LAPRAS,98,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CURSE, MOVE_LIQUIDATION,MOVE_ICE_SHARD,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEWGONG,98,ITEM_SITRUS_BERRY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_STOCKPILE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LANTURN,98,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_HEAL_BELL, MOVE_THUNDER,MOVE_SURF,MOVE_RAIN_DANCE,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_POLITOED,110,ITEM_DAMP_ROCK,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ENDEAVOR, MOVE_HYDRO_PUMP,MOVE_AMNESIA,MOVE_SWAGGER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_KINGDRA,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_DISABLE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_STARMIE,110,ITEM_LIGHT_CLAY,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_REFRESH, MOVE_REFLECT,MOVE_LIGHT_SCREEN,MOVE_RECOVER,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GOLDUCK,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_PSYCHIC,MOVE_YAWN,0);

		memcpy(evs, (u8[]){252, 0, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TENTACRUEL,110,ITEM_BLACK_SLUDGE,26,NATURE_HARDY,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_BARRIER,MOVE_SURF,MOVE_TOXIC_SPIKES,0);

		memcpy(evs, (u8[]){0, 252, 0, 252, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GYARADOS,110,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_BOUNCE, MOVE_THRASH,MOVE_AQUA_TAIL,MOVE_DRAGON_RUSH,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HELIOLISK,110,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_SURF, MOVE_VOLT_SWITCH,MOVE_HYPER_VOICE,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LAPRAS,110,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CURSE, MOVE_LIQUIDATION,MOVE_ICE_SHARD,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DEWGONG,110,ITEM_SITRUS_BERRY,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_STOCKPILE, MOVE_SURF,MOVE_ICE_BEAM,MOVE_REST,0);

		memcpy(evs, (u8[]){0, 0, 0, 252, 252, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LANTURN,110,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_HEAL_BELL, MOVE_THUNDER,MOVE_SURF,MOVE_RAIN_DANCE,0);
		break;
	}
}
...
static void DarPokemonSunTeam(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_NINETALES,63,ITEM_HEAT_ROCK,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_FLAMETHROWER,MOVE_SOLAR_BEAM,MOVE_WILL_O_WISP,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMAR,63,ITEM_EVIOLITE,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_CLEAR_SMOG, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARCANINE,63,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_THRASH, MOVE_FLARE_BLITZ,MOVE_CLOSE_COMBAT,MOVE_WILD_CHARGE,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_FLAREON,63,ITEM_TOXIC_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_FACADE, MOVE_FLARE_BLITZ,MOVE_SUPERPOWER,MOVE_QUICK_ATTACK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAPIDASH,63,ITEM_LIFE_ORB,26,NATURE_HARDY, 0xFF, evs, ivs, MOVE_MORNING_SUN, MOVE_SMART_STRIKE,MOVE_MEGAHORN,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JUMPLUFF,63,ITEM_LEFTOVERS,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_COTTON_GUARD, MOVE_SLEEP_POWDER,MOVE_SOLAR_BEAM,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SLEEP_POWDER, MOVE_SOLAR_BEAM,MOVE_FUTURE_SIGHT,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,63,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM,MOVE_ANCIENT_POWER,MOVE_BLAST_BURN,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VICTREEBEL,63,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_SOLAR_BEAM,MOVE_SYNTHESIS,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VILEPLUME,63,ITEM_BLACK_SLUDGE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_SOLAR_BEAM,MOVE_SYNTHESIS,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_NINETALES,77,ITEM_HEAT_ROCK,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_FLAMETHROWER,MOVE_SOLAR_BEAM,MOVE_WILL_O_WISP,0);

		memcpy(evs, (u8[]){252, 0, 128, 0, 0, 128}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMAR,77,ITEM_EVIOLITE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_CLEAR_SMOG, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ARCANINE,77,ITEM_LIFE_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_THRASH, MOVE_FLARE_BLITZ,MOVE_CLOSE_COMBAT,MOVE_WILD_CHARGE,0);

		memcpy(evs, (u8[]){0, 252, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TORKOAL,77,ITEM_HEAT_ROCK,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_RAPID_SPIN, MOVE_LAVA_PLUME,MOVE_CLEAR_SMOG,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_RAPIDASH,77,ITEM_LIFE_ORB,26,NATURE_HARDY, 0xFF, evs, ivs, MOVE_MORNING_SUN, MOVE_SMART_STRIKE,MOVE_MEGAHORN,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JUMPLUFF,77,ITEM_LEFTOVERS,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_COTTON_GUARD, MOVE_SLEEP_POWDER,MOVE_SOLAR_BEAM,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SLEEP_POWDER, MOVE_SOLAR_BEAM,MOVE_FUTURE_SIGHT,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,77,ITEM_LEFTOVERS,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM,MOVE_ANCIENT_POWER,MOVE_BLAST_BURN,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VICTREEBEL,77,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_SOLAR_BEAM,MOVE_SYNTHESIS,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VOLCARONA,77,ITEM_NONE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_NINETALES,98,ITEM_HEAT_ROCK,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_FLAMETHROWER,MOVE_SOLAR_BEAM,MOVE_WILL_O_WISP,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMAR,98,ITEM_EVIOLITE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_CLEAR_SMOG, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HELIOLISK,98,ITEM_LIFE_ORB,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_SURF, MOVE_VOLT_SWITCH,MOVE_HYPER_VOICE,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TORKOAL,98,ITEM_HEAT_ROCK,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_RAPID_SPIN, MOVE_LAVA_PLUME,MOVE_CLEAR_SMOG,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DARMANITAN,98,ITEM_LIFE_ORB,26,NATURE_HARDY, 0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_YAWN,MOVE_GIGA_IMPACT,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JUMPLUFF,98,ITEM_LEFTOVERS,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_COTTON_GUARD, MOVE_SLEEP_POWDER,MOVE_SOLAR_BEAM,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SLEEP_POWDER, MOVE_SOLAR_BEAM,MOVE_FUTURE_SIGHT,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){6, 0, 0, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM,MOVE_ANCIENT_POWER,MOVE_BLAST_BURN,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VICTREEBEL,98,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_SOLAR_BEAM,MOVE_SYNTHESIS,0);

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VOLCARONA,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_NINETALES,110,ITEM_HEAT_ROCK,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_FLAMETHROWER,MOVE_SOLAR_BEAM,MOVE_WILL_O_WISP,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MAGMAR,110,ITEM_EVIOLITE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_CLEAR_SMOG, MOVE_FIRE_BLAST,MOVE_THUNDERBOLT,MOVE_CONFUSE_RAY,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HELIOLISK,110,ITEM_LIFE_ORB,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_SURF, MOVE_VOLT_SWITCH,MOVE_HYPER_VOICE,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TORKOAL,110,ITEM_HEAT_ROCK,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_RAPID_SPIN, MOVE_LAVA_PLUME,MOVE_CLEAR_SMOG,MOVE_STEALTH_ROCK,0);

		memcpy(evs, (u8[]){0, 252, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DARMANITAN,110,ITEM_LIFE_ORB,26,NATURE_HARDY, 0xFF, evs, ivs, MOVE_HAMMER_ARM, MOVE_YAWN,MOVE_GIGA_IMPACT,MOVE_FLARE_BLITZ,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_JUMPLUFF,110,ITEM_LEFTOVERS,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_COTTON_GUARD, MOVE_SLEEP_POWDER,MOVE_SOLAR_BEAM,MOVE_WEATHER_BALL,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_EXEGGUTOR,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SLEEP_POWDER, MOVE_SOLAR_BEAM,MOVE_FUTURE_SIGHT,MOVE_DRACO_METEOR,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM,MOVE_ANCIENT_POWER,MOVE_BLAST_BURN,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VICTREEBEL,110,ITEM_LIFE_ORB,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB,MOVE_SOLAR_BEAM,MOVE_SYNTHESIS,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VOLCARONA,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);
		break;
	}
}
...
static void DarPokemonRareTeam(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_DRAGONITE,63,ITEM_DRAGON_FANG,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SNORLAX,63,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CURSE, MOVE_BODY_SLAM,MOVE_CRUNCH,MOVE_REST,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLASTOISE,63,ITEM_MYSTIC_WATER,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_AQUA_RING,MOVE_IRON_DEFENSE,MOVE_HYDRO_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,63,ITEM_CHARCOAL,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ANCIENT_POWER, MOVE_DRAGON_PULSE,MOVE_AIR_SLASH,MOVE_BLAST_BURN,0);
		
		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_LICKILICKY,63,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_THRASH, MOVE_POWER_WHIP,MOVE_KNOCK_OFF,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){252, 0, 0, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CLEFABLE,63,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_WISH, MOVE_MOONBLAST,MOVE_MOONLIGHT,MOVE_COSMIC_POWER,0);
		...
		ScriptGiveCustomMon(SPECIES_TOGETIC,63,ITEM_EVIOLITE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_YAWN, MOVE_AIR_SLASH,MOVE_MYSTICAL_FIRE,MOVE_NASTY_PLOT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_HITMONTOP,63,ITEM_NONE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_RAPID_SPIN, MOVE_HIGH_JUMP_KICK,MOVE_SUCKER_PUNCH,MOVE_FAKE_OUT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SCYTHER,63,ITEM_NONE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_COUNTER, MOVE_X_SCISSOR,MOVE_CLOSE_COMBAT,MOVE_PSYCHO_CUT,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_DRAGONITE,77,ITEM_DRAGON_FANG,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MILOTIC,77,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLASTOISE,77,ITEM_MYSTIC_WATER,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_AQUA_RING,MOVE_IRON_DEFENSE,MOVE_HYDRO_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,77,ITEM_CHARCOAL,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ANCIENT_POWER, MOVE_DRAGON_PULSE,MOVE_AIR_SLASH,MOVE_BLAST_BURN,0);

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VOLCARONA,77,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TRXATU,77,ITEM_SHARP_BEAK,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ROOST, MOVE_PSYCHIC,MOVE_HEAT_WAVE,MOVE_AEROBLAST,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLISSEY,77,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TOGEKISS,77,ITEM_SHARP_BEAK,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_YAWN, MOVE_AIR_SLASH,MOVE_MYSTICAL_FIRE,MOVE_NASTY_PLOT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TYRANITAR,77,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CRUNCH, MOVE_STONE_EDGE,MOVE_EARTHQUAKE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SCIZOR,77,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_COUNTER, MOVE_X_SCISSOR,MOVE_CLOSE_COMBAT,MOVE_BULLET_PUNCH,0);
		break;
		case 2:

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);
		ScriptGiveCustomMon(SPECIES_DRAGONITE,98,ITEM_DRAGON_FANG,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MILOTIC,98,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLASTOISE,98,ITEM_MYSTIC_WATER,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_AQUA_RING,MOVE_IRON_DEFENSE,MOVE_HYDRO_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,98,ITEM_CHARCOAL,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ANCIENT_POWER, MOVE_DRAGON_PULSE,MOVE_AIR_SLASH,MOVE_BLAST_BURN,0); 

		memcpy(evs, (u8[]){252, 0, 252, 6, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_VOLCARONA,98,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TRXATU,98,ITEM_SHARP_BEAK,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_ROOST, MOVE_PSYCHIC,MOVE_HEAT_WAVE,MOVE_AEROBLAST,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLISSEY,98,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TOGEKISS,98,ITEM_SHARP_BEAK,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_YAWN, MOVE_AIR_SLASH,MOVE_MYSTICAL_FIRE,MOVE_NASTY_PLOT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TYRANITAR,98,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CRUNCH, MOVE_STONE_EDGE,MOVE_EARTHQUAKE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 0, 252}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);
			ScriptGiveCustomMon(SPECIES_DUNSPARCE,98,ITEM_NONE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_CURSE, MOVE_EARTH_POWER,MOVE_ROOST,MOVE_BOOMBURST,0);
		break;
		case 3:
		...
		ScriptGiveCustomMon(SPECIES_DRAGONITE,110,ITEM_DRAGON_FANG,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_EXTREME_SPEED, MOVE_ROOST,MOVE_DRAGON_CLAW,MOVE_BARRIER,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_MILOTIC,110,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLASTOISE,110,ITEM_MYSTIC_WATER,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_AQUA_RING,MOVE_IRON_DEFENSE,MOVE_HYDRO_CANNON,0);

		memcpy(evs, (u8[]){0, 0, 6, 252, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_CHARIZARD,110,ITEM_CHARCOAL,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_ANCIENT_POWER, MOVE_DRAGON_PULSE,MOVE_AIR_SLASH,MOVE_BLAST_BURN,0); 
		...
		ScriptGiveCustomMon(SPECIES_TRXATU,110,ITEM_SHARP_BEAK,26,NATURE_TIMID,0xFF, evs, ivs, MOVE_ROOST, MOVE_PSYCHIC,MOVE_HEAT_WAVE,MOVE_AEROBLAST,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_BLISSEY,110,ITEM_LEFTOVERS,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED,MOVE_THUNDER_WAVE,MOVE_HEALING_WISH,0);

		memcpy(evs, (u8[]){252, 0, 252, 0, 0, 6}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TOGEKISS,110,ITEM_SHARP_BEAK,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_YAWN, MOVE_AIR_SLASH,MOVE_MYSTICAL_FIRE,MOVE_NASTY_PLOT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TYRANITAR,110,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CRUNCH, MOVE_STONE_EDGE,MOVE_EARTHQUAKE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 0, 252, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_DUNSPARCE_OLD,110,ITEM_NONE,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_CURSE, MOVE_EARTH_POWER,MOVE_ROOST,MOVE_BOOMBURST,0);
		break;
	}
}
...
static void DarPokemonPopularTeam(u8 opcion)
{
	...
	switch(opcion){
		...
		ScriptGiveCustomMon(SPECIES_FURRET,63,ITEM_SITRUS_BERRY,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SLASH, MOVE_COIL,MOVE_AQUA_TAIL,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_TYRANITAR,63,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_CRUNCH, MOVE_STONE_EDGE,MOVE_EARTHQUAKE,MOVE_GIGA_IMPACT,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,63,ITEM_LIGHT_CLAY,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);
		...
		ScriptGiveCustomMon(SPECIES_RHYDON,63,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_METAL_BURST, MOVE_ROCK_POLISH,MOVE_EARTHQUAKE,MOVE_ROCK_WRECKER,0);
		...
		ScriptGiveCustomMon(SPECIES_SWELLOW,63,ITEM_TOXIC_ORB,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_BRAVE_BIRD, MOVE_FACADE,MOVE_U_TURN,MOVE_GIGA_IMPACT,0);
		break;
		case 1:
		...
		ScriptGiveCustomMon(SPECIES_VOLCARONA,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_MORNING_SUN, MOVE_QUIVER_DANCE,MOVE_FLAMETHROWER,MOVE_AMNESIA,0);
		...
		ScriptGiveCustomMon(SPECIES_FURRET,77,ITEM_NONE,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_SLASH, MOVE_COIL,MOVE_AQUA_TAIL,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,77,ITEM_LIGHT_CLAY,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_GYARADOS,77,ITEM_CHOICE_BAND,26,NATURE_HARDY, 0xFF, evs, ivs, MOVE_BOUNCE, MOVE_THRASH,MOVE_AQUA_TAIL,MOVE_DRAGON_RUSH,0);
		...
		ScriptGiveCustomMon(SPECIES_MILOTIC,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SCIZOR,77,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_COUNTER, MOVE_X_SCISSOR,MOVE_CLOSE_COMBAT,MOVE_PSYCHO_CUT,0);
		break;
		case 2:
		...
		ScriptGiveCustomMon(SPECIES_MILOTIC,98,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_FURRET,98,ITEM_NONE,26,NATURE_HARDY, 0xFF, evs, ivs, MOVE_SLASH, MOVE_COIL,MOVE_AQUA_TAIL,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,98,ITEM_LIGHT_CLAY,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_METAGROSS,98,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_BULLET_PUNCH, MOVE_METEOR_MASH,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SCIZOR,98,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_COUNTER, MOVE_X_SCISSOR,MOVE_CLOSE_COMBAT,MOVE_PSYCHO_CUT,0);
		...
		ScriptGiveCustomMon(SPECIES_MILOTIC,110,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, evs, ivs, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP,MOVE_RECOVER,MOVE_MIRROR_COAT,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_FURRET,110,ITEM_NONE,26,NATURE_HARDY, 0xFF, evs, ivs, MOVE_SLASH, MOVE_COIL,MOVE_AQUA_TAIL,MOVE_AMNESIA,0);

		memcpy(evs, (u8[]){252, 0, 6, 252, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_ELECTRODE,110,ITEM_LIGHT_CLAY,26,NATURE_BOLD,0xFF, evs, ivs, MOVE_MIRROR_COAT, MOVE_THUNDERBOLT,MOVE_REFLECT,MOVE_LIGHT_SCREEN,0); 

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_METAGROSS,110,ITEM_ASSAULT_VEST,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_BULLET_PUNCH, MOVE_METEOR_MASH,MOVE_EARTHQUAKE,MOVE_EXPLOSION,0);

		memcpy(evs, (u8[]){252, 252, 6, 0, 0, 0}, 6);
        memcpy(ivs, (u8[]){31, 31, 31, 31, 31, 31}, 6);

		ScriptGiveCustomMon(SPECIES_SCIZOR,110,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, evs, ivs, MOVE_COUNTER, MOVE_X_SCISSOR,MOVE_CLOSE_COMBAT,MOVE_PSYCHO_CUT,0);
...
static void DarPokemonWeakTeam(u8 opcion){
	switch(opcion){
		case 0:
			ScriptGiveCustomMon(SPECIES_MAGIKARP,63,ITEM_WATER_GEM,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_HYDRO_PUMP, MOVE_DRAGON_RAGE,MOVE_SPLASH,MOVE_FLAIL,1);
			ScriptGiveCustomMon(SPECIES_DELIBIRD,63,ITEM_CHOICE_BAND,26,NATURE_JOLLY,0xFF, 0, 0, MOVE_DESTINY_BOND, MOVE_AERIAL_ACE,MOVE_DRILL_PECK,MOVE_PRESENT,0);
			ScriptGiveCustomMon(SPECIES_SMEARGLE,63,ITEM_NONE,26,NATURE_JOLLY,0xFF, 0, 0, MOVE_SKETCH, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_BELDUM,63,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_DOUBLE_EDGE, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_DITTO,63,ITEM_NONE,26,NATURE_HARDY,0xFF, 0, 0, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_SHEDINJA,63,ITEM_FOCUS_SASH,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_SWORDS_DANCE, MOVE_MIMIC,MOVE_SHADOW_SNEAK,MOVE_PHANTOM_FORCE,0);
			ScriptGiveCustomMon(SPECIES_UNOWN,63,ITEM_CHOICE_SCARF,26,NATURE_MODEST,0xFF, 0, 0, MOVE_HIDDEN_POWER, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_WYNAUT,63,ITEM_CUSTAP_BERRY,26,NATURE_BOLD,0xFF, 0, 0, MOVE_ENCORE, MOVE_COUNTER,MOVE_MIRROR_COAT,MOVE_DESTINY_BOND,0);
			ScriptGiveCustomMon(SPECIES_PUMPKABOO,63,ITEM_CHOICE_BAND,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_DESTINY_BOND, MOVE_TRICK_ROOM,MOVE_TRICK,MOVE_PAIN_SPLIT,0);
			ScriptGiveCustomMon(SPECIES_WIMPOD,63,ITEM_BRIGHT_POWDER,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_AQUA_JET, MOVE_DOUBLE_TEAM,MOVE_SAND_ATTACK,MOVE_STRUGGLE_BUG,0);
		break;
		case 1:
			ScriptGiveCustomMon(SPECIES_MAGIKARP,77,ITEM_WATER_GEM,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_HYDRO_PUMP, MOVE_DRAGON_RAGE,MOVE_BOUNCE,MOVE_FLAIL,1);
			ScriptGiveCustomMon(SPECIES_DELIBIRD,77,ITEM_SHARP_BEAK,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_FAKE_OUT, MOVE_POWER_UP_PUNCH,MOVE_DRILL_PECK,MOVE_PRESENT,0);
			ScriptGiveCustomMon(SPECIES_SMEARGLE,77,ITEM_NONE,26,NATURE_JOLLY,0xFF, 0, 0, MOVE_SKETCH, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_BELDUM,77,ITEM_SILK_SCARF,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_DOUBLE_EDGE, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_DITTO,77,ITEM_NONE,26,NATURE_HARDY,0xFF, 0, 0, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_IGGLYBUFF,77,ITEM_LEFTOVERS,26,NATURE_MODEST,0xFF, 0, 0, MOVE_PERISH_SONG, MOVE_WATER_PULSE,MOVE_COPYCAT,MOVE_SWEET_KISS,0);
			ScriptGiveCustomMon(SPECIES_CLEFFA,77,ITEM_TOXIC_ORB,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_BELLY_DRUM, MOVE_FACADE,MOVE_SWEET_KISS,MOVE_ENCORE,0);
			ScriptGiveCustomMon(SPECIES_WYNAUT,77,ITEM_CUSTAP_BERRY,26,NATURE_CALM,0xFF, 0, 0, MOVE_ENCORE, MOVE_COUNTER,MOVE_MIRROR_COAT,MOVE_TICKLE,0);
			ScriptGiveCustomMon(SPECIES_TYROGUE,77,ITEM_BRIGHT_POWDER,26,NATURE_HARDY,0xFF, 0, 0, MOVE_MACH_PUNCH, MOVE_RETALIATE,MOVE_FAKE_OUT,MOVE_FORESIGHT,0);
			ScriptGiveCustomMon(SPECIES_MUNCHLAX,77,ITEM_STARF_BERRY,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_SELF_DESTRUCT, MOVE_SECRET_POWER,MOVE_CHIP_AWAY,MOVE_RECYCLE,0);
		break;
		case 2:
			ScriptGiveCustomMon(SPECIES_MAGIKARP,98,ITEM_WATER_GEM,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_HYDRO_PUMP, MOVE_DRAGON_RAGE,MOVE_BOUNCE,MOVE_FLAIL,1);
			ScriptGiveCustomMon(SPECIES_TOGEPI,98,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, 0, MOVE_TRI_ATTACK, MOVE_DAZZLING_GLEAM,MOVE_METRONOME,MOVE_WISH,0);
			ScriptGiveCustomMon(SPECIES_SMEARGLE,98,ITEM_NONE,26,NATURE_JOLLY,0xFF, 0, 0, MOVE_SKETCH, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_FEEBAS,98,ITEM_QUICK_CLAW,26,NATURE_CALM,0xFF, 0, 0, MOVE_HYPNOSIS, MOVE_WATER_PULSE,MOVE_TACKLE,MOVE_FLAIL,0);
			ScriptGiveCustomMon(SPECIES_DITTO,98,ITEM_NONE,26,NATURE_HARDY,0xFF, 0, 0, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_RIOLU,98,ITEM_BLACK_BELT,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_AGILITY, MOVE_POWER_UP_PUNCH,MOVE_FORCE_PALM,MOVE_REVERSAL,0); 
			ScriptGiveCustomMon(SPECIES_SMOOCHUM,98,ITEM_CHOICE_SPECS,26,NATURE_TIMID,0xFF, 0, 0, MOVE_MIRACLE_EYE, MOVE_RAIN_DANCE,MOVE_PSYCHIC,MOVE_PERISH_SONG,0);
			ScriptGiveCustomMon(SPECIES_FARFETCHD,98,ITEM_LEEK,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_LEAF_BLADE, MOVE_U_TURN,MOVE_SLASH,MOVE_AIR_CUTTER,0);
			ScriptGiveCustomMon(SPECIES_TAILLOW,98,ITEM_TOXIC_ORB,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_BOOMBURST, MOVE_FACADE,MOVE_BRAVE_BIRD,MOVE_REVERSAL,0);
			ScriptGiveCustomMon(SPECIES_WISHIWASHI,98,ITEM_LEFTOVERS,26,NATURE_SASSY,0xFF, 0, 0, MOVE_MUDDY_WATER, MOVE_SURF,MOVE_DOUBLE_EDGE,MOVE_ENDEAVOR,0);
		break;
		case 3:
			ScriptGiveCustomMon(SPECIES_MAGIKARP,110,ITEM_WATER_GEM,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_HYDRO_PUMP, MOVE_DRAGON_RAGE,MOVE_BOUNCE,MOVE_FLAIL,1);
			ScriptGiveCustomMon(SPECIES_TOGEPI,110,ITEM_NONE,26,NATURE_MODEST,0xFF, 0, 0, MOVE_TRI_ATTACK, MOVE_DAZZLING_GLEAM,MOVE_METRONOME,MOVE_WISH,0);
			ScriptGiveCustomMon(SPECIES_SMEARGLE,110,ITEM_NONE,26,NATURE_JOLLY,0xFF, 0, 0, MOVE_SKETCH, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_FEEBAS,110,ITEM_QUICK_CLAW,26,NATURE_CALM,0xFF, 0, 0, MOVE_HYPNOSIS, MOVE_WATER_PULSE,MOVE_TACKLE,MOVE_FLAIL,0);
			ScriptGiveCustomMon(SPECIES_DITTO,110,ITEM_NONE,26,NATURE_HARDY,0xFF, 0, 0, MOVE_TRANSFORM, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
			ScriptGiveCustomMon(SPECIES_RIOLU,110,ITEM_BLACK_BELT,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_AGILITY, MOVE_POWER_UP_PUNCH,MOVE_FORCE_PALM,MOVE_REVERSAL,0); 
			ScriptGiveCustomMon(SPECIES_SMOOCHUM,110,ITEM_CHOICE_SPECS,26,NATURE_TIMID,0xFF, 0, 0, MOVE_MIRACLE_EYE, MOVE_RAIN_DANCE,MOVE_PSYCHIC,MOVE_PERISH_SONG,0);
			ScriptGiveCustomMon(SPECIES_FARFETCHD,110,ITEM_LEEK,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_LEAF_BLADE, MOVE_U_TURN,MOVE_SLASH,MOVE_AIR_CUTTER,0);
			ScriptGiveCustomMon(SPECIES_TAILLOW,110,ITEM_TOXIC_ORB,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_BOOMBURST, MOVE_FACADE,MOVE_BRAVE_BIRD,MOVE_REVERSAL,0);
			ScriptGiveCustomMon(SPECIES_TYROGUE,110,ITEM_LEFTOVERS,26,NATURE_ADAMANT,0xFF, 0, 0, MOVE_TACKLE, MOVE_NONE,MOVE_NONE,MOVE_NONE,0);
		break;
	}
}
...
static void Task_MysteryGift(u8 taskId)
{
	...
	NewGameInitData();
	SetTrainerId(35241, gSaveBlock2Ptr->playerTrainerId);
	ScriptContext2_RunNewScript(EventScript_SetHoenn);
	ResetInitialPlayerAvatarState();
	PlayTimeCounter_Start();
	gSaveBlock2Ptr->playerGender = ADMIN_JEFE;
	SetMoney(&gSaveBlock1Ptr->money, 5263157);
	data->state = HOENN6;
	break;
	case HOENN6:
		switch(MenuPersonalizado())
...
////HOENN
	...
	if (VarGet(VAR_HAS_ENTERED_BATTLE_FRONTIER) == 10) {
		...
		break;
			...
			{
case BULBASAUR:
	ScriptGiveMon(SPECIES_BULBASAUR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case IVYSAUR:
	ScriptGiveMon(SPECIES_IVYSAUR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VENUSAUR:
	ScriptGiveMon(SPECIES_VENUSAUR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHARMANDER:
	ScriptGiveMon(SPECIES_CHARMANDER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHARMELEON:
	ScriptGiveMon(SPECIES_CHARMELEON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHARIZARD:
	ScriptGiveMon(SPECIES_CHARIZARD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SQUIRTLE:
	ScriptGiveMon(SPECIES_SQUIRTLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WARTORTLE:
	ScriptGiveMon(SPECIES_WARTORTLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BLASTOISE:
	ScriptGiveMon(SPECIES_BLASTOISE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CATERPIE:
	ScriptGiveMon(SPECIES_CATERPIE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case METAPOD:
	ScriptGiveMon(SPECIES_METAPOD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BUTTERFREE:
	ScriptGiveMon(SPECIES_BUTTERFREE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WEEDLE:
	ScriptGiveMon(SPECIES_WEEDLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KAKUNA:
	ScriptGiveMon(SPECIES_KAKUNA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BEEDRILL:
	ScriptGiveMon(SPECIES_BEEDRILL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIDGEY:
	ScriptGiveMon(SPECIES_PIDGEY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIDGEOTTO:
	ScriptGiveMon(SPECIES_PIDGEOTTO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIDGEOT:
	ScriptGiveMon(SPECIES_PIDGEOT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RATTATA:
	ScriptGiveMon(SPECIES_RATTATA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RATICATE:
	ScriptGiveMon(SPECIES_RATICATE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPEAROW:
	ScriptGiveMon(SPECIES_SPEAROW,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FEAROW:
	ScriptGiveMon(SPECIES_FEAROW,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EKANS:
	ScriptGiveMon(SPECIES_EKANS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARBOK:
	ScriptGiveMon(SPECIES_ARBOK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIKACHU:
	ScriptGiveMon(SPECIES_PIKACHU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RAICHU:
	ScriptGiveMon(SPECIES_RAICHU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SANDSHREW:
	ScriptGiveMon(SPECIES_SANDSHREW,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SANDSLASH:
	ScriptGiveMon(SPECIES_SANDSLASH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NIDORAN_F:
	ScriptGiveMon(SPECIES_NIDORAN_F,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NIDORINA:
	ScriptGiveMon(SPECIES_NIDORINA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NIDOQUEEN:
	ScriptGiveMon(SPECIES_NIDOQUEEN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NIDORAN_M:
	ScriptGiveMon(SPECIES_NIDORAN_M,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NIDORINO:
	ScriptGiveMon(SPECIES_NIDORINO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NIDOKING:
	ScriptGiveMon(SPECIES_NIDOKING,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLEFAIRY:
	ScriptGiveMon(SPECIES_CLEFAIRY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLEFABLE:
	ScriptGiveMon(SPECIES_CLEFABLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VULPIX:
	ScriptGiveMon(SPECIES_VULPIX,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NINETALES:
	ScriptGiveMon(SPECIES_NINETALES,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JIGGLYPUFF:
	ScriptGiveMon(SPECIES_JIGGLYPUFF,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WIGGLYTUFF:
	ScriptGiveMon(SPECIES_WIGGLYTUFF,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZUBAT:
	ScriptGiveMon(SPECIES_ZUBAT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLBAT:
	ScriptGiveMon(SPECIES_GOLBAT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ODDISH:
	ScriptGiveMon(SPECIES_ODDISH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GLOOM:
	ScriptGiveMon(SPECIES_GLOOM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VILEPLUME:
	ScriptGiveMon(SPECIES_VILEPLUME,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PARAS:
	ScriptGiveMon(SPECIES_PARAS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PARASECT:
	ScriptGiveMon(SPECIES_PARASECT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VENONAT:
	ScriptGiveMon(SPECIES_VENONAT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VENOMOTH:
	ScriptGiveMon(SPECIES_VENOMOTH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DIGLETT:
	ScriptGiveMon(SPECIES_DIGLETT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUGTRIO:
	ScriptGiveMon(SPECIES_DUGTRIO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MEOWTH:
	ScriptGiveMon(SPECIES_MEOWTH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PERSIAN:
	ScriptGiveMon(SPECIES_PERSIAN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PSYDUCK:
	ScriptGiveMon(SPECIES_PSYDUCK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLDUCK:
	ScriptGiveMon(SPECIES_GOLDUCK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MANKEY:
	ScriptGiveMon(SPECIES_MANKEY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PRIMEAPE:
	ScriptGiveMon(SPECIES_PRIMEAPE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GROWLITHE:
	ScriptGiveMon(SPECIES_GROWLITHE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARCANINE:
	ScriptGiveMon(SPECIES_ARCANINE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POLIWAG:
	ScriptGiveMon(SPECIES_POLIWAG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POLIWHIRL:
	ScriptGiveMon(SPECIES_POLIWHIRL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POLIWRATH:
	ScriptGiveMon(SPECIES_POLIWRATH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ABRA:
	ScriptGiveMon(SPECIES_ABRA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KADABRA:
	ScriptGiveMon(SPECIES_KADABRA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ALAKAZAM:
	ScriptGiveMon(SPECIES_ALAKAZAM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MACHOP:
	ScriptGiveMon(SPECIES_MACHOP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MACHOKE:
	ScriptGiveMon(SPECIES_MACHOKE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MACHAMP:
	ScriptGiveMon(SPECIES_MACHAMP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BELLSPROUT:
	ScriptGiveMon(SPECIES_BELLSPROUT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WEEPINBELL:
	ScriptGiveMon(SPECIES_WEEPINBELL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VICTREEBEL:
	ScriptGiveMon(SPECIES_VICTREEBEL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TENTACOOL:
	ScriptGiveMon(SPECIES_TENTACOOL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TENTACRUEL:
	ScriptGiveMon(SPECIES_TENTACRUEL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GEODUDE:
	ScriptGiveMon(SPECIES_GEODUDE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRAVELER:
	ScriptGiveMon(SPECIES_GRAVELER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLEM:
	ScriptGiveMon(SPECIES_GOLEM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PONYTA:
	ScriptGiveMon(SPECIES_PONYTA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RAPIDASH:
	ScriptGiveMon(SPECIES_RAPIDASH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLOWPOKE:
	ScriptGiveMon(SPECIES_SLOWPOKE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLOWBRO:
	ScriptGiveMon(SPECIES_SLOWBRO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGNEMITE:
	ScriptGiveMon(SPECIES_MAGNEMITE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGNETON:
	ScriptGiveMon(SPECIES_MAGNETON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FARFETCHD:
	ScriptGiveMon(SPECIES_FARFETCHD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DODUO:
	ScriptGiveMon(SPECIES_DODUO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DODRIO:
	ScriptGiveMon(SPECIES_DODRIO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEEL:
	ScriptGiveMon(SPECIES_SEEL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DEWGONG:
	ScriptGiveMon(SPECIES_DEWGONG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRIMER:
	ScriptGiveMon(SPECIES_GRIMER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUK:
	ScriptGiveMon(SPECIES_MUK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHELLDER:
	ScriptGiveMon(SPECIES_SHELLDER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLOYSTER:
	ScriptGiveMon(SPECIES_CLOYSTER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GASTLY:
	ScriptGiveMon(SPECIES_GASTLY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HAUNTER:
	ScriptGiveMon(SPECIES_HAUNTER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GENGAR:
	ScriptGiveMon(SPECIES_GENGAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ONIX:
	ScriptGiveMon(SPECIES_ONIX,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DROWZEE:
	ScriptGiveMon(SPECIES_DROWZEE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HYPNO:
	ScriptGiveMon(SPECIES_HYPNO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KRABBY:
	ScriptGiveMon(SPECIES_KRABBY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KINGLER:
	ScriptGiveMon(SPECIES_KINGLER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VOLTORB:
	ScriptGiveMon(SPECIES_VOLTORB,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELECTRODE:
	ScriptGiveMon(SPECIES_ELECTRODE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EXEGGCUTE:
	ScriptGiveMon(SPECIES_EXEGGCUTE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EXEGGUTOR:
	ScriptGiveMon(SPECIES_EXEGGUTOR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CUBONE:
	ScriptGiveMon(SPECIES_CUBONE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAROWAK:
	ScriptGiveMon(SPECIES_MAROWAK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HITMONLEE:
	ScriptGiveMon(SPECIES_HITMONLEE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HITMONCHAN:
	ScriptGiveMon(SPECIES_HITMONCHAN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LICKITUNG:
	ScriptGiveMon(SPECIES_LICKITUNG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KOFFING:
	ScriptGiveMon(SPECIES_KOFFING,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WEEZING:
	ScriptGiveMon(SPECIES_WEEZING,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RHYHORN:
	ScriptGiveMon(SPECIES_RHYHORN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RHYDON:
	ScriptGiveMon(SPECIES_RHYDON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHANSEY:
	ScriptGiveMon(SPECIES_CHANSEY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TANGELA:
	ScriptGiveMon(SPECIES_TANGELA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KANGASKHAN:
	ScriptGiveMon(SPECIES_KANGASKHAN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HORSEA:
	ScriptGiveMon(SPECIES_HORSEA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEADRA:
	ScriptGiveMon(SPECIES_SEADRA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLDEEN:
	ScriptGiveMon(SPECIES_GOLDEEN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEAKING:
	ScriptGiveMon(SPECIES_SEAKING,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STARYU:
	ScriptGiveMon(SPECIES_STARYU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STARMIE:
	ScriptGiveMon(SPECIES_STARMIE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MR_MIME:
	ScriptGiveMon(SPECIES_MR_MIME,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCYTHER:
	ScriptGiveMon(SPECIES_SCYTHER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JYNX:
	ScriptGiveMon(SPECIES_JYNX,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELECTABUZZ:
	ScriptGiveMon(SPECIES_ELECTABUZZ,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGMAR:
	ScriptGiveMon(SPECIES_MAGMAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PINSIR:
	ScriptGiveMon(SPECIES_PINSIR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TAUROS:
	ScriptGiveMon(SPECIES_TAUROS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGIKARP:
	ScriptGiveMon(SPECIES_MAGIKARP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GYARADOS:
	ScriptGiveMon(SPECIES_GYARADOS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LAPRAS:
	ScriptGiveMon(SPECIES_LAPRAS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DITTO:
	ScriptGiveMon(SPECIES_DITTO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EEVEE:
	ScriptGiveMon(SPECIES_EEVEE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VAPOREON:
	ScriptGiveMon(SPECIES_VAPOREON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JOLTEON:
	ScriptGiveMon(SPECIES_JOLTEON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLAREON:
	ScriptGiveMon(SPECIES_FLAREON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PORYGON:
	ScriptGiveMon(SPECIES_PORYGON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case OMANYTE:
	ScriptGiveMon(SPECIES_OMANYTE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case OMASTAR:
	ScriptGiveMon(SPECIES_OMASTAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KABUTO:
	ScriptGiveMon(SPECIES_KABUTO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KABUTOPS:
	ScriptGiveMon(SPECIES_KABUTOPS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AERODACTYL:
	ScriptGiveMon(SPECIES_AERODACTYL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNORLAX:
	ScriptGiveMon(SPECIES_SNORLAX,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRATINI:
	ScriptGiveMon(SPECIES_DRATINI,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAGONAIR:
	ScriptGiveMon(SPECIES_DRAGONAIR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAGONITE:
	ScriptGiveMon(SPECIES_DRAGONITE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHIKORITA:
	ScriptGiveMon(SPECIES_CHIKORITA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BAYLEEF:
	ScriptGiveMon(SPECIES_BAYLEEF,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MEGANIUM:
	ScriptGiveMon(SPECIES_MEGANIUM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CYNDAQUIL:
	ScriptGiveMon(SPECIES_CYNDAQUIL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case QUILAVA:
	ScriptGiveMon(SPECIES_QUILAVA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYPHLOSION:
	ScriptGiveMon(SPECIES_TYPHLOSION,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOTODILE:
	ScriptGiveMon(SPECIES_TOTODILE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CROCONAW:
	ScriptGiveMon(SPECIES_CROCONAW,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FERALIGATR:
	ScriptGiveMon(SPECIES_FERALIGATR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SENTRET:
	ScriptGiveMon(SPECIES_SENTRET,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FURRET:
	ScriptGiveMon(SPECIES_FURRET,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HOOTHOOT:
	ScriptGiveMon(SPECIES_HOOTHOOT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NOCTOWL:
	ScriptGiveMon(SPECIES_NOCTOWL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LEDYBA:
	ScriptGiveMon(SPECIES_LEDYBA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LEDIAN:
	ScriptGiveMon(SPECIES_LEDIAN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPINARAK:
	ScriptGiveMon(SPECIES_SPINARAK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARIADOS:
	ScriptGiveMon(SPECIES_ARIADOS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CROBAT:
	ScriptGiveMon(SPECIES_CROBAT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHINCHOU:
	ScriptGiveMon(SPECIES_CHINCHOU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LANTURN:
	ScriptGiveMon(SPECIES_LANTURN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PICHU:
	ScriptGiveMon(SPECIES_PICHU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLEFFA:
	ScriptGiveMon(SPECIES_CLEFFA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case IGGLYBUFF:
	ScriptGiveMon(SPECIES_IGGLYBUFF,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOGEPI:
	ScriptGiveMon(SPECIES_TOGEPI,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOGETIC:
	ScriptGiveMon(SPECIES_TOGETIC,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NATU:
	ScriptGiveMon(SPECIES_NATU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case XATU:
	ScriptGiveMon(SPECIES_XATU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAREEP:
	ScriptGiveMon(SPECIES_MAREEP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLAAFFY:
	ScriptGiveMon(SPECIES_FLAAFFY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AMPHAROS:
	ScriptGiveMon(SPECIES_AMPHAROS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BELLOSSOM:
	ScriptGiveMon(SPECIES_BELLOSSOM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MARILL:
	ScriptGiveMon(SPECIES_MARILL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AZUMARILL:
	ScriptGiveMon(SPECIES_AZUMARILL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SUDOWOODO:
	ScriptGiveMon(SPECIES_SUDOWOODO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POLITOED:
	ScriptGiveMon(SPECIES_POLITOED,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HOPPIP:
	ScriptGiveMon(SPECIES_HOPPIP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKIPLOOM:
	ScriptGiveMon(SPECIES_SKIPLOOM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JUMPLUFF:
	ScriptGiveMon(SPECIES_JUMPLUFF,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AIPOM:
	ScriptGiveMon(SPECIES_AIPOM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SUNKERN:
	ScriptGiveMon(SPECIES_SUNKERN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SUNFLORA:
	ScriptGiveMon(SPECIES_SUNFLORA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case YANMA:
	ScriptGiveMon(SPECIES_YANMA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WOOPER:
	ScriptGiveMon(SPECIES_WOOPER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case QUAGSIRE:
	ScriptGiveMon(SPECIES_QUAGSIRE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ESPEON:
	ScriptGiveMon(SPECIES_ESPEON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case UMBREON:
	ScriptGiveMon(SPECIES_UMBREON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MURKROW:
	ScriptGiveMon(SPECIES_MURKROW,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLOWKING:
	ScriptGiveMon(SPECIES_SLOWKING,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MISDREAVUS:
	ScriptGiveMon(SPECIES_MISDREAVUS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case UNOWN:
	ScriptGiveMon(SPECIES_UNOWN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WOBBUFFET:
	ScriptGiveMon(SPECIES_WOBBUFFET,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GIRAFARIG:
	ScriptGiveMon(SPECIES_GIRAFARIG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PINECO:
	ScriptGiveMon(SPECIES_PINECO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FORRETRESS:
	ScriptGiveMon(SPECIES_FORRETRESS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUNSPARCE:
	ScriptGiveMon(SPECIES_DUNSPARCE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GLIGAR:
	ScriptGiveMon(SPECIES_GLIGAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STEELIX:
	ScriptGiveMon(SPECIES_STEELIX,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNUBBULL:
	ScriptGiveMon(SPECIES_SNUBBULL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRANBULL:
	ScriptGiveMon(SPECIES_GRANBULL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case QWILFISH:
	ScriptGiveMon(SPECIES_QWILFISH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCIZOR:
	ScriptGiveMon(SPECIES_SCIZOR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHUCKLE:
	ScriptGiveMon(SPECIES_SHUCKLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HERACROSS:
	ScriptGiveMon(SPECIES_HERACROSS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNEASEL:
	ScriptGiveMon(SPECIES_SNEASEL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TEDDIURSA:
	ScriptGiveMon(SPECIES_TEDDIURSA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case URSARING:
	ScriptGiveMon(SPECIES_URSARING,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLUGMA:
	ScriptGiveMon(SPECIES_SLUGMA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGCARGO:
	ScriptGiveMon(SPECIES_MAGCARGO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWINUB:
	ScriptGiveMon(SPECIES_SWINUB,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PILOSWINE:
	ScriptGiveMon(SPECIES_PILOSWINE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CORSOLA:
	ScriptGiveMon(SPECIES_CORSOLA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case REMORAID:
	ScriptGiveMon(SPECIES_REMORAID,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case OCTILLERY:
	ScriptGiveMon(SPECIES_OCTILLERY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DELIBIRD:
	ScriptGiveMon(SPECIES_DELIBIRD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MANTINE:
	ScriptGiveMon(SPECIES_MANTINE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKARMORY:
	ScriptGiveMon(SPECIES_SKARMORY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HOUNDOUR:
	ScriptGiveMon(SPECIES_HOUNDOUR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HOUNDOOM:
	ScriptGiveMon(SPECIES_HOUNDOOM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KINGDRA:
	ScriptGiveMon(SPECIES_KINGDRA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PHANPY:
	ScriptGiveMon(SPECIES_PHANPY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DONPHAN:
	ScriptGiveMon(SPECIES_DONPHAN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PORYGON2:
	ScriptGiveMon(SPECIES_PORYGON2,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STANTLER:
	ScriptGiveMon(SPECIES_STANTLER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SMEARGLE:
	ScriptGiveMon(SPECIES_SMEARGLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYROGUE:
	ScriptGiveMon(SPECIES_TYROGUE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HITMONTOP:
	ScriptGiveMon(SPECIES_HITMONTOP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SMOOCHUM:
	ScriptGiveMon(SPECIES_SMOOCHUM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELEKID:
	ScriptGiveMon(SPECIES_ELEKID,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGBY:
	ScriptGiveMon(SPECIES_MAGBY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MILTANK:
	ScriptGiveMon(SPECIES_MILTANK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BLISSEY:
	ScriptGiveMon(SPECIES_BLISSEY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RAIKOU:
	ScriptGiveMon(SPECIES_RAIKOU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ENTEI:
	ScriptGiveMon(SPECIES_ENTEI,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SUICUNE:
	ScriptGiveMon(SPECIES_SUICUNE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LARVITAR:
	ScriptGiveMon(SPECIES_LARVITAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PUPITAR:
	ScriptGiveMon(SPECIES_PUPITAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYRANITAR:
	ScriptGiveMon(SPECIES_TYRANITAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TREECKO:
	ScriptGiveMon(SPECIES_TREECKO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GROVYLE:
	ScriptGiveMon(SPECIES_GROVYLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCEPTILE:
	ScriptGiveMon(SPECIES_SCEPTILE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TORCHIC:
	ScriptGiveMon(SPECIES_TORCHIC,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COMBUSKEN:
	ScriptGiveMon(SPECIES_COMBUSKEN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BLAZIKEN:
	ScriptGiveMon(SPECIES_BLAZIKEN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUDKIP:
	ScriptGiveMon(SPECIES_MUDKIP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MARSHTOMP:
	ScriptGiveMon(SPECIES_MARSHTOMP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWAMPERT:
	ScriptGiveMon(SPECIES_SWAMPERT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POOCHYENA:
	ScriptGiveMon(SPECIES_POOCHYENA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MIGHTYENA:
	ScriptGiveMon(SPECIES_MIGHTYENA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZIGZAGOON:
	ScriptGiveMon(SPECIES_ZIGZAGOON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LINOONE:
	ScriptGiveMon(SPECIES_LINOONE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WURMPLE:
	ScriptGiveMon(SPECIES_WURMPLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SILCOON:
	ScriptGiveMon(SPECIES_SILCOON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BEAUTIFLY:
	ScriptGiveMon(SPECIES_BEAUTIFLY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CASCOON:
	ScriptGiveMon(SPECIES_CASCOON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUSTOX:
	ScriptGiveMon(SPECIES_DUSTOX,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LOTAD:
	ScriptGiveMon(SPECIES_LOTAD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LOMBRE:
	ScriptGiveMon(SPECIES_LOMBRE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUDICOLO:
	ScriptGiveMon(SPECIES_LUDICOLO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEEDOT:
	ScriptGiveMon(SPECIES_SEEDOT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NUZLEAF:
	ScriptGiveMon(SPECIES_NUZLEAF,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHIFTRY:
	ScriptGiveMon(SPECIES_SHIFTRY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TAILLOW:
	ScriptGiveMon(SPECIES_TAILLOW,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWELLOW:
	ScriptGiveMon(SPECIES_SWELLOW,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WINGULL:
	ScriptGiveMon(SPECIES_WINGULL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PELIPPER:
	ScriptGiveMon(SPECIES_PELIPPER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RALTS:
	ScriptGiveMon(SPECIES_RALTS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KIRLIA:
	ScriptGiveMon(SPECIES_KIRLIA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GARDEVOIR:
	ScriptGiveMon(SPECIES_GARDEVOIR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SURSKIT:
	ScriptGiveMon(SPECIES_SURSKIT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MASQUERAIN:
	ScriptGiveMon(SPECIES_MASQUERAIN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHROOMISH:
	ScriptGiveMon(SPECIES_SHROOMISH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRELOOM:
	ScriptGiveMon(SPECIES_BRELOOM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLAKOTH:
	ScriptGiveMon(SPECIES_SLAKOTH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VIGOROTH:
	ScriptGiveMon(SPECIES_VIGOROTH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLAKING:
	ScriptGiveMon(SPECIES_SLAKING,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NINCADA:
	ScriptGiveMon(SPECIES_NINCADA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NINJASK:
	ScriptGiveMon(SPECIES_NINJASK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHEDINJA:
	ScriptGiveMon(SPECIES_SHEDINJA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WHISMUR:
	ScriptGiveMon(SPECIES_WHISMUR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LOUDRED:
	ScriptGiveMon(SPECIES_LOUDRED,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EXPLOUD:
	ScriptGiveMon(SPECIES_EXPLOUD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAKUHITA:
	ScriptGiveMon(SPECIES_MAKUHITA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HARIYAMA:
	ScriptGiveMon(SPECIES_HARIYAMA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AZURILL:
	ScriptGiveMon(SPECIES_AZURILL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NOSEPASS:
	ScriptGiveMon(SPECIES_NOSEPASS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKITTY:
	ScriptGiveMon(SPECIES_SKITTY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DELCATTY:
	ScriptGiveMon(SPECIES_DELCATTY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SABLEYE:
	ScriptGiveMon(SPECIES_SABLEYE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAWILE:
	ScriptGiveMon(SPECIES_MAWILE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARON:
	ScriptGiveMon(SPECIES_ARON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LAIRON:
	ScriptGiveMon(SPECIES_LAIRON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AGGRON:
	ScriptGiveMon(SPECIES_AGGRON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MEDITITE:
	ScriptGiveMon(SPECIES_MEDITITE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MEDICHAM:
	ScriptGiveMon(SPECIES_MEDICHAM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELECTRIKE:
	ScriptGiveMon(SPECIES_ELECTRIKE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MANECTRIC:
	ScriptGiveMon(SPECIES_MANECTRIC,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PLUSLE:
	ScriptGiveMon(SPECIES_PLUSLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MINUN:
	ScriptGiveMon(SPECIES_MINUN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VOLBEAT:
	ScriptGiveMon(SPECIES_VOLBEAT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ILLUMISE:
	ScriptGiveMon(SPECIES_ILLUMISE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROSELIA:
	ScriptGiveMon(SPECIES_ROSELIA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GULPIN:
	ScriptGiveMon(SPECIES_GULPIN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWALOT:
	ScriptGiveMon(SPECIES_SWALOT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CARVANHA:
	ScriptGiveMon(SPECIES_CARVANHA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHARPEDO:
	ScriptGiveMon(SPECIES_SHARPEDO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WAILMER:
	ScriptGiveMon(SPECIES_WAILMER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WAILORD:
	ScriptGiveMon(SPECIES_WAILORD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NUMEL:
	ScriptGiveMon(SPECIES_NUMEL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CAMERUPT:
	ScriptGiveMon(SPECIES_CAMERUPT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TORKOAL:
	ScriptGiveMon(SPECIES_TORKOAL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPOINK:
	ScriptGiveMon(SPECIES_SPOINK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRUMPIG:
	ScriptGiveMon(SPECIES_GRUMPIG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPINDA:
	ScriptGiveMon(SPECIES_SPINDA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TRAPINCH:
	ScriptGiveMon(SPECIES_TRAPINCH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VIBRAVA:
	ScriptGiveMon(SPECIES_VIBRAVA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLYGON:
	ScriptGiveMon(SPECIES_FLYGON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CACNEA:
	ScriptGiveMon(SPECIES_CACNEA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CACTURNE:
	ScriptGiveMon(SPECIES_CACTURNE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWABLU:
	ScriptGiveMon(SPECIES_SWABLU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ALTARIA:
	ScriptGiveMon(SPECIES_ALTARIA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZANGOOSE:
	ScriptGiveMon(SPECIES_ZANGOOSE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEVIPER:
	ScriptGiveMon(SPECIES_SEVIPER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUNATONE:
	ScriptGiveMon(SPECIES_LUNATONE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SOLROCK:
	ScriptGiveMon(SPECIES_SOLROCK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BARBOACH:
	ScriptGiveMon(SPECIES_BARBOACH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WHISCASH:
	ScriptGiveMon(SPECIES_WHISCASH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CORPHISH:
	ScriptGiveMon(SPECIES_CORPHISH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRAWDAUNT:
	ScriptGiveMon(SPECIES_CRAWDAUNT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BALTOY:
	ScriptGiveMon(SPECIES_BALTOY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLAYDOL:
	ScriptGiveMon(SPECIES_CLAYDOL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LILEEP:
	ScriptGiveMon(SPECIES_LILEEP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRADILY:
	ScriptGiveMon(SPECIES_CRADILY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ANORITH:
	ScriptGiveMon(SPECIES_ANORITH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARMALDO:
	ScriptGiveMon(SPECIES_ARMALDO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FEEBAS:
	ScriptGiveMon(SPECIES_FEEBAS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MILOTIC:
	ScriptGiveMon(SPECIES_MILOTIC,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CASTFORM:
	ScriptGiveMon(SPECIES_CASTFORM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KECLEON:
	ScriptGiveMon(SPECIES_KECLEON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHUPPET:
	ScriptGiveMon(SPECIES_SHUPPET,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BANETTE:
	ScriptGiveMon(SPECIES_BANETTE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUSKULL:
	ScriptGiveMon(SPECIES_DUSKULL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUSCLOPS:
	ScriptGiveMon(SPECIES_DUSCLOPS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TROPIUS:
	ScriptGiveMon(SPECIES_TROPIUS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHIMECHO:
	ScriptGiveMon(SPECIES_CHIMECHO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ABSOL:
	ScriptGiveMon(SPECIES_ABSOL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WYNAUT:
	ScriptGiveMon(SPECIES_WYNAUT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNORUNT:
	ScriptGiveMon(SPECIES_SNORUNT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GLALIE:
	ScriptGiveMon(SPECIES_GLALIE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPHEAL:
	ScriptGiveMon(SPECIES_SPHEAL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEALEO:
	ScriptGiveMon(SPECIES_SEALEO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WALREIN:
	ScriptGiveMon(SPECIES_WALREIN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLAMPERL:
	ScriptGiveMon(SPECIES_CLAMPERL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HUNTAIL:
	ScriptGiveMon(SPECIES_HUNTAIL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOREBYSS:
	ScriptGiveMon(SPECIES_GOREBYSS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RELICANTH:
	ScriptGiveMon(SPECIES_RELICANTH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUVDISC:
	ScriptGiveMon(SPECIES_LUVDISC,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BAGON:
	ScriptGiveMon(SPECIES_BAGON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHELGON:
	ScriptGiveMon(SPECIES_SHELGON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SALAMENCE:
	ScriptGiveMon(SPECIES_SALAMENCE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BELDUM:
	ScriptGiveMon(SPECIES_BELDUM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case METANG:
	ScriptGiveMon(SPECIES_METANG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case METAGROSS:
	ScriptGiveMon(SPECIES_METAGROSS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TURTWIG:
	ScriptGiveMon(SPECIES_TURTWIG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GROTLE:
	ScriptGiveMon(SPECIES_GROTLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TORTERRA:
	ScriptGiveMon(SPECIES_TORTERRA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHIMCHAR:
	ScriptGiveMon(SPECIES_CHIMCHAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MONFERNO:
	ScriptGiveMon(SPECIES_MONFERNO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case INFERNAPE:
	ScriptGiveMon(SPECIES_INFERNAPE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIPLUP:
	ScriptGiveMon(SPECIES_PIPLUP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PRINPLUP:
	ScriptGiveMon(SPECIES_PRINPLUP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EMPOLEON:
	ScriptGiveMon(SPECIES_EMPOLEON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STARLY:
	ScriptGiveMon(SPECIES_STARLY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STARAVIA:
	ScriptGiveMon(SPECIES_STARAVIA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STARAPTOR:
	ScriptGiveMon(SPECIES_STARAPTOR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BIDOOF:
	ScriptGiveMon(SPECIES_BIDOOF,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BIBAREL:
	ScriptGiveMon(SPECIES_BIBAREL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KRICKETOT:
	ScriptGiveMon(SPECIES_KRICKETOT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KRICKETUNE:
	ScriptGiveMon(SPECIES_KRICKETUNE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHINX:
	ScriptGiveMon(SPECIES_SHINX,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUXIO:
	ScriptGiveMon(SPECIES_LUXIO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUXRAY:
	ScriptGiveMon(SPECIES_LUXRAY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BUDEW:
	ScriptGiveMon(SPECIES_BUDEW,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROSERADE:
	ScriptGiveMon(SPECIES_ROSERADE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRANIDOS:
	ScriptGiveMon(SPECIES_CRANIDOS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RAMPARDOS:
	ScriptGiveMon(SPECIES_RAMPARDOS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHIELDON:
	ScriptGiveMon(SPECIES_SHIELDON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BASTIODON:
	ScriptGiveMon(SPECIES_BASTIODON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BURMY:
	ScriptGiveMon(SPECIES_BURMY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WORMADAM:
	ScriptGiveMon(SPECIES_WORMADAM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MOTHIM:
	ScriptGiveMon(SPECIES_MOTHIM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COMBEE:
	ScriptGiveMon(SPECIES_COMBEE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VESPIQUEN:
	ScriptGiveMon(SPECIES_VESPIQUEN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PACHIRISU:
	ScriptGiveMon(SPECIES_PACHIRISU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BUIZEL:
	ScriptGiveMon(SPECIES_BUIZEL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLOATZEL:
	ScriptGiveMon(SPECIES_FLOATZEL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHERUBI:
	ScriptGiveMon(SPECIES_CHERUBI,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHERRIM:
	ScriptGiveMon(SPECIES_CHERRIM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHELLOS:
	ScriptGiveMon(SPECIES_SHELLOS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GASTRODON:
	ScriptGiveMon(SPECIES_GASTRODON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AMBIPOM:
	ScriptGiveMon(SPECIES_AMBIPOM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRIFLOON:
	ScriptGiveMon(SPECIES_DRIFLOON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRIFBLIM:
	ScriptGiveMon(SPECIES_DRIFBLIM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BUNEARY:
	ScriptGiveMon(SPECIES_BUNEARY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LOPUNNY:
	ScriptGiveMon(SPECIES_LOPUNNY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MISMAGIUS:
	ScriptGiveMon(SPECIES_MISMAGIUS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HONCHKROW:
	ScriptGiveMon(SPECIES_HONCHKROW,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GLAMEOW:
	ScriptGiveMon(SPECIES_GLAMEOW,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PURUGLY:
	ScriptGiveMon(SPECIES_PURUGLY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHINGLING:
	ScriptGiveMon(SPECIES_CHINGLING,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STUNKY:
	ScriptGiveMon(SPECIES_STUNKY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKUNTANK:
	ScriptGiveMon(SPECIES_SKUNTANK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRONZOR:
	ScriptGiveMon(SPECIES_BRONZOR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRONZONG:
	ScriptGiveMon(SPECIES_BRONZONG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BONSLY:
	ScriptGiveMon(SPECIES_BONSLY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MIME_JR:
	ScriptGiveMon(SPECIES_MIME_JR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HAPPINY:
	ScriptGiveMon(SPECIES_HAPPINY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHATOT:
	ScriptGiveMon(SPECIES_CHATOT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPIRITOMB:
	ScriptGiveMon(SPECIES_SPIRITOMB,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GIBLE:
	ScriptGiveMon(SPECIES_GIBLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GABITE:
	ScriptGiveMon(SPECIES_GABITE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GARCHOMP:
	ScriptGiveMon(SPECIES_GARCHOMP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUNCHLAX:
	ScriptGiveMon(SPECIES_MUNCHLAX,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RIOLU:
	ScriptGiveMon(SPECIES_RIOLU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUCARIO:
	ScriptGiveMon(SPECIES_LUCARIO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HIPPOPOTAS:
	ScriptGiveMon(SPECIES_HIPPOPOTAS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HIPPOWDON:
	ScriptGiveMon(SPECIES_HIPPOWDON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKORUPI:
	ScriptGiveMon(SPECIES_SKORUPI,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAPION:
	ScriptGiveMon(SPECIES_DRAPION,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CROAGUNK:
	ScriptGiveMon(SPECIES_CROAGUNK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOXICROAK:
	ScriptGiveMon(SPECIES_TOXICROAK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CARNIVINE:
	ScriptGiveMon(SPECIES_CARNIVINE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FINNEON:
	ScriptGiveMon(SPECIES_FINNEON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LUMINEON:
	ScriptGiveMon(SPECIES_LUMINEON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MANTYKE:
	ScriptGiveMon(SPECIES_MANTYKE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNOVER:
	ScriptGiveMon(SPECIES_SNOVER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ABOMASNOW:
	ScriptGiveMon(SPECIES_ABOMASNOW,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WEAVILE:
	ScriptGiveMon(SPECIES_WEAVILE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGNEZONE:
	ScriptGiveMon(SPECIES_MAGNEZONE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LICKILICKY:
	ScriptGiveMon(SPECIES_LICKILICKY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RHYPERIOR:
	ScriptGiveMon(SPECIES_RHYPERIOR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TANGROWTH:
	ScriptGiveMon(SPECIES_TANGROWTH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELECTIVIRE:
	ScriptGiveMon(SPECIES_ELECTIVIRE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAGMORTAR:
	ScriptGiveMon(SPECIES_MAGMORTAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOGEKISS:
	ScriptGiveMon(SPECIES_TOGEKISS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case YANMEGA:
	ScriptGiveMon(SPECIES_YANMEGA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LEAFEON:
	ScriptGiveMon(SPECIES_LEAFEON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GLACEON:
	ScriptGiveMon(SPECIES_GLACEON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GLISCOR:
	ScriptGiveMon(SPECIES_GLISCOR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAMOSWINE:
	ScriptGiveMon(SPECIES_MAMOSWINE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PORYGON_Z:
	ScriptGiveMon(SPECIES_PORYGON_Z,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GALLADE:
	ScriptGiveMon(SPECIES_GALLADE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PROBOPASS:
	ScriptGiveMon(SPECIES_PROBOPASS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUSKNOIR:
	ScriptGiveMon(SPECIES_DUSKNOIR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FROSLASS:
	ScriptGiveMon(SPECIES_FROSLASS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROTOM:
	ScriptGiveMon(SPECIES_ROTOM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNIVY:
	ScriptGiveMon(SPECIES_SNIVY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SERVINE:
	ScriptGiveMon(SPECIES_SERVINE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SERPERIOR:
	ScriptGiveMon(SPECIES_SERPERIOR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TEPIG:
	ScriptGiveMon(SPECIES_TEPIG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIGNITE:
	ScriptGiveMon(SPECIES_PIGNITE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EMBOAR:
	ScriptGiveMon(SPECIES_EMBOAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case OSHAWOTT:
	ScriptGiveMon(SPECIES_OSHAWOTT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DEWOTT:
	ScriptGiveMon(SPECIES_DEWOTT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SAMUROTT:
	ScriptGiveMon(SPECIES_SAMUROTT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PATRAT:
	ScriptGiveMon(SPECIES_PATRAT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WATCHOG:
	ScriptGiveMon(SPECIES_WATCHOG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LILLIPUP:
	ScriptGiveMon(SPECIES_LILLIPUP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HERDIER:
	ScriptGiveMon(SPECIES_HERDIER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STOUTLAND:
	ScriptGiveMon(SPECIES_STOUTLAND,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PURRLOIN:
	ScriptGiveMon(SPECIES_PURRLOIN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LIEPARD:
	ScriptGiveMon(SPECIES_LIEPARD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PANSAGE:
	ScriptGiveMon(SPECIES_PANSAGE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SIMISAGE:
	ScriptGiveMon(SPECIES_SIMISAGE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PANSEAR:
	ScriptGiveMon(SPECIES_PANSEAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SIMISEAR:
	ScriptGiveMon(SPECIES_SIMISEAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PANPOUR:
	ScriptGiveMon(SPECIES_PANPOUR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SIMIPOUR:
	ScriptGiveMon(SPECIES_SIMIPOUR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUNNA:
	ScriptGiveMon(SPECIES_MUNNA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUSHARNA:
	ScriptGiveMon(SPECIES_MUSHARNA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIDOVE:
	ScriptGiveMon(SPECIES_PIDOVE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TRANQUILL:
	ScriptGiveMon(SPECIES_TRANQUILL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case UNFEZANT:
	ScriptGiveMon(SPECIES_UNFEZANT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BLITZLE:
	ScriptGiveMon(SPECIES_BLITZLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZEBSTRIKA:
	ScriptGiveMon(SPECIES_ZEBSTRIKA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROGGENROLA:
	ScriptGiveMon(SPECIES_ROGGENROLA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BOLDORE:
	ScriptGiveMon(SPECIES_BOLDORE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GIGALITH:
	ScriptGiveMon(SPECIES_GIGALITH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WOOBAT:
	ScriptGiveMon(SPECIES_WOOBAT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWOOBAT:
	ScriptGiveMon(SPECIES_SWOOBAT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRILBUR:
	ScriptGiveMon(SPECIES_DRILBUR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EXCADRILL:
	ScriptGiveMon(SPECIES_EXCADRILL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AUDINO:
	ScriptGiveMon(SPECIES_AUDINO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TIMBURR:
	ScriptGiveMon(SPECIES_TIMBURR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GURDURR:
	ScriptGiveMon(SPECIES_GURDURR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CONKELDURR:
	ScriptGiveMon(SPECIES_CONKELDURR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYMPOLE:
	ScriptGiveMon(SPECIES_TYMPOLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PALPITOAD:
	ScriptGiveMon(SPECIES_PALPITOAD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEISMITOAD:
	ScriptGiveMon(SPECIES_SEISMITOAD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case THROH:
	ScriptGiveMon(SPECIES_THROH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SAWK:
	ScriptGiveMon(SPECIES_SAWK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SEWADDLE:
	ScriptGiveMon(SPECIES_SEWADDLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWADLOON:
	ScriptGiveMon(SPECIES_SWADLOON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LEAVANNY:
	ScriptGiveMon(SPECIES_LEAVANNY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VENIPEDE:
	ScriptGiveMon(SPECIES_VENIPEDE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WHIRLIPEDE:
	ScriptGiveMon(SPECIES_WHIRLIPEDE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCOLIPEDE:
	ScriptGiveMon(SPECIES_SCOLIPEDE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COTTONEE:
	ScriptGiveMon(SPECIES_COTTONEE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WHIMSICOTT:
	ScriptGiveMon(SPECIES_WHIMSICOTT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PETILIL:
	ScriptGiveMon(SPECIES_PETILIL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LILLIGANT:
	ScriptGiveMon(SPECIES_LILLIGANT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BASCULIN:
	ScriptGiveMon(SPECIES_BASCULIN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SANDILE:
	ScriptGiveMon(SPECIES_SANDILE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KROKOROK:
	ScriptGiveMon(SPECIES_KROKOROK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KROOKODILE:
	ScriptGiveMon(SPECIES_KROOKODILE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DARUMAKA:
	ScriptGiveMon(SPECIES_DARUMAKA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DARMANITAN:
	ScriptGiveMon(SPECIES_DARMANITAN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MARACTUS:
	ScriptGiveMon(SPECIES_MARACTUS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DWEBBLE:
	ScriptGiveMon(SPECIES_DWEBBLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRUSTLE:
	ScriptGiveMon(SPECIES_CRUSTLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCRAGGY:
	ScriptGiveMon(SPECIES_SCRAGGY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCRAFTY:
	ScriptGiveMon(SPECIES_SCRAFTY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SIGILYPH:
	ScriptGiveMon(SPECIES_SIGILYPH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case YAMASK:
	ScriptGiveMon(SPECIES_YAMASK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COFAGRIGUS:
	ScriptGiveMon(SPECIES_COFAGRIGUS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TIRTOUGA:
	ScriptGiveMon(SPECIES_TIRTOUGA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CARRACOSTA:
	ScriptGiveMon(SPECIES_CARRACOSTA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARCHEN:
	ScriptGiveMon(SPECIES_ARCHEN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARCHEOPS:
	ScriptGiveMon(SPECIES_ARCHEOPS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TRUBBISH:
	ScriptGiveMon(SPECIES_TRUBBISH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GARBODOR:
	ScriptGiveMon(SPECIES_GARBODOR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZORUA:
	ScriptGiveMon(SPECIES_ZORUA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZOROARK:
	ScriptGiveMon(SPECIES_ZOROARK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MINCCINO:
	ScriptGiveMon(SPECIES_MINCCINO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CINCCINO:
	ScriptGiveMon(SPECIES_CINCCINO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOTHITA:
	ScriptGiveMon(SPECIES_GOTHITA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOTHORITA:
	ScriptGiveMon(SPECIES_GOTHORITA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOTHITELLE:
	ScriptGiveMon(SPECIES_GOTHITELLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SOLOSIS:
	ScriptGiveMon(SPECIES_SOLOSIS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUOSION:
	ScriptGiveMon(SPECIES_DUOSION,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case REUNICLUS:
	ScriptGiveMon(SPECIES_REUNICLUS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUCKLETT:
	ScriptGiveMon(SPECIES_DUCKLETT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWANNA:
	ScriptGiveMon(SPECIES_SWANNA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VANILLITE:
	ScriptGiveMon(SPECIES_VANILLITE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VANILLISH:
	ScriptGiveMon(SPECIES_VANILLISH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VANILLUXE:
	ScriptGiveMon(SPECIES_VANILLUXE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DEERLING:
	ScriptGiveMon(SPECIES_DEERLING,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SAWSBUCK:
	ScriptGiveMon(SPECIES_SAWSBUCK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EMOLGA:
	ScriptGiveMon(SPECIES_EMOLGA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KARRABLAST:
	ScriptGiveMon(SPECIES_KARRABLAST,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ESCAVALIER:
	ScriptGiveMon(SPECIES_ESCAVALIER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FOONGUS:
	ScriptGiveMon(SPECIES_FOONGUS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AMOONGUSS:
	ScriptGiveMon(SPECIES_AMOONGUSS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FRILLISH:
	ScriptGiveMon(SPECIES_FRILLISH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JELLICENT:
	ScriptGiveMon(SPECIES_JELLICENT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ALOMOMOLA:
	ScriptGiveMon(SPECIES_ALOMOMOLA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JOLTIK:
	ScriptGiveMon(SPECIES_JOLTIK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GALVANTULA:
	ScriptGiveMon(SPECIES_GALVANTULA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FERROSEED:
	ScriptGiveMon(SPECIES_FERROSEED,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FERROTHORN:
	ScriptGiveMon(SPECIES_FERROTHORN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KLINK:
	ScriptGiveMon(SPECIES_KLINK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KLANG:
	ScriptGiveMon(SPECIES_KLANG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KLINKLANG:
	ScriptGiveMon(SPECIES_KLINKLANG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYNAMO:
	ScriptGiveMon(SPECIES_TYNAMO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EELEKTRIK:
	ScriptGiveMon(SPECIES_EELEKTRIK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EELEKTROSS:
	ScriptGiveMon(SPECIES_EELEKTROSS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELGYEM:
	ScriptGiveMon(SPECIES_ELGYEM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BEHEEYEM:
	ScriptGiveMon(SPECIES_BEHEEYEM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LITWICK:
	ScriptGiveMon(SPECIES_LITWICK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LAMPENT:
	ScriptGiveMon(SPECIES_LAMPENT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHANDELURE:
	ScriptGiveMon(SPECIES_CHANDELURE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AXEW:
	ScriptGiveMon(SPECIES_AXEW,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FRAXURE:
	ScriptGiveMon(SPECIES_FRAXURE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HAXORUS:
	ScriptGiveMon(SPECIES_HAXORUS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CUBCHOO:
	ScriptGiveMon(SPECIES_CUBCHOO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BEARTIC:
	ScriptGiveMon(SPECIES_BEARTIC,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRYOGONAL:
	ScriptGiveMon(SPECIES_CRYOGONAL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHELMET:
	ScriptGiveMon(SPECIES_SHELMET,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ACCELGOR:
	ScriptGiveMon(SPECIES_ACCELGOR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STUNFISK:
	ScriptGiveMon(SPECIES_STUNFISK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MIENFOO:
	ScriptGiveMon(SPECIES_MIENFOO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MIENSHAO:
	ScriptGiveMon(SPECIES_MIENSHAO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRUDDIGON:
	ScriptGiveMon(SPECIES_DRUDDIGON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLETT:
	ScriptGiveMon(SPECIES_GOLETT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLURK:
	ScriptGiveMon(SPECIES_GOLURK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PAWNIARD:
	ScriptGiveMon(SPECIES_PAWNIARD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BISHARP:
	ScriptGiveMon(SPECIES_BISHARP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BOUFFALANT:
	ScriptGiveMon(SPECIES_BOUFFALANT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RUFFLET:
	ScriptGiveMon(SPECIES_RUFFLET,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRAVIARY:
	ScriptGiveMon(SPECIES_BRAVIARY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VULLABY:
	ScriptGiveMon(SPECIES_VULLABY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MANDIBUZZ:
	ScriptGiveMon(SPECIES_MANDIBUZZ,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HEATMOR:
	ScriptGiveMon(SPECIES_HEATMOR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DURANT:
	ScriptGiveMon(SPECIES_DURANT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DEINO:
	ScriptGiveMon(SPECIES_DEINO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ZWEILOUS:
	ScriptGiveMon(SPECIES_ZWEILOUS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HYDREIGON:
	ScriptGiveMon(SPECIES_HYDREIGON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LARVESTA:
	ScriptGiveMon(SPECIES_LARVESTA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VOLCARONA:
	ScriptGiveMon(SPECIES_VOLCARONA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHESPIN:
	ScriptGiveMon(SPECIES_CHESPIN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case QUILLADIN:
	ScriptGiveMon(SPECIES_QUILLADIN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHESNAUGHT:
	ScriptGiveMon(SPECIES_CHESNAUGHT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FENNEKIN:
	ScriptGiveMon(SPECIES_FENNEKIN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRAIXEN:
	ScriptGiveMon(SPECIES_BRAIXEN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DELPHOX:
	ScriptGiveMon(SPECIES_DELPHOX,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FROAKIE:
	ScriptGiveMon(SPECIES_FROAKIE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FROGADIER:
	ScriptGiveMon(SPECIES_FROGADIER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRENINJA:
	ScriptGiveMon(SPECIES_GRENINJA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BUNNELBY:
	ScriptGiveMon(SPECIES_BUNNELBY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DIGGERSBY:
	ScriptGiveMon(SPECIES_DIGGERSBY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLETCHLING:
	ScriptGiveMon(SPECIES_FLETCHLING,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLETCHINDER:
	ScriptGiveMon(SPECIES_FLETCHINDER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TALONFLAME:
	ScriptGiveMon(SPECIES_TALONFLAME,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCATTERBUG:
	ScriptGiveMon(SPECIES_SCATTERBUG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPEWPA:
	ScriptGiveMon(SPECIES_SPEWPA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VIVILLON:
	ScriptGiveMon(SPECIES_VIVILLON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LITLEO:
	ScriptGiveMon(SPECIES_LITLEO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PYROAR:
	ScriptGiveMon(SPECIES_PYROAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLABEBE:
	ScriptGiveMon(SPECIES_FLABEBE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLOETTE:
	ScriptGiveMon(SPECIES_FLOETTE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLORGES:
	ScriptGiveMon(SPECIES_FLORGES,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKIDDO:
	ScriptGiveMon(SPECIES_SKIDDO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOGOAT:
	ScriptGiveMon(SPECIES_GOGOAT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PANCHAM:
	ScriptGiveMon(SPECIES_PANCHAM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PANGORO:
	ScriptGiveMon(SPECIES_PANGORO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FURFROU:
	ScriptGiveMon(SPECIES_FURFROU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ESPURR:
	ScriptGiveMon(SPECIES_ESPURR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MEOWSTIC:
	ScriptGiveMon(SPECIES_MEOWSTIC,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HONEDGE:
	ScriptGiveMon(SPECIES_HONEDGE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DOUBLADE:
	ScriptGiveMon(SPECIES_DOUBLADE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AEGISLASH:
	ScriptGiveMon(SPECIES_AEGISLASH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SPRITZEE:
	ScriptGiveMon(SPECIES_SPRITZEE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AROMATISSE:
	ScriptGiveMon(SPECIES_AROMATISSE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SWIRLIX:
	ScriptGiveMon(SPECIES_SWIRLIX,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLURPUFF:
	ScriptGiveMon(SPECIES_SLURPUFF,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case INKAY:
	ScriptGiveMon(SPECIES_INKAY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MALAMAR:
	ScriptGiveMon(SPECIES_MALAMAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BINACLE:
	ScriptGiveMon(SPECIES_BINACLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BARBARACLE:
	ScriptGiveMon(SPECIES_BARBARACLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKRELP:
	ScriptGiveMon(SPECIES_SKRELP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAGALGE:
	ScriptGiveMon(SPECIES_DRAGALGE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLAUNCHER:
	ScriptGiveMon(SPECIES_CLAUNCHER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLAWITZER:
	ScriptGiveMon(SPECIES_CLAWITZER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HELIOPTILE:
	ScriptGiveMon(SPECIES_HELIOPTILE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HELIOLISK:
	ScriptGiveMon(SPECIES_HELIOLISK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYRUNT:
	ScriptGiveMon(SPECIES_TYRUNT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYRANTRUM:
	ScriptGiveMon(SPECIES_TYRANTRUM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AMAURA:
	ScriptGiveMon(SPECIES_AMAURA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AURORUS:
	ScriptGiveMon(SPECIES_AURORUS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SYLVEON:
	ScriptGiveMon(SPECIES_SYLVEON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HAWLUCHA:
	ScriptGiveMon(SPECIES_HAWLUCHA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DEDENNE:
	ScriptGiveMon(SPECIES_DEDENNE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CARBINK:
	ScriptGiveMon(SPECIES_CARBINK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOOMY:
	ScriptGiveMon(SPECIES_GOOMY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SLIGGOO:
	ScriptGiveMon(SPECIES_SLIGGOO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOODRA:
	ScriptGiveMon(SPECIES_GOODRA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KLEFKI:
	ScriptGiveMon(SPECIES_KLEFKI,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PHANTUMP:
	ScriptGiveMon(SPECIES_PHANTUMP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TREVENANT:
	ScriptGiveMon(SPECIES_TREVENANT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PUMPKABOO:
	ScriptGiveMon(SPECIES_PUMPKABOO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOURGEIST:
	ScriptGiveMon(SPECIES_GOURGEIST,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BERGMITE:
	ScriptGiveMon(SPECIES_BERGMITE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case AVALUGG:
	ScriptGiveMon(SPECIES_AVALUGG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NOIBAT:
	ScriptGiveMon(SPECIES_NOIBAT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NOIVERN:
	ScriptGiveMon(SPECIES_NOIVERN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROWLET:
	ScriptGiveMon(SPECIES_ROWLET,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DARTRIX:
	ScriptGiveMon(SPECIES_DARTRIX,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DECIDUEYE:
	ScriptGiveMon(SPECIES_DECIDUEYE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LITTEN:
	ScriptGiveMon(SPECIES_LITTEN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TORRACAT:
	ScriptGiveMon(SPECIES_TORRACAT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case INCINEROAR:
	ScriptGiveMon(SPECIES_INCINEROAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POPPLIO:
	ScriptGiveMon(SPECIES_POPPLIO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRIONNE:
	ScriptGiveMon(SPECIES_BRIONNE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PRIMARINA:
	ScriptGiveMon(SPECIES_PRIMARINA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PIKIPEK:
	ScriptGiveMon(SPECIES_PIKIPEK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TRUMBEAK:
	ScriptGiveMon(SPECIES_TRUMBEAK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOUCANNON:
	ScriptGiveMon(SPECIES_TOUCANNON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case YUNGOOS:
	ScriptGiveMon(SPECIES_YUNGOOS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GUMSHOOS:
	ScriptGiveMon(SPECIES_GUMSHOOS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRUBBIN:
	ScriptGiveMon(SPECIES_GRUBBIN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHARJABUG:
	ScriptGiveMon(SPECIES_CHARJABUG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case VIKAVOLT:
	ScriptGiveMon(SPECIES_VIKAVOLT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRABRAWLER:
	ScriptGiveMon(SPECIES_CRABRAWLER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRABOMINABLE:
	ScriptGiveMon(SPECIES_CRABOMINABLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ORICORIO:
	ScriptGiveMon(SPECIES_ORICORIO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CUTIEFLY:
	ScriptGiveMon(SPECIES_CUTIEFLY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RIBOMBEE:
	ScriptGiveMon(SPECIES_RIBOMBEE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROCKRUFF:
	ScriptGiveMon(SPECIES_ROCKRUFF,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LYCANROC:
	ScriptGiveMon(SPECIES_LYCANROC,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WISHIWASHI:
	ScriptGiveMon(SPECIES_WISHIWASHI,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MAREANIE:
	ScriptGiveMon(SPECIES_MAREANIE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOXAPEX:
	ScriptGiveMon(SPECIES_TOXAPEX,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUDBRAY:
	ScriptGiveMon(SPECIES_MUDBRAY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MUDSDALE:
	ScriptGiveMon(SPECIES_MUDSDALE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DEWPIDER:
	ScriptGiveMon(SPECIES_DEWPIDER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARAQUANID:
	ScriptGiveMon(SPECIES_ARAQUANID,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FOMANTIS:
	ScriptGiveMon(SPECIES_FOMANTIS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case LURANTIS:
	ScriptGiveMon(SPECIES_LURANTIS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MORELULL:
	ScriptGiveMon(SPECIES_MORELULL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SHIINOTIC:
	ScriptGiveMon(SPECIES_SHIINOTIC,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SALANDIT:
	ScriptGiveMon(SPECIES_SALANDIT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SALAZZLE:
	ScriptGiveMon(SPECIES_SALAZZLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STUFFUL:
	ScriptGiveMon(SPECIES_STUFFUL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BEWEAR:
	ScriptGiveMon(SPECIES_BEWEAR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BOUNSWEET:
	ScriptGiveMon(SPECIES_BOUNSWEET,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STEENEE:
	ScriptGiveMon(SPECIES_STEENEE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TSAREENA:
	ScriptGiveMon(SPECIES_TSAREENA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COMFEY:
	ScriptGiveMon(SPECIES_COMFEY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ORANGURU:
	ScriptGiveMon(SPECIES_ORANGURU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PASSIMIAN:
	ScriptGiveMon(SPECIES_PASSIMIAN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WIMPOD:
	ScriptGiveMon(SPECIES_WIMPOD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOLISOPOD:
	ScriptGiveMon(SPECIES_GOLISOPOD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SANDYGAST:
	ScriptGiveMon(SPECIES_SANDYGAST,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PALOSSAND:
	ScriptGiveMon(SPECIES_PALOSSAND,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PYUKUMUKU:
	ScriptGiveMon(SPECIES_PYUKUMUKU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TYPE_NULL:
	ScriptGiveMon(SPECIES_TYPE_NULL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SILVALLY:
	ScriptGiveMon(SPECIES_SILVALLY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MINIOR:
	ScriptGiveMon(SPECIES_MINIOR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KOMALA:
	ScriptGiveMon(SPECIES_KOMALA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TURTONATOR:
	ScriptGiveMon(SPECIES_TURTONATOR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOGEDEMARU:
	ScriptGiveMon(SPECIES_TOGEDEMARU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MIMIKYU:
	ScriptGiveMon(SPECIES_MIMIKYU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BRUXISH:
	ScriptGiveMon(SPECIES_BRUXISH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAMPA:
	ScriptGiveMon(SPECIES_DRAMPA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DHELMISE:
	ScriptGiveMon(SPECIES_DHELMISE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case JANGMO_O:
	ScriptGiveMon(SPECIES_JANGMO_O,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HAKAMO_O:
	ScriptGiveMon(SPECIES_HAKAMO_O,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case KOMMO_O:
	ScriptGiveMon(SPECIES_KOMMO_O,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TAPU_KOKO:
	ScriptGiveMon(SPECIES_TAPU_KOKO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TAPU_LELE:
	ScriptGiveMon(SPECIES_TAPU_LELE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TAPU_BULU:
	ScriptGiveMon(SPECIES_TAPU_BULU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TAPU_FINI:
	ScriptGiveMon(SPECIES_TAPU_FINI,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GROOKEY:
	ScriptGiveMon(SPECIES_GROOKEY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case THWACKEY:
	ScriptGiveMon(SPECIES_THWACKEY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RILLABOOM:
	ScriptGiveMon(SPECIES_RILLABOOM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SCORBUNNY:
	ScriptGiveMon(SPECIES_SCORBUNNY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RABOOT:
	ScriptGiveMon(SPECIES_RABOOT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CINDERACE:
	ScriptGiveMon(SPECIES_CINDERACE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SOBBLE:
	ScriptGiveMon(SPECIES_SOBBLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRIZZILE:
	ScriptGiveMon(SPECIES_DRIZZILE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case INTELEON:
	ScriptGiveMon(SPECIES_INTELEON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SKWOVET:
	ScriptGiveMon(SPECIES_SKWOVET,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GREEDENT:
	ScriptGiveMon(SPECIES_GREEDENT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROOKIDEE:
	ScriptGiveMon(SPECIES_ROOKIDEE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CORVISQUIRE:
	ScriptGiveMon(SPECIES_CORVISQUIRE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CORVIKNIGHT:
	ScriptGiveMon(SPECIES_CORVIKNIGHT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BLIPBUG:
	ScriptGiveMon(SPECIES_BLIPBUG,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DOTTLER:
	ScriptGiveMon(SPECIES_DOTTLER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ORBEETLE:
	ScriptGiveMon(SPECIES_ORBEETLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case NICKIT:
	ScriptGiveMon(SPECIES_NICKIT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case THIEVUL:
	ScriptGiveMon(SPECIES_THIEVUL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GOSSIFLEUR:
	ScriptGiveMon(SPECIES_GOSSIFLEUR,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ELDEGOSS:
	ScriptGiveMon(SPECIES_ELDEGOSS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case WOOLOO:
	ScriptGiveMon(SPECIES_WOOLOO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DUBWOOL:
	ScriptGiveMon(SPECIES_DUBWOOL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CHEWTLE:
	ScriptGiveMon(SPECIES_CHEWTLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DREDNAW:
	ScriptGiveMon(SPECIES_DREDNAW,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case YAMPER:
	ScriptGiveMon(SPECIES_YAMPER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BOLTUND:
	ScriptGiveMon(SPECIES_BOLTUND,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ROLYCOLY:
	ScriptGiveMon(SPECIES_ROLYCOLY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CARKOL:
	ScriptGiveMon(SPECIES_CARKOL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COALOSSAL:
	ScriptGiveMon(SPECIES_COALOSSAL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case APPLIN:
	ScriptGiveMon(SPECIES_APPLIN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FLAPPLE:
	ScriptGiveMon(SPECIES_FLAPPLE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case APPLETUN:
	ScriptGiveMon(SPECIES_APPLETUN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SILICOBRA:
	ScriptGiveMon(SPECIES_SILICOBRA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SANDACONDA:
	ScriptGiveMon(SPECIES_SANDACONDA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CRAMORANT:
	ScriptGiveMon(SPECIES_CRAMORANT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARROKUDA:
	ScriptGiveMon(SPECIES_ARROKUDA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case BARRASKEWDA:
	ScriptGiveMon(SPECIES_BARRASKEWDA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOXEL:
	ScriptGiveMon(SPECIES_TOXEL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TOXTRICITY:
	ScriptGiveMon(SPECIES_TOXTRICITY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SIZZLIPEDE:
	ScriptGiveMon(SPECIES_SIZZLIPEDE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CENTISKORCH:
	ScriptGiveMon(SPECIES_CENTISKORCH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CLOBBOPUS:
	ScriptGiveMon(SPECIES_CLOBBOPUS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRAPPLOCT:
	ScriptGiveMon(SPECIES_GRAPPLOCT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SINISTEA:
	ScriptGiveMon(SPECIES_SINISTEA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case POLTEAGEIST:
	ScriptGiveMon(SPECIES_POLTEAGEIST,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HATENNA:
	ScriptGiveMon(SPECIES_HATENNA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HATTREM:
	ScriptGiveMon(SPECIES_HATTREM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case HATTERENE:
	ScriptGiveMon(SPECIES_HATTERENE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case IMPIDIMP:
	ScriptGiveMon(SPECIES_IMPIDIMP,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MORGREM:
	ScriptGiveMon(SPECIES_MORGREM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case GRIMMSNARL:
	ScriptGiveMon(SPECIES_GRIMMSNARL,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case OBSTAGOON:
	ScriptGiveMon(SPECIES_OBSTAGOON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PERRSERKER:
	ScriptGiveMon(SPECIES_PERRSERKER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CURSOLA:
	ScriptGiveMon(SPECIES_CURSOLA,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SIRFETCHD:
	ScriptGiveMon(SPECIES_SIRFETCHD,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MR_RIME:
	ScriptGiveMon(SPECIES_MR_RIME,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case RUNERIGUS:
	ScriptGiveMon(SPECIES_RUNERIGUS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MILCERY:
	ScriptGiveMon(SPECIES_MILCERY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ALCREMIE:
	ScriptGiveMon(SPECIES_ALCREMIE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FALINKS:
	ScriptGiveMon(SPECIES_FALINKS,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case PINCURCHIN:
	ScriptGiveMon(SPECIES_PINCURCHIN,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case SNOM:
	ScriptGiveMon(SPECIES_SNOM,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case FROSMOTH:
	ScriptGiveMon(SPECIES_FROSMOTH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case STONJOURNER:
	ScriptGiveMon(SPECIES_STONJOURNER,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case EISCUE:
	ScriptGiveMon(SPECIES_EISCUE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case INDEEDEE:
	ScriptGiveMon(SPECIES_INDEEDEE,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case MORPEKO:
	ScriptGiveMon(SPECIES_MORPEKO,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case CUFANT:
	ScriptGiveMon(SPECIES_CUFANT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case COPPERAJAH:
	ScriptGiveMon(SPECIES_COPPERAJAH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRACOZOLT:
	ScriptGiveMon(SPECIES_DRACOZOLT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARCTOZOLT:
	ScriptGiveMon(SPECIES_ARCTOZOLT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRACOVISH:
	ScriptGiveMon(SPECIES_DRACOVISH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case ARCTOVISH:
	ScriptGiveMon(SPECIES_ARCTOVISH,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DURALUDON:
	ScriptGiveMon(SPECIES_DURALUDON,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DREEPY:
	ScriptGiveMon(SPECIES_DREEPY,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAKLOAK:
	ScriptGiveMon(SPECIES_DRAKLOAK,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case DRAGAPULT:
	ScriptGiveMon(SPECIES_DRAGAPULT,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;

case TRXATU:
	ScriptGiveMon(SPECIES_TRXATU,110,ITEM_NONE,0,0,0);
	VarAdd(VAR_HAS_ENTERED_BATTLE_FRONTIER,1);
	data->state = MG_MYTEAM_HOENN;
	break;
	}
