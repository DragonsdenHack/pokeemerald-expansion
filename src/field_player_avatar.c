...
static bool8 CanDisguiseRun(void);
...
static const u16 sPlayerAvatarGfxIds[][6] =
{
    {OBJ_EVENT_GFX_PROTA, OBJ_EVENT_GFX_PLAYER_ALTO_RANGO, OBJ_EVENT_GFX_PLAYER_EJECUTIVO, OBJ_EVENT_GFX_PLAYER_ADMIN, OBJ_EVENT_GFX_ADMIN, OBJ_EVENT_GFX_PLAYER_ADMIN_JEFE},
...
static const u16 sPlayerAvatarGfxToStateFlag[6][5][2] =
{
    [MALE] =
    {
...
u8 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    switch (gfxId)
    {
	case OBJ_EVENT_GFX_PLAYER_ALTO_RANGO:
	case OBJ_EVENT_GFX_PLAYER_ALTO_RANGO_BICI:
	case OBJ_EVENT_GFX_PLAYER_ALTO_RANGO_SURF:
	case OBJ_EVENT_GFX_PLAYER_ALTO_RANGO_FIELDMOVE:
		return FEMALE;
	case OBJ_EVENT_GFX_PLAYER_EJECUTIVO:
	case OBJ_EVENT_GFX_PLAYER_EJECUTIVO_BICI:
	case OBJ_EVENT_GFX_PLAYER_EJECUTIVO_SURF:
	case OBJ_EVENT_GFX_PLAYER_EJECUTIVO_FIELDMOVE:
		return EJECUTIVO;
	case OBJ_EVENT_GFX_PLAYER_ADMIN:
	case OBJ_EVENT_GFX_PLAYER_ADMIN_BICI:
	case OBJ_EVENT_GFX_PLAYER_ADMIN_SURF:
	case OBJ_EVENT_GFX_PLAYER_ADMIN_FIELDMOVE:
		return ADMIN;
	case OBJ_EVENT_GFX_ADMIN:
	case OBJ_EVENT_GFX_BICIADMIN:
	case OBJ_EVENT_GFX_SURFADMIN:
	case OBJ_EVENT_GFX_ADMINPOKEBALL:
		return ADMIN_JEFE;
	case OBJ_EVENT_GFX_PLAYER_ADMIN_JEFE:
	case OBJ_EVENT_GFX_PLAYER_ADMIN_JEFE_BICI:
	case OBJ_EVENT_GFX_PLAYER_ADMIN_JEFE_SURF:
	case OBJ_EVENT_GFX_PLAYER_ADMIN_JEFE_FIELDMOVE:
		return ADMIN_JEFE2;	
    default:
        return MALE;
    }
